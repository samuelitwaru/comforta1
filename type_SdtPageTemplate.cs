...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "PageTemplate" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtPageTemplate : GxSilentTrnSdt
   {
      ...
      public void Load( short AV102PageTemplateId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV102PageTemplateId});
         return  ;
      }
   ...
   [DataContract(Name = @"PageTemplate", Namespace = "Comforta11")]
