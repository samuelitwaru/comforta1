...
namespace GeneXus.Programs {
   public class updatelocation : GXDataArea
   {
      ...
      public updatelocation( IGxContext context )
      {
                           ...
                           ref short aP3_LocationId )
      {
         ...
         this.AV16LocationId = aP3_LocationId;
         executePrivate();
         aP3_LocationId=this.AV16LocationId;
      }
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV16LocationId = (short)(Math.Round(NumberUtil.Val( GetPar( "LocationId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "AV16LocationId", StringUtil.LTrimStr( (decimal)(AV16LocationId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("updatelocation.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10PreviousStep)),UrlEncode(StringUtil.RTrim(AV11CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV9GoingBack)),UrlEncode(StringUtil.LTrimStr(AV16LocationId,4,0))}, new string[] {"PreviousStep","CurrentStep","GoingBack","LocationId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vGOINGBACK", AV9GoingBack);
         GxWebStd.gx_hidden_field( context, "gxhash_vGOINGBACK", GetSecureSignedToken( "", AV9GoingBack, context));
         GxWebStd.gx_hidden_field( context, "vLOCATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16LocationId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      }
      ...
      {
         return formatLink("updatelocation.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10PreviousStep)),UrlEncode(StringUtil.RTrim(AV11CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV9GoingBack)),UrlEncode(StringUtil.LTrimStr(AV16LocationId,4,0))}, new string[] {"PreviousStep","CurrentStep","GoingBack","LocationId"})  ;
      }
      ...
      {
         return context.GetMessage( "Update Location", "") ;
      }
      ...
      protected void WB3T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_3T2( true) ;
         }
         else
         {
            wb_table1_6_3T2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_3T2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START3T2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Update Location", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E113T2( )
      {
         ...
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Location Information", "");
         AV13WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Amenities", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Amenities", "");
         AV13WizardSteps.Add(AV14WizardStep, 0);
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "UpdateLocationStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "updatelocationstep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "UpdateLocationStep1";
               WebComp_Wizardstepwc_Component = "UpdateLocationStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0015",(string)"",(string)AV17Pgmname+"_Data",(string)AV10PreviousStep,(bool)AV9GoingBack,(short)AV16LocationId});
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step2") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "UpdateLocationStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "updatelocationstep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "UpdateLocationStep2";
               WebComp_Wizardstepwc_Component = "UpdateLocationStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void wb_table1_6_3T2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_UpdateLocation.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            wb_table1_6_3T2e( true) ;
         }
         else
         {
            wb_table1_6_3T2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV9GoingBack", AV9GoingBack);
         GxWebStd.gx_hidden_field( context, "gxhash_vGOINGBACK", GetSecureSignedToken( "", AV9GoingBack, context));
         AV16LocationId = Convert.ToInt16(getParm(obj,3));
         AssignAttri("", false, "AV16LocationId", StringUtil.LTrimStr( (decimal)(AV16LocationId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714331156", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("updatelocation.js", "?202482714331156", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Update Location", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      private short AV16LocationId ;
      private short wcpOAV16LocationId ;
