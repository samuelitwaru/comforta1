...
namespace GeneXus.Programs {
   public class amenitiestypeww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV40IsAuthorized_AmenitiesTypeName = StringUtil.StrToBool( GetPar( "IsAuthorized_AmenitiesTypeName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV24ManageFiltersExecutionStep, AV19ColumnsSelector, AV42Pgmname, AV27TFAmenitiesTypeName, AV28TFAmenitiesTypeName_Sel, AV14OrderedDsc, AV37IsAuthorized_Update, AV39IsAuthorized_Delete, AV40IsAuthorized_AmenitiesTypeName, AV41IsAuthorized_Insert) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_AMENITIESTYPENAME", AV40IsAuthorized_AmenitiesTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_AMENITIESTYPENAME", GetSecureSignedToken( "", AV40IsAuthorized_AmenitiesTypeName, context));
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV40IsAuthorized_AmenitiesTypeName ,
      ...
      protected void E17392( )
      {
         ...
         GXt_boolean1 = AV40IsAuthorized_AmenitiesTypeName;
         ...
         AV40IsAuthorized_AmenitiesTypeName = GXt_boolean1;
         AssignAttri("", false, "AV40IsAuthorized_AmenitiesTypeName", AV40IsAuthorized_AmenitiesTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_AMENITIESTYPENAME", GetSecureSignedToken( "", AV40IsAuthorized_AmenitiesTypeName, context));
      ...
      private void E19392( )
      {
         ...
         if ( AV40IsAuthorized_AmenitiesTypeName )
         {
      ...
      protected void E11392( )
      {
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "AmenitiesTypeWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "AmenitiesTypeWWColumnsSelector", out  GXt_char3) ;
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "amenitiestype_Insert", out  GXt_boolean1) ;
      ...
      protected void S192( )
      {
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV28TFAmenitiesTypeName_Sel)),  AV28TFAmenitiesTypeName_Sel, out  GXt_char3) ;
         Ddo_grid_Selectedvalue_set = GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV27TFAmenitiesTypeName)),  AV27TFAmenitiesTypeName, out  GXt_char3) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915584932", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenitiestypeww.js", "?202481915584933", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E12392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E13392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E14392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E19392',iparms:[{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV36Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV38Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAmenitiesTypeName_Link',ctrl:'AMENITIESTYPENAME',prop:'Link'}]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E15392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E11392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E16392',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV19ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV42Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFAmenitiesTypeName',fld:'vTFAMENITIESTYPENAME',pic:''},{av:'AV28TFAmenitiesTypeName_Sel',fld:'vTFAMENITIESTYPENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV39IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV40IsAuthorized_AmenitiesTypeName',fld:'vISAUTHORIZED_AMENITIESTYPENAME',pic:'',hsh:true},{av:'AV41IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9',hsh:true}]");
      ...
      private bool AV40IsAuthorized_AmenitiesTypeName ;
