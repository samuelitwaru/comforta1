...
namespace GeneXus.Programs {
   public class createresidentstep4 : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714303571", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createresidentstep4.js", "?202482714303572", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      protected void sendrow_302( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_30_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavResidentproductservicesdts__productservicetypename_Internalname,((SdtResidentProductServiceSDT)AV26ResidentProductServiceSDTs.Item(AV34GXV1)).gxTpr_Productservicetypename,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavResidentproductservicesdts__productservicetypename_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(int)edtavResidentproductservicesdts__productservicetypename_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)30,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridsContainer.GetWrapped() == 1 )
            {
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV31DeleteRecord',fld:'vDELETERECORD',pic:''}]}");
         ...
         setEventMetadata("ENTER","{handler:'E192X2',iparms:[{av:'AV16HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV29WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30},{av:'AV30WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV23Resident',fld:'vRESIDENT',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV30WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV23Resident',fld:'vRESIDENT',pic:''},{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30},{av:'AV8AddedProductsServices',fld:'vADDEDPRODUCTSSERVICES',pic:''},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E132X2',iparms:[{av:'AV29WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[{av:'AV30WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("'DOFINISH'","{handler:'E142X2',iparms:[{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30},{av:'AV29WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV30WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV23Resident',fld:'vRESIDENT',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV16HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("'DOFINISH'",",oparms:[{av:'AV30WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV23Resident',fld:'vRESIDENT',pic:''},{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30},{av:'AV8AddedProductsServices',fld:'vADDEDPRODUCTSSERVICES',pic:''},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'}]}");
         setEventMetadata("'DOADDPRODUCTSERVICE'","{handler:'E152X2',iparms:[{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9'},{av:'dynavProductserviceid'},{av:'AV22ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV8AddedProductsServices',fld:'vADDEDPRODUCTSSERVICES',pic:''},{av:'A74ProductServiceName',fld:'PRODUCTSERVICENAME',pic:''},{av:'A75ProductServiceDescription',fld:'PRODUCTSERVICEDESCRIPTION',pic:''},{av:'A72ProductServiceTypeName',fld:'PRODUCTSERVICETYPENAME',pic:''},{av:'A76ProductServiceQuantity',fld:'PRODUCTSERVICEQUANTITY',pic:'ZZZ9'},{av:'A77ProductServicePicture',fld:'PRODUCTSERVICEPICTURE',pic:''},{av:'A40000ProductServicePicture_GXI',fld:'PRODUCTSERVICEPICTURE_GXI',pic:''},{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30},{av:'AV29WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV16HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("VDELETERECORD.CLICK",",oparms:[{av:'AV26ResidentProductServiceSDTs',fld:'vRESIDENTPRODUCTSERVICESDTS',grid:30,pic:''},{av:'nGXsfl_30_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:30},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_30',ctrl:'GRIDS',prop:'GridRC',grid:30}]}");
         setEventMetadata("VALIDV_PRODUCTSERVICEID","{handler:'Validv_Productserviceid',iparms:[]");
         setEventMetadata("VALIDV_PRODUCTSERVICEID",",oparms:[]}");
