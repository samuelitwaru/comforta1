...
namespace GeneXus.Programs {
   public class addsuppliers : GXDataArea
   {
      public addsuppliers( )
      {
      ...
      public addsuppliers( IGxContext context )
      {
      ...
      {
         return formatLink("addsuppliers.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10PreviousStep)),UrlEncode(StringUtil.RTrim(AV11CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV9GoingBack))}, new string[] {"PreviousStep","CurrentStep","GoingBack"})  ;
      }
      ...
      {
         return context.GetMessage( "Add Suppliers", "") ;
      }
      ...
      protected void WB2H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_2H2( true) ;
         }
         else
         {
            wb_table1_6_2H2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_2H2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2H2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Add Suppliers", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E112H2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = context.GetMessage( "AGB Suppliers", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "AGB Suppliers", "");
         AV13WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Generic Suppliers", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Generic Suppliers", "");
         AV13WizardSteps.Add(AV14WizardStep, 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV11CurrentStep)) )
         {
            ...
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV12CurrentStepAux, "")), context));
            AV7WebSession.Remove(AV30Pgmname+"_Data");
         }
         else
         {
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "AddSuppliersStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "addsuppliersstep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "AddSuppliersStep1";
               WebComp_Wizardstepwc_Component = "AddSuppliersStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0015",(string)"",(string)AV30Pgmname+"_Data",(string)AV10PreviousStep,(bool)AV9GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step2") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "AddSuppliersStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "addsuppliersstep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "AddSuppliersStep2";
               WebComp_Wizardstepwc_Component = "AddSuppliersStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void E122H2( )
      {
         ...
         AV15StepNumber = 1;
         AV31GXV1 = 1;
         while ( AV31GXV1 <= AV13WizardSteps.Count )
         {
            AV14WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV13WizardSteps.Item(AV31GXV1));
      ...
      protected void wb_table1_6_2H2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_AddSuppliers.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            wb_table1_6_2H2e( true) ;
         }
         else
         {
            wb_table1_6_2H2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714325061", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("addsuppliers.js", "?202482714325061", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Add Suppliers", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
