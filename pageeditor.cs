...
namespace GeneXus.Programs {
   public class pageeditor : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("pageeditor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV13PageId,4,0)),UrlEncode(StringUtil.LTrimStr(AV7PageTemplateId,4,0))}, new string[] {"PageId","PageTemplateId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vBCPAGE", AV10BCPage);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vBCPAGE", AV10BCPage);
         }
         GxWebStd.gx_hidden_field( context, "vPAGETEMPLATEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7PageTemplateId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAGETEMPLATEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV7PageTemplateId), "ZZZ9"), context));
      ...
      {
         return formatLink("pageeditor.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV13PageId,4,0)),UrlEncode(StringUtil.LTrimStr(AV7PageTemplateId,4,0))}, new string[] {"PageId","PageTemplateId"})  ;
      }
      ...
      protected void WB360( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsavebtn_Internalname, "", context.GetMessage( "Save", ""), bttBtnsavebtn_Jsonclick, 7, context.GetMessage( "Save", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11361_client"+"'", TempTags, "", 2, "HLP_PageEditor.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_22_362( true) ;
         }
         else
         {
            wb_table1_22_362( false) ;
         }
         return  ;
      }

      protected void wb_table1_22_362e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void E14362( )
      {
         /* Start Routine */
         returnInSub = false;
         AV10BCPage = new SdtPage(context);
         if ( (0==AV13PageId) )
         {
            AV8PageTemplate.Load(AV7PageTemplateId);
            Ucpageeditor_Pagetemplatehtml = AV8PageTemplate.gxTpr_Pagetemplatehtml;
            ucUcpageeditor.SendProperty(context, "", false, Ucpageeditor_Internalname, "PageTemplateHtml", Ucpageeditor_Pagetemplatehtml);
            Ucpageeditor_Pagetemplatecss = AV8PageTemplate.gxTpr_Pagetemplatecss;
            ucUcpageeditor.SendProperty(context, "", false, Ucpageeditor_Internalname, "PageTemplateCss", Ucpageeditor_Pagetemplatecss);
         }
         else
         {
            AV10BCPage.Load(AV13PageId);
            Ucpageeditor_Pagetemplatehtml = AV10BCPage.gxTpr_Pagehtmlcontent;
            ucUcpageeditor.SendProperty(context, "", false, Ucpageeditor_Internalname, "PageTemplateHtml", Ucpageeditor_Pagetemplatehtml);
            Ucpageeditor_Pagetemplatecss = AV10BCPage.gxTpr_Pagecsscontent;
            ucUcpageeditor.SendProperty(context, "", false, Ucpageeditor_Internalname, "PageTemplateCss", Ucpageeditor_Pagetemplatecss);
            Form.Caption = Form.Caption+" - "+AV10BCPage.gxTpr_Pagename;
      ...
      protected void E12362( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV10BCPage", AV10BCPage);
      }
      ...
      protected void S122( )
      {
         /* 'UPDATEPAGE' Routine */
         returnInSub = false;
         AV10BCPage.gxTpr_Pageid = AV13PageId;
         AV10BCPage.gxTpr_Pagehtmlcontent = Ucpageeditor_Pagetemplatehtml;
         AV10BCPage.gxTpr_Pagecsscontent = Ucpageeditor_Pagetemplatecss;
         AV10BCPage.gxTpr_Pagejsoncontent = Ucpageeditor_Pagetemplatehtml;
         GXt_int1 = 0;
         new getloggedinusercustomerid(context ).execute( out  GXt_int1) ;
         AV10BCPage.gxTpr_Customerid = GXt_int1;
         if ( AV10BCPage.Update() )
         {
         ...
         {
            AV15GXV2 = 1;
            AV14GXV1 = AV10BCPage.GetMessages();
            while ( AV15GXV2 <= AV14GXV1.Count )
            {
               AV12Message = ((GeneXus.Utils.SdtMessages_Message)AV14GXV1.Item(AV15GXV2));
      ...
      protected void wb_table1_22_362( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_22_362e( true) ;
         }
         else
         {
            wb_table1_22_362e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV13PageId", StringUtil.LTrimStr( (decimal)(AV13PageId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13PageId), "ZZZ9"), context));
         AV7PageTemplateId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV7PageTemplateId", StringUtil.LTrimStr( (decimal)(AV7PageTemplateId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAGETEMPLATEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV7PageTemplateId), "ZZZ9"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915581389", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pageeditor.js", "?202481915581389", false, true);
         context.AddJavascriptSource("UserControls/UCAppToolBoxRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/ConfirmPanel/BootstrapConfirmPanelRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV13PageId',fld:'vPAGEID',pic:'ZZZ9',hsh:true},{av:'AV7PageTemplateId',fld:'vPAGETEMPLATEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOSAVEBTN'","{handler:'E11361',iparms:[]");
         setEventMetadata("'DOSAVEBTN'",",oparms:[]}");
         setEventMetadata("SAVEBTN_MODAL.CLOSE","{handler:'E13362',iparms:[]");
         setEventMetadata("SAVEBTN_MODAL.CLOSE",",oparms:[]}");
         setEventMetadata("UCPAGEEDITOR.ONSAVE","{handler:'E12362',iparms:[{av:'AV13PageId',fld:'vPAGEID',pic:'ZZZ9',hsh:true},{av:'AV10BCPage',fld:'vBCPAGE',pic:''},{av:'Ucpageeditor_Pagetemplatehtml',ctrl:'UCPAGEEDITOR',prop:'PageTemplateHtml'},{av:'Ucpageeditor_Pagetemplatecss',ctrl:'UCPAGEEDITOR',prop:'PageTemplateCss'}]");
         setEventMetadata("UCPAGEEDITOR.ONSAVE",",oparms:[{av:'AV10BCPage',fld:'vBCPAGE',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV8PageTemplate = new SdtPageTemplate(context);
      ...
      private SdtPage AV10BCPage ;
      private GeneXus.Utils.SdtMessages_Message AV12Message ;
      private SdtPageTemplate AV8PageTemplate ;
   }
