...
namespace GeneXus.Programs {
   public class pageww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV57CustomerId = (short)(Math.Round(NumberUtil.Val( GetPar( "CustomerId"), "."), 18, MidpointRounding.ToEven));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV57CustomerId, AV24ManageFiltersExecutionStep, AV58Pgmname, AV27TFPageName, AV28TFPageName_Sel, AV14OrderedDsc, AV49IsAuthorized_Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCUSTOMERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57CustomerId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void WB300( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnnewpagebtn_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", context.GetMessage( "New Page", ""), bttBtnnewpagebtn_Jsonclick, 7, context.GetMessage( "New Page", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11301_client"+"'", TempTags, "", 2, "HLP_PageWW.htm");
         ...
         if ( wbEnd == 35 )
         {
            ...
            wb_table1_52_302( true) ;
         }
         else
         {
            wb_table1_52_302( false) ;
         }
         return  ;
      }

      protected void wb_table1_52_302e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV56UpdatePage = cgiGet( edtavUpdatepage_Internalname);
                              AssignProp("", false, edtavUpdatepage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV56UpdatePage)) ? AV62Updatepage_GXI : context.convertURL( context.PathToRelativeUrl( AV56UpdatePage))), !bGXsfl_35_Refreshing);
                              AssignProp("", false, edtavUpdatepage_Internalname, "SrcSet", context.GetImageSrcSet( AV56UpdatePage), true);
                              A98PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtPageId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A98PageId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "PAGEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A98PageId), 4, 0, ".", "")));
      }
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      }
      ...
      protected void RF302( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV59Pagewwds_1_filterfulltext ,
                                                 AV61Pagewwds_3_tfpagename_sel ,
                                                 AV60Pagewwds_2_tfpagename ,
                                                 AV57CustomerId ,
                                                 A99PageName ,
                                                 A1CustomerId ,
                                                 AV14OrderedDsc } ,
            ...
            lV59Pagewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV59Pagewwds_1_filterfulltext), "%", "");
            lV60Pagewwds_2_tfpagename = StringUtil.Concat( StringUtil.RTrim( AV60Pagewwds_2_tfpagename), "%", "");
            /* Using cursor H00302 */
            pr_default.execute(0, new Object[] {lV59Pagewwds_1_filterfulltext, lV60Pagewwds_2_tfpagename, AV61Pagewwds_3_tfpagename_sel, AV57CustomerId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A5CustomerEmail = H00302_A5CustomerEmail[0];
               n5CustomerEmail = H00302_n5CustomerEmail[0];
               A3CustomerName = H00302_A3CustomerName[0];
               A1CustomerId = H00302_A1CustomerId[0];
               A101PageJsonContent = H00302_A101PageJsonContent[0];
               A100PageHtmlContent = H00302_A100PageHtmlContent[0];
               A99PageName = H00302_A99PageName[0];
               A98PageId = H00302_A98PageId[0];
               A5CustomerEmail = H00302_A5CustomerEmail[0];
               n5CustomerEmail = H00302_n5CustomerEmail[0];
               A3CustomerName = H00302_A3CustomerName[0];
               E19302 ();
      ...
      protected void send_integrity_lvl_hashes302( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV49IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV49IsAuthorized_Delete, context));
         GxWebStd.gx_hidden_field( context, "gxhash_PAGEID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sGXsfl_35_idx, context.localUtil.Format( (decimal)(A98PageId), "ZZZ9"), context));
      }
      ...
      {
         AV59Pagewwds_1_filterfulltext = AV16FilterFullText;
         AV60Pagewwds_2_tfpagename = AV27TFPageName;
         AV61Pagewwds_3_tfpagename_sel = AV28TFPageName_Sel;
         ...
         lV60Pagewwds_2_tfpagename = StringUtil.Concat( StringUtil.RTrim( AV60Pagewwds_2_tfpagename), "%", "");
         /* Using cursor H00303 */
         pr_default.execute(1, new Object[] {lV59Pagewwds_1_filterfulltext, lV60Pagewwds_2_tfpagename, AV61Pagewwds_3_tfpagename_sel, AV57CustomerId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtavDelete_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDelete_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtPageId_Enabled = 0;
         AssignProp("", false, edtPageId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtPageName_Enabled = 0;
         AssignProp("", false, edtPageName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtPageHtmlContent_Enabled = 0;
         AssignProp("", false, edtPageHtmlContent_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageHtmlContent_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtPageJsonContent_Enabled = 0;
         AssignProp("", false, edtPageJsonContent_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageJsonContent_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerId_Enabled = 0;
         AssignProp("", false, edtCustomerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerName_Enabled = 0;
         AssignProp("", false, edtCustomerName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerEmail_Enabled = 0;
         AssignProp("", false, edtCustomerEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerEmail_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void E17302( )
      {
         /* Start Routine */
         returnInSub = false;
         GXt_int1 = AV57CustomerId;
         new getloggedinusercustomerid(context ).execute( out  GXt_int1) ;
         AV57CustomerId = GXt_int1;
         AssignAttri("", false, "AV57CustomerId", StringUtil.LTrimStr( (decimal)(AV57CustomerId), 4, 0));
         subGrid_Rows = 10;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      private void E19302( )
      {
         ...
         AV56UpdatePage = context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( ));
         AssignAttri("", false, edtavUpdatepage_Internalname, AV56UpdatePage);
         AV62Updatepage_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         edtavUpdatepage_Tooltiptext = "";
         AV48Delete = "<i class=\"fa fa-times\"></i>";
         AssignAttri("", false, edtavDelete_Internalname, AV48Delete);
         if ( AV49IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("page.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A98PageId,4,0))}, new string[] {"Mode","PageId"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E12302( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("PageWWFilters")),UrlEncode(StringUtil.RTrim(AV58Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV24ManageFiltersExecutionStep = 2;
            AssignAttri("", false, "AV24ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV24ManageFiltersExecutionStep), 1, 0));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "PageWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "page_Delete", out  GXt_boolean4) ;
      ...
      protected void S182( )
      {
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV28TFPageName_Sel)),  AV28TFPageName_Sel, out  GXt_char3) ;
         Ddo_grid_Selectedvalue_set = GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV27TFPageName)),  AV27TFPageName, out  GXt_char3) ;
      ...
      protected void wb_table1_52_302( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_52_302e( true) ;
         }
         else
         {
            wb_table1_52_302e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248271433691", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pageww.js", "?20248271433693", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            TempTags = " " + ((edtavUpdatepage_Enabled!=0)&&(edtavUpdatepage_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 36,'',false,'',35)\"" : " ");
            ...
            StyleString = "";
            AV56UpdatePage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV56UpdatePage))&&String.IsNullOrEmpty(StringUtil.RTrim( AV62Updatepage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV56UpdatePage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV56UpdatePage)) ? AV62Updatepage_GXI : context.PathToRelativeUrl( AV56UpdatePage));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdatepage_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)1,(string)"",(string)edtavUpdatepage_Tooltiptext,(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)7,(string)edtavUpdatepage_Jsonclick,(string)"'"+""+"'"+",false,"+"'"+"e20302_client"+"'",(string)StyleString,(string)ClassString,(string)"WWActionColumn",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV56UpdatePage_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl35( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", context.convertURL( AV56UpdatePage));
            GridColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavUpdatepage_Tooltiptext));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A98PageId), 4, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A99PageName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A100PageHtmlContent));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A101PageJsonContent));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize_properties( )
      {
         ...
         edtavUpdatepage_Visible = -1;
         edtavUpdatepage_Enabled = 1;
         edtavUpdatepage_Tooltiptext = "";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV44GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV45GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E13302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E14302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E15302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedcolumn',ctrl:'DDO_GRID',prop:'SelectedColumn'},{av:'Ddo_grid_Filteredtext_get',ctrl:'DDO_GRID',prop:'FilteredText_get'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E19302',iparms:[{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A98PageId',fld:'PAGEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV56UpdatePage',fld:'vUPDATEPAGE',pic:''},{av:'edtavUpdatepage_Tooltiptext',ctrl:'vUPDATEPAGE',prop:'Tooltiptext'},{av:'AV48Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E12302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'Ddo_grid_Selectedvalue_set',ctrl:'DDO_GRID',prop:'SelectedValue_set'},{av:'Ddo_grid_Filteredtext_set',ctrl:'DDO_GRID',prop:'FilteredText_set'},{av:'Ddo_grid_Sortedstatus',ctrl:'DDO_GRID',prop:'SortedStatus'},{av:'AV43GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV44GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV45GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("'DONEWPAGEBTN'","{handler:'E11301',iparms:[]");
         setEventMetadata("'DONEWPAGEBTN'",",oparms:[]}");
         setEventMetadata("NEWPAGEBTN_MODAL.CLOSE","{handler:'E16302',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV57CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9'},{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV58Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV27TFPageName',fld:'vTFPAGENAME',pic:''},{av:'AV28TFPageName_Sel',fld:'vTFPAGENAME_SEL',pic:''},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("NEWPAGEBTN_MODAL.CLOSE",",oparms:[{av:'AV24ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV43GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV44GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV45GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV22ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("VUPDATEPAGE.CLICK","{handler:'E20302',iparms:[{av:'A98PageId',fld:'PAGEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("VUPDATEPAGE.CLICK",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         AV48Delete = "";
         scmdbuf = "";
         lV59Pagewwds_1_filterfulltext = "";
         lV60Pagewwds_2_tfpagename = "";
         AV59Pagewwds_1_filterfulltext = "";
         AV61Pagewwds_3_tfpagename_sel = "";
         AV60Pagewwds_2_tfpagename = "";
         H00302_A5CustomerEmail = new string[] {""} ;
         H00302_n5CustomerEmail = new bool[] {false} ;
         H00302_A3CustomerName = new string[] {""} ;
         H00302_A1CustomerId = new short[1] ;
         H00302_A101PageJsonContent = new string[] {""} ;
         H00302_A100PageHtmlContent = new string[] {""} ;
         H00302_A99PageName = new string[] {""} ;
         H00302_A98PageId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pageww__default(),
            new Object[][] {
                new Object[] {
               H00302_A5CustomerEmail, H00302_n5CustomerEmail, H00302_A3CustomerName, H00302_A1CustomerId, H00302_A101PageJsonContent, H00302_A100PageHtmlContent, H00302_A99PageName, H00302_A98PageId
               }
               , new Object[] {
      ...
      private int edtavUpdatepage_Enabled ;
      private int edtavUpdatepage_Visible ;
      ...
      private bool AV56UpdatePage_IsBlob ;
      ...
      private string AV62Updatepage_GXI ;
      private string A99PageName ;
      private string A3CustomerName ;
      private string A5CustomerEmail ;
      private string lV59Pagewwds_1_filterfulltext ;
      private string lV60Pagewwds_2_tfpagename ;
      private string AV59Pagewwds_1_filterfulltext ;
      private string AV61Pagewwds_3_tfpagename_sel ;
      private string AV60Pagewwds_2_tfpagename ;
      private string AV56UpdatePage ;
      ...
      private string[] H00302_A5CustomerEmail ;
      private bool[] H00302_n5CustomerEmail ;
      private string[] H00302_A3CustomerName ;
      private short[] H00302_A1CustomerId ;
      private string[] H00302_A101PageJsonContent ;
      private string[] H00302_A100PageHtmlContent ;
      private string[] H00302_A99PageName ;
      private short[] H00302_A98PageId ;
   ...
   public class pageww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00302( IGxContext context ,
                                             string AV59Pagewwds_1_filterfulltext ,
                                             string AV61Pagewwds_3_tfpagename_sel ,
                                             string AV60Pagewwds_2_tfpagename ,
                                             short AV57CustomerId ,
                                             string A99PageName ,
                                             short A1CustomerId ,
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV59Pagewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.PageName like '%' || :lV59Pagewwds_1_filterfulltext))");
         }
         else
         {
            GXv_int6[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV61Pagewwds_3_tfpagename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV60Pagewwds_2_tfpagename)) ) )
         {
            AddWhere(sWhereString, "(T1.PageName like :lV60Pagewwds_2_tfpagename)");
         }
         else
         {
            GXv_int6[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Pagewwds_3_tfpagename_sel)) && ! ( StringUtil.StrCmp(AV61Pagewwds_3_tfpagename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.PageName = ( :AV61Pagewwds_3_tfpagename_sel))");
         }
         else
         {
            GXv_int6[2] = 1;
         }
         if ( StringUtil.StrCmp(AV61Pagewwds_3_tfpagename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.PageName))=0))");
         }
         if ( ! (0==AV57CustomerId) )
         {
            AddWhere(sWhereString, "(T1.CustomerId = :AV57CustomerId)");
         }
         else
         {
            GXv_int6[3] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00302(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
               case 1 :
                     return conditional_H00303(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV59Pagewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV60Pagewwds_2_tfpagename",GXType.VarChar,40,0) ,
          new ParDef("AV61Pagewwds_3_tfpagename_sel",GXType.VarChar,40,0) ,
          new ParDef("AV57CustomerId",GXType.Int16,4,0) ,
