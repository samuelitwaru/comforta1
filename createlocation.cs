...
namespace GeneXus.Programs {
   public class createlocation : GXDataArea
   {
      ...
      public createlocation( IGxContext context )
      {
      ...
      {
         return formatLink("createlocation.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10PreviousStep)),UrlEncode(StringUtil.RTrim(AV11CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV9GoingBack))}, new string[] {"PreviousStep","CurrentStep","GoingBack"})  ;
      }
      ...
      {
         return context.GetMessage( "Create Location and Receptionists", "") ;
      }
      ...
      protected void WB2G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_2G2( true) ;
         }
         else
         {
            wb_table1_6_2G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_2G2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START2G2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Create Location and Receptionists", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E112G2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Receptionists", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Receptionist Information", "");
         AV13WizardSteps.Add(AV14WizardStep, 0);
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "CreateLocationStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "createlocationstep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "CreateLocationStep1";
               WebComp_Wizardstepwc_Component = "CreateLocationStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step2") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "CreateLocationStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "createlocationstep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "CreateLocationStep2";
               WebComp_Wizardstepwc_Component = "CreateLocationStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step3") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "CreateLocationStep3")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "createlocationstep3", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "CreateLocationStep3";
               WebComp_Wizardstepwc_Component = "CreateLocationStep3";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void wb_table1_6_2G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_CreateLocation.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            wb_table1_6_2G2e( true) ;
         }
         else
         {
            wb_table1_6_2G2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714324052", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("createlocation.js", "?202482714324053", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Create Location and Receptionists", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
