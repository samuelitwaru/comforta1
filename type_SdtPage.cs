...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Page" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtPage : GxSilentTrnSdt
   {
      ...
      public void Load( short AV98PageId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(short)AV98PageId});
         return  ;
      }
   ...
   [DataContract(Name = @"Page", Namespace = "Comforta11")]
