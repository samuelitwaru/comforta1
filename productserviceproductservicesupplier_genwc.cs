...
namespace GeneXus.Programs {
   public class productserviceproductservicesupplier_genwc : GXWebComponent
   {
      public productserviceproductservicesupplier_genwc( )
      {
      ...
      public productserviceproductservicesupplier_genwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV32IsAuthorized_Supplier_GenKvKNumber = StringUtil.StrToBool( GetPar( "IsAuthorized_Supplier_GenKvKNumber"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProductServiceId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV32IsAuthorized_Supplier_GenKvKNumber, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "ProductServiceProductServiceSupplier_GenWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Product Service Product Service Supplier_Gen WC", "")) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_SUPPLIER_GENKVKNUMBER", AV32IsAuthorized_Supplier_GenKvKNumber);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUPPLIER_GENKVKNUMBER", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Supplier_GenKvKNumber, context));
      ...
      {
         return "ProductServiceProductServiceSupplier_GenWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Product Service Product Service Supplier_Gen WC", "") ;
      }
      ...
      protected void WB1W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productserviceproductservicesupplier_genwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START1W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Product Service Product Service Supplier_Gen WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV32IsAuthorized_Supplier_GenKvKNumber ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIER_GENID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A64Supplier_GenId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"SUPPLIER_GENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A64Supplier_GenId), 4, 0, ".", "")));
      }
      ...
      protected void RF1W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8ProductServiceId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H001W2 */
            pr_default.execute(0, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A73ProductServiceId = H001W2_A73ProductServiceId[0];
               AssignAttri(sPrefix, false, "A73ProductServiceId", StringUtil.LTrimStr( (decimal)(A73ProductServiceId), 4, 0));
               A70Supplier_GenContactPhone = H001W2_A70Supplier_GenContactPhone[0];
               n70Supplier_GenContactPhone = H001W2_n70Supplier_GenContactPhone[0];
               A69Supplier_GenContactName = H001W2_A69Supplier_GenContactName[0];
               n69Supplier_GenContactName = H001W2_n69Supplier_GenContactName[0];
               A68Supplier_GenPostalAddress = H001W2_A68Supplier_GenPostalAddress[0];
               n68Supplier_GenPostalAddress = H001W2_n68Supplier_GenPostalAddress[0];
               A67Supplier_GenVisitingAddress = H001W2_A67Supplier_GenVisitingAddress[0];
               n67Supplier_GenVisitingAddress = H001W2_n67Supplier_GenVisitingAddress[0];
               A66Supplier_GenCompanyName = H001W2_A66Supplier_GenCompanyName[0];
               A65Supplier_GenKvKNumber = H001W2_A65Supplier_GenKvKNumber[0];
               A64Supplier_GenId = H001W2_A64Supplier_GenId[0];
               A70Supplier_GenContactPhone = H001W2_A70Supplier_GenContactPhone[0];
               n70Supplier_GenContactPhone = H001W2_n70Supplier_GenContactPhone[0];
               A69Supplier_GenContactName = H001W2_A69Supplier_GenContactName[0];
               n69Supplier_GenContactName = H001W2_n69Supplier_GenContactName[0];
      ...
      protected void send_integrity_lvl_hashes1W2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIER_GENID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A64Supplier_GenId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H001W3 */
         pr_default.execute(1, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtSupplier_GenId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenKvKNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenKvKNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenKvKNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenCompanyName_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenCompanyName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenCompanyName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenVisitingAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenVisitingAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenVisitingAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenPostalAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenPostalAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenPostalAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenContactName_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenContactName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenContactName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenContactPhone_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenContactPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenContactPhone_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      ...
      protected void E161W2( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_Supplier_GenKvKNumber;
         ...
         AV32IsAuthorized_Supplier_GenKvKNumber = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV32IsAuthorized_Supplier_GenKvKNumber", AV32IsAuthorized_Supplier_GenKvKNumber);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUPPLIER_GENKVKNUMBER", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Supplier_GenKvKNumber, context));
      ...
      private void E181W2( )
      {
         ...
         if ( AV32IsAuthorized_Supplier_GenKvKNumber )
         {
      ...
      protected void E111W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceSupplier_GenWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceSupplier_GenWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProductServiceProductServiceSupplier_GenWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProductServiceProductServiceSupplier_GenWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Supplier_Gen";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productserviceproductservicesupplier_genwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714303979", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("productserviceproductservicesupplier_genwc.js", "?202482714303979", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtSupplier_GenId_Internalname = sPrefix+"SUPPLIER_GENID_"+sGXsfl_35_idx;
         edtSupplier_GenKvKNumber_Internalname = sPrefix+"SUPPLIER_GENKVKNUMBER_"+sGXsfl_35_idx;
         edtSupplier_GenCompanyName_Internalname = sPrefix+"SUPPLIER_GENCOMPANYNAME_"+sGXsfl_35_idx;
         edtSupplier_GenVisitingAddress_Internalname = sPrefix+"SUPPLIER_GENVISITINGADDRESS_"+sGXsfl_35_idx;
         edtSupplier_GenPostalAddress_Internalname = sPrefix+"SUPPLIER_GENPOSTALADDRESS_"+sGXsfl_35_idx;
         edtSupplier_GenContactName_Internalname = sPrefix+"SUPPLIER_GENCONTACTNAME_"+sGXsfl_35_idx;
         edtSupplier_GenContactPhone_Internalname = sPrefix+"SUPPLIER_GENCONTACTPHONE_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtSupplier_GenId_Internalname = sPrefix+"SUPPLIER_GENID_"+sGXsfl_35_fel_idx;
         edtSupplier_GenKvKNumber_Internalname = sPrefix+"SUPPLIER_GENKVKNUMBER_"+sGXsfl_35_fel_idx;
         edtSupplier_GenCompanyName_Internalname = sPrefix+"SUPPLIER_GENCOMPANYNAME_"+sGXsfl_35_fel_idx;
         edtSupplier_GenVisitingAddress_Internalname = sPrefix+"SUPPLIER_GENVISITINGADDRESS_"+sGXsfl_35_fel_idx;
         edtSupplier_GenPostalAddress_Internalname = sPrefix+"SUPPLIER_GENPOSTALADDRESS_"+sGXsfl_35_fel_idx;
         edtSupplier_GenContactName_Internalname = sPrefix+"SUPPLIER_GENCONTACTNAME_"+sGXsfl_35_fel_idx;
         edtSupplier_GenContactPhone_Internalname = sPrefix+"SUPPLIER_GENCONTACTPHONE_"+sGXsfl_35_fel_idx;
      }
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplier_GenVisitingAddress_Internalname,(string)A67Supplier_GenVisitingAddress,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A67Supplier_GenVisitingAddress),(string)"_blank",(string)"",(string)"",(string)edtSupplier_GenVisitingAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtSupplier_GenKvKNumber_Internalname = sPrefix+"SUPPLIER_GENKVKNUMBER";
         edtSupplier_GenCompanyName_Internalname = sPrefix+"SUPPLIER_GENCOMPANYNAME";
         edtSupplier_GenVisitingAddress_Internalname = sPrefix+"SUPPLIER_GENVISITINGADDRESS";
         edtSupplier_GenPostalAddress_Internalname = sPrefix+"SUPPLIER_GENPOSTALADDRESS";
         edtSupplier_GenContactName_Internalname = sPrefix+"SUPPLIER_GENCONTACTNAME";
         edtSupplier_GenContactPhone_Internalname = sPrefix+"SUPPLIER_GENCONTACTPHONE";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:Supplier_GenId|3:Supplier_GenKvKNumber|4:Supplier_GenCompanyName|5:Supplier_GenVisitingAddress|6:Supplier_GenPostalAddress|7:Supplier_GenContactName|8:Supplier_GenContactPhone";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E131W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E141W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E181W2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A64Supplier_GenId',fld:'SUPPLIER_GENID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSupplier_GenKvKNumber_Link',ctrl:'SUPPLIER_GENKVKNUMBER',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E111W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E151W2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_GenKvKNumber',fld:'vISAUTHORIZED_SUPPLIER_GENKVKNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A64Supplier_GenId',fld:'SUPPLIER_GENID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("VALID_SUPPLIER_GENID","{handler:'Valid_Supplier_genid',iparms:[]");
         setEventMetadata("VALID_SUPPLIER_GENID",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H001W2_A73ProductServiceId = new short[1] ;
         H001W2_A70Supplier_GenContactPhone = new string[] {""} ;
         H001W2_n70Supplier_GenContactPhone = new bool[] {false} ;
         H001W2_A69Supplier_GenContactName = new string[] {""} ;
         H001W2_n69Supplier_GenContactName = new bool[] {false} ;
         H001W2_A68Supplier_GenPostalAddress = new string[] {""} ;
         H001W2_n68Supplier_GenPostalAddress = new bool[] {false} ;
         H001W2_A67Supplier_GenVisitingAddress = new string[] {""} ;
         H001W2_n67Supplier_GenVisitingAddress = new bool[] {false} ;
         H001W2_A66Supplier_GenCompanyName = new string[] {""} ;
         H001W2_A65Supplier_GenKvKNumber = new string[] {""} ;
         H001W2_A64Supplier_GenId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productserviceproductservicesupplier_genwc__default(),
            new Object[][] {
                new Object[] {
               H001W2_A73ProductServiceId, H001W2_A70Supplier_GenContactPhone, H001W2_n70Supplier_GenContactPhone, H001W2_A69Supplier_GenContactName, H001W2_n69Supplier_GenContactName, H001W2_A68Supplier_GenPostalAddress, H001W2_n68Supplier_GenPostalAddress, H001W2_A67Supplier_GenVisitingAddress, H001W2_n67Supplier_GenVisitingAddress, H001W2_A66Supplier_GenCompanyName,
               H001W2_A65Supplier_GenKvKNumber, H001W2_A64Supplier_GenId
               }
               , new Object[] {
      ...
      private bool AV32IsAuthorized_Supplier_GenKvKNumber ;
      ...
      private short[] H001W2_A73ProductServiceId ;
      private string[] H001W2_A70Supplier_GenContactPhone ;
      private bool[] H001W2_n70Supplier_GenContactPhone ;
      private string[] H001W2_A69Supplier_GenContactName ;
      private bool[] H001W2_n69Supplier_GenContactName ;
      private string[] H001W2_A68Supplier_GenPostalAddress ;
      private bool[] H001W2_n68Supplier_GenPostalAddress ;
      private string[] H001W2_A67Supplier_GenVisitingAddress ;
      private bool[] H001W2_n67Supplier_GenVisitingAddress ;
      private string[] H001W2_A66Supplier_GenCompanyName ;
      private string[] H001W2_A65Supplier_GenKvKNumber ;
      private short[] H001W2_A64Supplier_GenId ;
   ...
   public class productserviceproductservicesupplier_genwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.ProductServiceId, T2.Supplier_GenContactPhone, T2.Supplier_GenContactName, T2.Supplier_GenPostalAddress, T2.Supplier_GenVisitingAddress, T2.Supplier_GenCompanyName, T2.Supplier_GenKvKNumber, T1.Supplier_GenId";
         sFromString = " FROM (Supplier_GenProductService T1 INNER JOIN Supplier_Gen T2 ON T2.Supplier_GenId = T1.Supplier_GenId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.Supplier_GenId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.Supplier_GenKvKNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_GenCompanyName like '%' || :lV16FilterFullText) or ( T2.Supplier_GenVisitingAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_GenPostalAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_GenContactName like '%' || :lV16FilterFullText) or ( T2.Supplier_GenContactPhone like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenKvKNumber, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenKvKNumber DESC, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T1.Supplier_GenId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenCompanyName, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenCompanyName DESC, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenVisitingAddress, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenVisitingAddress DESC, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenPostalAddress, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenPostalAddress DESC, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenContactName, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenContactName DESC, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_GenContactPhone, T1.Supplier_GenId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_GenContactPhone DESC, T1.Supplier_GenId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T1.ProductServiceId";
         }
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (Supplier_GenProductService T1 INNER JOIN Supplier_Gen T2 ON T2.Supplier_GenId = T1.Supplier_GenId)";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.Supplier_GenId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.Supplier_GenKvKNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_GenCompanyName like '%' || :lV16FilterFullText) or ( T2.Supplier_GenVisitingAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_GenPostalAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_GenContactName like '%' || :lV16FilterFullText) or ( T2.Supplier_GenContactPhone like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001W2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] );
               case 1 :
                     return conditional_H001W3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] );
         }
