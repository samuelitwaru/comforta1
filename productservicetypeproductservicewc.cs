...
namespace GeneXus.Programs {
   public class productservicetypeproductservicewc : GXWebComponent
   {
      public productservicetypeproductservicewc( )
      {
      ...
      public productservicetypeproductservicewc( IGxContext context )
      {
      ...
      {
         this.AV8ProductServiceTypeId = aP0_ProductServiceTypeId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ProductServiceTypeId = (short)(Math.Round(NumberUtil.Val( GetPar( "ProductServiceTypeId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8ProductServiceTypeId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceTypeId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8ProductServiceTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProductServiceTypeId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_ProductServiceName, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "ProductServiceTypeProductServiceWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Product Service Type Product Service WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("productservicetypeproductservicewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8ProductServiceTypeId,4,0))}, new string[] {"ProductServiceTypeId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_PRODUCTSERVICENAME", AV31IsAuthorized_ProductServiceName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRODUCTSERVICENAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_ProductServiceName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ProductServiceTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ProductServiceTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPRODUCTSERVICETYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProductServiceTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "ProductServiceTypeProductServiceWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Product Service Type Product Service WC", "") ;
      }
      ...
      protected void WB240( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productservicetypeproductservicewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductServiceTypeId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A71ProductServiceTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A71ProductServiceTypeId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductServiceTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtProductServiceTypeId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_ProductServiceTypeProductServiceWC.htm");
            /* User Defined Control */
      ...
      protected void START242( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Product Service Type Product Service WC", ""), 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A77ProductServicePicture)) ? A40000ProductServicePicture_GXI : context.convertURL( context.PathToRelativeUrl( A77ProductServicePicture))), !bGXsfl_35_Refreshing);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUCTSERVICEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A73ProductServiceId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PRODUCTSERVICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A73ProductServiceId), 4, 0, ".", "")));
      }
      ...
      protected void RF242( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8ProductServiceTypeId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H00242 */
            pr_default.execute(0, new Object[] {AV8ProductServiceTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A71ProductServiceTypeId = H00242_A71ProductServiceTypeId[0];
               AssignAttri(sPrefix, false, "A71ProductServiceTypeId", StringUtil.LTrimStr( (decimal)(A71ProductServiceTypeId), 4, 0));
               A40000ProductServicePicture_GXI = H00242_A40000ProductServicePicture_GXI[0];
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A77ProductServicePicture)) ? A40000ProductServicePicture_GXI : context.convertURL( context.PathToRelativeUrl( A77ProductServicePicture))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "SrcSet", context.GetImageSrcSet( A77ProductServicePicture), true);
               A76ProductServiceQuantity = H00242_A76ProductServiceQuantity[0];
               A75ProductServiceDescription = H00242_A75ProductServiceDescription[0];
               A74ProductServiceName = H00242_A74ProductServiceName[0];
               A73ProductServiceId = H00242_A73ProductServiceId[0];
               A77ProductServicePicture = H00242_A77ProductServicePicture[0];
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A77ProductServicePicture)) ? A40000ProductServicePicture_GXI : context.convertURL( context.PathToRelativeUrl( A77ProductServicePicture))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "SrcSet", context.GetImageSrcSet( A77ProductServicePicture), true);
               E18242 ();
      ...
      protected void send_integrity_lvl_hashes242( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PRODUCTSERVICEID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A73ProductServiceId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H00243 */
         pr_default.execute(1, new Object[] {AV8ProductServiceTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtProductServiceId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtProductServiceName_Enabled = 0;
         AssignProp(sPrefix, false, edtProductServiceName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtProductServiceDescription_Enabled = 0;
         AssignProp(sPrefix, false, edtProductServiceDescription_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceDescription_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtProductServiceQuantity_Enabled = 0;
         AssignProp(sPrefix, false, edtProductServiceQuantity_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceQuantity_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtProductServicePicture_Enabled = 0;
         AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServicePicture_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtProductServiceTypeId_Enabled = 0;
         AssignProp(sPrefix, false, edtProductServiceTypeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceTypeId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP240( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ProductServiceTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProductServiceTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E16242( )
      {
         ...
         AssignAttri(sPrefix, false, "AV31IsAuthorized_ProductServiceName", AV31IsAuthorized_ProductServiceName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRODUCTSERVICENAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_ProductServiceName, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtProductServiceTypeId_Visible = 0;
         AssignProp(sPrefix, false, edtProductServiceTypeId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtProductServiceTypeId_Visible), 5, 0), true);
      ...
      protected void E11242( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceTypeProductServiceWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceTypeProductServiceWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProductServiceTypeProductServiceWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProductServiceTypeProductServiceWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "ProductService";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "ProductServiceTypeId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ProductServiceTypeId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ProductServiceTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ProductServiceTypeId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceTypeId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8ProductServiceTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productservicetypeproductservicewc", GetJustCreated( ));
         ...
         {
            AV8ProductServiceTypeId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ProductServiceTypeId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceTypeId), 4, 0));
         }
         wcpOAV8ProductServiceTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProductServiceTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8ProductServiceTypeId != wcpOAV8ProductServiceTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8ProductServiceTypeId = AV8ProductServiceTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8ProductServiceTypeId = cgiGet( sPrefix+"AV8ProductServiceTypeId_CTRL");
         if ( StringUtil.Len( sCtrlAV8ProductServiceTypeId) > 0 )
         {
            AV8ProductServiceTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8ProductServiceTypeId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8ProductServiceTypeId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceTypeId), 4, 0));
         }
         else
         {
            AV8ProductServiceTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8ProductServiceTypeId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProductServiceTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProductServiceTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8ProductServiceTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProductServiceTypeId_CTRL", StringUtil.RTrim( sCtrlAV8ProductServiceTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915563841", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("productservicetypeproductservicewc.js", "?202481915563841", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtProductServiceQuantity_Internalname = sPrefix+"PRODUCTSERVICEQUANTITY_"+sGXsfl_35_idx;
         edtProductServicePicture_Internalname = sPrefix+"PRODUCTSERVICEPICTURE_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtProductServiceQuantity_Internalname = sPrefix+"PRODUCTSERVICEQUANTITY_"+sGXsfl_35_fel_idx;
         edtProductServicePicture_Internalname = sPrefix+"PRODUCTSERVICEPICTURE_"+sGXsfl_35_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:ProductServiceId|3:ProductServiceName|4:ProductServiceDescription|5:ProductServiceQuantity";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E12242',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E13242',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E14242',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18242',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtProductServiceName_Link',ctrl:'PRODUCTSERVICENAME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E11242',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E15242',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceTypeId',fld:'vPRODUCTSERVICETYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_ProductServiceName',fld:'vISAUTHORIZED_PRODUCTSERVICENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H00242_A71ProductServiceTypeId = new short[1] ;
         H00242_A40000ProductServicePicture_GXI = new string[] {""} ;
         H00242_A76ProductServiceQuantity = new short[1] ;
         H00242_A75ProductServiceDescription = new string[] {""} ;
         H00242_A74ProductServiceName = new string[] {""} ;
         H00242_A73ProductServiceId = new short[1] ;
         H00242_A77ProductServicePicture = new string[] {""} ;
         ...
         sCtrlAV8ProductServiceTypeId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         sImgUrl = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productservicetypeproductservicewc__default(),
            new Object[][] {
                new Object[] {
               H00242_A71ProductServiceTypeId, H00242_A40000ProductServicePicture_GXI, H00242_A76ProductServiceQuantity, H00242_A75ProductServiceDescription, H00242_A74ProductServiceName, H00242_A73ProductServiceId, H00242_A77ProductServicePicture
               }
               , new Object[] {
      ...
      private short AV8ProductServiceTypeId ;
      private short wcpOAV8ProductServiceTypeId ;
      ...
      private string sCtrlAV8ProductServiceTypeId ;
      ...
      private short[] H00242_A71ProductServiceTypeId ;
      private string[] H00242_A40000ProductServicePicture_GXI ;
      private short[] H00242_A76ProductServiceQuantity ;
      private string[] H00242_A75ProductServiceDescription ;
      private string[] H00242_A74ProductServiceName ;
      private short[] H00242_A73ProductServiceId ;
      private string[] H00242_A77ProductServicePicture ;
   ...
   public class productservicetypeproductservicewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8ProductServiceTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " ProductServiceTypeId, ProductServicePicture_GXI, ProductServiceQuantity, ProductServiceDescription, ProductServiceName, ProductServiceId, ProductServicePicture";
         sFromString = " FROM ProductService";
         sOrderString = "";
         AddWhere(sWhereString, "(ProductServiceTypeId = :AV8ProductServiceTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(ProductServiceId,'9999'), 2) like '%' || :lV16FilterFullText) or ( ProductServiceName like '%' || :lV16FilterFullText) or ( ProductServiceDescription like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(ProductServiceQuantity,'9999'), 2) like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY ProductServiceTypeId, ProductServiceName, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceTypeId DESC, ProductServiceName DESC, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceTypeId, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceTypeId DESC, ProductServiceId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceTypeId, ProductServiceDescription, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceTypeId DESC, ProductServiceDescription DESC, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceTypeId, ProductServiceQuantity, ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceTypeId DESC, ProductServiceQuantity DESC, ProductServiceId";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00242(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H00243(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8ProductServiceTypeId",GXType.Int16,4,0) ,
