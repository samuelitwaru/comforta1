...
namespace GeneXus.Programs {
   public class getreceptionistlocationid : GXProcedure
   {
      ...
      {
         getreceptionistlocationid objgetreceptionistlocationid;
         objgetreceptionistlocationid = new getreceptionistlocationid();
         objgetreceptionistlocationid.AV9LocationId = 0 ;
         objgetreceptionistlocationid.context.SetSubmitInitialConfig(context);
         objgetreceptionistlocationid.initialize();
         Submit( executePrivateCatch,objgetreceptionistlocationid);
         aP0_LocationId=this.AV9LocationId;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getreceptionistlocationid)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
