...
namespace GeneXus.Programs {
   public class customertypegeneral : GXWebComponent
   {
      public customertypegeneral( )
      {
      ...
      public customertypegeneral( IGxContext context )
      {
      ...
      {
         this.A78CustomerTypeId = aP0_CustomerTypeId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A78CustomerTypeId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "CustomerTypeGeneral";
               WS1S2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customertypegeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A78CustomerTypeId,4,0))}, new string[] {"CustomerTypeId"}) +"\">") ;
      ...
      protected void WB1S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "customertypegeneral.aspx");
            }
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerTypeName_Internalname, A79CustomerTypeName, StringUtil.RTrim( context.localUtil.Format( A79CustomerTypeName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerTypeName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_CustomerTypeGeneral.htm");
      ...
      protected void RF1S2( )
      {
         ...
         {
            /* Using cursor H001S2 */
            pr_default.execute(0, new Object[] {A78CustomerTypeId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A79CustomerTypeName = H001S2_A79CustomerTypeName[0];
               AssignAttri(sPrefix, false, "A79CustomerTypeName", A79CustomerTypeName);
               /* Execute user event: Load */
               E141S2 ();
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtCustomerTypeName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerTypeName_Enabled), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "CustomerType";
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A78CustomerTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A78CustomerTypeId", StringUtil.LTrimStr( (decimal)(A78CustomerTypeId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA78CustomerTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "customertypegeneral", GetJustCreated( ));
         ...
         wcpOA78CustomerTypeId = A78CustomerTypeId;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714311112", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("customertypegeneral.js", "?202482714311112", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'},{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E111S1',iparms:[{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[{ctrl:'BTNUPDATE',prop:'Visible'}]}");
         setEventMetadata("'DODELETE'","{handler:'E121S1',iparms:[{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001S2_A78CustomerTypeId = new short[1] ;
         H001S2_A79CustomerTypeName = new string[] {""} ;
         ...
         sCtrlA78CustomerTypeId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customertypegeneral__default(),
            new Object[][] {
                new Object[] {
               H001S2_A78CustomerTypeId, H001S2_A79CustomerTypeName
               }
            }
         );
         AV14Pgmname = "CustomerTypeGeneral";
      ...
      private short wcpOA78CustomerTypeId ;
      ...
      private string sCtrlA78CustomerTypeId ;
      ...
      private short[] H001S2_A78CustomerTypeId ;
      private string[] H001S2_A79CustomerTypeName ;
   ...
   public class customertypegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("CustomerTypeId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001S2", "SELECT CustomerTypeId, CustomerTypeName FROM CustomerType WHERE CustomerTypeId = :CustomerTypeId ORDER BY CustomerTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001S2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
