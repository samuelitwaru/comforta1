...
namespace GeneXus.Programs {
   public class gx0061 : GXDataArea
   {
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtResidentINIndividualId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINIndividualId_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtResidentINIndividualBsnNumber_Enabled = 0;
         AssignProp("", false, edtResidentINIndividualBsnNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINIndividualBsnNumber_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtResidentINIndividualGivenName_Enabled = 0;
         AssignProp("", false, edtResidentINIndividualGivenName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINIndividualGivenName_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtResidentId_Enabled = 0;
         AssignProp("", false, edtResidentId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentId_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915584232", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0061.js", "?202481915584232", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cResidentINIndividualId',fld:'vCRESIDENTININDIVIDUALID',pic:'ZZZ9'},{av:'AV7cResidentINIndividualBsnNumber',fld:'vCRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'AV8cResidentINIndividualGivenName',fld:'vCRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV9cResidentINIndividualLastName',fld:'vCRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV10cResidentINIndividualPhone',fld:'vCRESIDENTININDIVIDUALPHONE',pic:''},{av:'cmbavCresidentinindividualgender'},{av:'AV11cResidentINIndividualGender',fld:'vCRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV12pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALIDV_CRESIDENTININDIVIDUALGENDER",",oparms:[]}");
