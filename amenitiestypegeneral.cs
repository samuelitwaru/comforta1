...
namespace GeneXus.Programs {
   public class amenitiestypegeneral : GXWebComponent
   {
      ...
      {
         this.A108AmenitiesTypeId = aP0_AmenitiesTypeId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)A108AmenitiesTypeId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Amenities Type General", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("amenitiestypegeneral.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(A108AmenitiesTypeId,4,0))}, new string[] {"AmenitiesTypeId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA108AmenitiesTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      {
         return context.GetMessage( "Amenities Type General", "") ;
      }
      ...
      protected void WB3E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAmenitiesTypeName_Internalname, A109AmenitiesTypeName, StringUtil.RTrim( context.localUtil.Format( A109AmenitiesTypeName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmenitiesTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAmenitiesTypeName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_AmenitiesTypeGeneral.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", context.GetMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, context.GetMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e113e1_client"+"'", TempTags, "", 2, "HLP_AmenitiesTypeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", context.GetMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, context.GetMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e123e1_client"+"'", TempTags, "", 2, "HLP_AmenitiesTypeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3E2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Amenities Type General", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A109AmenitiesTypeName = H003E2_A109AmenitiesTypeName[0];
      ...
      protected void STRUP3E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA108AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA108AmenitiesTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A108AmenitiesTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA108AmenitiesTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A108AmenitiesTypeId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
         }
         wcpOA108AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA108AmenitiesTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( A108AmenitiesTypeId != wcpOA108AmenitiesTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOA108AmenitiesTypeId = A108AmenitiesTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA108AmenitiesTypeId = cgiGet( sPrefix+"A108AmenitiesTypeId_CTRL");
         if ( StringUtil.Len( sCtrlA108AmenitiesTypeId) > 0 )
         {
            A108AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlA108AmenitiesTypeId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
         }
         else
         {
            A108AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"A108AmenitiesTypeId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A108AmenitiesTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA108AmenitiesTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A108AmenitiesTypeId_CTRL", StringUtil.RTrim( sCtrlA108AmenitiesTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714312225", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("amenitiestypegeneral.js", "?202482714312225", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'},{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E113E1',iparms:[{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[{ctrl:'BTNUPDATE',prop:'Visible'}]}");
         setEventMetadata("'DODELETE'","{handler:'E123E1',iparms:[{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H003E2_A108AmenitiesTypeId = new short[1] ;
         H003E2_A109AmenitiesTypeName = new string[] {""} ;
      ...
      private short wcpOA108AmenitiesTypeId ;
      ...
      private string sCtrlA108AmenitiesTypeId ;
      ...
      private short[] H003E2_A108AmenitiesTypeId ;
      private string[] H003E2_A109AmenitiesTypeName ;
   ...
   public class amenitiestypegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003E2", "SELECT AmenitiesTypeId, AmenitiesTypeName FROM AmenitiesType WHERE AmenitiesTypeId = :AmenitiesTypeId ORDER BY AmenitiesTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003E2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
