...
namespace GeneXus.Programs {
   public class page : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtPageName_Internalname, A99PageName, StringUtil.RTrim( context.localUtil.Format( A99PageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPageName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Page.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A3CustomerName, StringUtil.RTrim( context.localUtil.Format( A3CustomerName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Page.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerEmail_Internalname, A5CustomerEmail, StringUtil.RTrim( context.localUtil.Format( A5CustomerEmail, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "mailto:"+A5CustomerEmail, "", "", "", edtCustomerEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "start", true, "", "HLP_Page.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtavCombocustomerid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20ComboCustomerId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavCombocustomerid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV20ComboCustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(AV20ComboCustomerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombocustomerid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombocustomerid_Visible, edtavCombocustomerid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Page.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtPageId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A98PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtPageId_Enabled!=0) ? context.localUtil.Format( (decimal)(A98PageId), "ZZZ9") : context.localUtil.Format( (decimal)(A98PageId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPageId_Jsonclick, 0, "Attribute", "", "", "", "", edtPageId_Visible, edtPageId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Page.htm");
         /* Multiple line edit */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtPageHtmlContent_Internalname, A100PageHtmlContent, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,61);\"", 0, edtPageHtmlContent_Visible, edtPageHtmlContent_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "5242880", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Page.htm");
         /* Multiple line edit */
         ...
         ClassString = "Attribute";
         StyleString = "";
         GxWebStd.gx_html_textarea( context, edtPageJsonContent_Internalname, A101PageJsonContent, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,62);\"", 0, edtPageJsonContent_Visible, edtPageJsonContent_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Page.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               /* Read saved values. */
               Z98PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "Z98PageId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               Z99PageName = cgiGet( "Z99PageName");
               ...
               AssignAttri("", false, "A99PageName", A99PageName);
               ...
               AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
               A100PageHtmlContent = cgiGet( edtPageHtmlContent_Internalname);
               AssignAttri("", false, "A100PageHtmlContent", A100PageHtmlContent);
               A101PageJsonContent = cgiGet( edtPageJsonContent_Internalname);
               AssignAttri("", false, "A101PageJsonContent", A101PageJsonContent);
               ...
               A98PageId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtPageId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
               forbiddenHiddens.Add("PageId", context.localUtil.Format( (decimal)(A98PageId), "ZZZ9"));
               forbiddenHiddens.Add("Gx_mode", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")));
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A98PageId != Z98PageId ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
               {
      ...
      protected void ZM0C21( short GX_JID )
      {
         if ( ( GX_JID == 8 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z99PageName = T000C3_A99PageName[0];
               Z1CustomerId = T000C3_A1CustomerId[0];
            }
            else
            {
      ...
      protected void standaloneModal( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            A3CustomerName = T000C4_A3CustomerName[0];
            AssignAttri("", false, "A3CustomerName", A3CustomerName);
            A5CustomerEmail = T000C4_A5CustomerEmail[0];
            n5CustomerEmail = T000C4_n5CustomerEmail[0];
            AssignAttri("", false, "A5CustomerEmail", A5CustomerEmail);
            pr_default.close(2);
         }
      }
      ...
      protected void Load0C21( )
      {
         ...
         {
            RcdFound21 = 1;
            A99PageName = T000C5_A99PageName[0];
            AssignAttri("", false, "A99PageName", A99PageName);
            A100PageHtmlContent = T000C5_A100PageHtmlContent[0];
            AssignAttri("", false, "A100PageHtmlContent", A100PageHtmlContent);
            A112PageCssContent = T000C5_A112PageCssContent[0];
            A101PageJsonContent = T000C5_A101PageJsonContent[0];
            AssignAttri("", false, "A101PageJsonContent", A101PageJsonContent);
            A3CustomerName = T000C5_A3CustomerName[0];
            AssignAttri("", false, "A3CustomerName", A3CustomerName);
            A5CustomerEmail = T000C5_A5CustomerEmail[0];
            n5CustomerEmail = T000C5_n5CustomerEmail[0];
            AssignAttri("", false, "A5CustomerEmail", A5CustomerEmail);
            A1CustomerId = T000C5_A1CustomerId[0];
            AssignAttri("", false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
            ZM0C21( -8) ;
         }
         pr_default.close(3);
      ...
      protected void gxLoad_9( short A1CustomerId )
      {
         ...
         A3CustomerName = T000C6_A3CustomerName[0];
         AssignAttri("", false, "A3CustomerName", A3CustomerName);
         A5CustomerEmail = T000C6_A5CustomerEmail[0];
         n5CustomerEmail = T000C6_n5CustomerEmail[0];
         AssignAttri("", false, "A5CustomerEmail", A5CustomerEmail);
      ...
      {
         /* Using cursor T000C7 */
         pr_default.execute(5, new Object[] {A98PageId});
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0C21( 8) ;
            RcdFound21 = 1;
            A98PageId = T000C3_A98PageId[0];
            AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
            A99PageName = T000C3_A99PageName[0];
            AssignAttri("", false, "A99PageName", A99PageName);
            A100PageHtmlContent = T000C3_A100PageHtmlContent[0];
            AssignAttri("", false, "A100PageHtmlContent", A100PageHtmlContent);
            A112PageCssContent = T000C3_A112PageCssContent[0];
            A101PageJsonContent = T000C3_A101PageJsonContent[0];
            AssignAttri("", false, "A101PageJsonContent", A101PageJsonContent);
            A1CustomerId = T000C3_A1CustomerId[0];
            AssignAttri("", false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
            Z98PageId = A98PageId;
            sMode21 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound21 = 0;
         /* Using cursor T000C8 */
         pr_default.execute(6, new Object[] {A98PageId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T000C8_A98PageId[0] < A98PageId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T000C8_A98PageId[0] > A98PageId ) ) )
            {
               A98PageId = T000C8_A98PageId[0];
               AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
               RcdFound21 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound21 = 0;
         /* Using cursor T000C9 */
         pr_default.execute(7, new Object[] {A98PageId});
         if ( (pr_default.getStatus(7) != 101) )
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( T000C9_A98PageId[0] > A98PageId ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( T000C9_A98PageId[0] < A98PageId ) ) )
            {
               A98PageId = T000C9_A98PageId[0];
               AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
               RcdFound21 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency0C21( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z99PageName, T000C2_A99PageName[0]) != 0 ) || ( Z1CustomerId != T000C2_A1CustomerId[0] ) )
            {
               if ( StringUtil.StrCmp(Z99PageName, T000C2_A99PageName[0]) != 0 )
               {
                  GXUtil.WriteLog("page:[seudo value changed for attri]"+"PageName");
                  GXUtil.WriteLogRaw("Old: ",Z99PageName);
                  GXUtil.WriteLogRaw("Current: ",T000C2_A99PageName[0]);
               }
               if ( Z1CustomerId != T000C2_A1CustomerId[0] )
               {
                  GXUtil.WriteLog("page:[seudo value changed for attri]"+"CustomerId");
                  GXUtil.WriteLogRaw("Old: ",Z1CustomerId);
                  GXUtil.WriteLogRaw("Current: ",T000C2_A1CustomerId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A99PageName, A100PageHtmlContent, A112PageCssContent, A101PageJsonContent, A1CustomerId});
                     pr_default.close(8);
                     /* Retrieving last key number assigned */
                     /* Using cursor T000C11 */
                     pr_default.execute(9);
                     A98PageId = T000C11_A98PageId[0];
                     AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
                     pr_default.close(9);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A99PageName, A100PageHtmlContent, A112PageCssContent, A101PageJsonContent, A1CustomerId, A98PageId});
                     pr_default.close(10);
                     pr_default.SmartCacheProvider.SetUpdated("Page");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(11, new Object[] {A98PageId});
                  pr_default.close(11);
                  pr_default.SmartCacheProvider.SetUpdated("Page");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls0C21( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A3CustomerName = T000C14_A3CustomerName[0];
            AssignAttri("", false, "A3CustomerName", A3CustomerName);
            A5CustomerEmail = T000C14_A5CustomerEmail[0];
            n5CustomerEmail = T000C14_n5CustomerEmail[0];
            AssignAttri("", false, "A5CustomerEmail", A5CustomerEmail);
            pr_default.close(12);
         }
      }
      ...
      public void ScanStart0C21( )
      {
         ...
         {
            RcdFound21 = 1;
            A98PageId = T000C15_A98PageId[0];
            AssignAttri("", false, "A98PageId", StringUtil.LTrimStr( (decimal)(A98PageId), 4, 0));
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext0C21( )
      {
         /* Scan next routine */
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z98PageId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z98PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "Z99PageName", Z99PageName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714313913", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("page.js", "?202482714313914", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV11TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7PageId',fld:'vPAGEID',pic:'ZZZ9',hsh:true},{av:'A98PageId',fld:'PAGEID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALID_CUSTOMERID","{handler:'Valid_Customerid',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'A3CustomerName',fld:'CUSTOMERNAME',pic:''},{av:'A5CustomerEmail',fld:'CUSTOMEREMAIL',pic:''}]");
         setEventMetadata("VALID_CUSTOMERID",",oparms:[{av:'A3CustomerName',fld:'CUSTOMERNAME',pic:''},{av:'A5CustomerEmail',fld:'CUSTOMEREMAIL',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         Z3CustomerName = "";
         Z5CustomerEmail = "";
         T000C4_A3CustomerName = new string[] {""} ;
         T000C4_A5CustomerEmail = new string[] {""} ;
         T000C4_n5CustomerEmail = new bool[] {false} ;
         T000C5_A98PageId = new short[1] ;
         T000C5_A99PageName = new string[] {""} ;
         T000C5_A100PageHtmlContent = new string[] {""} ;
         T000C5_A112PageCssContent = new string[] {""} ;
         T000C5_A101PageJsonContent = new string[] {""} ;
         T000C5_A3CustomerName = new string[] {""} ;
         T000C5_A5CustomerEmail = new string[] {""} ;
         T000C5_n5CustomerEmail = new bool[] {false} ;
         T000C5_A1CustomerId = new short[1] ;
         T000C6_A3CustomerName = new string[] {""} ;
         T000C6_A5CustomerEmail = new string[] {""} ;
         T000C6_n5CustomerEmail = new bool[] {false} ;
         T000C7_A98PageId = new short[1] ;
         T000C3_A98PageId = new short[1] ;
         T000C3_A99PageName = new string[] {""} ;
         T000C3_A100PageHtmlContent = new string[] {""} ;
         T000C3_A112PageCssContent = new string[] {""} ;
         T000C3_A101PageJsonContent = new string[] {""} ;
         T000C3_A1CustomerId = new short[1] ;
         T000C8_A98PageId = new short[1] ;
         T000C9_A98PageId = new short[1] ;
         T000C2_A98PageId = new short[1] ;
         T000C2_A99PageName = new string[] {""} ;
         T000C2_A100PageHtmlContent = new string[] {""} ;
         T000C2_A112PageCssContent = new string[] {""} ;
         T000C2_A101PageJsonContent = new string[] {""} ;
         T000C2_A1CustomerId = new short[1] ;
         T000C11_A98PageId = new short[1] ;
         T000C14_A3CustomerName = new string[] {""} ;
         T000C14_A5CustomerEmail = new string[] {""} ;
         T000C14_n5CustomerEmail = new bool[] {false} ;
         T000C15_A98PageId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.page__default(),
            new Object[][] {
                new Object[] {
               T000C2_A98PageId, T000C2_A99PageName, T000C2_A100PageHtmlContent, T000C2_A112PageCssContent, T000C2_A101PageJsonContent, T000C2_A1CustomerId
               }
               , new Object[] {
               T000C3_A98PageId, T000C3_A99PageName, T000C3_A100PageHtmlContent, T000C3_A112PageCssContent, T000C3_A101PageJsonContent, T000C3_A1CustomerId
               }
               , new Object[] {
               T000C4_A3CustomerName, T000C4_A5CustomerEmail, T000C4_n5CustomerEmail
               }
               , new Object[] {
               T000C5_A98PageId, T000C5_A99PageName, T000C5_A100PageHtmlContent, T000C5_A112PageCssContent, T000C5_A101PageJsonContent, T000C5_A3CustomerName, T000C5_A5CustomerEmail, T000C5_n5CustomerEmail, T000C5_A1CustomerId
               }
               , new Object[] {
               T000C6_A3CustomerName, T000C6_A5CustomerEmail, T000C6_n5CustomerEmail
               }
               , new Object[] {
               T000C7_A98PageId
               }
               ...
               , new Object[] {
               T000C14_A3CustomerName, T000C14_A5CustomerEmail, T000C14_n5CustomerEmail
               }
               , new Object[] {
               T000C15_A98PageId
               }
      ...
      private string[] T000C4_A3CustomerName ;
      private string[] T000C4_A5CustomerEmail ;
      private bool[] T000C4_n5CustomerEmail ;
      private short[] T000C5_A98PageId ;
      private string[] T000C5_A99PageName ;
      private string[] T000C5_A100PageHtmlContent ;
      private string[] T000C5_A112PageCssContent ;
      private string[] T000C5_A101PageJsonContent ;
      private string[] T000C5_A3CustomerName ;
      private string[] T000C5_A5CustomerEmail ;
      private bool[] T000C5_n5CustomerEmail ;
      private short[] T000C5_A1CustomerId ;
      private string[] T000C6_A3CustomerName ;
      private string[] T000C6_A5CustomerEmail ;
      private bool[] T000C6_n5CustomerEmail ;
      private short[] T000C7_A98PageId ;
      private short[] T000C3_A98PageId ;
      private string[] T000C3_A99PageName ;
      private string[] T000C3_A100PageHtmlContent ;
      private string[] T000C3_A112PageCssContent ;
      private string[] T000C3_A101PageJsonContent ;
      private short[] T000C3_A1CustomerId ;
      private short[] T000C8_A98PageId ;
      private short[] T000C9_A98PageId ;
      private short[] T000C2_A98PageId ;
      private string[] T000C2_A99PageName ;
      private string[] T000C2_A100PageHtmlContent ;
      private string[] T000C2_A112PageCssContent ;
      private string[] T000C2_A101PageJsonContent ;
      private short[] T000C2_A1CustomerId ;
      private short[] T000C11_A98PageId ;
      private string[] T000C14_A3CustomerName ;
      private string[] T000C14_A5CustomerEmail ;
      private bool[] T000C14_n5CustomerEmail ;
      private short[] T000C15_A98PageId ;
 ...
 public class page__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T000C2", "SELECT PageId, PageName, PageHtmlContent, PageCssContent, PageJsonContent, CustomerId FROM Page WHERE PageId = :PageId  FOR UPDATE OF Page NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT000C2,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C3", "SELECT PageId, PageName, PageHtmlContent, PageCssContent, PageJsonContent, CustomerId FROM Page WHERE PageId = :PageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C3,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C4", "SELECT CustomerName, CustomerEmail FROM Customer WHERE CustomerId = :CustomerId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C4,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C5", "SELECT TM1.PageId, TM1.PageName, TM1.PageHtmlContent, TM1.PageCssContent, TM1.PageJsonContent, T2.CustomerName, T2.CustomerEmail, TM1.CustomerId FROM (Page TM1 INNER JOIN Customer T2 ON T2.CustomerId = TM1.CustomerId) WHERE TM1.PageId = :PageId ORDER BY TM1.PageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C5,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C6", "SELECT CustomerName, CustomerEmail FROM Customer WHERE CustomerId = :CustomerId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C6,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C7", "SELECT PageId FROM Page WHERE PageId = :PageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C7,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C8", "SELECT PageId FROM Page WHERE ( PageId > :PageId) ORDER BY PageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C8,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000C9", "SELECT PageId FROM Page WHERE ( PageId < :PageId) ORDER BY PageId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C9,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000C10", "SAVEPOINT gxupdate;INSERT INTO Page(PageName, PageHtmlContent, PageCssContent, PageJsonContent, CustomerId) VALUES(:PageName, :PageHtmlContent, :PageCssContent, :PageJsonContent, :CustomerId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000C10)
           ,new CursorDef("T000C11", "SELECT currval('PageId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C11,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C12", "SAVEPOINT gxupdate;UPDATE Page SET PageName=:PageName, PageHtmlContent=:PageHtmlContent, PageCssContent=:PageCssContent, PageJsonContent=:PageJsonContent, CustomerId=:CustomerId  WHERE PageId = :PageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000C12)
           ,new CursorDef("T000C13", "SAVEPOINT gxupdate;DELETE FROM Page  WHERE PageId = :PageId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000C13)
           ,new CursorDef("T000C14", "SELECT CustomerName, CustomerEmail FROM Customer WHERE CustomerId = :CustomerId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C14,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000C15", "SELECT PageId FROM Page ORDER BY PageId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000C15,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
