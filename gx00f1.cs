...
namespace GeneXus.Programs {
   public class gx00f1 : GXDataArea
   {
      public gx00f1( )
      {
      ...
      public void execute( short aP0_pSupplier_AgbId ,
                           out short aP1_pProductServiceId )
      {
         this.AV7pSupplier_AgbId = aP0_pSupplier_AgbId;
         this.AV8pProductServiceId = 0 ;
         executePrivate();
         aP1_pProductServiceId=this.AV8pProductServiceId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV7pSupplier_AgbId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV7pSupplier_AgbId", StringUtil.LTrimStr( (decimal)(AV7pSupplier_AgbId), 4, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pProductServiceId = (short)(Math.Round(NumberUtil.Val( GetPar( "pProductServiceId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "AV8pProductServiceId", StringUtil.LTrimStr( (decimal)(AV8pProductServiceId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7pSupplier_AgbId = (short)(Math.Round(NumberUtil.Val( GetPar( "pSupplier_AgbId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProductServiceId, AV7pSupplier_AgbId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00f1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pSupplier_AgbId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pSupplier_AgbId","pProductServiceId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPSUPPLIER_AGBID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pSupplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vPPRODUCTSERVICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pProductServiceId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("gx00f1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pSupplier_AgbId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pSupplier_AgbId","pProductServiceId"})  ;
      }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductserviceidfilter_Internalname, context.GetMessage( "Product Service Id", ""), "", "", lblLblproductserviceidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00F1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120c1_client"+"'", TempTags, "", 2, "HLP_Gx00F1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00F1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000C2 */
            pr_default.execute(0, new Object[] {AV7pSupplier_AgbId, AV6cProductServiceId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A55Supplier_AgbId = H000C2_A55Supplier_AgbId[0];
               A73ProductServiceId = H000C2_A73ProductServiceId[0];
               /* Execute user event: Load */
               E140C2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTSERVICEID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A73ProductServiceId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H000C3 */
         pr_default.execute(1, new Object[] {AV7pSupplier_AgbId, AV6cProductServiceId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtProductServiceId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtProductServiceId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         edtSupplier_AgbId_Enabled = 0;
         AssignProp("", false, edtSupplier_AgbId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void E150C2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pProductServiceId = A73ProductServiceId;
         AssignAttri("", false, "AV8pProductServiceId", StringUtil.LTrimStr( (decimal)(AV8pProductServiceId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV8pProductServiceId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pSupplier_AgbId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pSupplier_AgbId", StringUtil.LTrimStr( (decimal)(AV7pSupplier_AgbId), 4, 0));
         AV8pProductServiceId = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV8pProductServiceId", StringUtil.LTrimStr( (decimal)(AV8pProductServiceId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714332798", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00f1.js", "?202482714332799", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtProductServiceId_Internalname = "PRODUCTSERVICEID_"+sGXsfl_24_idx;
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtProductServiceId_Internalname = "PRODUCTSERVICEID_"+sGXsfl_24_fel_idx;
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtProductServiceId_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_AgbId',fld:'vPSUPPLIER_AGBID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E120C1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLPRODUCTSERVICEIDFILTER.CLICK","{handler:'E110C1',iparms:[{av:'divProductserviceidfiltercontainer_Class',ctrl:'PRODUCTSERVICEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E150C2',iparms:[{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pProductServiceId',fld:'vPPRODUCTSERVICEID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_AgbId',fld:'vPSUPPLIER_AGBID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_AgbId',fld:'vPSUPPLIER_AGBID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_AgbId',fld:'vPSUPPLIER_AGBID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_AgbId',fld:'vPSUPPLIER_AGBID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Supplier_agbid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000C2_A55Supplier_AgbId = new short[1] ;
         H000C2_A73ProductServiceId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00f1__default(),
            new Object[][] {
                new Object[] {
               H000C2_A55Supplier_AgbId, H000C2_A73ProductServiceId
               }
               , new Object[] {
      ...
      private short AV7pSupplier_AgbId ;
      private short AV8pProductServiceId ;
      private short wcpOAV7pSupplier_AgbId ;
      ...
      private string edtProductServiceId_Link ;
      ...
      private short[] H000C2_A55Supplier_AgbId ;
      private short[] H000C2_A73ProductServiceId ;
      private long[] H000C3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pProductServiceId ;
   ...
   public class gx00f1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV7pSupplier_AgbId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT Supplier_AgbId, ProductServiceId FROM Supplier_AgbProductService WHERE Supplier_AgbId = :AV7pSupplier_AgbId and ProductServiceId >= :AV6cProductServiceId ORDER BY Supplier_AgbId, ProductServiceId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000C3", "SELECT COUNT(*) FROM Supplier_AgbProductService WHERE Supplier_AgbId = :AV7pSupplier_AgbId and ProductServiceId >= :AV6cProductServiceId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
