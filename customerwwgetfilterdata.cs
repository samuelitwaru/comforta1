...
namespace GeneXus.Programs {
   public class customerwwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         customerwwgetfilterdata objcustomerwwgetfilterdata;
         objcustomerwwgetfilterdata = new customerwwgetfilterdata();
         objcustomerwwgetfilterdata.AV47DDOName = aP0_DDOName;
         objcustomerwwgetfilterdata.AV48SearchTxtParms = aP1_SearchTxtParms;
         objcustomerwwgetfilterdata.AV49SearchTxtTo = aP2_SearchTxtTo;
         objcustomerwwgetfilterdata.AV50OptionsJson = "" ;
         objcustomerwwgetfilterdata.AV51OptionsDescJson = "" ;
         objcustomerwwgetfilterdata.AV52OptionIndexesJson = "" ;
         objcustomerwwgetfilterdata.context.SetSubmitInitialConfig(context);
         objcustomerwwgetfilterdata.initialize();
         Submit( executePrivateCatch,objcustomerwwgetfilterdata);
         aP3_OptionsJson=this.AV50OptionsJson;
         aP4_OptionsDescJson=this.AV51OptionsDescJson;
         aP5_OptionIndexesJson=this.AV52OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((customerwwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S121( )
      {
         ...
         AV61Customerwwds_6_tfcustomerpostaladdress = AV17TFCustomerPostalAddress;
         AV62Customerwwds_7_tfcustomerpostaladdress_sel = AV18TFCustomerPostalAddress_Sel;
         AV63Customerwwds_8_tfcustomeremail = AV19TFCustomerEmail;
         AV64Customerwwds_9_tfcustomeremail_sel = AV20TFCustomerEmail_Sel;
         AV65Customerwwds_10_tfcustomervisitingaddress = AV21TFCustomerVisitingAddress;
         AV66Customerwwds_11_tfcustomervisitingaddress_sel = AV22TFCustomerVisitingAddress_Sel;
         AV67Customerwwds_12_tfcustomerphone = AV23TFCustomerPhone;
         AV68Customerwwds_13_tfcustomerphone_sel = AV24TFCustomerPhone_Sel;
         AV69Customerwwds_14_tfcustomervatnumber = AV25TFCustomerVatNumber;
         AV70Customerwwds_15_tfcustomervatnumber_sel = AV26TFCustomerVatNumber_Sel;
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              AV62Customerwwds_7_tfcustomerpostaladdress_sel ,
                                              AV61Customerwwds_6_tfcustomerpostaladdress ,
                                              AV64Customerwwds_9_tfcustomeremail_sel ,
                                              AV63Customerwwds_8_tfcustomeremail ,
                                              AV66Customerwwds_11_tfcustomervisitingaddress_sel ,
                                              AV65Customerwwds_10_tfcustomervisitingaddress ,
                                              AV68Customerwwds_13_tfcustomerphone_sel ,
                                              AV67Customerwwds_12_tfcustomerphone ,
                                              AV70Customerwwds_15_tfcustomervatnumber_sel ,
                                              AV69Customerwwds_14_tfcustomervatnumber ,
         ...
         lV61Customerwwds_6_tfcustomerpostaladdress = StringUtil.Concat( StringUtil.RTrim( AV61Customerwwds_6_tfcustomerpostaladdress), "%", "");
         lV63Customerwwds_8_tfcustomeremail = StringUtil.Concat( StringUtil.RTrim( AV63Customerwwds_8_tfcustomeremail), "%", "");
         lV65Customerwwds_10_tfcustomervisitingaddress = StringUtil.Concat( StringUtil.RTrim( AV65Customerwwds_10_tfcustomervisitingaddress), "%", "");
         lV67Customerwwds_12_tfcustomerphone = StringUtil.PadR( StringUtil.RTrim( AV67Customerwwds_12_tfcustomerphone), 20, "%");
         lV69Customerwwds_14_tfcustomervatnumber = StringUtil.Concat( StringUtil.RTrim( AV69Customerwwds_14_tfcustomervatnumber), "%", "");
         lV71Customerwwds_16_tfcustomertypename = StringUtil.Concat( StringUtil.RTrim( AV71Customerwwds_16_tfcustomertypename), "%", "");
         /* Using cursor P002B2 */
         pr_default.execute(0, new Object[] {lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV56Customerwwds_1_filterfulltext, lV57Customerwwds_2_tfcustomerkvknumber, AV58Customerwwds_3_tfcustomerkvknumber_sel, lV59Customerwwds_4_tfcustomername, AV60Customerwwds_5_tfcustomername_sel, lV61Customerwwds_6_tfcustomerpostaladdress, AV62Customerwwds_7_tfcustomerpostaladdress_sel, lV63Customerwwds_8_tfcustomeremail, AV64Customerwwds_9_tfcustomeremail_sel, lV65Customerwwds_10_tfcustomervisitingaddress, AV66Customerwwds_11_tfcustomervisitingaddress_sel, lV67Customerwwds_12_tfcustomerphone, AV68Customerwwds_13_tfcustomerphone_sel, lV69Customerwwds_14_tfcustomervatnumber, AV70Customerwwds_15_tfcustomervatnumber_sel, lV71Customerwwds_16_tfcustomertypename, AV72Customerwwds_17_tfcustomertypename_sel});
      ...
      protected void S141( )
      {
         ...
         while ( (pr_default.getStatus(2) != 101) )
         {
            ...
            A79CustomerTypeName = P002B4_A79CustomerTypeName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P002B4_A4CustomerPostalAddress[0], A4CustomerPostalAddress) == 0 ) )
            {
               BRK2B6 = false;
               A1CustomerId = P002B4_A1CustomerId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S151( )
      {
         ...
         while ( (pr_default.getStatus(3) != 101) )
         {
            ...
            A79CustomerTypeName = P002B5_A79CustomerTypeName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(3) != 101) && ( StringUtil.StrCmp(P002B5_A5CustomerEmail[0], A5CustomerEmail) == 0 ) )
            {
               BRK2B8 = false;
               A1CustomerId = P002B5_A1CustomerId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S161( )
      {
         ...
         while ( (pr_default.getStatus(4) != 101) )
         {
            ...
            A79CustomerTypeName = P002B6_A79CustomerTypeName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(4) != 101) && ( StringUtil.StrCmp(P002B6_A6CustomerVisitingAddress[0], A6CustomerVisitingAddress) == 0 ) )
            {
               BRK2B10 = false;
               A1CustomerId = P002B6_A1CustomerId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S171( )
      {
         ...
         while ( (pr_default.getStatus(5) != 101) )
         {
            ...
            A79CustomerTypeName = P002B7_A79CustomerTypeName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(5) != 101) && ( StringUtil.StrCmp(P002B7_A7CustomerPhone[0], A7CustomerPhone) == 0 ) )
            {
               BRK2B12 = false;
               A1CustomerId = P002B7_A1CustomerId[0];
               AV41count = (long)(AV41count+1);
      ...
      protected void S181( )
      {
         ...
         while ( (pr_default.getStatus(6) != 101) )
         {
            ...
            A79CustomerTypeName = P002B8_A79CustomerTypeName[0];
            AV41count = 0;
            while ( (pr_default.getStatus(6) != 101) && ( StringUtil.StrCmp(P002B8_A14CustomerVatNumber[0], A14CustomerVatNumber) == 0 ) )
            {
               BRK2B14 = false;
               A1CustomerId = P002B8_A1CustomerId[0];
               AV41count = (long)(AV41count+1);
      ...
      public override void initialize( )
      {
         ...
         lV61Customerwwds_6_tfcustomerpostaladdress = "";
         lV63Customerwwds_8_tfcustomeremail = "";
         lV65Customerwwds_10_tfcustomervisitingaddress = "";
         lV67Customerwwds_12_tfcustomerphone = "";
         lV69Customerwwds_14_tfcustomervatnumber = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customerwwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P002B2_A78CustomerTypeId, P002B2_n78CustomerTypeId, P002B2_A41CustomerKvkNumber, P002B2_A79CustomerTypeName, P002B2_A14CustomerVatNumber, P002B2_A7CustomerPhone, P002B2_n7CustomerPhone, P002B2_A6CustomerVisitingAddress, P002B2_n6CustomerVisitingAddress, P002B2_A5CustomerEmail,
               P002B2_n5CustomerEmail, P002B2_A4CustomerPostalAddress, P002B2_n4CustomerPostalAddress, P002B2_A3CustomerName, P002B2_A1CustomerId
               }
               , new Object[] {
               P002B3_A78CustomerTypeId, P002B3_n78CustomerTypeId, P002B3_A3CustomerName, P002B3_A79CustomerTypeName, P002B3_A14CustomerVatNumber, P002B3_A7CustomerPhone, P002B3_n7CustomerPhone, P002B3_A6CustomerVisitingAddress, P002B3_n6CustomerVisitingAddress, P002B3_A5CustomerEmail,
               P002B3_n5CustomerEmail, P002B3_A4CustomerPostalAddress, P002B3_n4CustomerPostalAddress, P002B3_A41CustomerKvkNumber, P002B3_A1CustomerId
               }
               , new Object[] {
               P002B4_A78CustomerTypeId, P002B4_n78CustomerTypeId, P002B4_A4CustomerPostalAddress, P002B4_n4CustomerPostalAddress, P002B4_A79CustomerTypeName, P002B4_A14CustomerVatNumber, P002B4_A7CustomerPhone, P002B4_n7CustomerPhone, P002B4_A6CustomerVisitingAddress, P002B4_n6CustomerVisitingAddress,
               P002B4_A5CustomerEmail, P002B4_n5CustomerEmail, P002B4_A3CustomerName, P002B4_A41CustomerKvkNumber, P002B4_A1CustomerId
               }
               , new Object[] {
               P002B5_A78CustomerTypeId, P002B5_n78CustomerTypeId, P002B5_A5CustomerEmail, P002B5_n5CustomerEmail, P002B5_A79CustomerTypeName, P002B5_A14CustomerVatNumber, P002B5_A7CustomerPhone, P002B5_n7CustomerPhone, P002B5_A6CustomerVisitingAddress, P002B5_n6CustomerVisitingAddress,
               P002B5_A4CustomerPostalAddress, P002B5_n4CustomerPostalAddress, P002B5_A3CustomerName, P002B5_A41CustomerKvkNumber, P002B5_A1CustomerId
               }
               , new Object[] {
               P002B6_A78CustomerTypeId, P002B6_n78CustomerTypeId, P002B6_A6CustomerVisitingAddress, P002B6_n6CustomerVisitingAddress, P002B6_A79CustomerTypeName, P002B6_A14CustomerVatNumber, P002B6_A7CustomerPhone, P002B6_n7CustomerPhone, P002B6_A5CustomerEmail, P002B6_n5CustomerEmail,
               P002B6_A4CustomerPostalAddress, P002B6_n4CustomerPostalAddress, P002B6_A3CustomerName, P002B6_A41CustomerKvkNumber, P002B6_A1CustomerId
               }
               , new Object[] {
               P002B7_A78CustomerTypeId, P002B7_n78CustomerTypeId, P002B7_A7CustomerPhone, P002B7_n7CustomerPhone, P002B7_A79CustomerTypeName, P002B7_A14CustomerVatNumber, P002B7_A6CustomerVisitingAddress, P002B7_n6CustomerVisitingAddress, P002B7_A5CustomerEmail, P002B7_n5CustomerEmail,
               P002B7_A4CustomerPostalAddress, P002B7_n4CustomerPostalAddress, P002B7_A3CustomerName, P002B7_A41CustomerKvkNumber, P002B7_A1CustomerId
               }
               , new Object[] {
               P002B8_A78CustomerTypeId, P002B8_n78CustomerTypeId, P002B8_A14CustomerVatNumber, P002B8_A79CustomerTypeName, P002B8_A7CustomerPhone, P002B8_n7CustomerPhone, P002B8_A6CustomerVisitingAddress, P002B8_n6CustomerVisitingAddress, P002B8_A5CustomerEmail, P002B8_n5CustomerEmail,
               P002B8_A4CustomerPostalAddress, P002B8_n4CustomerPostalAddress, P002B8_A3CustomerName, P002B8_A41CustomerKvkNumber, P002B8_A1CustomerId
               }
               , new Object[] {
               P002B9_A78CustomerTypeId, P002B9_n78CustomerTypeId, P002B9_A79CustomerTypeName, P002B9_A14CustomerVatNumber, P002B9_A7CustomerPhone, P002B9_n7CustomerPhone, P002B9_A6CustomerVisitingAddress, P002B9_n6CustomerVisitingAddress, P002B9_A5CustomerEmail, P002B9_n5CustomerEmail,
               P002B9_A4CustomerPostalAddress, P002B9_n4CustomerPostalAddress, P002B9_A3CustomerName, P002B9_A41CustomerKvkNumber, P002B9_A1CustomerId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string AV67Customerwwds_12_tfcustomerphone ;
      private string AV68Customerwwds_13_tfcustomerphone_sel ;
      private string scmdbuf ;
      private string lV67Customerwwds_12_tfcustomerphone ;
      ...
      private string AV61Customerwwds_6_tfcustomerpostaladdress ;
      private string AV62Customerwwds_7_tfcustomerpostaladdress_sel ;
      private string AV63Customerwwds_8_tfcustomeremail ;
      private string AV64Customerwwds_9_tfcustomeremail_sel ;
      private string AV65Customerwwds_10_tfcustomervisitingaddress ;
      private string AV66Customerwwds_11_tfcustomervisitingaddress_sel ;
      private string AV69Customerwwds_14_tfcustomervatnumber ;
      private string AV70Customerwwds_15_tfcustomervatnumber_sel ;
      ...
      private string lV61Customerwwds_6_tfcustomerpostaladdress ;
      private string lV63Customerwwds_8_tfcustomeremail ;
      private string lV65Customerwwds_10_tfcustomervisitingaddress ;
      private string lV69Customerwwds_14_tfcustomervatnumber ;
   ...
   public class customerwwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_P002B2( IGxContext context ,
                                             ...
                                             string AV62Customerwwds_7_tfcustomerpostaladdress_sel ,
                                             string AV61Customerwwds_6_tfcustomerpostaladdress ,
                                             string AV64Customerwwds_9_tfcustomeremail_sel ,
                                             string AV63Customerwwds_8_tfcustomeremail ,
                                             string AV66Customerwwds_11_tfcustomervisitingaddress_sel ,
                                             string AV65Customerwwds_10_tfcustomervisitingaddress ,
                                             string AV68Customerwwds_13_tfcustomerphone_sel ,
                                             string AV67Customerwwds_12_tfcustomerphone ,
                                             string AV70Customerwwds_15_tfcustomervatnumber_sel ,
                                             string AV69Customerwwds_14_tfcustomervatnumber ,
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerKvkNumber, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV62Customerwwds_7_tfcustomerpostaladdress_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Customerwwds_6_tfcustomerpostaladdress)) ) )
         {
            AddWhere(sWhereString, "(T1.CustomerPostalAddress like :lV61Customerwwds_6_tfcustomerpostaladdress)");
         }
         else
         {
            GXv_int1[12] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Customerwwds_7_tfcustomerpostaladdress_sel)) && ! ( StringUtil.StrCmp(AV62Customerwwds_7_tfcustomerpostaladdress_sel, context.GetMessage( "<#Empty#>", "")) == 0 ) )
         {
            AddWhere(sWhereString, "(T1.CustomerPostalAddress = ( :AV62Customerwwds_7_tfcustomerpostaladdress_sel))");
         }
         else
         {
            GXv_int1[13] = 1;
         }
         if ( StringUtil.StrCmp(AV62Customerwwds_7_tfcustomerpostaladdress_sel, context.GetMessage( "<#Empty#>", "")) == 0 )
         {
            AddWhere(sWhereString, "(T1.CustomerPostalAddress IS NULL or (char_length(trim(trailing ' ' from T1.CustomerPostalAddress))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV64Customerwwds_9_tfcustomeremail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Customerwwds_8_tfcustomeremail)) ) )
         {
            AddWhere(sWhereString, "(T1.CustomerEmail like :lV63Customerwwds_8_tfcustomeremail)");
         }
         else
         {
            GXv_int1[14] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV64Customerwwds_9_tfcustomeremail_sel)) && ! ( StringUtil.StrCmp(AV64Customerwwds_9_tfcustomeremail_sel, context.GetMessage( "<#Empty#>", "")) == 0 ) )
         {
            AddWhere(sWhereString, "(T1.CustomerEmail = ( :AV64Customerwwds_9_tfcustomeremail_sel))");
         }
         else
         {
            GXv_int1[15] = 1;
         }
         if ( StringUtil.StrCmp(AV64Customerwwds_9_tfcustomeremail_sel, context.GetMessage( "<#Empty#>", "")) == 0 )
         {
            AddWhere(sWhereString, "(T1.CustomerEmail IS NULL or (char_length(trim(trailing ' ' from T1.CustomerEmail))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV66Customerwwds_11_tfcustomervisitingaddress_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV65Customerwwds_10_tfcustomervisitingaddress)) ) )
         {
            AddWhere(sWhereString, "(T1.CustomerVisitingAddress like :lV65Customerwwds_10_tfcustomervisitingaddress)");
         }
         else
         {
            GXv_int1[16] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV66Customerwwds_11_tfcustomervisitingaddress_sel)) && ! ( StringUtil.StrCmp(AV66Customerwwds_11_tfcustomervisitingaddress_sel, context.GetMessage( "<#Empty#>", "")) == 0 ) )
         {
            AddWhere(sWhereString, "(T1.CustomerVisitingAddress = ( :AV66Customerwwds_11_tfcustomervisitingaddress_sel))");
         }
         else
         {
            GXv_int1[17] = 1;
         }
         if ( StringUtil.StrCmp(AV66Customerwwds_11_tfcustomervisitingaddress_sel, context.GetMessage( "<#Empty#>", "")) == 0 )
         {
            AddWhere(sWhereString, "(T1.CustomerVisitingAddress IS NULL or (char_length(trim(trailing ' ' from T1.CustomerVisitingAddress))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV68Customerwwds_13_tfcustomerphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV67Customerwwds_12_tfcustomerphone)) ) )
         {
            AddWhere(sWhereString, "(T1.CustomerPhone like :lV67Customerwwds_12_tfcustomerphone)");
         }
         else
         {
            GXv_int1[18] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV68Customerwwds_13_tfcustomerphone_sel)) && ! ( StringUtil.StrCmp(AV68Customerwwds_13_tfcustomerphone_sel, context.GetMessage( "<#Empty#>", "")) == 0 ) )
         {
            AddWhere(sWhereString, "(T1.CustomerPhone = ( :AV68Customerwwds_13_tfcustomerphone_sel))");
         }
         else
         {
            GXv_int1[19] = 1;
         }
         if ( StringUtil.StrCmp(AV68Customerwwds_13_tfcustomerphone_sel, context.GetMessage( "<#Empty#>", "")) == 0 )
         {
            AddWhere(sWhereString, "(T1.CustomerPhone IS NULL or (char_length(trim(trailing ' ' from T1.CustomerPhone))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV70Customerwwds_15_tfcustomervatnumber_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV69Customerwwds_14_tfcustomervatnumber)) ) )
         {
            AddWhere(sWhereString, "(T1.CustomerVatNumber like :lV69Customerwwds_14_tfcustomervatnumber)");
         }
         else
         {
            GXv_int1[20] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV70Customerwwds_15_tfcustomervatnumber_sel)) && ! ( StringUtil.StrCmp(AV70Customerwwds_15_tfcustomervatnumber_sel, context.GetMessage( "<#Empty#>", "")) == 0 ) )
         {
            AddWhere(sWhereString, "(T1.CustomerVatNumber = ( :AV70Customerwwds_15_tfcustomervatnumber_sel))");
         }
         else
         {
            GXv_int1[21] = 1;
         }
         if ( StringUtil.StrCmp(AV70Customerwwds_15_tfcustomervatnumber_sel, context.GetMessage( "<#Empty#>", "")) == 0 )
         {
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerName, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerPostalAddress, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerEmail, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerVisitingAddress, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerPhone, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T1.CustomerVatNumber, T2.CustomerTypeName, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
                                             ...
                                             string A79CustomerTypeName )
      {
         ...
         scmdbuf = "SELECT T1.CustomerTypeId, T2.CustomerTypeName, T1.CustomerVatNumber, T1.CustomerPhone, T1.CustomerVisitingAddress, T1.CustomerEmail, T1.CustomerPostalAddress, T1.CustomerName, T1.CustomerKvkNumber, T1.CustomerId FROM (Customer T1 LEFT JOIN CustomerType T2 ON T2.CustomerTypeId = T1.CustomerTypeId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Customerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.CustomerKvkNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerName like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPostalAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerEmail like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVisitingAddress like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerPhone like '%' || :lV56Customerwwds_1_filterfulltext) or ( T1.CustomerVatNumber like '%' || :lV56Customerwwds_1_filterfulltext) or ( T2.CustomerTypeName like '%' || :lV56Customerwwds_1_filterfulltext))");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV61Customerwwds_6_tfcustomerpostaladdress",GXType.VarChar,1024,0) ,
          new ParDef("AV62Customerwwds_7_tfcustomerpostaladdress_sel",GXType.VarChar,1024,0) ,
          new ParDef("lV63Customerwwds_8_tfcustomeremail",GXType.VarChar,100,0) ,
          new ParDef("AV64Customerwwds_9_tfcustomeremail_sel",GXType.VarChar,100,0) ,
          new ParDef("lV65Customerwwds_10_tfcustomervisitingaddress",GXType.VarChar,1024,0) ,
          new ParDef("AV66Customerwwds_11_tfcustomervisitingaddress_sel",GXType.VarChar,1024,0) ,
          new ParDef("lV67Customerwwds_12_tfcustomerphone",GXType.Char,20,0) ,
          new ParDef("AV68Customerwwds_13_tfcustomerphone_sel",GXType.Char,20,0) ,
          new ParDef("lV69Customerwwds_14_tfcustomervatnumber",GXType.VarChar,14,0) ,
          new ParDef("AV70Customerwwds_15_tfcustomervatnumber_sel",GXType.VarChar,14,0) ,
