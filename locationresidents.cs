...
namespace GeneXus.Programs {
   public class locationresidents : GXDataArea
   {
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavViewqrcode_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavViewqrcode_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentid_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentid_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentbsnnumber_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentbsnnumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentbsnnumber_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentgivenname_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentgivenname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentgivenname_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentlastname_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentlastname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentlastname_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentinitials_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentinitials_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentinitials_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentemail_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentemail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentemail_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentaddress_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentaddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentaddress_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residentphone_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residentphone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residentphone_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavResidentdetailss__residenttypename_Enabled = 0;
         AssignProp("", false, edtavResidentdetailss__residenttypename_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavResidentdetailss__residenttypename_Enabled), 5, 0), !bGXsfl_45_Refreshing);
         edtavUpdateresident_Enabled = 0;
         AssignProp("", false, edtavUpdateresident_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdateresident_Enabled), 5, 0), !bGXsfl_45_Refreshing);
      ...
      protected void E173Q2( )
      {
         ...
         if ( AV33GAMUser.checkrole(context.GetMessage( "Customer Manager", "")) )
         {
         ...
         {
            if ( AV33GAMUser.checkrole(context.GetMessage( "Receptionist", "")) )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119594947", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("locationresidents.js", "?202482119594950", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{ctrl:'RESIDENTDETAILSS__RESIDENTBSNNUMBER',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTGIVENNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTLASTNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTEMAIL',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTADDRESS',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTPHONE',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTTYPENAME',prop:'Visible'},{av:'AV12GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV13GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{ctrl:'BTNCREATERESIDENTACTION',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E133Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E143Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E193Q2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV32viewQrCode',fld:'vVIEWQRCODE',pic:''},{av:'AV27UpdateResident',fld:'vUPDATERESIDENT',pic:''},{av:'AV9Delete',fld:'vDELETE',pic:''}]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E153Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{ctrl:'RESIDENTDETAILSS__RESIDENTBSNNUMBER',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTGIVENNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTLASTNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTEMAIL',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTADDRESS',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTPHONE',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTTYPENAME',prop:'Visible'},{av:'AV12GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV13GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{ctrl:'BTNCREATERESIDENTACTION',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E123Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV14GridState',fld:'vGRIDSTATE',pic:''},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{ctrl:'RESIDENTDETAILSS__RESIDENTBSNNUMBER',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTGIVENNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTLASTNAME',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTEMAIL',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTADDRESS',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTPHONE',prop:'Visible'},{ctrl:'RESIDENTDETAILSS__RESIDENTTYPENAME',prop:'Visible'},{av:'AV12GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV13GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{ctrl:'BTNCREATERESIDENTACTION',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("'DOCREATERESIDENTACTION'","{handler:'E113Q1',iparms:[]");
         setEventMetadata("'DOCREATERESIDENTACTION'",",oparms:[]}");
         setEventMetadata("VLOCATIONOPTION.CONTROLVALUECHANGED","{handler:'E163Q2',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'AV48Udparg1',fld:'vUDPARG1',pic:'9999',hsh:true},{av:'A18CustomerLocationId',fld:'CUSTOMERLOCATIONID',pic:'ZZZ9'},{av:'dynavLocationoption'},{av:'AV31LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'A39ResidentGAMGUID',fld:'RESIDENTGAMGUID',pic:''},{av:'A40ResidentBsnNumber',fld:'RESIDENTBSNNUMBER',pic:''},{av:'A33ResidentGivenName',fld:'RESIDENTGIVENNAME',pic:''},{av:'A34ResidentLastName',fld:'RESIDENTLASTNAME',pic:''},{av:'A35ResidentInitials',fld:'RESIDENTINITIALS',pic:''},{av:'A36ResidentEmail',fld:'RESIDENTEMAIL',pic:''},{av:'A37ResidentAddress',fld:'RESIDENTADDRESS',pic:''},{av:'A38ResidentPhone',fld:'RESIDENTPHONE',pic:''},{av:'A83ResidentTypeName',fld:'RESIDENTTYPENAME',pic:''},{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45},{av:'GRID_nEOF'},{av:'AV19ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV5ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV45Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV10FilterFullText',fld:'vFILTERFULLTEXT',pic:''}]");
         setEventMetadata("VLOCATIONOPTION.CONTROLVALUECHANGED",",oparms:[{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45}]}");
         setEventMetadata("VVIEWQRCODE.CLICK","{handler:'E203Q2',iparms:[{av:'AV22ResidentDetailss',fld:'vRESIDENTDETAILSS',grid:45,pic:''},{av:'nGXsfl_45_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:45},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_45',ctrl:'GRID',prop:'GridRC',grid:45}]");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV22ResidentDetailss = new GXBaseCollection<SdtResidentDetails>( context, "ResidentDetails", "Comforta11");
      ...
      private int edtavUpdateresident_Visible ;
