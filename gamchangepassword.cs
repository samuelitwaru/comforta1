...
namespace GeneXus.Programs {
   public class gamchangepassword : GXHttpHandler
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamchangepassword.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV6IDP_State))}, new string[] {"IDP_State"}) +"\">") ;
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "Center", "top", "", "", "div");
            wb_table1_21_0O2( true) ;
         }
         else
         {
            wb_table1_21_0O2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_0O2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void wb_table1_21_0O2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_21_0O2e( true) ;
         }
         else
         {
            wb_table1_21_0O2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248244132023", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamchangepassword.js", "?20248244132026", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120O2',iparms:[{av:'AV12UserPasswordNew',fld:'vUSERPASSWORDNEW',pic:''},{av:'AV13UserPasswordNewConf',fld:'vUSERPASSWORDNEWCONF',pic:''},{av:'AV11UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV6IDP_State',fld:'vIDP_STATE',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("BACKTOLOGIN.CLICK","{handler:'E130O2',iparms:[]");
