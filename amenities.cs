...
namespace GeneXus.Programs {
   public class amenities : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtAmenitiesName_Internalname, A110AmenitiesName, StringUtil.RTrim( context.localUtil.Format( A110AmenitiesName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmenitiesName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtAmenitiesName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Amenities.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         GxWebStd.gx_single_line_edit( context, edtAmenitiesTypeId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A108AmenitiesTypeId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmenitiesTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtAmenitiesTypeId_Visible, edtAmenitiesTypeId_Enabled, 1, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Amenities.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtavComboamenitiestypeid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV20ComboAmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavComboamenitiestypeid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV20ComboAmenitiesTypeId), "ZZZ9") : context.localUtil.Format( (decimal)(AV20ComboAmenitiesTypeId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavComboamenitiestypeid_Jsonclick, 0, "Attribute", "", "", "", "", edtavComboamenitiestypeid_Visible, edtavComboamenitiestypeid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Amenities.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtAmenitiesId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtAmenitiesId_Enabled!=0) ? context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9") : context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmenitiesId_Jsonclick, 0, "Attribute", "", "", "", "", edtAmenitiesId_Visible, edtAmenitiesId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Amenities.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               /* Read saved values. */
               Z107AmenitiesId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "Z107AmenitiesId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               Z110AmenitiesName = cgiGet( "Z110AmenitiesName");
               ...
               Gx_mode = cgiGet( "Mode");
               N108AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "N108AmenitiesTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               ...
               A109AmenitiesTypeName = cgiGet( "AMENITIESTYPENAME");
               ...
               AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
               ...
               A107AmenitiesId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtAmenitiesId_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
               forbiddenHiddens.Add("AmenitiesId", context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"));
               forbiddenHiddens.Add("Gx_mode", StringUtil.RTrim( context.localUtil.Format( Gx_mode, "@!")));
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A107AmenitiesId != Z107AmenitiesId ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
               {
      ...
      protected void ZM0E24( short GX_JID )
      {
         if ( ( GX_JID == 8 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z110AmenitiesName = T000E3_A110AmenitiesName[0];
               Z108AmenitiesTypeId = T000E3_A108AmenitiesTypeId[0];
            }
            else
            {
      ...
      protected void standaloneNotModal( )
      {
         ...
         if ( ! (0==AV7AmenitiesId) )
         {
            A107AmenitiesId = AV7AmenitiesId;
            AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
         }
      ...
      protected void standaloneModal( )
      {
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ! (0==AV13Insert_AmenitiesTypeId) )
         {
            A108AmenitiesTypeId = AV13Insert_AmenitiesTypeId;
            AssignAttri("", false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
         }
         else
         {
            A108AmenitiesTypeId = AV20ComboAmenitiesTypeId;
            AssignAttri("", false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
         }
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) && ( Gx_BScreen == 0 ) )
         {
            ...
            A109AmenitiesTypeName = T000E4_A109AmenitiesTypeName[0];
            pr_default.close(2);
         }
      }
      ...
      {
         /* Using cursor T000E5 */
         pr_default.execute(3, new Object[] {A107AmenitiesId});
         if ( (pr_default.getStatus(3) != 101) )
         {
            RcdFound24 = 1;
            A110AmenitiesName = T000E5_A110AmenitiesName[0];
            AssignAttri("", false, "A110AmenitiesName", A110AmenitiesName);
            A109AmenitiesTypeName = T000E5_A109AmenitiesTypeName[0];
            A108AmenitiesTypeId = T000E5_A108AmenitiesTypeId[0];
            AssignAttri("", false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
            ZM0E24( -8) ;
         }
         pr_default.close(3);
      ...
      protected void gxLoad_9( short A108AmenitiesTypeId )
      {
         /* Using cursor T000E6 */
         ...
         A109AmenitiesTypeName = T000E6_A109AmenitiesTypeName[0];
      ...
      {
         /* Using cursor T000E7 */
         pr_default.execute(5, new Object[] {A107AmenitiesId});
      ...
      {
         /* Using cursor T000E3 */
         pr_default.execute(1, new Object[] {A107AmenitiesId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0E24( 8) ;
            RcdFound24 = 1;
            A107AmenitiesId = T000E3_A107AmenitiesId[0];
            AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
            A110AmenitiesName = T000E3_A110AmenitiesName[0];
            AssignAttri("", false, "A110AmenitiesName", A110AmenitiesName);
            A108AmenitiesTypeId = T000E3_A108AmenitiesTypeId[0];
            AssignAttri("", false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
            Z107AmenitiesId = A107AmenitiesId;
            sMode24 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         RcdFound24 = 0;
         /* Using cursor T000E8 */
         pr_default.execute(6, new Object[] {A107AmenitiesId});
         if ( (pr_default.getStatus(6) != 101) )
         {
            while ( (pr_default.getStatus(6) != 101) && ( ( T000E8_A107AmenitiesId[0] < A107AmenitiesId ) ) )
            {
               pr_default.readNext(6);
            }
            if ( (pr_default.getStatus(6) != 101) && ( ( T000E8_A107AmenitiesId[0] > A107AmenitiesId ) ) )
            {
               A107AmenitiesId = T000E8_A107AmenitiesId[0];
               AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
               RcdFound24 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         RcdFound24 = 0;
         /* Using cursor T000E9 */
         pr_default.execute(7, new Object[] {A107AmenitiesId});
         if ( (pr_default.getStatus(7) != 101) )
         {
            while ( (pr_default.getStatus(7) != 101) && ( ( T000E9_A107AmenitiesId[0] > A107AmenitiesId ) ) )
            {
               pr_default.readNext(7);
            }
            if ( (pr_default.getStatus(7) != 101) && ( ( T000E9_A107AmenitiesId[0] < A107AmenitiesId ) ) )
            {
               A107AmenitiesId = T000E9_A107AmenitiesId[0];
               AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
               RcdFound24 = 1;
            }
         }
      ...
      protected void btn_enter( )
      {
         ...
         else
         {
            if ( RcdFound24 == 1 )
            {
               if ( A107AmenitiesId != Z107AmenitiesId )
               {
                  A107AmenitiesId = Z107AmenitiesId;
                  AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
      ...
      protected void CheckOptimisticConcurrency0E24( )
      {
         ...
         {
            /* Using cursor T000E2 */
            pr_default.execute(0, new Object[] {A107AmenitiesId});
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z110AmenitiesName, T000E2_A110AmenitiesName[0]) != 0 ) || ( Z108AmenitiesTypeId != T000E2_A108AmenitiesTypeId[0] ) )
            {
               if ( StringUtil.StrCmp(Z110AmenitiesName, T000E2_A110AmenitiesName[0]) != 0 )
               {
                  GXUtil.WriteLog("amenities:[seudo value changed for attri]"+"AmenitiesName");
                  GXUtil.WriteLogRaw("Old: ",Z110AmenitiesName);
                  GXUtil.WriteLogRaw("Current: ",T000E2_A110AmenitiesName[0]);
               }
               if ( Z108AmenitiesTypeId != T000E2_A108AmenitiesTypeId[0] )
               {
                  GXUtil.WriteLog("amenities:[seudo value changed for attri]"+"AmenitiesTypeId");
                  GXUtil.WriteLogRaw("Old: ",Z108AmenitiesTypeId);
                  GXUtil.WriteLogRaw("Current: ",T000E2_A108AmenitiesTypeId[0]);
               }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(8, new Object[] {A110AmenitiesName, A108AmenitiesTypeId});
                     pr_default.close(8);
                     /* Retrieving last key number assigned */
                     /* Using cursor T000E11 */
                     pr_default.execute(9);
                     A107AmenitiesId = T000E11_A107AmenitiesId[0];
                     AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
                     pr_default.close(9);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(10, new Object[] {A110AmenitiesName, A108AmenitiesTypeId, A107AmenitiesId});
                     pr_default.close(10);
                     pr_default.SmartCacheProvider.SetUpdated("Amenities");
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(11, new Object[] {A107AmenitiesId});
                  pr_default.close(11);
                  pr_default.SmartCacheProvider.SetUpdated("Amenities");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls0E24( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(12, new Object[] {A108AmenitiesTypeId});
            A109AmenitiesTypeName = T000E14_A109AmenitiesTypeName[0];
            pr_default.close(12);
         }
         if ( AnyError == 0 )
         {
            /* Using cursor T000E15 */
            pr_default.execute(13, new Object[] {A107AmenitiesId});
      ...
      public void ScanStart0E24( )
      {
         ...
         {
            RcdFound24 = 1;
            A107AmenitiesId = T000E16_A107AmenitiesId[0];
            AssignAttri("", false, "A107AmenitiesId", StringUtil.LTrimStr( (decimal)(A107AmenitiesId), 4, 0));
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z107AmenitiesId", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "Z110AmenitiesName", Z110AmenitiesName);
         ...
         GxWebStd.gx_hidden_field( context, "N108AmenitiesTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "AMENITIESTYPENAME", A109AmenitiesTypeName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714312617", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenities.js", "?202482714312619", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV11TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7AmenitiesId',fld:'vAMENITIESID',pic:'ZZZ9',hsh:true},{av:'A107AmenitiesId',fld:'AMENITIESID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALID_AMENITIESTYPEID","{handler:'Valid_Amenitiestypeid',iparms:[{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'},{av:'A109AmenitiesTypeName',fld:'AMENITIESTYPENAME',pic:''}]");
         setEventMetadata("VALID_AMENITIESTYPEID",",oparms:[{av:'A109AmenitiesTypeName',fld:'AMENITIESTYPENAME',pic:''}]}");
         setEventMetadata("VALIDV_COMBOAMENITIESTYPEID","{handler:'Validv_Comboamenitiestypeid',iparms:[]");
         setEventMetadata("VALIDV_COMBOAMENITIESTYPEID",",oparms:[]}");
         setEventMetadata("VALID_AMENITIESID","{handler:'Valid_Amenitiesid',iparms:[]");
         setEventMetadata("VALID_AMENITIESID",",oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         T000E4_A109AmenitiesTypeName = new string[] {""} ;
         T000E5_A107AmenitiesId = new short[1] ;
         T000E5_A110AmenitiesName = new string[] {""} ;
         T000E5_A109AmenitiesTypeName = new string[] {""} ;
         T000E5_A108AmenitiesTypeId = new short[1] ;
         T000E6_A109AmenitiesTypeName = new string[] {""} ;
         T000E7_A107AmenitiesId = new short[1] ;
         T000E3_A107AmenitiesId = new short[1] ;
         T000E3_A110AmenitiesName = new string[] {""} ;
         T000E3_A108AmenitiesTypeId = new short[1] ;
         T000E8_A107AmenitiesId = new short[1] ;
         T000E9_A107AmenitiesId = new short[1] ;
         T000E2_A107AmenitiesId = new short[1] ;
         T000E2_A110AmenitiesName = new string[] {""} ;
         T000E2_A108AmenitiesTypeId = new short[1] ;
         T000E11_A107AmenitiesId = new short[1] ;
         T000E14_A109AmenitiesTypeName = new string[] {""} ;
         T000E15_A1CustomerId = new short[1] ;
         T000E15_A18CustomerLocationId = new short[1] ;
         T000E15_A107AmenitiesId = new short[1] ;
         T000E16_A107AmenitiesId = new short[1] ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenities__default(),
            new Object[][] {
                new Object[] {
               T000E2_A107AmenitiesId, T000E2_A110AmenitiesName, T000E2_A108AmenitiesTypeId
               }
               , new Object[] {
               T000E3_A107AmenitiesId, T000E3_A110AmenitiesName, T000E3_A108AmenitiesTypeId
               }
               , new Object[] {
               T000E4_A109AmenitiesTypeName
               }
               , new Object[] {
               T000E5_A107AmenitiesId, T000E5_A110AmenitiesName, T000E5_A109AmenitiesTypeName, T000E5_A108AmenitiesTypeId
               }
               , new Object[] {
               T000E6_A109AmenitiesTypeName
               }
               , new Object[] {
               T000E7_A107AmenitiesId
               }
               , new Object[] {
               T000E8_A107AmenitiesId
               }
               , new Object[] {
               T000E9_A107AmenitiesId
               }
               , new Object[] {
               }
               , new Object[] {
               T000E11_A107AmenitiesId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000E14_A109AmenitiesTypeName
               }
               , new Object[] {
               T000E15_A1CustomerId, T000E15_A18CustomerLocationId, T000E15_A107AmenitiesId
               }
               , new Object[] {
               T000E16_A107AmenitiesId
               }
            }
         );
         AV23Pgmname = "Amenities";
      ...
      private short N108AmenitiesTypeId ;
      ...
      private string[] T000E4_A109AmenitiesTypeName ;
      private short[] T000E5_A107AmenitiesId ;
      private string[] T000E5_A110AmenitiesName ;
      private string[] T000E5_A109AmenitiesTypeName ;
      private short[] T000E5_A108AmenitiesTypeId ;
      private string[] T000E6_A109AmenitiesTypeName ;
      private short[] T000E7_A107AmenitiesId ;
      private short[] T000E3_A107AmenitiesId ;
      private string[] T000E3_A110AmenitiesName ;
      private short[] T000E3_A108AmenitiesTypeId ;
      private short[] T000E8_A107AmenitiesId ;
      private short[] T000E9_A107AmenitiesId ;
      private short[] T000E2_A107AmenitiesId ;
      private string[] T000E2_A110AmenitiesName ;
      private short[] T000E2_A108AmenitiesTypeId ;
      private short[] T000E11_A107AmenitiesId ;
      private string[] T000E14_A109AmenitiesTypeName ;
      private short[] T000E15_A1CustomerId ;
      private short[] T000E15_A18CustomerLocationId ;
      private short[] T000E15_A107AmenitiesId ;
      private short[] T000E16_A107AmenitiesId ;
 ...
 public class amenities__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T000E2", "SELECT AmenitiesId, AmenitiesName, AmenitiesTypeId FROM Amenities WHERE AmenitiesId = :AmenitiesId  FOR UPDATE OF Amenities NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT000E2,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E3", "SELECT AmenitiesId, AmenitiesName, AmenitiesTypeId FROM Amenities WHERE AmenitiesId = :AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E3,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E4", "SELECT AmenitiesTypeName FROM AmenitiesType WHERE AmenitiesTypeId = :AmenitiesTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E4,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E5", "SELECT TM1.AmenitiesId, TM1.AmenitiesName, T2.AmenitiesTypeName, TM1.AmenitiesTypeId FROM (Amenities TM1 INNER JOIN AmenitiesType T2 ON T2.AmenitiesTypeId = TM1.AmenitiesTypeId) WHERE TM1.AmenitiesId = :AmenitiesId ORDER BY TM1.AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E5,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E6", "SELECT AmenitiesTypeName FROM AmenitiesType WHERE AmenitiesTypeId = :AmenitiesTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E6,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E7", "SELECT AmenitiesId FROM Amenities WHERE AmenitiesId = :AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E7,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E8", "SELECT AmenitiesId FROM Amenities WHERE ( AmenitiesId > :AmenitiesId) ORDER BY AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E8,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000E9", "SELECT AmenitiesId FROM Amenities WHERE ( AmenitiesId < :AmenitiesId) ORDER BY AmenitiesId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E9,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000E10", "SAVEPOINT gxupdate;INSERT INTO Amenities(AmenitiesName, AmenitiesTypeId) VALUES(:AmenitiesName, :AmenitiesTypeId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000E10)
           ,new CursorDef("T000E11", "SELECT currval('AmenitiesId') ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E11,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E12", "SAVEPOINT gxupdate;UPDATE Amenities SET AmenitiesName=:AmenitiesName, AmenitiesTypeId=:AmenitiesTypeId  WHERE AmenitiesId = :AmenitiesId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000E12)
           ,new CursorDef("T000E13", "SAVEPOINT gxupdate;DELETE FROM Amenities  WHERE AmenitiesId = :AmenitiesId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000E13)
           ,new CursorDef("T000E14", "SELECT AmenitiesTypeName FROM AmenitiesType WHERE AmenitiesTypeId = :AmenitiesTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E14,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000E15", "SELECT CustomerId, CustomerLocationId, AmenitiesId FROM CustomerLocationsAmenities WHERE AmenitiesId = :AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E15,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T000E16", "SELECT AmenitiesId FROM Amenities ORDER BY AmenitiesId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E16,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
