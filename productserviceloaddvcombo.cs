...
namespace GeneXus.Programs {
   public class productserviceloaddvcombo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP7_Combo_DataJson )
      {
         productserviceloaddvcombo objproductserviceloaddvcombo;
         objproductserviceloaddvcombo = new productserviceloaddvcombo();
         objproductserviceloaddvcombo.AV17ComboName = aP0_ComboName;
         objproductserviceloaddvcombo.AV18TrnMode = aP1_TrnMode;
         objproductserviceloaddvcombo.AV19IsDynamicCall = aP2_IsDynamicCall;
         objproductserviceloaddvcombo.AV20ProductServiceId = aP3_ProductServiceId;
         objproductserviceloaddvcombo.AV21SearchTxtParms = aP4_SearchTxtParms;
         objproductserviceloaddvcombo.AV22SelectedValue = "" ;
         objproductserviceloaddvcombo.AV23SelectedText = "" ;
         objproductserviceloaddvcombo.AV24Combo_DataJson = "" ;
         objproductserviceloaddvcombo.context.SetSubmitInitialConfig(context);
         objproductserviceloaddvcombo.initialize();
         Submit( executePrivateCatch,objproductserviceloaddvcombo);
         aP5_SelectedValue=this.AV22SelectedValue;
         aP6_SelectedText=this.AV23SelectedText;
         aP7_Combo_DataJson=this.AV24Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((productserviceloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
