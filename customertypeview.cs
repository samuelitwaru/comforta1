...
namespace GeneXus.Programs {
   public class customertypeview : GXDataArea
   {
      ...
      public customertypeview( IGxContext context )
      {
      ...
      public void execute( short aP0_CustomerTypeId ,
                           string aP1_TabCode )
      {
         this.AV10CustomerTypeId = aP0_CustomerTypeId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10CustomerTypeId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV10CustomerTypeId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerTypeId), "ZZZ9"), context));
      ...
      {
         get {
            return "customertypeview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customertypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CustomerTypeId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CustomerTypeId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCUSTOMERTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerTypeId), "ZZZ9"), context));
      ...
      {
         return formatLink("customertypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CustomerTypeId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CustomerTypeId","TabCode"})  ;
      }
      ...
      {
         return context.GetMessage( "Customer Type View", "") ;
      }
      ...
      protected void WB1R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Customer Type", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CustomerTypeView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCustomertypegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCustomer_title_Internalname, context.GetMessage( "Customer", ""), "", "", lblCustomer_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_CustomerTypeView.htm");
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablecustomer_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Customerwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START1R2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Customer Type View", ""), 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 33 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Customerwc_Component) != 0 )
                           {
                              WebComp_Customerwc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Customerwc_Component = OldCustomerwc;
                        }
                     }
      ...
      protected void STRUP1R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vCUSTOMERTYPEID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E111R2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("customertypeww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV14GXLvl9 = 0;
         /* Using cursor H001R2 */
         pr_default.execute(0, new Object[] {AV10CustomerTypeId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A78CustomerTypeId = H001R2_A78CustomerTypeId[0];
            A79CustomerTypeName = H001R2_A79CustomerTypeName[0];
            AV14GXLvl9 = 1;
            Form.Caption = A79CustomerTypeName;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "CustomerTypeGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "customertypegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "CustomerTypeGeneral";
            WebComp_Webcomponent_general_Component = "CustomerTypeGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(short)AV10CustomerTypeId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Customer") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Customerwc_Component), StringUtil.Lower( "CustomerTypeCustomerWC")) != 0 )
            {
               WebComp_Customerwc = getWebComponent(GetType(), "GeneXus.Programs", "customertypecustomerwc", new Object[] {context} );
               WebComp_Customerwc.ComponentInit();
               WebComp_Customerwc.Name = "CustomerTypeCustomerWC";
               WebComp_Customerwc_Component = "CustomerTypeCustomerWC";
            }
            if ( StringUtil.Len( WebComp_Customerwc_Component) != 0 )
            {
               WebComp_Customerwc.setjustcreated();
               WebComp_Customerwc.componentprepare(new Object[] {(string)"W0033",(string)"",(short)AV10CustomerTypeId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CustomerTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV10CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV10CustomerTypeId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerTypeId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119585517", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customertypeview.js", "?202482119585517", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divCustomertypegeneral_cell_Internalname = "CUSTOMERTYPEGENERAL_CELL";
         lblCustomer_title_Internalname = "CUSTOMER_TITLE";
         divUnnamedtablecustomer_Internalname = "UNNAMEDTABLECUSTOMER";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Customer Type View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CustomerTypeId',fld:'vCUSTOMERTYPEID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001R2_A78CustomerTypeId = new short[1] ;
         H001R2_A79CustomerTypeName = new string[] {""} ;
         A79CustomerTypeName = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customertypeview__default(),
            new Object[][] {
                new Object[] {
               H001R2_A78CustomerTypeId, H001R2_A79CustomerTypeName
               }
            }
         );
      ...
      private short AV10CustomerTypeId ;
      private short wcpOAV10CustomerTypeId ;
      ...
      private string divCustomertypegeneral_cell_Internalname ;
      ...
      private string divUnnamedtablecustomer_Internalname ;
      ...
      private short[] H001R2_A78CustomerTypeId ;
      private string[] H001R2_A79CustomerTypeName ;
   ...
   public class customertypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10CustomerTypeId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001R2", "SELECT CustomerTypeId, CustomerTypeName FROM CustomerType WHERE CustomerTypeId = :AV10CustomerTypeId ORDER BY CustomerTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001R2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
