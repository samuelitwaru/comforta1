...
namespace GeneXus.Programs {
   public class gx0021 : GXDataArea
   {
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtCustomerManagerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerManagerId_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtCustomerManagerGivenName_Enabled = 0;
         AssignProp("", false, edtCustomerManagerGivenName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerManagerGivenName_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtCustomerManagerLastName_Enabled = 0;
         AssignProp("", false, edtCustomerManagerLastName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerManagerLastName_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtCustomerManagerInitials_Enabled = 0;
         AssignProp("", false, edtCustomerManagerInitials_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerManagerInitials_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         edtCustomerId_Enabled = 0;
         AssignProp("", false, edtCustomerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerId_Enabled), 5, 0), !bGXsfl_74_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714333032", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0021.js", "?202482714333032", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cCustomerManagerId',fld:'vCCUSTOMERMANAGERID',pic:'ZZZ9'},{av:'AV7cCustomerManagerGivenName',fld:'vCCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV8cCustomerManagerLastName',fld:'vCCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV9cCustomerManagerInitials',fld:'vCCUSTOMERMANAGERINITIALS',pic:''},{av:'AV10cCustomerManagerEmail',fld:'vCCUSTOMERMANAGEREMAIL',pic:''},{av:'AV11cCustomerManagerPhone',fld:'vCCUSTOMERMANAGERPHONE',pic:''},{av:'AV12pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALIDV_CCUSTOMERMANAGEREMAIL",",oparms:[]}");
