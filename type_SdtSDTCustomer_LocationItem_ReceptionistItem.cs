...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDTCustomer.LocationItem.ReceptionistItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"SDTCustomer.LocationItem.ReceptionistItem", Namespace="Comforta11")]
