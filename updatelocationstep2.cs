...
namespace GeneXus.Programs {
   public class updatelocationstep2 : GXWebComponent
   {
      ...
      protected void S122( )
      {
         ...
         {
            A107AmenitiesId = H003V2_A107AmenitiesId[0];
            A110AmenitiesName = H003V2_A110AmenitiesName[0];
            A108AmenitiesTypeId = H003V2_A108AmenitiesTypeId[0];
            AV18LocationAmenitiesSDT = new SdtLocationAmenitiesSDT(context);
            AV18LocationAmenitiesSDT.gxTpr_Amenitiesid = A107AmenitiesId;
            AV18LocationAmenitiesSDT.gxTpr_Amenitiesname = A110AmenitiesName;
            AV18LocationAmenitiesSDT.gxTpr_Selected = false;
            AV18LocationAmenitiesSDT.gxTpr_Amenitiestypeid = A108AmenitiesTypeId;
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A107AmenitiesId = H003V3_A107AmenitiesId[0];
            AV17LocationAmenitiesCollection.Add(A107AmenitiesId, 0);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248271430264", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("updatelocationstep2.js", "?20248271430264", false, true);
      ...
      protected void sendrow_182( )
      {
         ...
         /* Check box */
         TempTags = " " + ((chkavLocationamenitiessdts__selected.Enabled!=0)&&(chkavLocationamenitiessdts__selected.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 22,'"+sPrefix+"',false,'"+sGXsfl_18_idx+"',18)\"" : " ");
         ...
         /* Single line edit */
         TempTags = " " + ((edtavLocationamenitiessdts__amenitiesid_Enabled!=0)&&(edtavLocationamenitiessdts__amenitiesid_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 31,'"+sPrefix+"',false,'"+sGXsfl_18_idx+"',18)\"" : " ");
         ROClassString = "Attribute";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavLocationamenitiessdts__amenitiestypename_Enabled = 1;
         edtavLocationamenitiessdts__amenitiestypename_Visible = 1;
         edtavLocationamenitiessdts__amenitiestypeid_Jsonclick = "";
         edtavLocationamenitiessdts__amenitiestypeid_Enabled = 1;
         ...
         chkavLocationamenitiessdts__selected.Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'sPrefix'},{av:'AV19LocationAmenitiesSDTs',fld:'vLOCATIONAMENITIESSDTS',grid:18,pic:'',hsh:true},{av:'nGXsfl_18_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:18},{av:'nRC_GXsfl_18',ctrl:'GRIDS',prop:'GridRC',grid:18},{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV10CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV6MyCustomer',fld:'vMYCUSTOMER',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDS.LOAD","{handler:'E143V2',iparms:[]");
         setEventMetadata("GRIDS.LOAD",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E113V2',iparms:[{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV22WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV19LocationAmenitiesSDTs',fld:'vLOCATIONAMENITIESSDTS',grid:18,pic:'',hsh:true},{av:'nGXsfl_18_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:18},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_18',ctrl:'GRIDS',prop:'GridRC',grid:18},{av:'AV10CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV5LocationId',fld:'vLOCATIONID',pic:'ZZZ9'},{av:'AV23WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV6MyCustomer',fld:'vMYCUSTOMER',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV23WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E123V2',iparms:[{av:'AV5LocationId',fld:'vLOCATIONID',pic:'ZZZ9'},{av:'AV22WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV19LocationAmenitiesSDTs',fld:'vLOCATIONAMENITIESSDTS',grid:18,pic:'',hsh:true},{av:'nGXsfl_18_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:18},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_18',ctrl:'GRIDS',prop:'GridRC',grid:18}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[{av:'AV5LocationId',fld:'vLOCATIONID',pic:'ZZZ9'},{av:'AV23WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("'DOFINISH'","{handler:'E153V2',iparms:[{av:'AV10CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV5LocationId',fld:'vLOCATIONID',pic:'ZZZ9'},{av:'AV23WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV19LocationAmenitiesSDTs',fld:'vLOCATIONAMENITIESSDTS',grid:18,pic:'',hsh:true},{av:'nGXsfl_18_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:18},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_18',ctrl:'GRIDS',prop:'GridRC',grid:18},{av:'AV22WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV6MyCustomer',fld:'vMYCUSTOMER',pic:'',hsh:true}]");
         setEventMetadata("'DOFINISH'",",oparms:[]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003V2_A107AmenitiesId = new short[1] ;
         H003V2_A110AmenitiesName = new string[] {""} ;
         H003V2_A108AmenitiesTypeId = new short[1] ;
         A110AmenitiesName = "";
         H003V3_A18CustomerLocationId = new short[1] ;
         H003V3_A1CustomerId = new short[1] ;
         H003V3_A107AmenitiesId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.updatelocationstep2__default(),
            new Object[][] {
                new Object[] {
               H003V2_A107AmenitiesId, H003V2_A110AmenitiesName, H003V2_A108AmenitiesTypeId
               }
               , new Object[] {
               H003V3_A18CustomerLocationId, H003V3_A1CustomerId, H003V3_A107AmenitiesId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int edtavLocationamenitiessdts__amenitiestypeid_Enabled ;
      private int edtavLocationamenitiessdts__amenitiestypename_Enabled ;
      ...
      private short[] H003V2_A107AmenitiesId ;
      private string[] H003V2_A110AmenitiesName ;
      private short[] H003V2_A108AmenitiesTypeId ;
      private short[] H003V3_A18CustomerLocationId ;
      private short[] H003V3_A1CustomerId ;
      private short[] H003V3_A107AmenitiesId ;
