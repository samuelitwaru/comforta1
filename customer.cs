...
namespace GeneXus.Programs {
   public class customer : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         {
            A107AmenitiesId = (short)(Math.Round(NumberUtil.Val( GetPar( "AmenitiesId"), "."), 18, MidpointRounding.ToEven));
            setAjaxCallMode();
            if ( ! IsValidAjaxCall( true) )
            {
               GxWebError = 1;
      ...
      protected void DrawControls( )
      {
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtCustomerId_Enabled!=0) ? context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9") : context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtavCombocustomertypeid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV27ComboCustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavCombocustomertypeid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV27ComboCustomerTypeId), "ZZZ9") : context.localUtil.Format( (decimal)(AV27ComboCustomerTypeId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombocustomertypeid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombocustomertypeid_Visible, edtavCombocustomertypeid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Customer.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* User Defined Control */
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerLastLine_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A93CustomerLastLine), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtCustomerLastLine_Enabled!=0) ? context.localUtil.Format( (decimal)(A93CustomerLastLine), "ZZZ9") : context.localUtil.Format( (decimal)(A93CustomerLastLine), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerLastLine_Jsonclick, 0, "Attribute", "", "", "", "", edtCustomerLastLine_Visible, edtCustomerLastLine_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Customer.htm");
         /* User Defined Control */
      ...
      protected void CONFIRM_0123( )
      {
         ...
         while ( nGXsfl_168_idx < nRC_GXsfl_168 )
         {
            ...
            ChangePostValue( edtAmenitiesId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            ChangePostValue( edtAmenitiesTypeId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            ChangePostValue( edtAmenitiesTypeName_Internalname, A109AmenitiesTypeName) ;
            ChangePostValue( "ZT_"+"Z107AmenitiesId_"+sGXsfl_168_idx, StringUtil.LTrim( StringUtil.NToC( (decimal)(Z107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            ChangePostValue( "nRcdDeleted_23_"+sGXsfl_168_idx, StringUtil.LTrim( StringUtil.NToC( (decimal)(nRcdDeleted_23), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            ChangePostValue( "nRcdExists_23_"+sGXsfl_168_idx, StringUtil.LTrim( StringUtil.NToC( (decimal)(nRcdExists_23), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            ChangePostValue( "nIsMod_23_"+sGXsfl_168_idx, StringUtil.LTrim( StringUtil.NToC( (decimal)(nIsMod_23), 4, 0, context.GetLanguageProperty( "decimal_point"), ""))) ;
            if ( nIsMod_23 != 0 )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(42, new Object[] {A1CustomerId, A18CustomerLocationId, A19CustomerLocationVisitingAddres, A20CustomerLocationPostalAddress, A21CustomerLocationEmail, A22CustomerLocationPhone, A94CustomerLocationLastLine});
                     pr_default.close(42);
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     if ( AnyError == 0 )
                     {
                        ...
                        pr_default.execute(43, new Object[] {A19CustomerLocationVisitingAddres, A20CustomerLocationPostalAddress, A21CustomerLocationEmail, A22CustomerLocationPhone, A94CustomerLocationLastLine, A1CustomerId, A18CustomerLocationId});
                        pr_default.close(43);
                        pr_default.SmartCacheProvider.SetUpdated("CustomerLocation");
      ...
      protected void ZM0123( short GX_JID )
      {
         ...
         if ( GX_JID == -36 )
         {
            Z1CustomerId = A1CustomerId;
            Z18CustomerLocationId = A18CustomerLocationId;
            Z107AmenitiesId = A107AmenitiesId;
            Z110AmenitiesName = A110AmenitiesName;
      ...
      protected void Load0123( )
      {
         ...
         pr_default.execute(69, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
         if ( (pr_default.getStatus(69) != 101) )
         {
            RcdFound23 = 1;
            A110AmenitiesName = T000171_A110AmenitiesName[0];
            A109AmenitiesTypeName = T000171_A109AmenitiesTypeName[0];
            A108AmenitiesTypeId = T000171_A108AmenitiesTypeId[0];
            ZM0123( -36) ;
         }
         pr_default.close(69);
         OnLoadActions0123( ) ;
      ...
      protected void CheckExtendedTable0123( )
      {
         ...
         standaloneModal0123( ) ;
         /* Using cursor T00014 */
         pr_default.execute(2, new Object[] {A107AmenitiesId});
         ...
         A110AmenitiesName = T00014_A110AmenitiesName[0];
         A108AmenitiesTypeId = T00014_A108AmenitiesTypeId[0];
         pr_default.close(2);
         /* Using cursor T00015 */
         ...
         A109AmenitiesTypeName = T00015_A109AmenitiesTypeName[0];
         pr_default.close(3);
      }
      ...
      protected void gxLoad_37( short A107AmenitiesId )
      {
         /* Using cursor T000172 */
         pr_default.execute(70, new Object[] {A107AmenitiesId});
         ...
         A110AmenitiesName = T000172_A110AmenitiesName[0];
         A108AmenitiesTypeId = T000172_A108AmenitiesTypeId[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A110AmenitiesName)+"\""+","+"\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, ".", "")))+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(70) == 101) )
         {
            AddString( ",") ;
      ...
      protected void gxLoad_38( short A108AmenitiesTypeId )
      {
         /* Using cursor T000173 */
         pr_default.execute(71, new Object[] {A108AmenitiesTypeId});
         ...
         A109AmenitiesTypeName = T000173_A109AmenitiesTypeName[0];
         GxWebStd.set_html_headers( context, 0, "", "");
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( A109AmenitiesTypeName)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(71) == 101) )
         {
            AddString( ",") ;
      ...
      protected void GetKey0123( )
      {
         ...
         pr_default.execute(72, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
      ...
      {
         /* Using cursor T00013 */
         pr_default.execute(1, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM0123( 36) ;
            RcdFound23 = 1;
            InitializeNonKey0123( ) ;
            A107AmenitiesId = T00013_A107AmenitiesId[0];
            Z1CustomerId = A1CustomerId;
            Z18CustomerLocationId = A18CustomerLocationId;
            Z107AmenitiesId = A107AmenitiesId;
            sMode23 = Gx_mode;
      ...
      protected void CheckOptimisticConcurrency0123( )
      {
         ...
         {
            /* Using cursor T00012 */
            pr_default.execute(0, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(73, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
                     pr_default.close(73);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  pr_default.execute(74, new Object[] {A1CustomerId, A18CustomerLocationId, A107AmenitiesId});
                  pr_default.close(74);
                  pr_default.SmartCacheProvider.SetUpdated("CustomerLocationsAmenities");
                  if ( AnyError == 0 )
                  {
      ...
      protected void OnDeleteControls0123( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            pr_default.execute(75, new Object[] {A107AmenitiesId});
            A110AmenitiesName = T000177_A110AmenitiesName[0];
            A108AmenitiesTypeId = T000177_A108AmenitiesTypeId[0];
            pr_default.close(75);
            /* Using cursor T000178 */
            pr_default.execute(76, new Object[] {A108AmenitiesTypeId});
            A109AmenitiesTypeName = T000178_A109AmenitiesTypeName[0];
            pr_default.close(76);
         }
      }
      ...
      public void ScanStart0123( )
      {
         ...
         {
            RcdFound23 = 1;
            A107AmenitiesId = T000179_A107AmenitiesId[0];
         }
         /* Load Subordinate Levels */
      }
      ...
      protected void SendRow013( )
      {
         ...
         ClassString = "Attribute";
         StyleString = "";
         Freestylelevel_locationsRow.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerLocationPostalAddress_Internalname,(string)A20CustomerLocationPostalAddress,"http://maps.google.com/maps?q="+GXUtil.UrlEncode( A20CustomerLocationPostalAddress),TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,115);\"",(short)0,(short)1,(int)edtCustomerLocationPostalAddress_Enabled,(short)0,(short)80,(string)"chr",(short)10,(string)"row",(short)0,(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"1024",(short)-1,(short)0,(string)"_blank",(string)"",(short)0,(bool)true,(string)"GeneXus\\Address",(string)"'"+""+"'"+",false,"+"'"+""+"'",(short)0,(string)""});
         Freestylelevel_locationsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Freestylelevel_locationsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         Freestylelevel_locationsRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
         /* Div Control */
         ...
         GxWebStd.gx_hidden_field( context, GXCCtl, A110AmenitiesName);
      ...
      protected void ReadRow013( )
      {
         ...
         GXCCtl = "AMENITIESNAME_" + sGXsfl_97_idx;
         A110AmenitiesName = cgiGet( GXCCtl);
         GXCCtl = "nRC_GXsfl_129_" + sGXsfl_97_idx;
         nRC_GXsfl_129 = (int)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         GXCCtl = "nRC_GXsfl_143_" + sGXsfl_97_idx;
         nRC_GXsfl_143 = (int)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void SendRow014( )
      {
         ...
         /* Single line edit */
         ROClassString = "Attribute";
         Gridlevel_receptionistRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerLocationReceptionistId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A23CustomerLocationReceptionistId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtCustomerLocationReceptionistId_Enabled!=0) ? context.localUtil.Format( (decimal)(A23CustomerLocationReceptionistId), "ZZZ9") : context.localUtil.Format( (decimal)(A23CustomerLocationReceptionistId), "ZZZ9"))),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerLocationReceptionistId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"TrnColumn",(string)"",(short)0,(int)edtCustomerLocationReceptionistId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)129,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         /* Single line edit */
      ...
      protected void SubsflControlProps_16823( )
      {
      ...
      protected void SubsflControlProps_fel_16823( )
      {
      ...
      protected void SendRow0123( )
      {
         ...
         /* Subfile cell */
         /* Single line edit */
         TempTags = " data-gxoch1=\"gx.fn.setControlValue('nIsMod_23_" + sGXsfl_168_idx + "',1);gx.fn.setControlValue('nIsMod_3_" + sGXsfl_97_idx + "',1);\"  onfocus=\"gx.evt.onfocus(this, 169,'',false,'" + sGXsfl_168_idx + "',168)\"";
         ROClassString = "Attribute";
         Gridlevel_amenitiesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmenitiesId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,169);\"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAmenitiesId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"TrnColumn",(string)"",(short)-1,(int)edtAmenitiesId_Enabled,(short)1,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)168,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)edtAmenitiesId_Horizontalalignment,(bool)false,(string)""});
         /* Subfile cell */
         /* Single line edit */
         ROClassString = "Attribute";
         Gridlevel_amenitiesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmenitiesTypeId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtAmenitiesTypeId_Enabled!=0) ? context.localUtil.Format( (decimal)(A108AmenitiesTypeId), "ZZZ9") : context.localUtil.Format( (decimal)(A108AmenitiesTypeId), "ZZZ9"))),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAmenitiesTypeId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"TrnColumn",(string)"",(short)-1,(int)edtAmenitiesTypeId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)168,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
         /* Subfile cell */
         /* Single line edit */
         ROClassString = "Attribute";
         Gridlevel_amenitiesRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmenitiesTypeName_Internalname,(string)A109AmenitiesTypeName,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAmenitiesTypeName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"TrnColumn",(string)"",(short)-1,(int)edtAmenitiesTypeName_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)168,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
         ajax_sending_grid_row(Gridlevel_amenitiesRow);
         send_integrity_lvl_hashes0123( ) ;
         GXCCtl = "Z107AmenitiesId_" + sGXsfl_168_idx;
         GxWebStd.gx_hidden_field( context, GXCCtl, StringUtil.LTrim( StringUtil.NToC( (decimal)(Z107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GXCCtl = "nRcdDeleted_23_" + sGXsfl_168_idx;
         ...
         GXCCtl = "nRcdExists_23_" + sGXsfl_168_idx;
         ...
         GXCCtl = "nIsMod_23_" + sGXsfl_168_idx;
      ...
      protected void ReadRow0123( )
      {
         ...
         GXCCtl = "Z107AmenitiesId_" + sGXsfl_168_idx;
         Z107AmenitiesId = (short)(Math.Round(context.localUtil.CToN( cgiGet( GXCCtl), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         GXCCtl = "nRcdDeleted_23_" + sGXsfl_168_idx;
      ...
      protected void ConfirmValues010( )
      {
         ...
         while ( nGXsfl_168_idx < nRC_GXsfl_168 )
         {
            ...
            sGXsfl_168_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_168_idx), 4, 0), 4, "0") + sGXsfl_97_idx;
            SubsflControlProps_16823( ) ;
            ChangePostValue( "Z107AmenitiesId_"+sGXsfl_168_idx, cgiGet( "ZT_"+"Z107AmenitiesId_"+sGXsfl_168_idx)) ;
            DeletePostValue( "ZT_"+"Z107AmenitiesId_"+sGXsfl_168_idx) ;
         }
         nGXsfl_97_idx = 0;
         sGXsfl_97_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_97_idx), 4, 0), 4, "0");
         SubsflControlProps_973( ) ;
      ...
      {
         A110AmenitiesName = "";
         AssignAttri("", false, "A110AmenitiesName", A110AmenitiesName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482210113052", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customer.js", "?202482210113054", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void StartGridControl168( )
      {
         ...
         Gridlevel_amenitiesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, ".", ""))));
         ...
         Gridlevel_amenitiesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         Gridlevel_amenitiesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, ".", ""))));
         ...
         Gridlevel_amenitiesContainer.AddColumnProperties(Gridlevel_amenitiesColumn);
         Gridlevel_amenitiesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         Gridlevel_amenitiesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A109AmenitiesTypeName));
      ...
      public void Valid_Amenitiesid( )
      {
         ...
         /*  Sending validation outputs */
         AssignAttri("", false, "A110AmenitiesName", A110AmenitiesName);
         AssignAttri("", false, "A108AmenitiesTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, ".", "")));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV11TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV7CustomerId',fld:'vCUSTOMERID',pic:'ZZZ9',hsh:true},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("AFTER TRN","{handler:'E14012',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV11TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true}]");
         setEventMetadata("AFTER TRN",",oparms:[]}");
         setEventMetadata("'WIZARDNEXT'","{handler:'E12012',iparms:[{av:'Gxuitabspanel_steps_Activepage',ctrl:'GXUITABSPANEL_STEPS',prop:'ActivePage'},{av:'AV15CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''}]");
         ...
         setEventMetadata("VALID_CUSTOMERTYPEID","{handler:'Valid_Customertypeid',iparms:[{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'},{av:'A79CustomerTypeName',fld:'CUSTOMERTYPENAME',pic:''}]");
         setEventMetadata("VALID_CUSTOMERTYPEID",",oparms:[{av:'A79CustomerTypeName',fld:'CUSTOMERTYPENAME',pic:''}]}");
         setEventMetadata("VALIDV_COMBOCUSTOMERTYPEID","{handler:'Validv_Combocustomertypeid',iparms:[]");
         setEventMetadata("VALIDV_COMBOCUSTOMERTYPEID",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERLASTLINE","{handler:'Valid_Customerlastline',iparms:[]");
         setEventMetadata("VALID_CUSTOMERLASTLINE",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERMANAGERID","{handler:'Valid_Customermanagerid',iparms:[]");
         setEventMetadata("VALID_CUSTOMERMANAGERID",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERMANAGERGIVENNAME","{handler:'Valid_Customermanagergivenname',iparms:[]");
         setEventMetadata("VALID_CUSTOMERMANAGERGIVENNAME",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERMANAGERLASTNAME","{handler:'Valid_Customermanagerlastname',iparms:[{av:'A16CustomerManagerGivenName',fld:'CUSTOMERMANAGERGIVENNAME',pic:''},{av:'A9CustomerManagerLastName',fld:'CUSTOMERMANAGERLASTNAME',pic:''},{av:'A17CustomerManagerInitials',fld:'CUSTOMERMANAGERINITIALS',pic:''}]");
         setEventMetadata("VALID_CUSTOMERMANAGERLASTNAME",",oparms:[{av:'A17CustomerManagerInitials',fld:'CUSTOMERMANAGERINITIALS',pic:''}]}");
         setEventMetadata("VALID_CUSTOMERMANAGEREMAIL","{handler:'Valid_Customermanageremail',iparms:[]");
         setEventMetadata("VALID_CUSTOMERMANAGEREMAIL",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERMANAGERGENDER","{handler:'Valid_Customermanagergender',iparms:[]");
         setEventMetadata("VALID_CUSTOMERMANAGERGENDER",",oparms:[]}");
         ...
         setEventMetadata("VALID_CUSTOMERLOCATIONEMAIL",",oparms:[]}");
         ...
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTID",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTGI","{handler:'Valid_Customerlocationreceptionistgi',iparms:[]");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTGI",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTLA","{handler:'Valid_Customerlocationreceptionistla',iparms:[{av:'A24CustomerLocationReceptionistGi',fld:'CUSTOMERLOCATIONRECEPTIONISTGI',pic:''},{av:'A25CustomerLocationReceptionistLa',fld:'CUSTOMERLOCATIONRECEPTIONISTLA',pic:''},{av:'A26CustomerLocationReceptionistIn',fld:'CUSTOMERLOCATIONRECEPTIONISTIN',pic:''}]");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTLA",",oparms:[{av:'A26CustomerLocationReceptionistIn',fld:'CUSTOMERLOCATIONRECEPTIONISTIN',pic:''}]}");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTEM","{handler:'Valid_Customerlocationreceptionistem',iparms:[]");
         setEventMetadata("VALID_CUSTOMERLOCATIONRECEPTIONISTEM",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Customerlocationreceptionistga',iparms:[]");
         setEventMetadata("NULL",",oparms:[]}");
         setEventMetadata("VALID_SUPPLIER_AGBID","{handler:'Valid_Supplier_agbid',iparms:[{av:'A55Supplier_AgbId',fld:'SUPPLIER_AGBID',pic:'ZZZ9'},{av:'A56Supplier_AgbNumber',fld:'SUPPLIER_AGBNUMBER',pic:''},{av:'A57Supplier_AgbName',fld:'SUPPLIER_AGBNAME',pic:''},{av:'A58Supplier_AgbKvkNumber',fld:'SUPPLIER_AGBKVKNUMBER',pic:''},{av:'A59Supplier_AgbVisitingAddress',fld:'SUPPLIER_AGBVISITINGADDRESS',pic:''},{av:'A60Supplier_AgbPostalAddress',fld:'SUPPLIER_AGBPOSTALADDRESS',pic:''},{av:'A61Supplier_AgbEmail',fld:'SUPPLIER_AGBEMAIL',pic:''},{av:'A62Supplier_AgbPhone',fld:'SUPPLIER_AGBPHONE',pic:''},{av:'A63Supplier_AgbContactName',fld:'SUPPLIER_AGBCONTACTNAME',pic:''}]");
         ...
         setEventMetadata("NULL",",oparms:[]}");
         setEventMetadata("VALID_SUPPLIER_GENID","{handler:'Valid_Supplier_genid',iparms:[{av:'A64Supplier_GenId',fld:'SUPPLIER_GENID',pic:'ZZZ9'},{av:'A65Supplier_GenKvKNumber',fld:'SUPPLIER_GENKVKNUMBER',pic:''},{av:'A66Supplier_GenCompanyName',fld:'SUPPLIER_GENCOMPANYNAME',pic:''},{av:'A67Supplier_GenVisitingAddress',fld:'SUPPLIER_GENVISITINGADDRESS',pic:''},{av:'A68Supplier_GenPostalAddress',fld:'SUPPLIER_GENPOSTALADDRESS',pic:''},{av:'A69Supplier_GenContactName',fld:'SUPPLIER_GENCONTACTNAME',pic:''},{av:'A70Supplier_GenContactPhone',fld:'SUPPLIER_GENCONTACTPHONE',pic:''}]");
         setEventMetadata("VALID_SUPPLIER_GENID",",oparms:[{av:'A65Supplier_GenKvKNumber',fld:'SUPPLIER_GENKVKNUMBER',pic:''},{av:'A66Supplier_GenCompanyName',fld:'SUPPLIER_GENCOMPANYNAME',pic:''},{av:'A67Supplier_GenVisitingAddress',fld:'SUPPLIER_GENVISITINGADDRESS',pic:''},{av:'A68Supplier_GenPostalAddress',fld:'SUPPLIER_GENPOSTALADDRESS',pic:''},{av:'A69Supplier_GenContactName',fld:'SUPPLIER_GENCONTACTNAME',pic:''},{av:'A70Supplier_GenContactPhone',fld:'SUPPLIER_GENCONTACTPHONE',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Supplier_gencontactphone',iparms:[]");
         setEventMetadata("NULL",",oparms:[]}");
         setEventMetadata("VALID_AMENITIESID","{handler:'Valid_Amenitiesid',iparms:[{av:'A107AmenitiesId',fld:'AMENITIESID',pic:'ZZZ9'},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'},{av:'A110AmenitiesName',fld:'AMENITIESNAME',pic:''},{av:'A109AmenitiesTypeName',fld:'AMENITIESTYPENAME',pic:''}]");
         setEventMetadata("VALID_AMENITIESID",",oparms:[{av:'A110AmenitiesName',fld:'AMENITIESNAME',pic:''},{av:'A108AmenitiesTypeId',fld:'AMENITIESTYPEID',pic:'ZZZ9'},{av:'A109AmenitiesTypeName',fld:'AMENITIESTYPENAME',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         T000171_A110AmenitiesName = new string[] {""} ;
         T000171_A109AmenitiesTypeName = new string[] {""} ;
         T000171_A107AmenitiesId = new short[1] ;
         T000171_A108AmenitiesTypeId = new short[1] ;
         T00014_A110AmenitiesName = new string[] {""} ;
         T00014_A108AmenitiesTypeId = new short[1] ;
         T00015_A109AmenitiesTypeName = new string[] {""} ;
         T000172_A110AmenitiesName = new string[] {""} ;
         T000172_A108AmenitiesTypeId = new short[1] ;
         T000173_A109AmenitiesTypeName = new string[] {""} ;
         T000174_A1CustomerId = new short[1] ;
         T000174_A18CustomerLocationId = new short[1] ;
         T000174_A107AmenitiesId = new short[1] ;
         T00013_A1CustomerId = new short[1] ;
         T00013_A18CustomerLocationId = new short[1] ;
         T00013_A107AmenitiesId = new short[1] ;
         sMode23 = "";
         T00012_A1CustomerId = new short[1] ;
         T00012_A18CustomerLocationId = new short[1] ;
         T00012_A107AmenitiesId = new short[1] ;
         T000177_A110AmenitiesName = new string[] {""} ;
         T000177_A108AmenitiesTypeId = new short[1] ;
         T000178_A109AmenitiesTypeName = new string[] {""} ;
         T000179_A1CustomerId = new short[1] ;
         T000179_A18CustomerLocationId = new short[1] ;
         T000179_A107AmenitiesId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customer__default(),
            new Object[][] {
                new Object[] {
               T00012_A1CustomerId, T00012_A18CustomerLocationId, T00012_A107AmenitiesId
               }
               , new Object[] {
               T00013_A1CustomerId, T00013_A18CustomerLocationId, T00013_A107AmenitiesId
               }
               , new Object[] {
               T00014_A110AmenitiesName, T00014_A108AmenitiesTypeId
               }
               , new Object[] {
               T00015_A109AmenitiesTypeName
               }
               , new Object[] {
               ...
               , new Object[] {
               T000114_A1CustomerId, T000114_A18CustomerLocationId, T000114_A19CustomerLocationVisitingAddres, T000114_A20CustomerLocationPostalAddress, T000114_A21CustomerLocationEmail, T000114_A22CustomerLocationPhone, T000114_A94CustomerLocationLastLine
               }
               , new Object[] {
               T000115_A1CustomerId, T000115_A18CustomerLocationId, T000115_A19CustomerLocationVisitingAddres, T000115_A20CustomerLocationPostalAddress, T000115_A21CustomerLocationEmail, T000115_A22CustomerLocationPhone, T000115_A94CustomerLocationLastLine
               }
               , new Object[] {
               ...
               , new Object[] {
               T000142_A1CustomerId, T000142_A18CustomerLocationId, T000142_A19CustomerLocationVisitingAddres, T000142_A20CustomerLocationPostalAddress, T000142_A21CustomerLocationEmail, T000142_A22CustomerLocationPhone, T000142_A94CustomerLocationLastLine
               }
               , new Object[] {
               ...
               , new Object[] {
               T000171_A1CustomerId, T000171_A18CustomerLocationId, T000171_A110AmenitiesName, T000171_A109AmenitiesTypeName, T000171_A107AmenitiesId, T000171_A108AmenitiesTypeId
               }
               , new Object[] {
               T000172_A110AmenitiesName, T000172_A108AmenitiesTypeId
               }
               , new Object[] {
               T000173_A109AmenitiesTypeName
               }
               , new Object[] {
               T000174_A1CustomerId, T000174_A18CustomerLocationId, T000174_A107AmenitiesId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T000177_A110AmenitiesName, T000177_A108AmenitiesTypeId
               }
               , new Object[] {
               T000178_A109AmenitiesTypeName
               }
               , new Object[] {
               T000179_A1CustomerId, T000179_A18CustomerLocationId, T000179_A107AmenitiesId
               }
            }
         );
         AV30Pgmname = "Customer";
      ...
      private string Z110AmenitiesName ;
      ...
      private short[] T000132_A98PageId ;
      ...
      private string[] T000171_A110AmenitiesName ;
      private string[] T000171_A109AmenitiesTypeName ;
      private short[] T000171_A107AmenitiesId ;
      private short[] T000171_A108AmenitiesTypeId ;
      private string[] T00014_A110AmenitiesName ;
      private short[] T00014_A108AmenitiesTypeId ;
      private string[] T00015_A109AmenitiesTypeName ;
      private string[] T000172_A110AmenitiesName ;
      private short[] T000172_A108AmenitiesTypeId ;
      private string[] T000173_A109AmenitiesTypeName ;
      private short[] T000174_A1CustomerId ;
      private short[] T000174_A18CustomerLocationId ;
      private short[] T000174_A107AmenitiesId ;
      private short[] T00013_A1CustomerId ;
      private short[] T00013_A18CustomerLocationId ;
      private short[] T00013_A107AmenitiesId ;
      private short[] T00012_A1CustomerId ;
      private short[] T00012_A18CustomerLocationId ;
      private short[] T00012_A107AmenitiesId ;
      private string[] T000177_A110AmenitiesName ;
      private short[] T000177_A108AmenitiesTypeId ;
      private string[] T000178_A109AmenitiesTypeName ;
      private short[] T000179_A1CustomerId ;
      private short[] T000179_A18CustomerLocationId ;
      private short[] T000179_A107AmenitiesId ;
 ...
 public class customer__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new ParDef("CustomerLocationPostalAddress",GXType.VarChar,1024,0) ,
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000114", "SELECT CustomerId, CustomerLocationId, CustomerLocationVisitingAddres, CustomerLocationPostalAddress, CustomerLocationEmail, CustomerLocationPhone, CustomerLocationLastLine FROM CustomerLocation WHERE CustomerId = :CustomerId AND CustomerLocationId = :CustomerLocationId  FOR UPDATE OF CustomerLocation NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT000114,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T000115", "SELECT CustomerId, CustomerLocationId, CustomerLocationVisitingAddres, CustomerLocationPostalAddress, CustomerLocationEmail, CustomerLocationPhone, CustomerLocationLastLine FROM CustomerLocation WHERE CustomerId = :CustomerId AND CustomerLocationId = :CustomerLocationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000115,1, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000142", "SELECT CustomerId, CustomerLocationId, CustomerLocationVisitingAddres, CustomerLocationPostalAddress, CustomerLocationEmail, CustomerLocationPhone, CustomerLocationLastLine FROM CustomerLocation WHERE CustomerId = :CustomerId and CustomerLocationId = :CustomerLocationId ORDER BY CustomerId, CustomerLocationId ",true, GxErrorMask.GX_NOMASK, false, this,prmT000142,6, GxCacheFrequency.OFF ,true,false )
           ...
           ,new CursorDef("T000144", "SAVEPOINT gxupdate;INSERT INTO CustomerLocation(CustomerId, CustomerLocationId, CustomerLocationVisitingAddres, CustomerLocationPostalAddress, CustomerLocationEmail, CustomerLocationPhone, CustomerLocationLastLine) VALUES(:CustomerId, :CustomerLocationId, :CustomerLocationVisitingAddres, :CustomerLocationPostalAddress, :CustomerLocationEmail, :CustomerLocationPhone, :CustomerLocationLastLine);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000144)
