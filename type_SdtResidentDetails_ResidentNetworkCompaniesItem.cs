...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="ResidentDetails.ResidentNetworkCompaniesItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"ResidentDetails.ResidentNetworkCompaniesItem", Namespace="Comforta11")]
