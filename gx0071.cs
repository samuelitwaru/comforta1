...
namespace GeneXus.Programs {
   public class gx0071 : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCRESIDENTINCOMPANYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_hidden_field( context, "vPRESIDENTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10pResidentId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vPRESIDENTINCOMPANYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11pResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "Selection List INCompany", "") ;
      }
      ...
      protected void WB060( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblresidentincompanyidfilter_Internalname, context.GetMessage( "Resident INCompany Id", ""), "", "", lblLblresidentincompanyidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11061_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0071.htm");
            ...
            GxWebStd.gx_label_element( context, edtavCresidentincompanyid_Internalname, context.GetMessage( "Resident INCompany Id", ""), "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_54_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCresidentincompanyid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavCresidentincompanyid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV6cResidentINCompanyId), "ZZZ9") : context.localUtil.Format( (decimal)(AV6cResidentINCompanyId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCresidentincompanyid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCresidentincompanyid_Visible, edtavCresidentincompanyid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Gx0071.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblresidentincompanykvknumberfilter_Internalname, context.GetMessage( "Resident INCompany Kvk Number", ""), "", "", lblLblresidentincompanykvknumberfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12061_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0071.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCresidentincompanykvknumber_Internalname, context.GetMessage( "Resident INCompany Kvk Number", ""), "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblresidentincompanynamefilter_Internalname, context.GetMessage( "Resident INCompany Name", ""), "", "", lblLblresidentincompanynamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13061_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0071.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCresidentincompanyname_Internalname, context.GetMessage( "Resident INCompany Name", ""), "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblresidentincompanyphonefilter_Internalname, context.GetMessage( "Resident INCompany Phone", ""), "", "", lblLblresidentincompanyphonefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14061_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0071.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCresidentincompanyphone_Internalname, context.GetMessage( "Resident INCompany Phone", ""), "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
         ...
         if ( wbEnd == 54 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0071.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START062( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Selection List INCompany", ""), 0) ;
         context.wjLoc = "";
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCRESIDENTINCOMPANYID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) != Convert.ToDecimal( AV6cResidentINCompanyId )) )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtResidentINCompanyId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINCompanyId_Enabled), 5, 0), !bGXsfl_54_Refreshing);
         edtResidentINCompanyKvkNumber_Enabled = 0;
         AssignProp("", false, edtResidentINCompanyKvkNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINCompanyKvkNumber_Enabled), 5, 0), !bGXsfl_54_Refreshing);
         edtResidentINCompanyName_Enabled = 0;
         AssignProp("", false, edtResidentINCompanyName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINCompanyName_Enabled), 5, 0), !bGXsfl_54_Refreshing);
         edtResidentINCompanyPhone_Enabled = 0;
         AssignProp("", false, edtResidentINCompanyPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentINCompanyPhone_Enabled), 5, 0), !bGXsfl_54_Refreshing);
         edtResidentId_Enabled = 0;
         AssignProp("", false, edtResidentId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentId_Enabled), 5, 0), !bGXsfl_54_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP060( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCresidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCresidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999 )) ) )
            {
            ...
            {
               AV6cResidentINCompanyId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCresidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV6cResidentINCompanyId", StringUtil.LTrimStr( (decimal)(AV6cResidentINCompanyId), 4, 0));
            }
      ...
      protected void E16062( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( context.GetMessage( "GXSPC_SelectionList", ""), context.GetMessage( "INCompany", ""), "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915584341", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0071.js", "?202481915584341", false, true);
      ...
      protected void sendrow_542( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_54_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A50ResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")))+"'"+"]);";
            ...
            edtResidentINCompanyKvkNumber_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A50ResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")))+"'"+"]);";
      ...
      protected void StartGridControl54( )
      {
         if ( Grid1Container.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "INCompany Id", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            ...
            context.SendWebValue( context.GetMessage( "INCompany Name", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "INCompany Phone", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Selection List INCompany", "");
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cResidentINCompanyId',fld:'vCRESIDENTINCOMPANYID',pic:'ZZZ9'},{av:'AV7cResidentINCompanyKvkNumber',fld:'vCRESIDENTINCOMPANYKVKNUMBER',pic:''},{av:'AV8cResidentINCompanyName',fld:'vCRESIDENTINCOMPANYNAME',pic:''},{av:'AV9cResidentINCompanyPhone',fld:'vCRESIDENTINCOMPANYPHONE',pic:''},{av:'AV10pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
