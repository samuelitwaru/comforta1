...
namespace GeneXus.Programs {
   public class customercustomizationwwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         customercustomizationwwgetfilterdata objcustomercustomizationwwgetfilterdata;
         objcustomercustomizationwwgetfilterdata = new customercustomizationwwgetfilterdata();
         objcustomercustomizationwwgetfilterdata.AV37DDOName = aP0_DDOName;
         objcustomercustomizationwwgetfilterdata.AV38SearchTxtParms = aP1_SearchTxtParms;
         objcustomercustomizationwwgetfilterdata.AV39SearchTxtTo = aP2_SearchTxtTo;
         objcustomercustomizationwwgetfilterdata.AV40OptionsJson = "" ;
         objcustomercustomizationwwgetfilterdata.AV41OptionsDescJson = "" ;
         objcustomercustomizationwwgetfilterdata.AV42OptionIndexesJson = "" ;
         objcustomercustomizationwwgetfilterdata.context.SetSubmitInitialConfig(context);
         objcustomercustomizationwwgetfilterdata.initialize();
         Submit( executePrivateCatch,objcustomercustomizationwwgetfilterdata);
         aP3_OptionsJson=this.AV40OptionsJson;
         aP4_OptionsDescJson=this.AV41OptionsDescJson;
         aP5_OptionIndexesJson=this.AV42OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((customercustomizationwwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
