...
namespace GeneXus.Programs {
   public class pagetemplateselector : GXWebComponent
   {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A105PageTemplateImage)) ? A40000PageTemplateImage_GXI : context.convertURL( context.PathToRelativeUrl( A105PageTemplateImage))), !bGXsfl_12_Refreshing);
                              AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "SrcSet", context.GetImageSrcSet( A105PageTemplateImage), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PAGETEMPLATEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A102PageTemplateId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PAGETEMPLATEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A102PageTemplateId), 4, 0, ".", "")));
      }
      ...
      protected void RF322( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A102PageTemplateId = H00322_A102PageTemplateId[0];
               A103PageTemplateName = H00322_A103PageTemplateName[0];
               A40000PageTemplateImage_GXI = H00322_A40000PageTemplateImage_GXI[0];
               AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A105PageTemplateImage)) ? A40000PageTemplateImage_GXI : context.convertURL( context.PathToRelativeUrl( A105PageTemplateImage))), !bGXsfl_12_Refreshing);
               AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "SrcSet", context.GetImageSrcSet( A105PageTemplateImage), true);
               A105PageTemplateImage = H00322_A105PageTemplateImage[0];
               AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A105PageTemplateImage)) ? A40000PageTemplateImage_GXI : context.convertURL( context.PathToRelativeUrl( A105PageTemplateImage))), !bGXsfl_12_Refreshing);
               AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "SrcSet", context.GetImageSrcSet( A105PageTemplateImage), true);
               E13322 ();
      ...
      protected void send_integrity_lvl_hashes322( )
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV17Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV17Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PAGETEMPLATEID"+"_"+sGXsfl_12_idx, GetSecureSignedToken( sPrefix+sGXsfl_12_idx, context.localUtil.Format( (decimal)(A102PageTemplateId), "ZZZ9"), context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtPageTemplateImage_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageTemplateImage_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         edtPageTemplateName_Enabled = 0;
         AssignProp(sPrefix, false, edtPageTemplateName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageTemplateName_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         edtPageTemplateId_Enabled = 0;
         AssignProp(sPrefix, false, edtPageTemplateId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtPageTemplateId_Enabled), 5, 0), !bGXsfl_12_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915564463", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("pagetemplateselector.js", "?202481915564463", false, true);
            context.AddJavascriptSource("Window/InNewWindowRender.js", "", false, true);
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 3 == 0 ) || ( nGXsfl_12_idx <= subGrid_fnc_Recordsperpage( ) * 3 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtPageTemplateImage_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"",(short)0,(string)"",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A105PageTemplateImage_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
            ...
            ClassString = "CardWithImageAttributeDescription";
            StyleString = "";
            GridRow.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {(string)edtavDescription_Internalname,(string)AV16Description,(string)"",(string)"",(short)0,(short)1,(int)edtavDescription_Enabled,(short)0,(short)80,(string)"chr",(short)10,(string)"row",(short)0,(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"2097152",(short)-1,(short)0,(string)"",(string)"",(short)-1,(bool)true,(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(short)0,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            /* Div Control */
            ...
            ClassString = "Button";
            StyleString = "";
            GridRow.AddColumnProperties("button", 2, isAjaxCallMode( ), new Object[] {(string)bttBtncard_action_Internalname+"_"+sGXsfl_12_idx,"gx.evt.setGridEvt("+StringUtil.Str( (decimal)(12), 2, 0)+","+"null"+");",context.GetMessage( "Select", ""),(string)bttBtncard_action_Jsonclick,(short)7,context.GetMessage( "Select", ""),(string)"",(string)StyleString,(string)ClassString,(short)1,(short)1,(string)"standard",(string)"'"+sPrefix+"'"+",false,"+"'"+"e14322_client"+"'",(string)TempTags,(string)"",(short)2});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13322',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("'DOCARD_ACTION'","{handler:'E14322',iparms:[{av:'A102PageTemplateId',fld:'PAGETEMPLATEID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'sPrefix'},{av:'AV17Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'sPrefix'},{av:'AV17Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'sPrefix'},{av:'AV17Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'sPrefix'},{av:'AV17Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
      ...
      public override void initialize( )
      {
         ...
         AV16Description = "";
         scmdbuf = "";
         H00322_A102PageTemplateId = new short[1] ;
         H00322_A103PageTemplateName = new string[] {""} ;
         H00322_A40000PageTemplateImage_GXI = new string[] {""} ;
         H00322_A105PageTemplateImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pagetemplateselector__default(),
            new Object[][] {
                new Object[] {
               H00322_A102PageTemplateId, H00322_A103PageTemplateName, H00322_A40000PageTemplateImage_GXI, H00322_A105PageTemplateImage
               }
               , new Object[] {
      ...
      private short[] H00322_A102PageTemplateId ;
      private string[] H00322_A103PageTemplateName ;
      private string[] H00322_A40000PageTemplateImage_GXI ;
      private string[] H00322_A105PageTemplateImage ;
   ...
   public class pagetemplateselector__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00322", "SELECT PageTemplateId, PageTemplateName, PageTemplateImage_GXI, PageTemplateImage FROM PageTemplate ORDER BY PageTemplateId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00322,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00323", "SELECT COUNT(*) FROM PageTemplate ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00323,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
