...
namespace GeneXus.Programs {
   public class getresidentinfo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_userId ,
                                 out SdtResidentDetails aP1_ResidentDetails )
      {
         getresidentinfo objgetresidentinfo;
         objgetresidentinfo = new getresidentinfo();
         objgetresidentinfo.AV9userId = aP0_userId;
         objgetresidentinfo.AV10ResidentDetails = new SdtResidentDetails(context) ;
         objgetresidentinfo.context.SetSubmitInitialConfig(context);
         objgetresidentinfo.initialize();
         Submit( executePrivateCatch,objgetresidentinfo);
         aP1_ResidentDetails=this.AV10ResidentDetails;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getresidentinfo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
