...
namespace GeneXus.Programs {
   public class loginresident : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_secretKey ,
                                 out SdtLoginResidentResponseSDT aP1_response )
      {
         loginresident objloginresident;
         objloginresident = new loginresident();
         objloginresident.AV15secretKey = aP0_secretKey;
         objloginresident.AV17response = new SdtLoginResidentResponseSDT(context) ;
         objloginresident.context.SetSubmitInitialConfig(context);
         objloginresident.initialize();
         Submit( executePrivateCatch,objloginresident);
         aP1_response=this.AV17response;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((loginresident)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
