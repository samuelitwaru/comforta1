...
namespace GeneXus.Programs {
   public class getloggedincustomermanagerid : GXProcedure
   {
      ...
      public void executeSubmit( out short aP0_CustomerManagerId ,
                                 out SdtCustomer aP1_Customer )
      {
         getloggedincustomermanagerid objgetloggedincustomermanagerid;
         objgetloggedincustomermanagerid = new getloggedincustomermanagerid();
         objgetloggedincustomermanagerid.AV10CustomerManagerId = 0 ;
         objgetloggedincustomermanagerid.AV8Customer = new SdtCustomer(context) ;
         objgetloggedincustomermanagerid.context.SetSubmitInitialConfig(context);
         objgetloggedincustomermanagerid.initialize();
         Submit( executePrivateCatch,objgetloggedincustomermanagerid);
         aP0_CustomerManagerId=this.AV10CustomerManagerId;
         aP1_Customer=this.AV8Customer;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getloggedincustomermanagerid)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
