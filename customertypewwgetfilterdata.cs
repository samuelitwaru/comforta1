...
namespace GeneXus.Programs {
   public class customertypewwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         customertypewwgetfilterdata objcustomertypewwgetfilterdata;
         objcustomertypewwgetfilterdata = new customertypewwgetfilterdata();
         objcustomertypewwgetfilterdata.AV31DDOName = aP0_DDOName;
         objcustomertypewwgetfilterdata.AV32SearchTxtParms = aP1_SearchTxtParms;
         objcustomertypewwgetfilterdata.AV33SearchTxtTo = aP2_SearchTxtTo;
         objcustomertypewwgetfilterdata.AV34OptionsJson = "" ;
         objcustomertypewwgetfilterdata.AV35OptionsDescJson = "" ;
         objcustomertypewwgetfilterdata.AV36OptionIndexesJson = "" ;
         objcustomertypewwgetfilterdata.context.SetSubmitInitialConfig(context);
         objcustomertypewwgetfilterdata.initialize();
         Submit( executePrivateCatch,objcustomertypewwgetfilterdata);
         aP3_OptionsJson=this.AV34OptionsJson;
         aP4_OptionsDescJson=this.AV35OptionsDescJson;
         aP5_OptionIndexesJson=this.AV36OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((customertypewwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
