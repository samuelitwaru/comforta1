   ...
   public class createcustomerstep2 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Create Customer Step2", "")) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_49", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_49), 8, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDSCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV25GridsCurrentPage), 10, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDSPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV26GridsPageCount), 10, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "Create Customer Step2", "") ;
      }
      ...
      protected void WB2F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavCustomermanagergivenname_Internalname, context.GetMessage( "Given Name", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCustomermanagerlastname_Internalname, context.GetMessage( "Last Name", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCustomermanageremail_Internalname, context.GetMessage( "Email", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCustomermanagerphone_Internalname, context.GetMessage( "Phone", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavCustomermanagergender_Internalname, context.GetMessage( "Gender", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(49), 2, 0)+","+"null"+");", context.GetMessage( "Add", ""), bttBtnsave_Jsonclick, 5, context.GetMessage( "Add", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOSAVE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CreateCustomerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 49 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnfinish_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(49), 2, 0)+","+"null"+");", context.GetMessage( "Finish", ""), bttBtnfinish_Jsonclick, 5, context.GetMessage( "Finish", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOFINISH\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CreateCustomerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCustomermanagerid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CustomerManagerId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV12CustomerManagerId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,73);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCustomermanagerid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCustomermanagerid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CreateCustomerStep2.htm");
            /* Single line edit */
      ...
      protected void START2F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Create Customer Step2", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void STRUP2F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_49 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_49"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV25GridsCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDSCURRENTPAGE"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AV26GridsPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDSPAGECOUNT"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            ...
            AssignAttri(sPrefix, false, "AV10CustomerManagerGender", AV10CustomerManagerGender);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCustomermanagerid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCustomermanagerid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999 )) ) )
            {
            ...
            {
               AV12CustomerManagerId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavCustomermanagerid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri(sPrefix, false, "AV12CustomerManagerId", StringUtil.LTrimStr( (decimal)(AV12CustomerManagerId), 4, 0));
            }
      ...
      protected void S122( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Given Name", ""), "", "", "", "", "", "", "", ""),  "error",  edtavCustomermanagergivenname_Internalname,  "true",  ""));
            AV43CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV43CheckRequiredFieldsResult", AV43CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV14CustomerManagerLastName)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Last Name", ""), "", "", "", "", "", "", "", ""),  "error",  edtavCustomermanagerlastname_Internalname,  "true",  ""));
            AV43CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV43CheckRequiredFieldsResult", AV43CheckRequiredFieldsResult);
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV8CustomerManagerEmail)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( context.GetMessage( "WWP_RequiredAttribute", ""), context.GetMessage( "Email", ""), "", "", "", "", "", "", "", ""),  "error",  edtavCustomermanageremail_Internalname,  "true",  ""));
            AV43CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV43CheckRequiredFieldsResult", AV43CheckRequiredFieldsResult);
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482213471865", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createcustomerstep2.js", "?202482213471865", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      protected void sendrow_492( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_49_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( ( cmbavCustomermanagersdts__customermanagergender.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               cmbavCustomermanagersdts__customermanagergender.addItem("Man", context.GetMessage( "Man", ""), 0);
               cmbavCustomermanagersdts__customermanagergender.addItem("Woman", context.GetMessage( "Woman", ""), 0);
               cmbavCustomermanagersdts__customermanagergender.addItem("Other", context.GetMessage( "Other", ""), 0);
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavCustomermanagergender.addItem("Man", context.GetMessage( "Man", ""), 0);
         cmbavCustomermanagergender.addItem("Woman", context.GetMessage( "Woman", ""), 0);
         cmbavCustomermanagergender.addItem("Other", context.GetMessage( "Other", ""), 0);
         if ( cmbavCustomermanagergender.ItemCount > 0 )
         {
         }
         GXCCtl = "CUSTOMERMANAGERSDTS__CUSTOMERMANAGERGENDER_" + sGXsfl_49_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV41DeleteRecord',fld:'vDELETERECORD',pic:''}]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE","{handler:'E112F2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Selectedpage',ctrl:'GRIDSPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E122F2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDSPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'}]}");
         setEventMetadata("ENTER","{handler:'E192F2',iparms:[{av:'AV43CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV39WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV12CustomerManagerId',fld:'vCUSTOMERMANAGERID',pic:'ZZZ9'},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV6Customer',fld:'vCUSTOMER',pic:''},{av:'AV40WizardData',fld:'vWIZARDDATA',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV43CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV40WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV6Customer',fld:'vCUSTOMER',pic:''},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E132F2',iparms:[{av:'AV39WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV12CustomerManagerId',fld:'vCUSTOMERMANAGERID',pic:'ZZZ9'},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[{av:'AV40WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("'DOFINISH'","{handler:'E142F2',iparms:[{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV39WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV12CustomerManagerId',fld:'vCUSTOMERMANAGERID',pic:'ZZZ9'},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''},{av:'AV6Customer',fld:'vCUSTOMER',pic:''},{av:'AV40WizardData',fld:'vWIZARDDATA',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("'DOFINISH'",",oparms:[{av:'AV40WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV6Customer',fld:'vCUSTOMER',pic:''},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''}]}");
         setEventMetadata("'DOSAVE'","{handler:'E152F2',iparms:[{av:'AV43CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'A10CustomerManagerEmail',fld:'CUSTOMERMANAGEREMAIL',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("'DOSAVE'",",oparms:[{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'AV43CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''},{av:'cmbavCustomermanagergender'},{av:'AV10CustomerManagerGender',fld:'vCUSTOMERMANAGERGENDER',pic:''},{av:'AV8CustomerManagerEmail',fld:'vCUSTOMERMANAGEREMAIL',pic:''},{av:'AV15CustomerManagerPhone',fld:'vCUSTOMERMANAGERPHONE',pic:''},{av:'AV9CustomerManagerGAMGUID',fld:'vCUSTOMERMANAGERGAMGUID',pic:''}]}");
         setEventMetadata("VDELETERECORD.CLICK","{handler:'E202F2',iparms:[{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV28HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VDELETERECORD.CLICK",",oparms:[{av:'AV17CustomerManagerSDTs',fld:'vCUSTOMERMANAGERSDTS',grid:49,pic:''},{av:'nGXsfl_49_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:49},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_49',ctrl:'GRIDS',prop:'GridRC',grid:49}]}");
         setEventMetadata("VALIDV_CUSTOMERMANAGERGIVENNAME","{handler:'Validv_Customermanagergivenname',iparms:[]");
         setEventMetadata("VALIDV_CUSTOMERMANAGERGIVENNAME",",oparms:[]}");
         setEventMetadata("VALIDV_CUSTOMERMANAGERLASTNAME","{handler:'Validv_Customermanagerlastname',iparms:[{av:'AV11CustomerManagerGivenName',fld:'vCUSTOMERMANAGERGIVENNAME',pic:''},{av:'AV14CustomerManagerLastName',fld:'vCUSTOMERMANAGERLASTNAME',pic:''},{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''}]");
         setEventMetadata("VALIDV_CUSTOMERMANAGERLASTNAME",",oparms:[{av:'AV13CustomerManagerInitials',fld:'vCUSTOMERMANAGERINITIALS',pic:''}]}");
         setEventMetadata("VALIDV_CUSTOMERMANAGEREMAIL","{handler:'Validv_Customermanageremail',iparms:[]");
         setEventMetadata("VALIDV_CUSTOMERMANAGEREMAIL",",oparms:[]}");
         setEventMetadata("VALIDV_CUSTOMERMANAGERGENDER","{handler:'Validv_Customermanagergender',iparms:[]");
         setEventMetadata("VALIDV_CUSTOMERMANAGERGENDER",",oparms:[]}");
      ...
      private int edtavDeleterecord_Visible ;
