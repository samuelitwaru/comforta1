   ...
   public class createresidentstep2 : GXWebComponent
   {
      ...
      protected void E152V2( )
      {
         ...
         if ( AV30CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "This BSN Number has already been added", ""));
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714295884", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createresidentstep2.js", "?202482714295884", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV27DeleteRecord',fld:'vDELETERECORD',pic:''}]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE","{handler:'E112V2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Selectedpage',ctrl:'GRIDSPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E122V2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDSPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'}]}");
         setEventMetadata("ENTER","{handler:'E192V2',iparms:[{av:'AV30CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV18ResidentINIndividualGivenName',fld:'vRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV20ResidentINIndividualLastName',fld:'vRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV15ResidentINIndividualBsnNumber',fld:'vRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'cmbavResidentinindividualgender'},{av:'AV17ResidentINIndividualGender',fld:'vRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV25WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV19ResidentINIndividualId',fld:'vRESIDENTININDIVIDUALID',pic:'ZZZ9'},{av:'AV16ResidentINIndividualEmail',fld:'vRESIDENTININDIVIDUALEMAIL',pic:''},{av:'AV21ResidentINIndividualPhone',fld:'vRESIDENTININDIVIDUALPHONE',pic:''},{av:'AV14ResidentINIndividualAddress',fld:'vRESIDENTININDIVIDUALADDRESS',pic:''},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV30CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E132V2',iparms:[{av:'AV25WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV19ResidentINIndividualId',fld:'vRESIDENTININDIVIDUALID',pic:'ZZZ9'},{av:'AV18ResidentINIndividualGivenName',fld:'vRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV20ResidentINIndividualLastName',fld:'vRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV15ResidentINIndividualBsnNumber',fld:'vRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'cmbavResidentinindividualgender'},{av:'AV17ResidentINIndividualGender',fld:'vRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV16ResidentINIndividualEmail',fld:'vRESIDENTININDIVIDUALEMAIL',pic:''},{av:'AV21ResidentINIndividualPhone',fld:'vRESIDENTININDIVIDUALPHONE',pic:''},{av:'AV14ResidentINIndividualAddress',fld:'vRESIDENTININDIVIDUALADDRESS',pic:''},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[]}");
         setEventMetadata("'DONEXT'","{handler:'E142V2',iparms:[{av:'AV25WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV19ResidentINIndividualId',fld:'vRESIDENTININDIVIDUALID',pic:'ZZZ9'},{av:'AV18ResidentINIndividualGivenName',fld:'vRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV20ResidentINIndividualLastName',fld:'vRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV15ResidentINIndividualBsnNumber',fld:'vRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'cmbavResidentinindividualgender'},{av:'AV17ResidentINIndividualGender',fld:'vRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV16ResidentINIndividualEmail',fld:'vRESIDENTININDIVIDUALEMAIL',pic:''},{av:'AV21ResidentINIndividualPhone',fld:'vRESIDENTININDIVIDUALPHONE',pic:''},{av:'AV14ResidentINIndividualAddress',fld:'vRESIDENTININDIVIDUALADDRESS',pic:''},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57}]");
         setEventMetadata("'DONEXT'",",oparms:[]}");
         setEventMetadata("'DOSAVEINDIVIDUAL'","{handler:'E152V2',iparms:[{av:'AV30CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'AV15ResidentINIndividualBsnNumber',fld:'vRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'AV18ResidentINIndividualGivenName',fld:'vRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV20ResidentINIndividualLastName',fld:'vRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV16ResidentINIndividualEmail',fld:'vRESIDENTININDIVIDUALEMAIL',pic:''},{av:'AV21ResidentINIndividualPhone',fld:'vRESIDENTININDIVIDUALPHONE',pic:''},{av:'cmbavResidentinindividualgender'},{av:'AV17ResidentINIndividualGender',fld:'vRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV14ResidentINIndividualAddress',fld:'vRESIDENTININDIVIDUALADDRESS',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("'DOSAVEINDIVIDUAL'",",oparms:[{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'AV30CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV15ResidentINIndividualBsnNumber',fld:'vRESIDENTININDIVIDUALBSNNUMBER',pic:''},{av:'AV18ResidentINIndividualGivenName',fld:'vRESIDENTININDIVIDUALGIVENNAME',pic:''},{av:'AV20ResidentINIndividualLastName',fld:'vRESIDENTININDIVIDUALLASTNAME',pic:''},{av:'AV16ResidentINIndividualEmail',fld:'vRESIDENTININDIVIDUALEMAIL',pic:''},{av:'AV21ResidentINIndividualPhone',fld:'vRESIDENTININDIVIDUALPHONE',pic:''},{av:'cmbavResidentinindividualgender'},{av:'AV17ResidentINIndividualGender',fld:'vRESIDENTININDIVIDUALGENDER',pic:''},{av:'AV14ResidentINIndividualAddress',fld:'vRESIDENTININDIVIDUALADDRESS',pic:''}]}");
         setEventMetadata("VDELETERECORD.CLICK","{handler:'E202V2',iparms:[{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VDELETERECORD.CLICK",",oparms:[{av:'AV22ResidentINIndividualSDTs',fld:'vRESIDENTININDIVIDUALSDTS',grid:57,pic:''},{av:'nGXsfl_57_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:57},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_57',ctrl:'GRIDS',prop:'GridRC',grid:57}]}");
         setEventMetadata("VALIDV_RESIDENTININDIVIDUALGENDER","{handler:'Validv_Residentinindividualgender',iparms:[]");
         setEventMetadata("VALIDV_RESIDENTININDIVIDUALGENDER",",oparms:[]}");
         setEventMetadata("VALIDV_RESIDENTININDIVIDUALEMAIL","{handler:'Validv_Residentinindividualemail',iparms:[]");
         setEventMetadata("VALIDV_RESIDENTININDIVIDUALEMAIL",",oparms:[]}");
