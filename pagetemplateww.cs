...
namespace GeneXus.Programs {
   public class pagetemplateww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13FilterFullText, AV53Pgmname, AV15IsAuthorized_Insert, AV16SelectedPageTemplateId) ;
      ...
      protected void RF342( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV52Pagetemplatewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV52Pagetemplatewwds_1_filterfulltext), "%", "");
            /* Using cursor H00342 */
            pr_default.execute(0, new Object[] {lV52Pagetemplatewwds_1_filterfulltext, lV52Pagetemplatewwds_1_filterfulltext, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_21_idx = (int)(1+GRID_nFirstRecordOnPage);
            sGXsfl_21_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_21_idx), 4, 0), 4, "0");
            SubsflControlProps_212( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV52Pagetemplatewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV52Pagetemplatewwds_1_filterfulltext), "%", "");
         /* Using cursor H00343 */
         pr_default.execute(1, new Object[] {lV52Pagetemplatewwds_1_filterfulltext, lV52Pagetemplatewwds_1_filterfulltext});
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV14Session.Get(AV53Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV53Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV14Session.Get(AV53Pgmname+"GridState"), null, "", "");
         }
         AV54GXV1 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482214511484", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("pagetemplateww.js", "?202482214511485", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/TabsPanel/BootstrapTabsPanelRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'edtPageTemplateId_Visible',ctrl:'PAGETEMPLATEID',prop:'Visible'},{av:'AV13FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV53Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'AV16SelectedPageTemplateId',fld:'vSELECTEDPAGETEMPLATEID',pic:'ZZZ9',hsh:true}]");
