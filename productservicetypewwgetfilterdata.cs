...
namespace GeneXus.Programs {
   public class productservicetypewwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         productservicetypewwgetfilterdata objproductservicetypewwgetfilterdata;
         objproductservicetypewwgetfilterdata = new productservicetypewwgetfilterdata();
         objproductservicetypewwgetfilterdata.AV31DDOName = aP0_DDOName;
         objproductservicetypewwgetfilterdata.AV32SearchTxtParms = aP1_SearchTxtParms;
         objproductservicetypewwgetfilterdata.AV33SearchTxtTo = aP2_SearchTxtTo;
         objproductservicetypewwgetfilterdata.AV34OptionsJson = "" ;
         objproductservicetypewwgetfilterdata.AV35OptionsDescJson = "" ;
         objproductservicetypewwgetfilterdata.AV36OptionIndexesJson = "" ;
         objproductservicetypewwgetfilterdata.context.SetSubmitInitialConfig(context);
         objproductservicetypewwgetfilterdata.initialize();
         Submit( executePrivateCatch,objproductservicetypewwgetfilterdata);
         aP3_OptionsJson=this.AV34OptionsJson;
         aP4_OptionsDescJson=this.AV35OptionsDescJson;
         aP5_OptionIndexesJson=this.AV36OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((productservicetypewwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
