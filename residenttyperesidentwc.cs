...
namespace GeneXus.Programs {
   public class residenttyperesidentwc : GXWebComponent
   {
      public residenttyperesidentwc( )
      {
      ...
      public residenttyperesidentwc( IGxContext context )
      {
      ...
      public void execute( short aP0_ResidentTypeId )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ResidentTypeId = (short)(Math.Round(NumberUtil.Val( GetPar( "ResidentTypeId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV8ResidentTypeId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8ResidentTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ResidentTypeId, AV20ManageFiltersExecutionStep, AV32Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV32Pgmname = "ResidentTypeResidentWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Resident Type Resident WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("residenttyperesidentwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8ResidentTypeId,4,0))}, new string[] {"ResidentTypeId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ResidentTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ResidentTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vRESIDENTTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ResidentTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "ResidentTypeResidentWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Resident Type Resident WC", "") ;
      }
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "residenttyperesidentwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START262( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Resident Type Resident WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RF262( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8ResidentTypeId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            {
               A82ResidentTypeId = H00262_A82ResidentTypeId[0];
               AssignAttri(sPrefix, false, "A82ResidentTypeId", StringUtil.LTrimStr( (decimal)(A82ResidentTypeId), 4, 0));
               A39ResidentGAMGUID = H00262_A39ResidentGAMGUID[0];
               A38ResidentPhone = H00262_A38ResidentPhone[0];
               n38ResidentPhone = H00262_n38ResidentPhone[0];
               A37ResidentAddress = H00262_A37ResidentAddress[0];
               n37ResidentAddress = H00262_n37ResidentAddress[0];
               A36ResidentEmail = H00262_A36ResidentEmail[0];
               A35ResidentInitials = H00262_A35ResidentInitials[0];
               n35ResidentInitials = H00262_n35ResidentInitials[0];
               A34ResidentLastName = H00262_A34ResidentLastName[0];
               A33ResidentGivenName = H00262_A33ResidentGivenName[0];
               A40ResidentBsnNumber = H00262_A40ResidentBsnNumber[0];
               A31ResidentId = H00262_A31ResidentId[0];
               E18262 ();
      ...
      protected void STRUP260( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ResidentTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E11262( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ResidentTypeResidentWCFilters")),UrlEncode(StringUtil.RTrim(AV32Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ResidentTypeResidentWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ResidentTypeResidentWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "resident_Insert", out  GXt_boolean3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ResidentTypeResidentWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ResidentTypeId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ResidentTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV8ResidentTypeId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "residenttyperesidentwc", GetJustCreated( ));
         ...
         {
            AV8ResidentTypeId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV8ResidentTypeId), 4, 0));
         }
         wcpOAV8ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ResidentTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV8ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8ResidentTypeId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV8ResidentTypeId), 4, 0));
         }
         else
         {
            AV8ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8ResidentTypeId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ResidentTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ResidentTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714303128", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("residenttyperesidentwc.js", "?202482714303128", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:ResidentId|3:ResidentBsnNumber|4:ResidentGivenName|5:ResidentLastName|6:ResidentInitials|7:ResidentEmail|8:ResidentAddress|9:ResidentPhone|10:ResidentGAMGUID";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18262',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A31ResidentId',fld:'RESIDENTID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E15262',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ResidentTypeId',fld:'vRESIDENTTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A31ResidentId',fld:'RESIDENTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Residentgamguid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H00262_A82ResidentTypeId = new short[1] ;
         H00262_A39ResidentGAMGUID = new string[] {""} ;
         H00262_A38ResidentPhone = new string[] {""} ;
         H00262_n38ResidentPhone = new bool[] {false} ;
         H00262_A37ResidentAddress = new string[] {""} ;
         H00262_n37ResidentAddress = new bool[] {false} ;
         H00262_A36ResidentEmail = new string[] {""} ;
         H00262_A35ResidentInitials = new string[] {""} ;
         H00262_n35ResidentInitials = new bool[] {false} ;
         H00262_A34ResidentLastName = new string[] {""} ;
         H00262_A33ResidentGivenName = new string[] {""} ;
         H00262_A40ResidentBsnNumber = new string[] {""} ;
         H00262_A31ResidentId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.residenttyperesidentwc__default(),
            new Object[][] {
                new Object[] {
               H00262_A82ResidentTypeId, H00262_A39ResidentGAMGUID, H00262_A38ResidentPhone, H00262_n38ResidentPhone, H00262_A37ResidentAddress, H00262_n37ResidentAddress, H00262_A36ResidentEmail, H00262_A35ResidentInitials, H00262_n35ResidentInitials, H00262_A34ResidentLastName,
               H00262_A33ResidentGivenName, H00262_A40ResidentBsnNumber, H00262_A31ResidentId
               }
               , new Object[] {
      ...
      private short AV8ResidentTypeId ;
      private short wcpOAV8ResidentTypeId ;
      ...
      private short[] H00262_A82ResidentTypeId ;
      private string[] H00262_A39ResidentGAMGUID ;
      private string[] H00262_A38ResidentPhone ;
      private bool[] H00262_n38ResidentPhone ;
      private string[] H00262_A37ResidentAddress ;
      private bool[] H00262_n37ResidentAddress ;
      private string[] H00262_A36ResidentEmail ;
      private string[] H00262_A35ResidentInitials ;
      private bool[] H00262_n35ResidentInitials ;
      private string[] H00262_A34ResidentLastName ;
      private string[] H00262_A33ResidentGivenName ;
      private string[] H00262_A40ResidentBsnNumber ;
      private short[] H00262_A31ResidentId ;
   ...
   public class residenttyperesidentwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8ResidentTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " ResidentTypeId, ResidentGAMGUID, ResidentPhone, ResidentAddress, ResidentEmail, ResidentInitials, ResidentLastName, ResidentGivenName, ResidentBsnNumber, ResidentId";
         sFromString = " FROM Resident";
         sOrderString = "";
         AddWhere(sWhereString, "(ResidentTypeId = :AV8ResidentTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(ResidentId,'9999'), 2) like '%' || :lV16FilterFullText) or ( ResidentBsnNumber like '%' || :lV16FilterFullText) or ( ResidentGivenName like '%' || :lV16FilterFullText) or ( ResidentLastName like '%' || :lV16FilterFullText) or ( ResidentInitials like '%' || :lV16FilterFullText) or ( ResidentEmail like '%' || :lV16FilterFullText) or ( ResidentAddress like '%' || :lV16FilterFullText) or ( ResidentPhone like '%' || :lV16FilterFullText) or ( ResidentGAMGUID like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentBsnNumber";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentBsnNumber DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentGivenName, ResidentId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentGivenName DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentLastName, ResidentId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentLastName DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentInitials, ResidentId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentInitials DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentEmail, ResidentId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentEmail DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentAddress, ResidentId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentAddress DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentPhone, ResidentId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentPhone DESC, ResidentId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY ResidentTypeId, ResidentGAMGUID, ResidentId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY ResidentTypeId DESC, ResidentGAMGUID DESC, ResidentId";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00262(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H00263(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8ResidentTypeId",GXType.Int16,4,0) ,
