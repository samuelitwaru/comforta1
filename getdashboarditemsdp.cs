...
namespace GeneXus.Programs {
   public class getdashboarditemsdp : GXProcedure
   {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta11") ;
         initialize();
         executePrivate();
      ...
      {
         getdashboarditemsdp objgetdashboarditemsdp;
         objgetdashboarditemsdp = new getdashboarditemsdp();
         objgetdashboarditemsdp.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta11") ;
         objgetdashboarditemsdp.context.SetSubmitInitialConfig(context);
         objgetdashboarditemsdp.initialize();
         Submit( executePrivateCatch,objgetdashboarditemsdp);
         aP0_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getdashboarditemsdp)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "Customer Manager", "");
         ...
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "All", "");
         ...
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
         Gxm2rootcol.Add(Gxm1homemodulessdt, 0);
         Gxm1homemodulessdt.gxTpr_Optiontitle = "Suppliers (Generic)";
         ...
         Gxm1homemodulessdt.gxTpr_Optioniconthemeclass = "fab fa-stripe-s";
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         ...
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "All", "");
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("residentww.aspx") ;
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "Reseptionist", "");
         ...
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "All", "");
         Gxm1homemodulessdt.gxTpr_Optionwclink = formatLink("amenitiesww.aspx") ;
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "Comforta Manager", "");
         ...
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "Receptionist", "");
         ...
         Gxm1homemodulessdt.gxTpr_Optiondescription = context.GetMessage( "Financial Partners", "");
         Gxm1homemodulessdt.gxTpr_Rolename = context.GetMessage( "Customer Manager", "");
         Gxm1homemodulessdt.gxTpr_Optiontype = 1;
         Gxm1homemodulessdt.gxTpr_Optionsize = 2;
         Gxm1homemodulessdt = new GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem(context);
