...
namespace GeneXus.Programs {
   public class gamotpauthentication : GXHttpHandler
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormBackgroundImage\" data-gx-class=\"form-horizontal FormBackgroundImage\" novalidate action=\""+formatLink("gamotpauthentication.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10IDP_State))}, new string[] {"IDP_State"}) +"\">") ;
      ...
      protected void E130Q2( )
      {
         ...
         {
            CallWebObject(formatLink("gamremotelogin.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV10IDP_State))}, new string[] {"IDP_State"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714315110", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamotpauthentication.js", "?202482714315112", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("BACKTOLOGIN.CLICK","{handler:'E130Q2',iparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''}]");
