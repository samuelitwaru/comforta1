...
namespace GeneXus.Programs {
   public class supplier_gensupplier_gencustomerwc : GXWebComponent
   {
      public supplier_gensupplier_gencustomerwc( )
      {
      ...
      public supplier_gensupplier_gencustomerwc( IGxContext context )
      {
      ...
      public void execute( short aP0_Supplier_GenId )
      {
         this.AV8Supplier_GenId = aP0_Supplier_GenId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "Supplier_GenId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8Supplier_GenId = (short)(Math.Round(NumberUtil.Val( GetPar( "Supplier_GenId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8Supplier_GenId", StringUtil.LTrimStr( (decimal)(AV8Supplier_GenId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8Supplier_GenId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV31IsAuthorized_CustomerTypeName = StringUtil.StrToBool( GetPar( "IsAuthorized_CustomerTypeName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8Supplier_GenId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_CustomerTypeName, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "Supplier_GenSupplier_GenCustomerWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Supplier_Gen Supplier_Gen Customer WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplier_gensupplier_gencustomerwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8Supplier_GenId,4,0))}, new string[] {"Supplier_GenId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_CUSTOMERTYPENAME", AV31IsAuthorized_CustomerTypeName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_CUSTOMERTYPENAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_CustomerTypeName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8Supplier_GenId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8Supplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUPPLIER_GENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Supplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "Supplier_GenSupplier_GenCustomerWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Supplier_Gen Supplier_Gen Customer WC", "") ;
      }
      ...
      protected void WB2C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "supplier_gensupplier_gencustomerwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSupplier_GenId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A64Supplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A64Supplier_GenId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplier_GenId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplier_GenId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Supplier_GenSupplier_GenCustomerWC.htm");
            /* User Defined Control */
      ...
      protected void START2C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Supplier_Gen Supplier_Gen Customer WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV31IsAuthorized_CustomerTypeName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CUSTOMERID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"CUSTOMERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, ".", "")));
      }
      ...
      protected void RF2C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8Supplier_GenId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H002C2 */
            pr_default.execute(0, new Object[] {AV8Supplier_GenId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A64Supplier_GenId = H002C2_A64Supplier_GenId[0];
               AssignAttri(sPrefix, false, "A64Supplier_GenId", StringUtil.LTrimStr( (decimal)(A64Supplier_GenId), 4, 0));
               A79CustomerTypeName = H002C2_A79CustomerTypeName[0];
               A78CustomerTypeId = H002C2_A78CustomerTypeId[0];
               n78CustomerTypeId = H002C2_n78CustomerTypeId[0];
               A14CustomerVatNumber = H002C2_A14CustomerVatNumber[0];
               A7CustomerPhone = H002C2_A7CustomerPhone[0];
               n7CustomerPhone = H002C2_n7CustomerPhone[0];
               A6CustomerVisitingAddress = H002C2_A6CustomerVisitingAddress[0];
               n6CustomerVisitingAddress = H002C2_n6CustomerVisitingAddress[0];
               A5CustomerEmail = H002C2_A5CustomerEmail[0];
               n5CustomerEmail = H002C2_n5CustomerEmail[0];
               A4CustomerPostalAddress = H002C2_A4CustomerPostalAddress[0];
               n4CustomerPostalAddress = H002C2_n4CustomerPostalAddress[0];
               A3CustomerName = H002C2_A3CustomerName[0];
               A41CustomerKvkNumber = H002C2_A41CustomerKvkNumber[0];
               A1CustomerId = H002C2_A1CustomerId[0];
               A18CustomerLocationId = H002C2_A18CustomerLocationId[0];
               A78CustomerTypeId = H002C2_A78CustomerTypeId[0];
               n78CustomerTypeId = H002C2_n78CustomerTypeId[0];
               A14CustomerVatNumber = H002C2_A14CustomerVatNumber[0];
               A7CustomerPhone = H002C2_A7CustomerPhone[0];
      ...
      protected void send_integrity_lvl_hashes2C2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_CUSTOMERID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H002C3 */
         pr_default.execute(1, new Object[] {AV8Supplier_GenId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtCustomerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerKvkNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerKvkNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerKvkNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerName_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerPostalAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerPostalAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerPostalAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerEmail_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerEmail_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerVisitingAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerVisitingAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerVisitingAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerPhone_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerPhone_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerVatNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerVatNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerVatNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerTypeId_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerTypeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerTypeId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtCustomerTypeName_Enabled = 0;
         AssignProp(sPrefix, false, edtCustomerTypeName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerTypeName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_GenId_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_GenId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP2C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8Supplier_GenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8Supplier_GenId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E162C2( )
      {
         ...
         GXt_boolean1 = AV31IsAuthorized_CustomerTypeName;
         ...
         AV31IsAuthorized_CustomerTypeName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV31IsAuthorized_CustomerTypeName", AV31IsAuthorized_CustomerTypeName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_CUSTOMERTYPENAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_CustomerTypeName, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtSupplier_GenId_Visible = 0;
         AssignProp(sPrefix, false, edtSupplier_GenId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtSupplier_GenId_Visible), 5, 0), true);
      ...
      private void E182C2( )
      {
         ...
         if ( AV31IsAuthorized_CustomerTypeName )
         {
      ...
      protected void E112C2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Supplier_GenSupplier_GenCustomerWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Supplier_GenSupplier_GenCustomerWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Supplier_GenSupplier_GenCustomerWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "customer_Insert", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Supplier_GenSupplier_GenCustomerWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "Supplier_GenId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8Supplier_GenId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8Supplier_GenId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8Supplier_GenId", StringUtil.LTrimStr( (decimal)(AV8Supplier_GenId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8Supplier_GenId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "supplier_gensupplier_gencustomerwc", GetJustCreated( ));
         ...
         {
            AV8Supplier_GenId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8Supplier_GenId", StringUtil.LTrimStr( (decimal)(AV8Supplier_GenId), 4, 0));
         }
         wcpOAV8Supplier_GenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8Supplier_GenId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8Supplier_GenId != wcpOAV8Supplier_GenId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8Supplier_GenId = AV8Supplier_GenId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8Supplier_GenId = cgiGet( sPrefix+"AV8Supplier_GenId_CTRL");
         if ( StringUtil.Len( sCtrlAV8Supplier_GenId) > 0 )
         {
            AV8Supplier_GenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8Supplier_GenId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8Supplier_GenId", StringUtil.LTrimStr( (decimal)(AV8Supplier_GenId), 4, 0));
         }
         else
         {
            AV8Supplier_GenId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8Supplier_GenId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8Supplier_GenId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Supplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8Supplier_GenId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8Supplier_GenId_CTRL", StringUtil.RTrim( sCtrlAV8Supplier_GenId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714302712", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("supplier_gensupplier_gencustomerwc.js", "?202482714302712", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtCustomerId_Internalname = sPrefix+"CUSTOMERID_"+sGXsfl_35_idx;
         edtCustomerKvkNumber_Internalname = sPrefix+"CUSTOMERKVKNUMBER_"+sGXsfl_35_idx;
         edtCustomerName_Internalname = sPrefix+"CUSTOMERNAME_"+sGXsfl_35_idx;
         edtCustomerPostalAddress_Internalname = sPrefix+"CUSTOMERPOSTALADDRESS_"+sGXsfl_35_idx;
         edtCustomerEmail_Internalname = sPrefix+"CUSTOMEREMAIL_"+sGXsfl_35_idx;
         edtCustomerVisitingAddress_Internalname = sPrefix+"CUSTOMERVISITINGADDRESS_"+sGXsfl_35_idx;
         edtCustomerPhone_Internalname = sPrefix+"CUSTOMERPHONE_"+sGXsfl_35_idx;
         edtCustomerVatNumber_Internalname = sPrefix+"CUSTOMERVATNUMBER_"+sGXsfl_35_idx;
         edtCustomerTypeId_Internalname = sPrefix+"CUSTOMERTYPEID_"+sGXsfl_35_idx;
         edtCustomerTypeName_Internalname = sPrefix+"CUSTOMERTYPENAME_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtCustomerId_Internalname = sPrefix+"CUSTOMERID_"+sGXsfl_35_fel_idx;
         edtCustomerKvkNumber_Internalname = sPrefix+"CUSTOMERKVKNUMBER_"+sGXsfl_35_fel_idx;
         edtCustomerName_Internalname = sPrefix+"CUSTOMERNAME_"+sGXsfl_35_fel_idx;
         edtCustomerPostalAddress_Internalname = sPrefix+"CUSTOMERPOSTALADDRESS_"+sGXsfl_35_fel_idx;
         edtCustomerEmail_Internalname = sPrefix+"CUSTOMEREMAIL_"+sGXsfl_35_fel_idx;
         edtCustomerVisitingAddress_Internalname = sPrefix+"CUSTOMERVISITINGADDRESS_"+sGXsfl_35_fel_idx;
         edtCustomerPhone_Internalname = sPrefix+"CUSTOMERPHONE_"+sGXsfl_35_fel_idx;
         edtCustomerVatNumber_Internalname = sPrefix+"CUSTOMERVATNUMBER_"+sGXsfl_35_fel_idx;
         edtCustomerTypeId_Internalname = sPrefix+"CUSTOMERTYPEID_"+sGXsfl_35_fel_idx;
         edtCustomerTypeName_Internalname = sPrefix+"CUSTOMERTYPENAME_"+sGXsfl_35_fel_idx;
      }
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A1CustomerId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A1CustomerId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerPostalAddress_Internalname,(string)A4CustomerPostalAddress,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A4CustomerPostalAddress),(string)"_blank",(string)"",(string)"",(string)edtCustomerPostalAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerVisitingAddress_Internalname,(string)A6CustomerVisitingAddress,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A6CustomerVisitingAddress),(string)"_blank",(string)"",(string)"",(string)edtCustomerVisitingAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCustomerTypeId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A78CustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A78CustomerTypeId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCustomerTypeId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Vat Number", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"end"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Customer Type Id", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Customer Type Name", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtCustomerPostalAddress_Internalname = sPrefix+"CUSTOMERPOSTALADDRESS";
         edtCustomerEmail_Internalname = sPrefix+"CUSTOMEREMAIL";
         edtCustomerVisitingAddress_Internalname = sPrefix+"CUSTOMERVISITINGADDRESS";
         edtCustomerPhone_Internalname = sPrefix+"CUSTOMERPHONE";
         edtCustomerVatNumber_Internalname = sPrefix+"CUSTOMERVATNUMBER";
         edtCustomerTypeId_Internalname = sPrefix+"CUSTOMERTYPEID";
         edtCustomerTypeName_Internalname = sPrefix+"CUSTOMERTYPENAME";
         Gridpaginationbar_Internalname = sPrefix+"GRIDPAGINATIONBAR";
         divGridtablewithpaginationbar_Internalname = sPrefix+"GRIDTABLEWITHPAGINATIONBAR";
         divTablegridheader_Internalname = sPrefix+"TABLEGRIDHEADER";
         Ddo_grid_Internalname = sPrefix+"DDO_GRID";
         edtSupplier_GenId_Internalname = sPrefix+"SUPPLIER_GENID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:CustomerId|3:CustomerKvkNumber|4:CustomerName|5:CustomerPostalAddress|6:CustomerEmail|7:CustomerVisitingAddress|8:CustomerPhone|9:CustomerVatNumber|10:CustomerTypeId|11:CustomerTypeName";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8Supplier_GenId',fld:'vSUPPLIER_GENID',pic:'ZZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CustomerTypeName',fld:'vISAUTHORIZED_CUSTOMERTYPENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E122C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8Supplier_GenId',fld:'vSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CustomerTypeName',fld:'vISAUTHORIZED_CUSTOMERTYPENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E182C2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CustomerTypeName',fld:'vISAUTHORIZED_CUSTOMERTYPENAME',pic:'',hsh:true},{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtCustomerTypeName_Link',ctrl:'CUSTOMERTYPENAME',prop:'Link'}]}");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E152C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8Supplier_GenId',fld:'vSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CustomerTypeName',fld:'vISAUTHORIZED_CUSTOMERTYPENAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Customertypename',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H002C2_A64Supplier_GenId = new short[1] ;
         H002C2_A79CustomerTypeName = new string[] {""} ;
         H002C2_A78CustomerTypeId = new short[1] ;
         H002C2_n78CustomerTypeId = new bool[] {false} ;
         H002C2_A14CustomerVatNumber = new string[] {""} ;
         H002C2_A7CustomerPhone = new string[] {""} ;
         H002C2_n7CustomerPhone = new bool[] {false} ;
         H002C2_A6CustomerVisitingAddress = new string[] {""} ;
         H002C2_n6CustomerVisitingAddress = new bool[] {false} ;
         H002C2_A5CustomerEmail = new string[] {""} ;
         H002C2_n5CustomerEmail = new bool[] {false} ;
         H002C2_A4CustomerPostalAddress = new string[] {""} ;
         H002C2_n4CustomerPostalAddress = new bool[] {false} ;
         H002C2_A3CustomerName = new string[] {""} ;
         H002C2_A41CustomerKvkNumber = new string[] {""} ;
         H002C2_A1CustomerId = new short[1] ;
         H002C2_A18CustomerLocationId = new short[1] ;
         ...
         sCtrlAV8Supplier_GenId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         gxphoneLink = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier_gensupplier_gencustomerwc__default(),
            new Object[][] {
                new Object[] {
               H002C2_A64Supplier_GenId, H002C2_A79CustomerTypeName, H002C2_A78CustomerTypeId, H002C2_n78CustomerTypeId, H002C2_A14CustomerVatNumber, H002C2_A7CustomerPhone, H002C2_n7CustomerPhone, H002C2_A6CustomerVisitingAddress, H002C2_n6CustomerVisitingAddress, H002C2_A5CustomerEmail,
               H002C2_n5CustomerEmail, H002C2_A4CustomerPostalAddress, H002C2_n4CustomerPostalAddress, H002C2_A3CustomerName, H002C2_A41CustomerKvkNumber, H002C2_A1CustomerId, H002C2_A18CustomerLocationId
               }
               , new Object[] {
      ...
      private short AV8Supplier_GenId ;
      private short wcpOAV8Supplier_GenId ;
      ...
      private string sCtrlAV8Supplier_GenId ;
      ...
      private bool AV31IsAuthorized_CustomerTypeName ;
      ...
      private short[] H002C2_A64Supplier_GenId ;
      private string[] H002C2_A79CustomerTypeName ;
      private short[] H002C2_A78CustomerTypeId ;
      private bool[] H002C2_n78CustomerTypeId ;
      private string[] H002C2_A14CustomerVatNumber ;
      private string[] H002C2_A7CustomerPhone ;
      private bool[] H002C2_n7CustomerPhone ;
      private string[] H002C2_A6CustomerVisitingAddress ;
      private bool[] H002C2_n6CustomerVisitingAddress ;
      private string[] H002C2_A5CustomerEmail ;
      private bool[] H002C2_n5CustomerEmail ;
      private string[] H002C2_A4CustomerPostalAddress ;
      private bool[] H002C2_n4CustomerPostalAddress ;
      private string[] H002C2_A3CustomerName ;
      private string[] H002C2_A41CustomerKvkNumber ;
      private short[] H002C2_A1CustomerId ;
      private short[] H002C2_A18CustomerLocationId ;
   ...
   public class supplier_gensupplier_gencustomerwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8Supplier_GenId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.Supplier_GenId, T3.CustomerTypeName, T2.CustomerTypeId, T2.CustomerVatNumber, T2.CustomerPhone, T2.CustomerVisitingAddress, T2.CustomerEmail, T2.CustomerPostalAddress, T2.CustomerName, T2.CustomerKvkNumber, T1.CustomerId, T1.CustomerLocationId";
         sFromString = " FROM ((CustomerLocationSupplier_Gen T1 INNER JOIN Customer T2 ON T2.CustomerId = T1.CustomerId) LEFT JOIN CustomerType T3 ON T3.CustomerTypeId = T2.CustomerTypeId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.Supplier_GenId = :AV8Supplier_GenId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.CustomerId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.CustomerKvkNumber like '%' || :lV16FilterFullText) or ( T2.CustomerName like '%' || :lV16FilterFullText) or ( T2.CustomerPostalAddress like '%' || :lV16FilterFullText) or ( T2.CustomerEmail like '%' || :lV16FilterFullText) or ( T2.CustomerVisitingAddress like '%' || :lV16FilterFullText) or ( T2.CustomerPhone like '%' || :lV16FilterFullText) or ( T2.CustomerVatNumber like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.CustomerTypeId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T3.CustomerTypeName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerKvkNumber, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerKvkNumber DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T1.CustomerId DESC, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerName, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerName DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerPostalAddress, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerPostalAddress DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerEmail, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerEmail DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerVisitingAddress, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerVisitingAddress DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerPhone, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerPhone DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerVatNumber, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerVatNumber DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T2.CustomerTypeId, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T2.CustomerTypeId DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId, T3.CustomerTypeName, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_GenId DESC, T3.CustomerTypeName DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.CustomerId, T1.CustomerLocationId, T1.Supplier_GenId";
         }
                                             ...
                                             short AV8Supplier_GenId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((CustomerLocationSupplier_Gen T1 INNER JOIN Customer T2 ON T2.CustomerId = T1.CustomerId) LEFT JOIN CustomerType T3 ON T3.CustomerTypeId = T2.CustomerTypeId)";
         AddWhere(sWhereString, "(T1.Supplier_GenId = :AV8Supplier_GenId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.CustomerId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.CustomerKvkNumber like '%' || :lV16FilterFullText) or ( T2.CustomerName like '%' || :lV16FilterFullText) or ( T2.CustomerPostalAddress like '%' || :lV16FilterFullText) or ( T2.CustomerEmail like '%' || :lV16FilterFullText) or ( T2.CustomerVisitingAddress like '%' || :lV16FilterFullText) or ( T2.CustomerPhone like '%' || :lV16FilterFullText) or ( T2.CustomerVatNumber like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.CustomerTypeId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T3.CustomerTypeName like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002C2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H002C3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8Supplier_GenId",GXType.Int16,4,0) ,
