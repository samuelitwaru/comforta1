...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="ResidentDetails.ResidentNetworkIndividualsItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"ResidentDetails.ResidentNetworkIndividualsItem", Namespace="Comforta11")]
