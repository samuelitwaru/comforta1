...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "LocationEvent" , Namespace = "Comforta11" )]
   [Serializable]
   ...
   [DataContract(Name = @"LocationEvent", Namespace = "Comforta11")]
   public class SdtLocationEvent_RESTInterface : GxGenericCollectionItem<SdtLocationEvent>
   {
      ...
      {
         get {
            return DateTimeUtil.TToC2( sdt.gxTpr_Locationeventstartdate) ;
         }

         set {
            sdt.gxTpr_Locationeventstartdate = DateTimeUtil.CToT2( value);
         }
      ...
      {
         get {
            return DateTimeUtil.TToC2( sdt.gxTpr_Locationeventenddate) ;
         }

         set {
            sdt.gxTpr_Locationeventenddate = DateTimeUtil.CToT2( value);
         }
