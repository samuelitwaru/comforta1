...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep2 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamrecoverpasswordstep2.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV9IDP_State)),UrlEncode(StringUtil.RTrim(AV10KeyToChangePassword))}, new string[] {"IDP_State","KeyToChangePassword"}) +"\">") ;
      ...
      {
         return formatLink("gamrecoverpasswordstep2.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV9IDP_State)),UrlEncode(StringUtil.RTrim(AV10KeyToChangePassword))}, new string[] {"IDP_State","KeyToChangePassword"})  ;
      }
      ...
      protected void E130T2( )
      {
         ...
         if ( new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).isremoteauthentication(AV9IDP_State) )
         {
            CallWebObject(formatLink("gamremotelogin.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV9IDP_State))}, new string[] {"IDP_State"}) );
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915571592", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep2.js", "?202481915571595", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("BACKTOLOGIN.CLICK","{handler:'E130T2',iparms:[{av:'AV9IDP_State',fld:'vIDP_STATE',pic:''}]");
