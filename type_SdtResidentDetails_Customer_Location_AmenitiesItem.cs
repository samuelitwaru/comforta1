...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="ResidentDetails.Customer.Location.AmenitiesItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"ResidentDetails.Customer.Location.AmenitiesItem", Namespace="Comforta11")]
