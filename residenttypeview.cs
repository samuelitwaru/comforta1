...
namespace GeneXus.Programs {
   public class residenttypeview : GXDataArea
   {
      public residenttypeview( )
      {
      ...
      public residenttypeview( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10ResidentTypeId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV10ResidentTypeId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ResidentTypeId), "ZZZ9"), context));
      ...
      {
         get {
            return "residenttypeview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("residenttypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10ResidentTypeId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"ResidentTypeId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vRESIDENTTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10ResidentTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ResidentTypeId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Residentwc == null ) )
         {
            WebComp_Residentwc.componentjscripts();
         }
      ...
      {
         return formatLink("residenttypeview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10ResidentTypeId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"ResidentTypeId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ResidentTypeView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Resident Type View", "") ;
      }
      ...
      protected void WB220( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Resident Type", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_ResidentTypeView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divResidenttypegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResident_title_Internalname, context.GetMessage( "Resident", ""), "", "", lblResident_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ResidentTypeView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Resident") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableresident_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0033"+"", StringUtil.RTrim( WebComp_Residentwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0033"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Residentwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldResidentwc), StringUtil.Lower( WebComp_Residentwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
                  }
                  WebComp_Residentwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldResidentwc), StringUtil.Lower( WebComp_Residentwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START222( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Resident Type View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldResidentwc = cgiGet( "W0033");
                           if ( ( StringUtil.Len( OldResidentwc) == 0 ) || ( StringUtil.StrCmp(OldResidentwc, WebComp_Residentwc_Component) != 0 ) )
                           {
                              WebComp_Residentwc = getWebComponent(GetType(), "GeneXus.Programs", OldResidentwc, new Object[] {context} );
                              WebComp_Residentwc.ComponentInit();
                              WebComp_Residentwc.Name = "OldResidentwc";
                              WebComp_Residentwc_Component = OldResidentwc;
                           }
                           if ( StringUtil.Len( WebComp_Residentwc_Component) != 0 )
                           {
                              WebComp_Residentwc.componentprocess("W0033", "", sEvt);
                           }
                           WebComp_Residentwc_Component = OldResidentwc;
                        }
                     }
      ...
      protected void RF222( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Residentwc_Component) != 0 )
               {
                  WebComp_Residentwc.componentstart();
               }
            }
         }
      ...
      protected void STRUP220( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10ResidentTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vRESIDENTTYPEID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E11222( )
      {
         ...
         lblWorkwithlink_Link = formatLink("residenttypeww.aspx") ;
         ...
         {
            A82ResidentTypeId = H00222_A82ResidentTypeId[0];
            A83ResidentTypeName = H00222_A83ResidentTypeName[0];
            AV14GXLvl9 = 1;
            Form.Caption = A83ResidentTypeName;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "ResidentTypeGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "residenttypegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "ResidentTypeGeneral";
            WebComp_Webcomponent_general_Component = "ResidentTypeGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(short)AV10ResidentTypeId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Resident") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Residentwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Residentwc_Component), StringUtil.Lower( "ResidentTypeResidentWC")) != 0 )
            {
               WebComp_Residentwc = getWebComponent(GetType(), "GeneXus.Programs", "residenttyperesidentwc", new Object[] {context} );
               WebComp_Residentwc.ComponentInit();
               WebComp_Residentwc.Name = "ResidentTypeResidentWC";
               WebComp_Residentwc_Component = "ResidentTypeResidentWC";
            }
            if ( StringUtil.Len( WebComp_Residentwc_Component) != 0 )
            {
               WebComp_Residentwc.setjustcreated();
               WebComp_Residentwc.componentprepare(new Object[] {(string)"W0033",(string)"",(short)AV10ResidentTypeId});
               WebComp_Residentwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Residentwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0033"+"");
               WebComp_Residentwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ResidentTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV10ResidentTypeId", StringUtil.LTrimStr( (decimal)(AV10ResidentTypeId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTTYPEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10ResidentTypeId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Residentwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Residentwc_Component) != 0 )
            {
               WebComp_Residentwc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119591230", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("residenttypeview.js", "?202482119591230", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divResidenttypegeneral_cell_Internalname = "RESIDENTTYPEGENERAL_CELL";
         lblResident_title_Internalname = "RESIDENT_TITLE";
         divUnnamedtableresident_Internalname = "UNNAMEDTABLERESIDENT";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Resident Type View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10ResidentTypeId',fld:'vRESIDENTTYPEID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         lblResident_title_Jsonclick = "";
         WebComp_Residentwc_Component = "";
         OldResidentwc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         ...
         scmdbuf = "";
         H00222_A82ResidentTypeId = new short[1] ;
         H00222_A83ResidentTypeName = new string[] {""} ;
         A83ResidentTypeName = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.residenttypeview__default(),
            new Object[][] {
                new Object[] {
               H00222_A82ResidentTypeId, H00222_A83ResidentTypeName
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Residentwc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
      }

      private short AV10ResidentTypeId ;
      private short wcpOAV10ResidentTypeId ;
      ...
      private string divResidenttypegeneral_cell_Internalname ;
      ...
      private string lblResident_title_Internalname ;
      private string lblResident_title_Jsonclick ;
      private string divUnnamedtableresident_Internalname ;
      private string WebComp_Residentwc_Component ;
      private string OldResidentwc ;
      private string sEvt ;
   ...
   public class residenttypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10ResidentTypeId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00222", "SELECT ResidentTypeId, ResidentTypeName FROM ResidentType WHERE ResidentTypeId = :AV10ResidentTypeId ORDER BY ResidentTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00222,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
