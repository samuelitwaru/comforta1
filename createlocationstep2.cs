   ...
   public class createlocationstep2 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Create Location Step2", "")) ;
      ...
      {
         return context.GetMessage( "Create Location Step2", "") ;
      }
      ...
      protected void WB3A0( )
      {
         ...
         if ( wbEnd == 18 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnwizardnext_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(18), 2, 0)+","+"null"+");", context.GetMessage( "GXM_next", ""), bttBtnwizardnext_Jsonclick, 5, context.GetMessage( "GXM_next", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_CreateLocationStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START3A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Create Location Step2", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_AMENITIESNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( A110AmenitiesName, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"AMENITIESNAME", A110AmenitiesName);
      }
      ...
      protected void RF3A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A110AmenitiesName = H003A2_A110AmenitiesName[0];
               A107AmenitiesId = H003A2_A107AmenitiesId[0];
               E143A2 ();
      ...
      protected void send_integrity_lvl_hashes3A2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vHASVALIDATIONERRORS", AV10HasValidationErrors);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vHASVALIDATIONERRORS", GetSecureSignedToken( sPrefix, AV10HasValidationErrors, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_AMENITIESID"+"_"+sGXsfl_18_idx, GetSecureSignedToken( sPrefix+sGXsfl_18_idx, context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_AMENITIESNAME"+"_"+sGXsfl_18_idx, GetSecureSignedToken( sPrefix+sGXsfl_18_idx, StringUtil.RTrim( context.localUtil.Format( A110AmenitiesName, "")), context));
      }
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtAmenitiesId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAmenitiesId_Enabled), 5, 0), !bGXsfl_18_Refreshing);
         edtAmenitiesName_Enabled = 0;
         AssignProp(sPrefix, false, edtAmenitiesName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAmenitiesName_Enabled), 5, 0), !bGXsfl_18_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      private void E143A2( )
      {
         ...
         while ( AV17GXV1 <= AV15WizardData.gxTpr_Step2.gxTpr_Grid.Count )
         {
            ...
            if ( ( AV9GridSelectedRow.gxTpr_Amenitiesid == A107AmenitiesId ) && ( StringUtil.StrCmp(AV9GridSelectedRow.gxTpr_Amenitiesname, A110AmenitiesName) == 0 ) )
            {
      ...
      protected void S132( )
      {
         ...
         while ( nGXsfl_18_fel_idx < nRC_GXsfl_18 )
         {
            ...
            if ( AV8GridSelected )
            {
               ...
               AV9GridSelectedRow.gxTpr_Amenitiesid = A107AmenitiesId;
               AV9GridSelectedRow.gxTpr_Amenitiesname = A110AmenitiesName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482210195666", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createlocationstep2.js", "?202482210195666", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      protected void sendrow_182( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_18_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Check box */
            TempTags = " " + ((chkavGridselected.Enabled!=0)&&(chkavGridselected.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 19,'"+sPrefix+"',false,'"+sGXsfl_18_idx+"',18)\"" : " ");
      ...
      public override void initialize_properties( )
      {
         ...
         chkavGridselected.Caption = "";
         chkavGridselected.Visible = -1;
         chkavGridselected.Enabled = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'chkavGridselected_Titleformat',ctrl:'vGRIDSELECTED',prop:'Titleformat'},{av:'chkavGridselected.Title.Text',ctrl:'vGRIDSELECTED',prop:'Title'},{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''},{av:'sPrefix'},{av:'AV11IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E143A2',iparms:[{av:'AV11IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'A107AmenitiesId',fld:'AMENITIESID',pic:'ZZZ9',hsh:true},{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''},{av:'A110AmenitiesName',fld:'AMENITIESNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtAmenitiesName_Link',ctrl:'AMENITIESNAME',prop:'Link'},{av:'AV8GridSelected',fld:'vGRIDSELECTED',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E113A2',iparms:[{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV14WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV8GridSelected',fld:'vGRIDSELECTED',grid:18,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_18',ctrl:'GRID',grid:18,prop:'GridRC',grid:18},{av:'A107AmenitiesId',fld:'AMENITIESID',grid:18,pic:'ZZZ9',hsh:true},{av:'A110AmenitiesName',fld:'AMENITIESNAME',grid:18,pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E123A2',iparms:[{av:'AV14WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV8GridSelected',fld:'vGRIDSELECTED',grid:18,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_18',ctrl:'GRID',grid:18,prop:'GridRC',grid:18},{av:'A107AmenitiesId',fld:'AMENITIESID',grid:18,pic:'ZZZ9',hsh:true},{av:'A110AmenitiesName',fld:'AMENITIESNAME',grid:18,pic:'',hsh:true}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''}]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'chkavGridselected_Titleformat',ctrl:'vGRIDSELECTED',prop:'Titleformat'},{av:'chkavGridselected.Title.Text',ctrl:'vGRIDSELECTED',prop:'Title'},{av:'AV11IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV15WizardData',fld:'vWIZARDDATA',pic:''},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         A110AmenitiesName = "";
         scmdbuf = "";
         H003A2_A110AmenitiesName = new string[] {""} ;
         H003A2_A107AmenitiesId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.createlocationstep2__default(),
            new Object[][] {
                new Object[] {
               H003A2_A110AmenitiesName, H003A2_A107AmenitiesId
               }
               , new Object[] {
      ...
      private string[] H003A2_A110AmenitiesName ;
      private short[] H003A2_A107AmenitiesId ;
   ...
   public class createlocationstep2__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003A2", "SELECT AmenitiesName, AmenitiesId FROM Amenities ORDER BY AmenitiesId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003A2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003A3", "SELECT COUNT(*) FROM Amenities ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003A3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
