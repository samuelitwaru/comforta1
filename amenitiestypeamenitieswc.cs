...
namespace GeneXus.Programs {
   public class amenitiestypeamenitieswc : GXWebComponent
   {
      public amenitiestypeamenitieswc( )
      {
      ...
      public amenitiestypeamenitieswc( IGxContext context )
      {
      ...
      {
         this.AV8AmenitiesTypeId = aP0_AmenitiesTypeId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8AmenitiesTypeId = (short)(Math.Round(NumberUtil.Val( GetPar( "AmenitiesTypeId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(AV8AmenitiesTypeId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8AmenitiesTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV31IsAuthorized_AmenitiesName = StringUtil.StrToBool( GetPar( "IsAuthorized_AmenitiesName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8AmenitiesTypeId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_AmenitiesName, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "AmenitiesTypeAmenitiesWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Amenities Type Amenities WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("amenitiestypeamenitieswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8AmenitiesTypeId,4,0))}, new string[] {"AmenitiesTypeId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_AMENITIESNAME", AV31IsAuthorized_AmenitiesName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_AMENITIESNAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_AmenitiesName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8AmenitiesTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vAMENITIESTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "AmenitiesTypeAmenitiesWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Amenities Type Amenities WC", "") ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "amenitiestypeamenitieswc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAmenitiesTypeId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A108AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A108AmenitiesTypeId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAmenitiesTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtAmenitiesTypeId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_AmenitiesTypeAmenitiesWC.htm");
            /* User Defined Control */
      ...
      protected void START3F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Amenities Type Amenities WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV31IsAuthorized_AmenitiesName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_AMENITIESID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"AMENITIESID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, ".", "")));
      }
      ...
      protected void RF3F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8AmenitiesTypeId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H003F2 */
            pr_default.execute(0, new Object[] {AV8AmenitiesTypeId, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A108AmenitiesTypeId = H003F2_A108AmenitiesTypeId[0];
               AssignAttri(sPrefix, false, "A108AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(A108AmenitiesTypeId), 4, 0));
               A110AmenitiesName = H003F2_A110AmenitiesName[0];
               A107AmenitiesId = H003F2_A107AmenitiesId[0];
               E183F2 ();
      ...
      protected void send_integrity_lvl_hashes3F2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_AMENITIESID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H003F3 */
         pr_default.execute(1, new Object[] {AV8AmenitiesTypeId, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtAmenitiesId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAmenitiesId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtAmenitiesName_Enabled = 0;
         AssignProp(sPrefix, false, edtAmenitiesName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtAmenitiesName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      ...
      protected void STRUP3F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AmenitiesTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E163F2( )
      {
         ...
         GXt_boolean1 = AV31IsAuthorized_AmenitiesName;
         ...
         AV31IsAuthorized_AmenitiesName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV31IsAuthorized_AmenitiesName", AV31IsAuthorized_AmenitiesName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_AMENITIESNAME", GetSecureSignedToken( sPrefix, AV31IsAuthorized_AmenitiesName, context));
      ...
      private void E183F2( )
      {
         ...
         if ( AV31IsAuthorized_AmenitiesName )
         {
      ...
      protected void E113F2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("AmenitiesTypeAmenitiesWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("AmenitiesTypeAmenitiesWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "AmenitiesTypeAmenitiesWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "AmenitiesTypeAmenitiesWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Amenities";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "AmenitiesTypeId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8AmenitiesTypeId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8AmenitiesTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(AV8AmenitiesTypeId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8AmenitiesTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "amenitiestypeamenitieswc", GetJustCreated( ));
         ...
         {
            AV8AmenitiesTypeId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(AV8AmenitiesTypeId), 4, 0));
         }
         wcpOAV8AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8AmenitiesTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8AmenitiesTypeId != wcpOAV8AmenitiesTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8AmenitiesTypeId = AV8AmenitiesTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8AmenitiesTypeId = cgiGet( sPrefix+"AV8AmenitiesTypeId_CTRL");
         if ( StringUtil.Len( sCtrlAV8AmenitiesTypeId) > 0 )
         {
            AV8AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8AmenitiesTypeId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8AmenitiesTypeId", StringUtil.LTrimStr( (decimal)(AV8AmenitiesTypeId), 4, 0));
         }
         else
         {
            AV8AmenitiesTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8AmenitiesTypeId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8AmenitiesTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8AmenitiesTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8AmenitiesTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8AmenitiesTypeId_CTRL", StringUtil.RTrim( sCtrlAV8AmenitiesTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119572847", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("amenitiestypeamenitieswc.js", "?202482119572848", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtAmenitiesId_Internalname = sPrefix+"AMENITIESID_"+sGXsfl_35_idx;
         edtAmenitiesName_Internalname = sPrefix+"AMENITIESNAME_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtAmenitiesId_Internalname = sPrefix+"AMENITIESID_"+sGXsfl_35_fel_idx;
         edtAmenitiesName_Internalname = sPrefix+"AMENITIESNAME_"+sGXsfl_35_fel_idx;
      }
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtAmenitiesId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A107AmenitiesId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A107AmenitiesId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtAmenitiesId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:AmenitiesId|3:AmenitiesName";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E123F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E133F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E143F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E183F2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A107AmenitiesId',fld:'AMENITIESID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAmenitiesName_Link',ctrl:'AMENITIESNAME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E113F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E153F2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_AmenitiesName',fld:'vISAUTHORIZED_AMENITIESNAME',pic:'',hsh:true},{av:'AV32IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A107AmenitiesId',fld:'AMENITIESID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H003F2_A108AmenitiesTypeId = new short[1] ;
         H003F2_A110AmenitiesName = new string[] {""} ;
         H003F2_A107AmenitiesId = new short[1] ;
         ...
         sCtrlAV8AmenitiesTypeId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenitiestypeamenitieswc__default(),
            new Object[][] {
                new Object[] {
               H003F2_A108AmenitiesTypeId, H003F2_A110AmenitiesName, H003F2_A107AmenitiesId
               }
               , new Object[] {
      ...
      private short AV8AmenitiesTypeId ;
      private short wcpOAV8AmenitiesTypeId ;
      ...
      private string sCtrlAV8AmenitiesTypeId ;
      ...
      private bool AV31IsAuthorized_AmenitiesName ;
      ...
      private short[] H003F2_A108AmenitiesTypeId ;
      private string[] H003F2_A110AmenitiesName ;
      private short[] H003F2_A107AmenitiesId ;
   ...
   public class amenitiestypeamenitieswc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003F2( IGxContext context ,
                                             string AV16FilterFullText ,
                                             short A107AmenitiesId ,
                                             string A110AmenitiesName ,
                                             short AV14OrderedBy ,
                                             bool AV15OrderedDsc ,
                                             short A108AmenitiesTypeId ,
                                             short AV8AmenitiesTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " AmenitiesTypeId, AmenitiesName, AmenitiesId";
         sFromString = " FROM Amenities";
         sOrderString = "";
         AddWhere(sWhereString, "(AmenitiesTypeId = :AV8AmenitiesTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(AmenitiesId,'9999'), 2) like '%' || :lV16FilterFullText) or ( AmenitiesName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY AmenitiesTypeId, AmenitiesName, AmenitiesId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AmenitiesTypeId DESC, AmenitiesName DESC, AmenitiesId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY AmenitiesTypeId, AmenitiesId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY AmenitiesTypeId DESC, AmenitiesId DESC";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY AmenitiesId";
         }
                                             ...
                                             short AV8AmenitiesTypeId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM Amenities";
         AddWhere(sWhereString, "(AmenitiesTypeId = :AV8AmenitiesTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(AmenitiesId,'9999'), 2) like '%' || :lV16FilterFullText) or ( AmenitiesName like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003F2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
               case 1 :
                     return conditional_H003F3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8AmenitiesTypeId",GXType.Int16,4,0) ,
