...
namespace GeneXus.Programs {
   public class customercustomizationview : GXDataArea
   {
      public customercustomizationview( )
      {
      ...
      public customercustomizationview( IGxContext context )
      {
      ...
      public void execute( short aP0_CustomerCustomizationId ,
                           string aP1_TabCode )
      {
         this.AV10CustomerCustomizationId = aP0_CustomerCustomizationId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10CustomerCustomizationId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10CustomerCustomizationId", StringUtil.LTrimStr( (decimal)(AV10CustomerCustomizationId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERCUSTOMIZATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerCustomizationId), "ZZZ9"), context));
      ...
      {
         get {
            return "customercustomizationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customercustomizationview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CustomerCustomizationId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CustomerCustomizationId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vCUSTOMERCUSTOMIZATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CustomerCustomizationId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERCUSTOMIZATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerCustomizationId), "ZZZ9"), context));
      ...
      {
         return formatLink("customercustomizationview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10CustomerCustomizationId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"CustomerCustomizationId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "CustomerCustomizationView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Customer Customization View", "") ;
      }
      ...
      protected void WB3I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Customer Customization", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_CustomerCustomizationView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCustomercustomizationgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      ...
      protected void START3I2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Customer Customization View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E113I2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("customercustomizationww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV14GXLvl9 = 0;
         /* Using cursor H003I2 */
         pr_default.execute(0, new Object[] {AV10CustomerCustomizationId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A128CustomerCustomizationId = H003I2_A128CustomerCustomizationId[0];
            A131CustomerCustomizationBaseColor = H003I2_A131CustomerCustomizationBaseColor[0];
            AV14GXLvl9 = 1;
            Form.Caption = A131CustomerCustomizationBaseColor;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "CustomerCustomizationGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "customercustomizationgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "CustomerCustomizationGeneral";
            WebComp_Webcomponent_general_Component = "CustomerCustomizationGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(short)AV10CustomerCustomizationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CustomerCustomizationId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV10CustomerCustomizationId", StringUtil.LTrimStr( (decimal)(AV10CustomerCustomizationId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCUSTOMERCUSTOMIZATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CustomerCustomizationId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915582722", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customercustomizationview.js", "?202481915582723", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divCustomercustomizationgeneral_cell_Internalname = "CUSTOMERCUSTOMIZATIONGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Customer Customization View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10CustomerCustomizationId',fld:'vCUSTOMERCUSTOMIZATIONID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003I2_A128CustomerCustomizationId = new short[1] ;
         H003I2_A131CustomerCustomizationBaseColor = new string[] {""} ;
         A131CustomerCustomizationBaseColor = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customercustomizationview__default(),
            new Object[][] {
                new Object[] {
               H003I2_A128CustomerCustomizationId, H003I2_A131CustomerCustomizationBaseColor
               }
            }
         );
      ...
      private short AV10CustomerCustomizationId ;
      private short wcpOAV10CustomerCustomizationId ;
      ...
      private string divCustomercustomizationgeneral_cell_Internalname ;
      ...
      private short[] H003I2_A128CustomerCustomizationId ;
      private string[] H003I2_A131CustomerCustomizationBaseColor ;
   ...
   public class customercustomizationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10CustomerCustomizationId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H003I2", "SELECT CustomerCustomizationId, CustomerCustomizationBaseColor FROM CustomerCustomization WHERE CustomerCustomizationId = :AV10CustomerCustomizationId ORDER BY CustomerCustomizationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003I2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
