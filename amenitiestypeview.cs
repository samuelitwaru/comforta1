...
namespace GeneXus.Programs {
   public class amenitiestypeview : GXDataArea
   {
      ...
      protected void E113C2( )
      {
         ...
         {
            A108AmenitiesTypeId = H003C2_A108AmenitiesTypeId[0];
            A109AmenitiesTypeName = H003C2_A109AmenitiesTypeName[0];
            AV14GXLvl9 = 1;
            Form.Caption = A109AmenitiesTypeName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915582678", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("amenitiestypeview.js", "?202481915582678", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10AmenitiesTypeId',fld:'vAMENITIESTYPEID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003C2_A108AmenitiesTypeId = new short[1] ;
         H003C2_A109AmenitiesTypeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenitiestypeview__default(),
            new Object[][] {
                new Object[] {
               H003C2_A108AmenitiesTypeId, H003C2_A109AmenitiesTypeName
               }
            }
         );
      ...
      private short[] H003C2_A108AmenitiesTypeId ;
      private string[] H003C2_A109AmenitiesTypeName ;
   ...
   public class amenitiestypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003C2", "SELECT AmenitiesTypeId, AmenitiesTypeName FROM AmenitiesType WHERE AmenitiesTypeId = :AV10AmenitiesTypeId ORDER BY AmenitiesTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003C2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
