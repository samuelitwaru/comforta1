...
namespace GeneXus.Programs {
   public class gx00h2 : GXDataArea
   {
      public gx00h2( )
      {
      ...
      public gx00h2( IGxContext context )
      {
      ...
      public void execute( short aP0_pCustomerId ,
                           ...
                           out short aP2_pSupplier_GenId )
      {
         this.AV7pCustomerId = aP0_pCustomerId;
         this.AV8pCustomerLocationId = aP1_pCustomerLocationId;
         this.AV9pSupplier_GenId = 0 ;
         executePrivate();
         aP2_pSupplier_GenId=this.AV9pSupplier_GenId;
      }
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV9pSupplier_GenId = (short)(Math.Round(NumberUtil.Val( GetPar( "pSupplier_GenId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri("", false, "AV9pSupplier_GenId", StringUtil.LTrimStr( (decimal)(AV9pSupplier_GenId), 4, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cSupplier_GenId, AV7pCustomerId, AV8pCustomerLocationId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00h2.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pCustomerId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pCustomerLocationId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pSupplier_GenId,4,0))}, new string[] {"pCustomerId","pCustomerLocationId","pSupplier_GenId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPSUPPLIER_GENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9pSupplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("gx00h2.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pCustomerId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pCustomerLocationId,4,0)),UrlEncode(StringUtil.LTrimStr(AV9pSupplier_GenId,4,0))}, new string[] {"pCustomerId","pCustomerLocationId","pSupplier_GenId"})  ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblsupplier_genidfilter_Internalname, context.GetMessage( "Supplier_Gen Id", ""), "", "", lblLblsupplier_genidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00H2.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120k1_client"+"'", TempTags, "", 2, "HLP_Gx00H2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00H2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {AV7pCustomerId, AV8pCustomerLocationId, AV6cSupplier_GenId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A18CustomerLocationId = H000K2_A18CustomerLocationId[0];
               A1CustomerId = H000K2_A1CustomerId[0];
               A64Supplier_GenId = H000K2_A64Supplier_GenId[0];
               /* Execute user event: Load */
               E140K2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIER_GENID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A64Supplier_GenId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {AV7pCustomerId, AV8pCustomerLocationId, AV6cSupplier_GenId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtSupplier_GenId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         edtCustomerId_Enabled = 0;
         AssignProp("", false, edtCustomerId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         edtCustomerLocationId_Enabled = 0;
         AssignProp("", false, edtCustomerLocationId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerLocationId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void E150K2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV9pSupplier_GenId = A64Supplier_GenId;
         AssignAttri("", false, "AV9pSupplier_GenId", StringUtil.LTrimStr( (decimal)(AV9pSupplier_GenId), 4, 0));
         context.setWebReturnParms(new Object[] {(short)AV9pSupplier_GenId});
         context.setWebReturnParmsMetadata(new Object[] {"AV9pSupplier_GenId"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV8pCustomerLocationId", StringUtil.LTrimStr( (decimal)(AV8pCustomerLocationId), 4, 0));
         AV9pSupplier_GenId = Convert.ToInt16(getParm(obj,2));
         AssignAttri("", false, "AV9pSupplier_GenId", StringUtil.LTrimStr( (decimal)(AV9pSupplier_GenId), 4, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714335319", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00h2.js", "?202482714335319", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtSupplier_GenId_Internalname = "SUPPLIER_GENID_"+sGXsfl_24_idx;
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtSupplier_GenId_Internalname = "SUPPLIER_GENID_"+sGXsfl_24_fel_idx;
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtSupplier_GenId_Link));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_GenId',fld:'vCSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV7pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'},{av:'AV8pCustomerLocationId',fld:'vPCUSTOMERLOCATIONID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E120K1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSUPPLIER_GENIDFILTER.CLICK","{handler:'E110K1',iparms:[{av:'divSupplier_genidfiltercontainer_Class',ctrl:'SUPPLIER_GENIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E150K2',iparms:[{av:'A64Supplier_GenId',fld:'SUPPLIER_GENID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV9pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_GenId',fld:'vCSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV7pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'},{av:'AV8pCustomerLocationId',fld:'vPCUSTOMERLOCATIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_GenId',fld:'vCSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV7pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'},{av:'AV8pCustomerLocationId',fld:'vPCUSTOMERLOCATIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_GenId',fld:'vCSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV7pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'},{av:'AV8pCustomerLocationId',fld:'vPCUSTOMERLOCATIONID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_GenId',fld:'vCSUPPLIER_GENID',pic:'ZZZ9'},{av:'AV7pCustomerId',fld:'vPCUSTOMERID',pic:'ZZZ9'},{av:'AV8pCustomerLocationId',fld:'vPCUSTOMERLOCATIONID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000K2_A18CustomerLocationId = new short[1] ;
         H000K2_A1CustomerId = new short[1] ;
         H000K2_A64Supplier_GenId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00h2__default(),
            new Object[][] {
                new Object[] {
               H000K2_A18CustomerLocationId, H000K2_A1CustomerId, H000K2_A64Supplier_GenId
               }
               , new Object[] {
      ...
      private short AV9pSupplier_GenId ;
      ...
      private string edtSupplier_GenId_Link ;
      ...
      private short[] H000K2_A18CustomerLocationId ;
      private short[] H000K2_A1CustomerId ;
      private short[] H000K2_A64Supplier_GenId ;
      private long[] H000K3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP2_pSupplier_GenId ;
      private GXWebForm Form ;
   }

   public class gx00h2__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT CustomerLocationId, CustomerId, Supplier_GenId FROM CustomerLocationSupplier_Gen WHERE CustomerId = :AV7pCustomerId and CustomerLocationId = :AV8pCustomerLocationId and Supplier_GenId >= :AV6cSupplier_GenId ORDER BY CustomerId, CustomerLocationId, Supplier_GenId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000K3", "SELECT COUNT(*) FROM CustomerLocationSupplier_Gen WHERE CustomerId = :AV7pCustomerId and CustomerLocationId = :AV8pCustomerLocationId and Supplier_GenId >= :AV6cSupplier_GenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
