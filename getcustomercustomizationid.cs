...
namespace GeneXus.Programs {
   public class getcustomercustomizationid : GXProcedure
   {
      ...
      {
         getcustomercustomizationid objgetcustomercustomizationid;
         objgetcustomercustomizationid = new getcustomercustomizationid();
         objgetcustomercustomizationid.AV9CustomerCustomizationId = 0 ;
         objgetcustomercustomizationid.context.SetSubmitInitialConfig(context);
         objgetcustomercustomizationid.initialize();
         Submit( executePrivateCatch,objgetcustomercustomizationid);
         aP0_CustomerCustomizationId=this.AV9CustomerCustomizationId;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getcustomercustomizationid)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
