...
namespace GeneXus.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248271430428", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?20248271430428", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD","{handler:'E151H2',iparms:[{av:'AV6ConfFormattingVariables',fld:'vCONFFORMATTINGVARIABLES',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDS',prop:'GridRC',grid:15}]");
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV8DefaultValue',fld:'vDEFAULTVALUE',pic:'ZZZZZZZZZ9'}]}");
         setEventMetadata("'DOUSERACTION1'","{handler:'E111H1',iparms:[]");
         setEventMetadata("'DOUSERACTION1'",",oparms:[]}");
         setEventMetadata("'DOUSERACTIONRESET'","{handler:'E121H2',iparms:[{av:'AV6ConfFormattingVariables',fld:'vCONFFORMATTINGVARIABLES',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDS',prop:'GridRC',grid:15},{av:'AV7VarProgramName',fld:'vVARPROGRAMNAME',pic:''}]");
         setEventMetadata("'DOUSERACTIONRESET'",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E131H2',iparms:[{av:'AV7VarProgramName',fld:'vVARPROGRAMNAME',pic:''},{av:'AV6ConfFormattingVariables',fld:'vCONFFORMATTINGVARIABLES',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDS',grid:15,prop:'GridRC',grid:15},{av:'AV8DefaultValue',fld:'vDEFAULTVALUE',grid:15,pic:'ZZZZZZZZZ9'}]");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Comforta11");
