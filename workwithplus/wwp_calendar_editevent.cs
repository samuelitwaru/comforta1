...
namespace GeneXus.Programs.workwithplus {
   public class wwp_calendar_editevent : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_Gx_mode ,
                                 ...
                                 out bool aP9_EventCreated )
      {
         wwp_calendar_editevent objwwp_calendar_editevent;
         objwwp_calendar_editevent = new wwp_calendar_editevent();
         objwwp_calendar_editevent.Gx_mode = aP0_Gx_mode;
         objwwp_calendar_editevent.AV18Title = aP1_Title;
         objwwp_calendar_editevent.AV13Date = aP2_Date;
         objwwp_calendar_editevent.AV17FromTime = aP3_FromTime;
         objwwp_calendar_editevent.AV19ToTime = aP4_ToTime;
         objwwp_calendar_editevent.AV11AllDay = aP5_AllDay;
         objwwp_calendar_editevent.AV14EndDate = aP6_EndDate;
         objwwp_calendar_editevent.AV12CalendarEventId = aP7_CalendarEventId;
         objwwp_calendar_editevent.AV9ErrorMessages = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus") ;
         objwwp_calendar_editevent.AV15EventCreated = false ;
         objwwp_calendar_editevent.context.SetSubmitInitialConfig(context);
         objwwp_calendar_editevent.initialize();
         Submit( executePrivateCatch,objwwp_calendar_editevent);
         aP8_ErrorMessages=this.AV9ErrorMessages;
         aP9_EventCreated=this.AV15EventCreated;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_calendar_editevent)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
