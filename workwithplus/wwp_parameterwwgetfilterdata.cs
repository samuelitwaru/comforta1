...
namespace GeneXus.Programs.workwithplus {
   public class wwp_parameterwwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         wwp_parameterwwgetfilterdata objwwp_parameterwwgetfilterdata;
         objwwp_parameterwwgetfilterdata = new wwp_parameterwwgetfilterdata();
         objwwp_parameterwwgetfilterdata.AV34DDOName = aP0_DDOName;
         objwwp_parameterwwgetfilterdata.AV35SearchTxtParms = aP1_SearchTxtParms;
         objwwp_parameterwwgetfilterdata.AV36SearchTxtTo = aP2_SearchTxtTo;
         objwwp_parameterwwgetfilterdata.AV37OptionsJson = "" ;
         objwwp_parameterwwgetfilterdata.AV38OptionsDescJson = "" ;
         objwwp_parameterwwgetfilterdata.AV39OptionIndexesJson = "" ;
         objwwp_parameterwwgetfilterdata.context.SetSubmitInitialConfig(context);
         objwwp_parameterwwgetfilterdata.initialize();
         Submit( executePrivateCatch,objwwp_parameterwwgetfilterdata);
         aP3_OptionsJson=this.AV37OptionsJson;
         aP4_OptionsDescJson=this.AV38OptionsDescJson;
         aP5_OptionIndexesJson=this.AV39OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_parameterwwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S121( )
      {
         ...
         {
            A87WWPParameterDescription = P000L2_A87WWPParameterDescription[0];
            A86WWPParameterCategory = P000L2_A86WWPParameterCategory[0];
            A84WWPParameterKey = P000L2_A84WWPParameterKey[0];
            A85WWPParameterValue = P000L2_A85WWPParameterValue[0];
            ...
            AV23Option = (String.IsNullOrEmpty(StringUtil.RTrim( A84WWPParameterKey)) ? "<#Empty#>" : A84WWPParameterKey);
      ...
      protected void S131( )
      {
         ...
         {
            BRK0L3 = false;
            A86WWPParameterCategory = P000L3_A86WWPParameterCategory[0];
            A87WWPParameterDescription = P000L3_A87WWPParameterDescription[0];
            A84WWPParameterKey = P000L3_A84WWPParameterKey[0];
            A85WWPParameterValue = P000L3_A85WWPParameterValue[0];
            if ( StringUtil.Len( A85WWPParameterValue) <= 30 )
            {
               A89WWPParameterValueTrimmed = A85WWPParameterValue;
            }
            ...
            AV28count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( StringUtil.StrCmp(P000L3_A86WWPParameterCategory[0], A86WWPParameterCategory) == 0 ) )
            {
               BRK0L3 = false;
               A84WWPParameterKey = P000L3_A84WWPParameterKey[0];
            ...
            if ( (0==AV19SkipItems) )
            {
               AV23Option = (String.IsNullOrEmpty(StringUtil.RTrim( A86WWPParameterCategory)) ? "<#Empty#>" : A86WWPParameterCategory);
               AV24Options.Add(AV23Option, 0);
      ...
      protected void S141( )
      {
         ...
         {
            BRK0L5 = false;
            A87WWPParameterDescription = P000L4_A87WWPParameterDescription[0];
            A86WWPParameterCategory = P000L4_A86WWPParameterCategory[0];
            A84WWPParameterKey = P000L4_A84WWPParameterKey[0];
            A85WWPParameterValue = P000L4_A85WWPParameterValue[0];
            if ( StringUtil.Len( A85WWPParameterValue) <= 30 )
            {
               A89WWPParameterValueTrimmed = A85WWPParameterValue;
            }
            ...
            AV28count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P000L4_A87WWPParameterDescription[0], A87WWPParameterDescription) == 0 ) )
            {
               BRK0L5 = false;
               A84WWPParameterKey = P000L4_A84WWPParameterKey[0];
               AV28count = (long)(AV28count+1);
            ...
            if ( (0==AV19SkipItems) )
            {
               AV23Option = (String.IsNullOrEmpty(StringUtil.RTrim( A87WWPParameterDescription)) ? "<#Empty#>" : A87WWPParameterDescription);
               AV24Options.Add(AV23Option, 0);
               AV27OptionIndexes.Add(StringUtil.Trim( context.localUtil.Format( (decimal)(AV28count), "Z,ZZZ,ZZZ,ZZ9")), 0);
               if ( AV24Options.Count == 10 )
               {
      ...
      protected void S151( )
      {
         ...
         {
            A87WWPParameterDescription = P000L5_A87WWPParameterDescription[0];
            A86WWPParameterCategory = P000L5_A86WWPParameterCategory[0];
            A84WWPParameterKey = P000L5_A84WWPParameterKey[0];
            A85WWPParameterValue = P000L5_A85WWPParameterValue[0];
            if ( StringUtil.Len( A85WWPParameterValue) <= 30 )
            {
               A89WWPParameterValueTrimmed = A85WWPParameterValue;
            }
            ...
            AV23Option = (String.IsNullOrEmpty(StringUtil.RTrim( A89WWPParameterValueTrimmed)) ? "<#Empty#>" : A89WWPParameterValueTrimmed);
            AV22InsertIndex = 1;
      ...
      public override void initialize( )
      {
         ...
         A87WWPParameterDescription = "";
         A85WWPParameterValue = "";
         P000L2_A87WWPParameterDescription = new string[] {""} ;
         P000L2_A86WWPParameterCategory = new string[] {""} ;
         P000L2_A84WWPParameterKey = new string[] {""} ;
         P000L2_A85WWPParameterValue = new string[] {""} ;
         A89WWPParameterValueTrimmed = "";
         AV23Option = "";
         P000L3_A86WWPParameterCategory = new string[] {""} ;
         P000L3_A87WWPParameterDescription = new string[] {""} ;
         P000L3_A84WWPParameterKey = new string[] {""} ;
         P000L3_A85WWPParameterValue = new string[] {""} ;
         P000L4_A87WWPParameterDescription = new string[] {""} ;
         P000L4_A86WWPParameterCategory = new string[] {""} ;
         P000L4_A84WWPParameterKey = new string[] {""} ;
         P000L4_A85WWPParameterValue = new string[] {""} ;
         P000L5_A87WWPParameterDescription = new string[] {""} ;
         P000L5_A86WWPParameterCategory = new string[] {""} ;
         P000L5_A84WWPParameterKey = new string[] {""} ;
         P000L5_A85WWPParameterValue = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.wwp_parameterwwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P000L2_A87WWPParameterDescription, P000L2_A86WWPParameterCategory, P000L2_A84WWPParameterKey, P000L2_A85WWPParameterValue
               }
               , new Object[] {
               P000L3_A86WWPParameterCategory, P000L3_A87WWPParameterDescription, P000L3_A84WWPParameterKey, P000L3_A85WWPParameterValue
               }
               , new Object[] {
               P000L4_A87WWPParameterDescription, P000L4_A86WWPParameterCategory, P000L4_A84WWPParameterKey, P000L4_A85WWPParameterValue
               }
               , new Object[] {
               P000L5_A87WWPParameterDescription, P000L5_A86WWPParameterCategory, P000L5_A84WWPParameterKey, P000L5_A85WWPParameterValue
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P000L2_A87WWPParameterDescription ;
      private string[] P000L2_A86WWPParameterCategory ;
      private string[] P000L2_A84WWPParameterKey ;
      private string[] P000L2_A85WWPParameterValue ;
      private string[] P000L3_A86WWPParameterCategory ;
      private string[] P000L3_A87WWPParameterDescription ;
      private string[] P000L3_A84WWPParameterKey ;
      private string[] P000L3_A85WWPParameterValue ;
      private string[] P000L4_A87WWPParameterDescription ;
      private string[] P000L4_A86WWPParameterCategory ;
      private string[] P000L4_A84WWPParameterKey ;
      private string[] P000L4_A85WWPParameterValue ;
      private string[] P000L5_A87WWPParameterDescription ;
      private string[] P000L5_A86WWPParameterCategory ;
      private string[] P000L5_A84WWPParameterKey ;
      private string[] P000L5_A85WWPParameterValue ;
   ...
   {
      protected Object[] conditional_P000L2( IGxContext context ,
      ...
      protected Object[] conditional_P000L3( IGxContext context ,
                                             string AV44Workwithplus_wwp_parameterwwds_1_filterfulltext ,
                                             string AV46Workwithplus_wwp_parameterwwds_3_tfwwpparameterkey_sel ,
                                             string AV45Workwithplus_wwp_parameterwwds_2_tfwwpparameterkey ,
                                             string AV48Workwithplus_wwp_parameterwwds_5_tfwwpparametercategory_sel ,
      ...
      protected Object[] conditional_P000L4( IGxContext context ,
                                             string AV44Workwithplus_wwp_parameterwwds_1_filterfulltext ,
                                             string AV46Workwithplus_wwp_parameterwwds_3_tfwwpparameterkey_sel ,
                                             string AV45Workwithplus_wwp_parameterwwds_2_tfwwpparameterkey ,
                                             string AV48Workwithplus_wwp_parameterwwds_5_tfwwpparametercategory_sel ,
      ...
      protected Object[] conditional_P000L5( IGxContext context ,
                                             string AV44Workwithplus_wwp_parameterwwds_1_filterfulltext ,
                                             string AV46Workwithplus_wwp_parameterwwds_3_tfwwpparameterkey_sel ,
                                             string AV45Workwithplus_wwp_parameterwwds_2_tfwwpparameterkey ,
                                             string AV48Workwithplus_wwp_parameterwwds_5_tfwwpparametercategory_sel ,
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P000L2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000L2,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P000L3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000L3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P000L4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000L4,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P000L5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP000L5,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
