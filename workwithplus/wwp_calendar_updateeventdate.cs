...
namespace GeneXus.Programs.workwithplus {
   public class wwp_calendar_updateeventdate : GXProcedure
   {
      ...
      {
         wwp_calendar_updateeventdate objwwp_calendar_updateeventdate;
         objwwp_calendar_updateeventdate = new wwp_calendar_updateeventdate();
         objwwp_calendar_updateeventdate.AV8EventToUpdate = aP0_EventToUpdate;
         objwwp_calendar_updateeventdate.context.SetSubmitInitialConfig(context);
         objwwp_calendar_updateeventdate.initialize();
         Submit( executePrivateCatch,objwwp_calendar_updateeventdate);
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_calendar_updateeventdate)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
