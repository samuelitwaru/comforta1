...
namespace GeneXus.Programs.workwithplus {
   public class wwp_calendar_getevent : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_EventId ,
                                 out GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item aP1_Calendar_Event )
      {
         wwp_calendar_getevent objwwp_calendar_getevent;
         objwwp_calendar_getevent = new wwp_calendar_getevent();
         objwwp_calendar_getevent.AV9EventId = aP0_EventId;
         objwwp_calendar_getevent.AV8Calendar_Event = new GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item(context) ;
         objwwp_calendar_getevent.context.SetSubmitInitialConfig(context);
         objwwp_calendar_getevent.initialize();
         Submit( executePrivateCatch,objwwp_calendar_getevent);
         aP1_Calendar_Event=this.AV8Calendar_Event;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_calendar_getevent)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
