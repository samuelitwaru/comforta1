...
namespace GeneXus.Programs.workwithplus {
   public class wwp_geteventsforflatdate : GXProcedure
   {
      ...
      public void executeSubmit( GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP0_Events ,
                                 ...
                                 out GeneXus.Programs.wwpbaseobjects.SdtWWPDateRangePickerOptions aP4_WWPDateRangePickerOptions )
      {
         wwp_geteventsforflatdate objwwp_geteventsforflatdate;
         objwwp_geteventsforflatdate = new wwp_geteventsforflatdate();
         objwwp_geteventsforflatdate.AV13Events = aP0_Events;
         objwwp_geteventsforflatdate.AV21FromDate = aP1_FromDate;
         objwwp_geteventsforflatdate.AV22ToDate = aP2_ToDate;
         objwwp_geteventsforflatdate.AV14EventsStyle = aP3_EventsStyle;
         objwwp_geteventsforflatdate.AV20WWPDateRangePickerOptions = new GeneXus.Programs.wwpbaseobjects.SdtWWPDateRangePickerOptions(context) ;
         objwwp_geteventsforflatdate.context.SetSubmitInitialConfig(context);
         objwwp_geteventsforflatdate.initialize();
         Submit( executePrivateCatch,objwwp_geteventsforflatdate);
         aP4_WWPDateRangePickerOptions=this.AV20WWPDateRangePickerOptions;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_geteventsforflatdate)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         AV9DateCollection = (GxSimpleCollection<DateTime>)(new GxSimpleCollection<DateTime>());
         AV23GXV1 = 1;
