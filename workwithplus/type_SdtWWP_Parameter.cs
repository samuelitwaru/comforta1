...
namespace GeneXus.Programs.workwithplus {
   ...
   [XmlType(TypeName =  "WWP_Parameter" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtWWP_Parameter : GxSilentTrnSdt
   {
      ...
      public void Load( string AV84WWPParameterKey )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV84WWPParameterKey});
         return  ;
      }
   ...
   [DataContract(Name = @"WorkWithPlus\WWP_Parameter", Namespace = "Comforta11")]
