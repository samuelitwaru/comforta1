...
namespace GeneXus.Programs.workwithplus {
   public class wwp_calendar_getevents : GXProcedure
   {
                           ...
                           out GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP4_Gxm2rootcol )
      {
         ...
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta11") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( bool aP0_IsSearching ,
                                 ...
                                 out GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item> aP4_Gxm2rootcol )
      {
         wwp_calendar_getevents objwwp_calendar_getevents;
         objwwp_calendar_getevents = new wwp_calendar_getevents();
         objwwp_calendar_getevents.AV5IsSearching = aP0_IsSearching;
         objwwp_calendar_getevents.AV8TitleFilter = aP1_TitleFilter;
         objwwp_calendar_getevents.AV6LoadFromDate = aP2_LoadFromDate;
         objwwp_calendar_getevents.AV7LoadToDate = aP3_LoadToDate;
         objwwp_calendar_getevents.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta11") ;
         objwwp_calendar_getevents.context.SetSubmitInitialConfig(context);
         objwwp_calendar_getevents.initialize();
         Submit( executePrivateCatch,objwwp_calendar_getevents);
         aP4_Gxm2rootcol=this.Gxm2rootcol;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wwp_calendar_getevents)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
