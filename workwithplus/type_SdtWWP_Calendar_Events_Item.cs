...
namespace GeneXus.Programs.workwithplus
{
	...
	[XmlType(TypeName="Item" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"Item", Namespace="Comforta11")]
	public class SdtWWP_Calendar_Events_Item_RESTInterface : GxGenericCollectionItem<SdtWWP_Calendar_Events_Item>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Start);

			}
			set { 
				sdt.gxTpr_Start = DateTimeUtil.CToT2(value);
			}
		}
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_End);

			}
			set { 
				sdt.gxTpr_End = DateTimeUtil.CToT2(value);
			}
		}
