...
namespace GeneXus.Programs {
   public class pageview : GXDataArea
   {
      ...
      {
         GxWebStd.gx_hidden_field( context, "vPAGEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10PageId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PageId), "ZZZ9"), context));
      ...
      {
         return context.GetMessage( "Page View", "") ;
      }
      ...
      protected void WB2Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Page", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_PageView.htm");
      ...
      protected void START2Z2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Page View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E112Z2( )
      {
         ...
         {
            A98PageId = H002Z2_A98PageId[0];
            A99PageName = H002Z2_A99PageName[0];
            AV14GXLvl9 = 1;
            Form.Caption = A99PageName;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714325365", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("pageview.js", "?202482714325365", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Page View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002Z2_A98PageId = new short[1] ;
         H002Z2_A99PageName = new string[] {""} ;
         A99PageName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pageview__default(),
            new Object[][] {
                new Object[] {
               H002Z2_A98PageId, H002Z2_A99PageName
               }
            }
         );
      ...
      private short[] H002Z2_A98PageId ;
      private string[] H002Z2_A99PageName ;
   ...
   public class pageview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002Z2", "SELECT PageId, PageName FROM Page WHERE PageId = :AV10PageId ORDER BY PageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Z2,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
