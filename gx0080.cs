...
namespace GeneXus.Programs {
   public class gx0080 : GXDataArea
   {
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtSupplier_AgbId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbId_Enabled), 5, 0), !bGXsfl_84_Refreshing);
         edtSupplier_AgbNumber_Enabled = 0;
         AssignProp("", false, edtSupplier_AgbNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbNumber_Enabled), 5, 0), !bGXsfl_84_Refreshing);
         edtSupplier_AgbName_Enabled = 0;
         AssignProp("", false, edtSupplier_AgbName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbName_Enabled), 5, 0), !bGXsfl_84_Refreshing);
         edtSupplier_AgbKvkNumber_Enabled = 0;
         AssignProp("", false, edtSupplier_AgbKvkNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbKvkNumber_Enabled), 5, 0), !bGXsfl_84_Refreshing);
         edtSupplier_AgbPhone_Enabled = 0;
         AssignProp("", false, edtSupplier_AgbPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbPhone_Enabled), 5, 0), !bGXsfl_84_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714332517", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0080.js", "?202482714332517", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cSupplier_AgbId',fld:'vCSUPPLIER_AGBID',pic:'ZZZ9'},{av:'AV7cSupplier_AgbNumber',fld:'vCSUPPLIER_AGBNUMBER',pic:''},{av:'AV8cSupplier_AgbName',fld:'vCSUPPLIER_AGBNAME',pic:''},{av:'AV9cSupplier_AgbKvkNumber',fld:'vCSUPPLIER_AGBKVKNUMBER',pic:''},{av:'AV10cSupplier_AgbEmail',fld:'vCSUPPLIER_AGBEMAIL',pic:''},{av:'AV11cSupplier_AgbPhone',fld:'vCSUPPLIER_AGBPHONE',pic:''},{av:'AV12cSupplier_AgbContactName',fld:'vCSUPPLIER_AGBCONTACTNAME',pic:''}]");
         ...
         setEventMetadata("VALIDV_CSUPPLIER_AGBEMAIL",",oparms:[]}");
