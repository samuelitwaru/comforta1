...
namespace GeneXus.Programs {
   public class addsuppliersstep2 : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915562975", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("addsuppliersstep2.js", "?202481915562978", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void sendrow_272( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_27_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavUdelete_Enabled!=0)&&(edtavUdelete_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 28,'"+sPrefix+"',false,'"+sGXsfl_27_idx+"',27)\"" : " ");
            ROClassString = "Attribute";
            GridsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavUdelete_Internalname,StringUtil.RTrim( AV43UDelete),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavUdelete_Enabled!=0)&&(edtavUdelete_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,28);\"" : " "),"'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVUDELETE.CLICK."+sGXsfl_27_idx+"'",(string)"",(string)"",context.GetMessage( "Delete item", ""),(string)"",(string)edtavUdelete_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavUdelete_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)27,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridsContainer.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDS.LOAD","{handler:'E152S2',iparms:[]");
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV43UDelete',fld:'vUDELETE',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E112S2',iparms:[{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV45WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV40SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'AV11Customer',fld:'vCUSTOMER',pic:''},{av:'AV21LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV11Customer',fld:'vCUSTOMER',pic:''},{av:'AV21LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',pic:''},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27}]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E122S2',iparms:[{av:'AV45WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV40SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27}]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[]}");
         setEventMetadata("'DOINSERTGENSUPPLIER'","{handler:'E132S2',iparms:[{av:'AV40SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("'DOINSERTGENSUPPLIER'",",oparms:[{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'AV40SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''}]}");
         setEventMetadata("VUDELETE.CLICK","{handler:'E162S2',iparms:[{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VUDELETE.CLICK",",oparms:[{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27}]}");
         setEventMetadata("GRIDS_FIRSTPAGE","{handler:'subgrids_firstpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_PREVPAGE","{handler:'subgrids_previouspage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_NEXTPAGE","{handler:'subgrids_nextpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_LASTPAGE","{handler:'subgrids_lastpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV23LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:27,pic:''},{av:'nGXsfl_27_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:27},{av:'nRC_GXsfl_27',ctrl:'GRIDS',prop:'GridRC',grid:27},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV19HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'dynavLocationoption'},{av:'AV24LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
