...
namespace GeneXus.Programs {
   public class customerloaddvcombo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP7_Combo_DataJson )
      {
         customerloaddvcombo objcustomerloaddvcombo;
         objcustomerloaddvcombo = new customerloaddvcombo();
         objcustomerloaddvcombo.AV17ComboName = aP0_ComboName;
         objcustomerloaddvcombo.AV18TrnMode = aP1_TrnMode;
         objcustomerloaddvcombo.AV19IsDynamicCall = aP2_IsDynamicCall;
         objcustomerloaddvcombo.AV20CustomerId = aP3_CustomerId;
         objcustomerloaddvcombo.AV21SearchTxtParms = aP4_SearchTxtParms;
         objcustomerloaddvcombo.AV22SelectedValue = "" ;
         objcustomerloaddvcombo.AV23SelectedText = "" ;
         objcustomerloaddvcombo.AV24Combo_DataJson = "" ;
         objcustomerloaddvcombo.context.SetSubmitInitialConfig(context);
         objcustomerloaddvcombo.initialize();
         Submit( executePrivateCatch,objcustomerloaddvcombo);
         aP5_SelectedValue=this.AV22SelectedValue;
         aP6_SelectedText=this.AV23SelectedText;
         aP7_Combo_DataJson=this.AV24Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((customerloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         if ( AV19IsDynamicCall )
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "GET_DSC") == 0 )
            {
               ...
               while ( AV35GXV1 <= AV30ValuesCollection.Count )
               {
                  ...
                  {
                     A107AmenitiesId = P002A2_A107AmenitiesId[0];
                     A110AmenitiesName = P002A2_A110AmenitiesName[0];
                     AV36GXLvl35 = 1;
                     AV29DscsCollection.Add(A110AmenitiesName, 0);
            ...
            else
            {
               ...
               {
                  A110AmenitiesName = P002A3_A110AmenitiesName[0];
                  A107AmenitiesId = P002A3_A107AmenitiesId[0];
                  AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
                  AV16Combo_DataItem.gxTpr_Id = StringUtil.Trim( StringUtil.Str( (decimal)(A107AmenitiesId), 4, 0));
                  AV16Combo_DataItem.gxTpr_Title = A110AmenitiesName;
      ...
      public override void initialize( )
      {
         ...
         AV31ValueItem = "";
         scmdbuf = "";
         P002A2_A107AmenitiesId = new short[1] ;
         P002A2_A110AmenitiesName = new string[] {""} ;
         A110AmenitiesName = "";
         lV14SearchTxt = "";
         P002A3_A110AmenitiesName = new string[] {""} ;
         P002A3_A107AmenitiesId = new short[1] ;
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customerloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P002A2_A107AmenitiesId, P002A2_A110AmenitiesName
               }
               , new Object[] {
               P002A3_A110AmenitiesName, P002A3_A107AmenitiesId
               }
               , new Object[] {
      ...
      private short[] P002A2_A107AmenitiesId ;
      private string[] P002A2_A110AmenitiesName ;
      private string[] P002A3_A110AmenitiesName ;
      private short[] P002A3_A107AmenitiesId ;
