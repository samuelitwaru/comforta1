...
namespace GeneXus.Programs {
   public class getcustomercustomizationvalues : GXProcedure
   {
      ...
      {
         getcustomercustomizationvalues objgetcustomercustomizationvalues;
         objgetcustomercustomizationvalues = new getcustomercustomizationvalues();
         objgetcustomercustomizationvalues.AV9CustomeCustomize = new SdtCustomerCustomizationSDT(context) ;
         objgetcustomercustomizationvalues.context.SetSubmitInitialConfig(context);
         objgetcustomercustomizationvalues.initialize();
         Submit( executePrivateCatch,objgetcustomercustomizationvalues);
         aP0_CustomeCustomize=this.AV9CustomeCustomize;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getcustomercustomizationvalues)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
