...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Customer" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtCustomer : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtCustomer_Manager> gxTpr_Manager_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtCustomer_Manager == null )
            {
               gxTv_SdtCustomer_Manager = new GXBCLevelCollection<SdtCustomer_Manager>( context, "Customer.Manager", "Comforta11");
            }
      ...
      public GXBCLevelCollection<SdtCustomer_Locations> gxTpr_Locations_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtCustomer_Locations == null )
            {
               gxTv_SdtCustomer_Locations = new GXBCLevelCollection<SdtCustomer_Locations>( context, "Customer.Locations", "Comforta11");
            }
   ...
   [DataContract(Name = @"Customer", Namespace = "Comforta11")]
