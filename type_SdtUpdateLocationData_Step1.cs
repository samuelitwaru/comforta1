/*
				   File: type_SdtUpdateLocationData_Step1
			Description: Step1
...
{
	[XmlRoot(ElementName="UpdateLocationData.Step1")]
	[XmlType(TypeName="UpdateLocationData.Step1" , Namespace="Comforta11" )]
	[Serializable]
	public class SdtUpdateLocationData_Step1 : GxUserType
	{
		public SdtUpdateLocationData_Step1( )
		{
			/* Constructor for serialization */
			gxTv_SdtUpdateLocationData_Step1_Customerlocationname = "";

			gxTv_SdtUpdateLocationData_Step1_Customerlocationemail = "";

			gxTv_SdtUpdateLocationData_Step1_Customerlocationphone = "";

			gxTv_SdtUpdateLocationData_Step1_Customerlocationpostaladdress = "";

			gxTv_SdtUpdateLocationData_Step1_Customerlocationvisitingaddress = "";

			gxTv_SdtUpdateLocationData_Step1_Customerlocationdescription = "";

		}

		public SdtUpdateLocationData_Step1(IGxContext context)
		{
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationname; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationname = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationid; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationid = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationemail; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationemail = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationphone; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationphone = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationpostaladdress; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationpostaladdress = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationvisitingaddress; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationvisitingaddress = value;
		...
		{
			get {
				return gxTv_SdtUpdateLocationData_Step1_Customerlocationdescription; 
			}
			set {
				gxTv_SdtUpdateLocationData_Step1_Customerlocationdescription = value;
		...
		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationname;
		 

		protected short gxTv_SdtUpdateLocationData_Step1_Customerlocationid;
		 

		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationemail;
		 

		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationphone;
		 

		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationpostaladdress;
		 

		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationvisitingaddress;
		 

		protected string gxTv_SdtUpdateLocationData_Step1_Customerlocationdescription;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"UpdateLocationData.Step1", Namespace="Comforta11")]
	public class SdtUpdateLocationData_Step1_RESTInterface : GxGenericCollectionItem<SdtUpdateLocationData_Step1>, System.Web.SessionState.IRequiresSessionState
	{
		public SdtUpdateLocationData_Step1_RESTInterface( ) : base()
		{	
		}

		public SdtUpdateLocationData_Step1_RESTInterface( SdtUpdateLocationData_Step1 psdt ) : base(psdt)
		{	
		}
		...
		public SdtUpdateLocationData_Step1 sdt
		{
			get { 
				return (SdtUpdateLocationData_Step1)Sdt;
			}
			set { 
				Sdt = value;
			}
		...
		void checkSdt( StreamingContext ctx )
		{
			if ( sdt == null )
			{
				sdt = new SdtUpdateLocationData_Step1() ;
			}
		}
	}
	#endregion
