...
namespace GeneXus.Programs {
   public class applicationdesign : GXDataArea
   {
      ...
      {
         get {
            return "applicationdesign_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("applicationdesign.aspx") +"\">") ;
      ...
      {
         return formatLink("applicationdesign.aspx")  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714331169", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("applicationdesign.js", "?202482714331170", false, true);
            context.AddJavascriptSource("UserControls/UCPageTreeRender.js", "", false, true);
         }
