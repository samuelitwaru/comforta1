...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Supplier_Gen" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtSupplier_Gen : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtSupplier_Gen_ProductService> gxTpr_Productservice_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtSupplier_Gen_Productservice == null )
            {
               gxTv_SdtSupplier_Gen_Productservice = new GXBCLevelCollection<SdtSupplier_Gen_ProductService>( context, "Supplier_Gen.ProductService", "Comforta11");
            }
   ...
   [DataContract(Name = @"Supplier_Gen", Namespace = "Comforta11")]
