...
namespace GeneXus.Programs {
   public class residenttypewwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         residenttypewwgetfilterdata objresidenttypewwgetfilterdata;
         objresidenttypewwgetfilterdata = new residenttypewwgetfilterdata();
         objresidenttypewwgetfilterdata.AV31DDOName = aP0_DDOName;
         objresidenttypewwgetfilterdata.AV32SearchTxtParms = aP1_SearchTxtParms;
         objresidenttypewwgetfilterdata.AV33SearchTxtTo = aP2_SearchTxtTo;
         objresidenttypewwgetfilterdata.AV34OptionsJson = "" ;
         objresidenttypewwgetfilterdata.AV35OptionsDescJson = "" ;
         objresidenttypewwgetfilterdata.AV36OptionIndexesJson = "" ;
         objresidenttypewwgetfilterdata.context.SetSubmitInitialConfig(context);
         objresidenttypewwgetfilterdata.initialize();
         Submit( executePrivateCatch,objresidenttypewwgetfilterdata);
         aP3_OptionsJson=this.AV34OptionsJson;
         aP4_OptionsDescJson=this.AV35OptionsDescJson;
         aP5_OptionIndexesJson=this.AV36OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((residenttypewwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
