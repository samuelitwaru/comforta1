...
namespace GeneXus.Programs {
   public class customercustomization : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A3CustomerName, StringUtil.RTrim( context.localUtil.Format( A3CustomerName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_CustomerCustomization.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Single line edit */
         GxWebStd.gx_single_line_edit( context, edtCustomerCustomizationId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A128CustomerCustomizationId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtCustomerCustomizationId_Enabled!=0) ? context.localUtil.Format( (decimal)(A128CustomerCustomizationId), "ZZZ9") : context.localUtil.Format( (decimal)(A128CustomerCustomizationId), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerCustomizationId_Jsonclick, 0, "Attribute", "", "", "", "", edtCustomerCustomizationId_Visible, edtCustomerCustomizationId_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_CustomerCustomization.htm");
         /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714313250", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customercustomization.js", "?202482714313252", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV10TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true},{av:'AV22CustomerCustomizationId',fld:'vCUSTOMERCUSTOMIZATIONID',pic:'ZZZ9',hsh:true},{av:'A128CustomerCustomizationId',fld:'CUSTOMERCUSTOMIZATIONID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("AFTER TRN","{handler:'E120H2',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV10TrnContext',fld:'vTRNCONTEXT',pic:'',hsh:true}]");
         setEventMetadata("AFTER TRN",",oparms:[]}");
         setEventMetadata("CUSTOMERCUSTOMIZATIONFONTSIZE.CONTROLVALUECHANGED","{handler:'E130H2',iparms:[{av:'cmbCustomerCustomizationFontSize'},{av:'A132CustomerCustomizationFontSize',fld:'CUSTOMERCUSTOMIZATIONFONTSIZE',pic:''}]");
         setEventMetadata("CUSTOMERCUSTOMIZATIONFONTSIZE.CONTROLVALUECHANGED",",oparms:[]}");
         setEventMetadata("VALID_CUSTOMERID","{handler:'Valid_Customerid',iparms:[{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9'},{av:'A3CustomerName',fld:'CUSTOMERNAME',pic:''}]");
