...
namespace GeneXus.Programs {
   public class gx0090 : GXDataArea
   {
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtSupplier_GenId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenId_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtSupplier_GenKvKNumber_Enabled = 0;
         AssignProp("", false, edtSupplier_GenKvKNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenKvKNumber_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtSupplier_GenCompanyName_Enabled = 0;
         AssignProp("", false, edtSupplier_GenCompanyName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenCompanyName_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         edtSupplier_GenContactName_Enabled = 0;
         AssignProp("", false, edtSupplier_GenContactName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_GenContactName_Enabled), 5, 0), !bGXsfl_64_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915584431", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0090.js", "?202481915584431", false, true);
