...
namespace GeneXus.Programs {
   public class agendacalendar : GXDataArea
   {
      ...
      public agendacalendar( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("agendacalendar.aspx") +"\">") ;
      ...
      {
         return formatLink("agendacalendar.aspx")  ;
      }
      ...
      {
         return context.GetMessage( "Agenda Calendar", "") ;
      }
      ...
      protected void WB3M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncreateevent_Internalname, "", context.GetMessage( "WWP_Calendar_CreateEvent", ""), bttBtncreateevent_Jsonclick, 5, context.GetMessage( "WWP_Calendar_CreateEvent", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOCREATEEVENT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWwp_search_Internalname, context.GetMessage( "WWP_Search", ""), "", "", lblWwp_search_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, 0, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockdatetypefilter_Internalname, context.GetMessage( "WWP_Calendar_Date", ""), "", "", lblTextblockdatetypefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDatetypefilter, cmbavDatetypefilter_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV20DateTypeFilter), 4, 0)), 1, cmbavDatetypefilter_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e113m1_client"+"'", "int", "", 1, cmbavDatetypefilter.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "", true, 0, "HLP_AgendaCalendar.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuaclear_Internalname, "", context.GetMessage( "WWP_Calendar_Clear", ""), bttBtnuaclear_Jsonclick, 5, context.GetMessage( "WWP_Calendar_Clear", ""), "", StyleString, ClassString, bttBtnuaclear_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUACLEAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuasearch_Internalname, "", context.GetMessage( "WWP_Calendar_Search", ""), bttBtnuasearch_Jsonclick, 5, context.GetMessage( "WWP_Calendar_Search", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUASEARCH\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndummydelete_Internalname, "", context.GetMessage( "Dummy Delete Event", ""), bttBtndummydelete_Jsonclick, 7, context.GetMessage( "Dummy Delete Event", ""), "", StyleString, ClassString, bttBtndummydelete_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e123m1_client"+"'", TempTags, "", 2, "HLP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, edtavDate_showingdatesfrom_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((edtavDate_showingdatesfrom_Visible==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_AgendaCalendar.htm");
            context.WriteHtmlTextNl( "</div>") ;
            wb_table1_52_3M2( true) ;
         }
         else
         {
            wb_table1_52_3M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_52_3M2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_57_3M2( true) ;
         }
         else
         {
            wb_table2_57_3M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_57_3M2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void START3M2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Agenda Calendar", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void S152( )
      {
         ...
         if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV31LoadedDotsFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV32LoadedDotsToDate ) ) )
         {
            ...
            if ( ( DateTimeUtil.ResetTime ( AV23DotsFromDate ) < DateTimeUtil.ResetTime ( AV33LoadedFromDate ) ) || ( DateTimeUtil.ResetTime ( AV24DotsToDate ) > DateTimeUtil.ResetTime ( AV34LoadedToDate ) ) )
            {
               ...
               AV26EventsAux = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta11");
            }
            else
            {
               GXt_SdtWWPDateRangePickerOptions5 = AV37WWPDateRangePickerOptions;
      ...
      protected void E263M2( )
      {
         /* Load Routine */
         returnInSub = false;
      }

      protected void wb_table2_57_3M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_57_3M2e( true) ;
         }
         else
         {
            wb_table2_57_3M2e( false) ;
         }
      }

      protected void wb_table1_52_3M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_52_3M2e( true) ;
         }
         else
         {
            wb_table1_52_3M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20248244151437", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("agendacalendar.js", "?20248244151437", false, true);
         context.AddJavascriptSource("DVelop/Calendar/index.global.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Calendar/WWPCalendarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/locales.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/wwp-daterangepicker.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Agenda Calendar", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDUMMYDELETE.CLOSE",",oparms:[{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("'DOCREATEEVENT'","{handler:'E213M2',iparms:[{av:'AV12Date',fld:'vDATE',pic:''}]");
         setEventMetadata("'DOCREATEEVENT'",",oparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!'},{av:'AV9CalendarEventsJson',fld:'vCALENDAREVENTSJSON',pic:''}]}");
         setEventMetadata("'DOUACLEAR'","{handler:'E223M2',iparms:[{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV10CalendarLoadFromDate',fld:'vCALENDARLOADFROMDATE',pic:''},{av:'AV11CalendarLoadToDate',fld:'vCALENDARLOADTODATE',pic:''},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("'DOUACLEAR'",",oparms:[{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'AV12Date',fld:'vDATE',pic:''},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{ctrl:'BTNDUMMYDELETE',prop:'Visible'},{ctrl:'BTNUACLEAR',prop:'Visible'},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("'DOUASEARCH'","{handler:'E233M2',iparms:[{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV10CalendarLoadFromDate',fld:'vCALENDARLOADFROMDATE',pic:''},{av:'AV11CalendarLoadToDate',fld:'vCALENDARLOADTODATE',pic:''},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("'DOUASEARCH'",",oparms:[{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{ctrl:'BTNDUMMYDELETE',prop:'Visible'},{ctrl:'BTNUACLEAR',prop:'Visible'},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("CREATEEVENT_MODAL.CLOSE","{handler:'E183M2',iparms:[{av:'Createevent_modal_Result',ctrl:'CREATEEVENT_MODAL',prop:'Result'},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV10CalendarLoadFromDate',fld:'vCALENDARLOADFROMDATE',pic:''},{av:'AV11CalendarLoadToDate',fld:'vCALENDARLOADTODATE',pic:''},{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'AV7CalendarEventId',fld:'vCALENDAREVENTID',pic:''},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("CREATEEVENT_MODAL.CLOSE",",oparms:[{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'Dvelop_confirmpanel_btndummydelete_Confirmationtext',ctrl:'DVELOP_CONFIRMPANEL_BTNDUMMYDELETE',prop:'ConfirmationText'},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("VDATE.CONTROLVALUECHANGED","{handler:'E243M2',iparms:[{av:'AV12Date',fld:'vDATE',pic:''}]");
         setEventMetadata("VDATE.CONTROLVALUECHANGED",",oparms:[{av:'AV6CalendarCurrentDate',fld:'vCALENDARCURRENTDATE',pic:''}]}");
         setEventMetadata("CALENDARUC.EVENTDATEUPDATED","{handler:'E143M2',iparms:[{av:'Calendaruc_Datetimeselected',ctrl:'CALENDARUC',prop:'DateTimeSelected'},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV10CalendarLoadFromDate',fld:'vCALENDARLOADFROMDATE',pic:''},{av:'AV11CalendarLoadToDate',fld:'vCALENDARLOADTODATE',pic:''},{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("CALENDARUC.EVENTDATEUPDATED",",oparms:[{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("CALENDARUC.EVENTSELECTED","{handler:'E133M2',iparms:[{av:'Calendaruc_Itemselected',ctrl:'CALENDARUC',prop:'ItemSelected'}]");
         setEventMetadata("CALENDARUC.EVENTSELECTED",",oparms:[{av:'AV7CalendarEventId',fld:'vCALENDAREVENTID',pic:''},{av:'Gx_mode',fld:'vMODE',pic:'@!'}]}");
         setEventMetadata("CALENDARUC.DELETEEVENT","{handler:'E153M2',iparms:[{av:'Calendaruc_Itemselected',ctrl:'CALENDARUC',prop:'ItemSelected'},{av:'AV7CalendarEventId',fld:'vCALENDAREVENTID',pic:''}]");
         setEventMetadata("CALENDARUC.DELETEEVENT",",oparms:[{av:'AV7CalendarEventId',fld:'vCALENDAREVENTID',pic:''},{av:'Dvelop_confirmpanel_btndummydelete_Confirmationtext',ctrl:'DVELOP_CONFIRMPANEL_BTNDUMMYDELETE',prop:'ConfirmationText'}]}");
         setEventMetadata("CALENDARUC.VISIBLEDATESCHANGED","{handler:'E163M2',iparms:[{av:'AV10CalendarLoadFromDate',fld:'vCALENDARLOADFROMDATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV11CalendarLoadToDate',fld:'vCALENDARLOADTODATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV6CalendarCurrentDate',fld:'vCALENDARCURRENTDATE',pic:''},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'Calendaruc_Filtermode',ctrl:'CALENDARUC',prop:'FilterMode'},{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'},{av:'Gx_date',fld:'vTODAY',pic:'',hsh:true},{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'AV36TitleFilter',fld:'vTITLEFILTER',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("CALENDARUC.VISIBLEDATESCHANGED",",oparms:[{av:'AV12Date',fld:'vDATE',pic:''},{av:'AV29ForceLoadDots',fld:'vFORCELOADDOTS',pic:''},{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'AV25Events',fld:'vEVENTS',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV21DisabledDays',fld:'vDISABLEDDAYS',pic:''},{av:'AV22DisabledDaysJson',fld:'vDISABLEDDAYSJSON',pic:''},{av:'AV19DateToSearchFrom',fld:'vDATETOSEARCHFROM',pic:''},{av:'AV18DatesToSearchTo',fld:'vDATESTOSEARCHTO',pic:''}]}");
         setEventMetadata("VDATE_SHOWINGDATESFROM.CONTROLVALUECHANGED","{handler:'E253M2',iparms:[{av:'AV27EventsLoaded',fld:'vEVENTSLOADED',pic:''},{av:'AV13Date_ShowingDatesFrom',fld:'vDATE_SHOWINGDATESFROM',pic:''},{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''},{av:'AV33LoadedFromDate',fld:'vLOADEDFROMDATE',pic:''},{av:'AV34LoadedToDate',fld:'vLOADEDTODATE',pic:''},{av:'Calendaruc_Defaulteventstyle',ctrl:'CALENDARUC',prop:'DefaultEventStyle'},{av:'AV25Events',fld:'vEVENTS',pic:''}]");
         setEventMetadata("VDATE_SHOWINGDATESFROM.CONTROLVALUECHANGED",",oparms:[{av:'AV31LoadedDotsFromDate',fld:'vLOADEDDOTSFROMDATE',pic:''},{av:'AV32LoadedDotsToDate',fld:'vLOADEDDOTSTODATE',pic:''}]}");
         setEventMetadata("VDATETYPEFILTER.CLICK","{handler:'E113M1',iparms:[{av:'cmbavDatetypefilter'},{av:'AV20DateTypeFilter',fld:'vDATETYPEFILTER',pic:'ZZZ9'}]");
         setEventMetadata("VDATETYPEFILTER.CLICK",",oparms:[{av:'AV14DateFilter',fld:'vDATEFILTER',pic:''},{av:'AV15DateRangeFilter',fld:'vDATERANGEFILTER',pic:''},{av:'AV17DateRangeFilter_To',fld:'vDATERANGEFILTER_TO',pic:''},{av:'edtavDaterangefilter_rangetext_Visible',ctrl:'vDATERANGEFILTER_RANGETEXT',prop:'Visible'},{av:'divDaterangefilter_rangetext_cell_Class',ctrl:'DATERANGEFILTER_RANGETEXT_CELL',prop:'Class'},{av:'edtavDatefilter_Visible',ctrl:'vDATEFILTER',prop:'Visible'},{av:'divDatefilter_cell_Class',ctrl:'DATEFILTER_CELL',prop:'Class'}]}");
         setEventMetadata("VALIDV_DATETYPEFILTER","{handler:'Validv_Datetypefilter',iparms:[]");
         setEventMetadata("VALIDV_DATETYPEFILTER",",oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         AV25Events = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta11");
         ...
         GXt_objcol_SdtWWP_Calendar_Events_Item3 = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWP_Calendar_Events_Item>( context, "Item", "Comforta11");
