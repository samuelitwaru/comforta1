...
namespace GeneXus.Programs {
   public class supplier_agbloaddvcombo : GXProcedure
   {
      ...
      {
         get {
            return "supplier_agb_Services_Execute" ;
         }

      }

      public supplier_agbloaddvcombo( )
      {
      ...
      public supplier_agbloaddvcombo( IGxContext context )
      {
                           ...
                           out string aP7_Combo_DataJson )
      {
         ...
         this.AV20Supplier_AgbId = aP3_Supplier_AgbId;
      ...
      public string executeUdp( string aP0_ComboName ,
                                ...
                                out string aP6_SelectedText )
      {
         execute(aP0_ComboName, aP1_TrnMode, aP2_IsDynamicCall, aP3_Supplier_AgbId, aP4_SearchTxtParms, out aP5_SelectedValue, out aP6_SelectedText, out aP7_Combo_DataJson);
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP7_Combo_DataJson )
      {
         supplier_agbloaddvcombo objsupplier_agbloaddvcombo;
         objsupplier_agbloaddvcombo = new supplier_agbloaddvcombo();
         objsupplier_agbloaddvcombo.AV17ComboName = aP0_ComboName;
         objsupplier_agbloaddvcombo.AV18TrnMode = aP1_TrnMode;
         objsupplier_agbloaddvcombo.AV19IsDynamicCall = aP2_IsDynamicCall;
         objsupplier_agbloaddvcombo.AV20Supplier_AgbId = aP3_Supplier_AgbId;
         objsupplier_agbloaddvcombo.AV21SearchTxtParms = aP4_SearchTxtParms;
         objsupplier_agbloaddvcombo.AV22SelectedValue = "" ;
         objsupplier_agbloaddvcombo.AV23SelectedText = "" ;
         objsupplier_agbloaddvcombo.AV24Combo_DataJson = "" ;
         objsupplier_agbloaddvcombo.context.SetSubmitInitialConfig(context);
         objsupplier_agbloaddvcombo.initialize();
         Submit( executePrivateCatch,objsupplier_agbloaddvcombo);
         aP5_SelectedValue=this.AV22SelectedValue;
         aP6_SelectedText=this.AV23SelectedText;
         aP7_Combo_DataJson=this.AV24Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((supplier_agbloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
         ...
         if ( AV19IsDynamicCall )
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "GET_DSC") == 0 )
            {
               ...
               while ( AV32GXV1 <= AV29ValuesCollection.Count )
               {
                  ...
                  {
                     A73ProductServiceId = P002E2_A73ProductServiceId[0];
                     A74ProductServiceName = P002E2_A74ProductServiceName[0];
                     AV33GXLvl29 = 1;
            ...
            else
            {
               ...
               {
                  A74ProductServiceName = P002E3_A74ProductServiceName[0];
                  A73ProductServiceId = P002E3_A73ProductServiceId[0];
      ...
      public override void initialize( )
      {
         ...
         AV30ValueItem = "";
         scmdbuf = "";
         P002E2_A73ProductServiceId = new short[1] ;
         P002E2_A74ProductServiceName = new string[] {""} ;
         A74ProductServiceName = "";
         lV14SearchTxt = "";
         P002E3_A74ProductServiceName = new string[] {""} ;
         P002E3_A73ProductServiceId = new short[1] ;
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV15Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier_agbloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P002E2_A73ProductServiceId, P002E2_A74ProductServiceName
               }
               , new Object[] {
               P002E3_A74ProductServiceName, P002E3_A73ProductServiceId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV20Supplier_AgbId ;
      ...
      private short[] P002E2_A73ProductServiceId ;
      private string[] P002E2_A74ProductServiceName ;
      private string[] P002E3_A74ProductServiceName ;
      private short[] P002E3_A73ProductServiceId ;
   ...
   public class supplier_agbloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_P002E3(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P002E2", "SELECT ProductServiceId, ProductServiceName FROM ProductService WHERE ProductServiceId = :AV31ProductServiceId_Filter ORDER BY ProductServiceId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002E2,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P002E3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP002E3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
