...
namespace GeneXus.Programs {
   public class amenitiestypewwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         amenitiestypewwgetfilterdata objamenitiestypewwgetfilterdata;
         objamenitiestypewwgetfilterdata = new amenitiestypewwgetfilterdata();
         objamenitiestypewwgetfilterdata.AV31DDOName = aP0_DDOName;
         objamenitiestypewwgetfilterdata.AV32SearchTxtParms = aP1_SearchTxtParms;
         objamenitiestypewwgetfilterdata.AV33SearchTxtTo = aP2_SearchTxtTo;
         objamenitiestypewwgetfilterdata.AV34OptionsJson = "" ;
         objamenitiestypewwgetfilterdata.AV35OptionsDescJson = "" ;
         objamenitiestypewwgetfilterdata.AV36OptionIndexesJson = "" ;
         objamenitiestypewwgetfilterdata.context.SetSubmitInitialConfig(context);
         objamenitiestypewwgetfilterdata.initialize();
         Submit( executePrivateCatch,objamenitiestypewwgetfilterdata);
         aP3_OptionsJson=this.AV34OptionsJson;
         aP4_OptionsDescJson=this.AV35OptionsDescJson;
         aP5_OptionIndexesJson=this.AV36OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((amenitiestypewwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRK372 = false;
            A109AmenitiesTypeName = P00372_A109AmenitiesTypeName[0];
            A108AmenitiesTypeId = P00372_A108AmenitiesTypeId[0];
            AV25count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00372_A109AmenitiesTypeName[0], A109AmenitiesTypeName) == 0 ) )
            {
               BRK372 = false;
               A108AmenitiesTypeId = P00372_A108AmenitiesTypeId[0];
            ...
            if ( (0==AV16SkipItems) )
            {
               AV20Option = (String.IsNullOrEmpty(StringUtil.RTrim( A109AmenitiesTypeName)) ? "<#Empty#>" : A109AmenitiesTypeName);
      ...
      public override void initialize( )
      {
         ...
         A109AmenitiesTypeName = "";
         P00372_A109AmenitiesTypeName = new string[] {""} ;
         P00372_A108AmenitiesTypeId = new short[1] ;
         AV20Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.amenitiestypewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00372_A109AmenitiesTypeName, P00372_A108AmenitiesTypeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00372_A109AmenitiesTypeName ;
      private short[] P00372_A108AmenitiesTypeId ;
   ...
   public class amenitiestypewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00372(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
