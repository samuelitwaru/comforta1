...
namespace GeneXus.Programs {
   public class getloggedinusercustomerid : GXProcedure
   {
      ...
      {
         getloggedinusercustomerid objgetloggedinusercustomerid;
         objgetloggedinusercustomerid = new getloggedinusercustomerid();
         objgetloggedinusercustomerid.AV9CustomerId = 0 ;
         objgetloggedinusercustomerid.context.SetSubmitInitialConfig(context);
         objgetloggedinusercustomerid.initialize();
         Submit( executePrivateCatch,objgetloggedinusercustomerid);
         aP0_CustomerId=this.AV9CustomerId;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getloggedinusercustomerid)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
