...
namespace GeneXus.Programs {
   public class pageloaddvcombo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP7_Combo_DataJson )
      {
         pageloaddvcombo objpageloaddvcombo;
         objpageloaddvcombo = new pageloaddvcombo();
         objpageloaddvcombo.AV17ComboName = aP0_ComboName;
         objpageloaddvcombo.AV18TrnMode = aP1_TrnMode;
         objpageloaddvcombo.AV19IsDynamicCall = aP2_IsDynamicCall;
         objpageloaddvcombo.AV20PageId = aP3_PageId;
         objpageloaddvcombo.AV21SearchTxtParms = aP4_SearchTxtParms;
         objpageloaddvcombo.AV22SelectedValue = "" ;
         objpageloaddvcombo.AV23SelectedText = "" ;
         objpageloaddvcombo.AV24Combo_DataJson = "" ;
         objpageloaddvcombo.context.SetSubmitInitialConfig(context);
         objpageloaddvcombo.initialize();
         Submit( executePrivateCatch,objpageloaddvcombo);
         aP5_SelectedValue=this.AV22SelectedValue;
         aP6_SelectedText=this.AV23SelectedText;
         aP7_Combo_DataJson=this.AV24Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((pageloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A41CustomerKvkNumber = P00342_A41CustomerKvkNumber[0];
               A1CustomerId = P00342_A1CustomerId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  {
                     A98PageId = P00343_A98PageId[0];
                     A1CustomerId = P00343_A1CustomerId[0];
                     A41CustomerKvkNumber = P00343_A41CustomerKvkNumber[0];
                     A41CustomerKvkNumber = P00343_A41CustomerKvkNumber[0];
               ...
               else
               {
                  ...
                  {
                     A1CustomerId = P00344_A1CustomerId[0];
                     A41CustomerKvkNumber = P00344_A41CustomerKvkNumber[0];
                     AV23SelectedText = A41CustomerKvkNumber;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         lV14SearchTxt = "";
         A41CustomerKvkNumber = "";
         P00342_A41CustomerKvkNumber = new string[] {""} ;
         P00342_A1CustomerId = new short[1] ;
         AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         AV15Combo_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         P00343_A98PageId = new short[1] ;
         P00343_A1CustomerId = new short[1] ;
         P00343_A41CustomerKvkNumber = new string[] {""} ;
         P00344_A1CustomerId = new short[1] ;
         P00344_A41CustomerKvkNumber = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pageloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00342_A41CustomerKvkNumber, P00342_A1CustomerId
               }
               , new Object[] {
               P00343_A98PageId, P00343_A1CustomerId, P00343_A41CustomerKvkNumber
               }
               , new Object[] {
               P00344_A1CustomerId, P00344_A41CustomerKvkNumber
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00342_A41CustomerKvkNumber ;
      private short[] P00342_A1CustomerId ;
      private short[] P00343_A98PageId ;
      private short[] P00343_A1CustomerId ;
      private string[] P00343_A41CustomerKvkNumber ;
      private short[] P00344_A1CustomerId ;
      private string[] P00344_A41CustomerKvkNumber ;
   ...
   public class pageloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00342(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00342", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00342,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00343", "SELECT T1.PageId, T1.CustomerId, T2.CustomerKvkNumber FROM (Page T1 INNER JOIN Customer T2 ON T2.CustomerId = T1.CustomerId) WHERE T1.PageId = :AV20PageId ORDER BY T1.PageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00343,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00344", "SELECT CustomerId, CustomerKvkNumber FROM Customer WHERE CustomerId = :AV28CustomerId ORDER BY CustomerId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00344,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
