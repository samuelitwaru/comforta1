...
namespace GeneXus.Programs {
   public class wwp_masterpageselectlanguage : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714301344", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwp_masterpageselectlanguage.js", "?202482714301346", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOACTIONCHANGEPASSWORD'","{handler:'E123H2',iparms:[]");
         setEventMetadata("'DOACTIONCHANGEPASSWORD'",",oparms:[]}");
         setEventMetadata("'DOLOGOUT'","{handler:'E133H2',iparms:[]");
         setEventMetadata("'DOLOGOUT'",",oparms:[]}");
         setEventMetadata("'SELECTDUTCH'","{handler:'E143H2',iparms:[]");
         setEventMetadata("'SELECTDUTCH'",",oparms:[]}");
         setEventMetadata("'SELECTENGLISH'","{handler:'E153H2',iparms:[]");
         setEventMetadata("'SELECTENGLISH'",",oparms:[]}");
         return  ;
      }
