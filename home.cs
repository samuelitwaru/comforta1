...
namespace GeneXus.Programs {
   public class home : GXDataArea
   {
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavOptiontitle_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavOptiontitle_Enabled), 5, 0), !bGXsfl_12_Refreshing);
      }
      ...
      protected void E110Z2( )
      {
         ...
         new getuserdashboarditems(context ).execute( out  GXt_objcol_SdtHomeModulesSDT_HomeModulesSDTItem1) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915571971", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("home.js", "?202481915571972", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDHOMEMODULESSDTS_nFirstRecordOnPage'},{av:'GRIDHOMEMODULESSDTS_nEOF'},{av:'edtavOptionlink_Visible',ctrl:'vOPTIONLINK',prop:'Visible'},{av:'AV6HomeModulesSDT',fld:'vHOMEMODULESSDT',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDHOMEMODULESSDTS.LOAD","{handler:'E120Z2',iparms:[{av:'AV6HomeModulesSDT',fld:'vHOMEMODULESSDT',pic:'',hsh:true}]");
         setEventMetadata("GRIDHOMEMODULESSDTS.LOAD",",oparms:[{av:'AV5OptionLink',fld:'vOPTIONLINK',pic:''},{av:'lblLayoutoptionandtitleoptionicon_Caption',ctrl:'LAYOUTOPTIONANDTITLEOPTIONICON',prop:'Caption'},{av:'AV7OptionTitle',fld:'vOPTIONTITLE',pic:''},{av:'divLayoutoptionandtitletablecell_Visible',ctrl:'LAYOUTOPTIONANDTITLETABLECELL',prop:'Visible'},{av:'divLayoutprogressbartablecell_Visible',ctrl:'LAYOUTPROGRESSBARTABLECELL',prop:'Visible'},{av:'divLayoutprogresscircletablecell_Visible',ctrl:'LAYOUTPROGRESSCIRCLETABLECELL',prop:'Visible'},{av:'divLayoutcustomwctablecell_Visible',ctrl:'LAYOUTCUSTOMWCTABLECELL',prop:'Visible'},{ctrl:'LAYOUTPROGRESSBARWC'},{ctrl:'LAYOUTPROGRESSCIRCLEWC'}]}");
      ...
      public override void initialize( )
      {
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV6HomeModulesSDT = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta11");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         WebComp_Layoutprogressbarwc_Component = "";
         WebComp_Layoutprogresscirclewc_Component = "";
         GXt_objcol_SdtHomeModulesSDT_HomeModulesSDTItem1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeModulesSDT_HomeModulesSDTItem>( context, "HomeModulesSDTItem", "Comforta11");
