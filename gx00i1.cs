...
namespace GeneXus.Programs {
   public class gx00i1 : GXDataArea
   {
      public gx00i1( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV7pResidentId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV7pResidentId", StringUtil.LTrimStr( (decimal)(AV7pResidentId), 4, 0));
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7pResidentId = (short)(Math.Round(NumberUtil.Val( GetPar( "pResidentId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProductServiceId, AV7pResidentId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00i1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pResidentId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pResidentId","pProductServiceId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRESIDENTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pResidentId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("gx00i1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pResidentId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pResidentId","pProductServiceId"})  ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductserviceidfilter_Internalname, context.GetMessage( "Product Service Id", ""), "", "", lblLblproductserviceidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00I1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120d1_client"+"'", TempTags, "", 2, "HLP_Gx00I1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00I1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {AV7pResidentId, AV6cProductServiceId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A31ResidentId = H000D2_A31ResidentId[0];
               A73ProductServiceId = H000D2_A73ProductServiceId[0];
               /* Execute user event: Load */
               E140D2 ();
      ...
      {
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {AV7pResidentId, AV6cProductServiceId});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp("", false, edtResidentId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentId_Enabled), 5, 0), !bGXsfl_24_Refreshing);
         fix_multi_value_controls( ) ;
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pResidentId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pResidentId", StringUtil.LTrimStr( (decimal)(AV7pResidentId), 4, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915584577", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00i1.js", "?202481915584577", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E120D1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E150D2',iparms:[{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pProductServiceId',fld:'vPPRODUCTSERVICEID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pResidentId',fld:'vPRESIDENTID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000D2_A31ResidentId = new short[1] ;
         H000D2_A73ProductServiceId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00i1__default(),
            new Object[][] {
                new Object[] {
               H000D2_A31ResidentId, H000D2_A73ProductServiceId
               }
               , new Object[] {
      ...
      private short AV7pResidentId ;
      private short AV8pProductServiceId ;
      private short wcpOAV7pResidentId ;
      ...
      private short[] H000D2_A31ResidentId ;
      private short[] H000D2_A73ProductServiceId ;
   ...
   public class gx00i1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV7pResidentId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT ResidentId, ProductServiceId FROM ResidentProductService WHERE ResidentId = :AV7pResidentId and ProductServiceId >= :AV6cProductServiceId ORDER BY ResidentId, ProductServiceId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000D3", "SELECT COUNT(*) FROM ResidentProductService WHERE ResidentId = :AV7pResidentId and ProductServiceId >= :AV6cProductServiceId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
