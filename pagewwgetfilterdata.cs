...
namespace GeneXus.Programs {
   public class pagewwgetfilterdata : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_DDOName ,
                                 ...
                                 out string aP5_OptionIndexesJson )
      {
         pagewwgetfilterdata objpagewwgetfilterdata;
         objpagewwgetfilterdata = new pagewwgetfilterdata();
         objpagewwgetfilterdata.AV41DDOName = aP0_DDOName;
         objpagewwgetfilterdata.AV42SearchTxtParms = aP1_SearchTxtParms;
         objpagewwgetfilterdata.AV43SearchTxtTo = aP2_SearchTxtTo;
         objpagewwgetfilterdata.AV44OptionsJson = "" ;
         objpagewwgetfilterdata.AV45OptionsDescJson = "" ;
         objpagewwgetfilterdata.AV46OptionIndexesJson = "" ;
         objpagewwgetfilterdata.context.SetSubmitInitialConfig(context);
         objpagewwgetfilterdata.initialize();
         Submit( executePrivateCatch,objpagewwgetfilterdata);
         aP3_OptionsJson=this.AV44OptionsJson;
         aP4_OptionsDescJson=this.AV45OptionsDescJson;
         aP5_OptionIndexesJson=this.AV46OptionIndexesJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((pagewwgetfilterdata)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      protected void S121( )
      {
         ...
         {
            BRK332 = false;
            A99PageName = P00332_A99PageName[0];
            A1CustomerId = P00332_A1CustomerId[0];
            A98PageId = P00332_A98PageId[0];
            AV35count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00332_A99PageName[0], A99PageName) == 0 ) )
            {
               BRK332 = false;
               A98PageId = P00332_A98PageId[0];
            ...
            if ( (0==AV26SkipItems) )
            {
               AV30Option = (String.IsNullOrEmpty(StringUtil.RTrim( A99PageName)) ? "<#Empty#>" : A99PageName);
      ...
      public override void initialize( )
      {
         ...
         A99PageName = "";
         P00332_A99PageName = new string[] {""} ;
         P00332_A1CustomerId = new short[1] ;
         P00332_A98PageId = new short[1] ;
         AV30Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.pagewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00332_A99PageName, P00332_A1CustomerId, P00332_A98PageId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string[] P00332_A99PageName ;
      private short[] P00332_A1CustomerId ;
      private short[] P00332_A98PageId ;
   ...
   public class pagewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00332(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] );
         }
