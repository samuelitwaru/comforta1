...
namespace GeneXus.Programs {
   public class supplier_agbsupplier_agbcustomerwc : GXWebComponent
   {
      public supplier_agbsupplier_agbcustomerwc( )
      {
      ...
      public supplier_agbsupplier_agbcustomerwc( IGxContext context )
      {
      ...
      {
         this.AV8Supplier_AgbId = aP0_Supplier_AgbId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8Supplier_AgbId = (short)(Math.Round(NumberUtil.Val( GetPar( "Supplier_AgbId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV8Supplier_AgbId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8Supplier_AgbId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8Supplier_AgbId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_CustomerTypeName, AV32IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "Supplier_AgbSupplier_AgbCustomerWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Supplier_Agb Supplier_Agb Customer WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplier_agbsupplier_agbcustomerwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8Supplier_AgbId,4,0))}, new string[] {"Supplier_AgbId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8Supplier_AgbId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8Supplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV32IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vSUPPLIER_AGBID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Supplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "Supplier_AgbSupplier_AgbCustomerWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Supplier_Agb Supplier_Agb Customer WC", "") ;
      }
      ...
      protected void WB290( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "supplier_agbsupplier_agbcustomerwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtSupplier_AgbId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A55Supplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A55Supplier_AgbId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplier_AgbId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplier_AgbId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_Supplier_AgbSupplier_AgbCustomerWC.htm");
            /* User Defined Control */
      ...
      protected void START292( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Supplier_Agb Supplier_Agb Customer WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RF292( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H00292 */
            pr_default.execute(0, new Object[] {AV8Supplier_AgbId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A55Supplier_AgbId = H00292_A55Supplier_AgbId[0];
               AssignAttri(sPrefix, false, "A55Supplier_AgbId", StringUtil.LTrimStr( (decimal)(A55Supplier_AgbId), 4, 0));
               A79CustomerTypeName = H00292_A79CustomerTypeName[0];
               A78CustomerTypeId = H00292_A78CustomerTypeId[0];
               n78CustomerTypeId = H00292_n78CustomerTypeId[0];
               A14CustomerVatNumber = H00292_A14CustomerVatNumber[0];
               A7CustomerPhone = H00292_A7CustomerPhone[0];
               n7CustomerPhone = H00292_n7CustomerPhone[0];
               A6CustomerVisitingAddress = H00292_A6CustomerVisitingAddress[0];
               n6CustomerVisitingAddress = H00292_n6CustomerVisitingAddress[0];
               A5CustomerEmail = H00292_A5CustomerEmail[0];
               n5CustomerEmail = H00292_n5CustomerEmail[0];
               A4CustomerPostalAddress = H00292_A4CustomerPostalAddress[0];
               n4CustomerPostalAddress = H00292_n4CustomerPostalAddress[0];
               A3CustomerName = H00292_A3CustomerName[0];
               A41CustomerKvkNumber = H00292_A41CustomerKvkNumber[0];
               A1CustomerId = H00292_A1CustomerId[0];
               A18CustomerLocationId = H00292_A18CustomerLocationId[0];
               A78CustomerTypeId = H00292_A78CustomerTypeId[0];
               n78CustomerTypeId = H00292_n78CustomerTypeId[0];
               A14CustomerVatNumber = H00292_A14CustomerVatNumber[0];
               A7CustomerPhone = H00292_A7CustomerPhone[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H00293 */
         pr_default.execute(1, new Object[] {AV8Supplier_AgbId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP290( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8Supplier_AgbId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E11292( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Supplier_AgbSupplier_AgbCustomerWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Supplier_AgbSupplier_AgbCustomerWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Supplier_AgbSupplier_AgbCustomerWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Supplier_AgbSupplier_AgbCustomerWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "Supplier_AgbId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8Supplier_AgbId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8Supplier_AgbId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV8Supplier_AgbId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8Supplier_AgbId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "supplier_agbsupplier_agbcustomerwc", GetJustCreated( ));
         ...
         {
            AV8Supplier_AgbId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV8Supplier_AgbId), 4, 0));
         }
         wcpOAV8Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8Supplier_AgbId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8Supplier_AgbId != wcpOAV8Supplier_AgbId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8Supplier_AgbId = AV8Supplier_AgbId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8Supplier_AgbId = cgiGet( sPrefix+"AV8Supplier_AgbId_CTRL");
         if ( StringUtil.Len( sCtrlAV8Supplier_AgbId) > 0 )
         {
            AV8Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8Supplier_AgbId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV8Supplier_AgbId), 4, 0));
         }
         else
         {
            AV8Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8Supplier_AgbId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8Supplier_AgbId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8Supplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8Supplier_AgbId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8Supplier_AgbId_CTRL", StringUtil.RTrim( sCtrlAV8Supplier_AgbId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915553159", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("supplier_agbsupplier_agbcustomerwc.js", "?202481915553160", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E18292',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_CustomerTypeName',fld:'vISAUTHORIZED_CUSTOMERTYPENAME',pic:'',hsh:true},{av:'A78CustomerTypeId',fld:'CUSTOMERTYPEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H00292_A55Supplier_AgbId = new short[1] ;
         H00292_A79CustomerTypeName = new string[] {""} ;
         H00292_A78CustomerTypeId = new short[1] ;
         H00292_n78CustomerTypeId = new bool[] {false} ;
         H00292_A14CustomerVatNumber = new string[] {""} ;
         H00292_A7CustomerPhone = new string[] {""} ;
         H00292_n7CustomerPhone = new bool[] {false} ;
         H00292_A6CustomerVisitingAddress = new string[] {""} ;
         H00292_n6CustomerVisitingAddress = new bool[] {false} ;
         H00292_A5CustomerEmail = new string[] {""} ;
         H00292_n5CustomerEmail = new bool[] {false} ;
         H00292_A4CustomerPostalAddress = new string[] {""} ;
         H00292_n4CustomerPostalAddress = new bool[] {false} ;
         H00292_A3CustomerName = new string[] {""} ;
         H00292_A41CustomerKvkNumber = new string[] {""} ;
         H00292_A1CustomerId = new short[1] ;
         H00292_A18CustomerLocationId = new short[1] ;
         ...
         sCtrlAV8Supplier_AgbId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         gxphoneLink = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier_agbsupplier_agbcustomerwc__default(),
            new Object[][] {
                new Object[] {
               H00292_A55Supplier_AgbId, H00292_A79CustomerTypeName, H00292_A78CustomerTypeId, H00292_n78CustomerTypeId, H00292_A14CustomerVatNumber, H00292_A7CustomerPhone, H00292_n7CustomerPhone, H00292_A6CustomerVisitingAddress, H00292_n6CustomerVisitingAddress, H00292_A5CustomerEmail,
               H00292_n5CustomerEmail, H00292_A4CustomerPostalAddress, H00292_n4CustomerPostalAddress, H00292_A3CustomerName, H00292_A41CustomerKvkNumber, H00292_A1CustomerId, H00292_A18CustomerLocationId
               }
               , new Object[] {
      ...
      private short AV8Supplier_AgbId ;
      private short wcpOAV8Supplier_AgbId ;
      ...
      private string sCtrlAV8Supplier_AgbId ;
      ...
      private short[] H00292_A55Supplier_AgbId ;
      private string[] H00292_A79CustomerTypeName ;
      private short[] H00292_A78CustomerTypeId ;
      private bool[] H00292_n78CustomerTypeId ;
      private string[] H00292_A14CustomerVatNumber ;
      private string[] H00292_A7CustomerPhone ;
      private bool[] H00292_n7CustomerPhone ;
      private string[] H00292_A6CustomerVisitingAddress ;
      private bool[] H00292_n6CustomerVisitingAddress ;
      private string[] H00292_A5CustomerEmail ;
      private bool[] H00292_n5CustomerEmail ;
      private string[] H00292_A4CustomerPostalAddress ;
      private bool[] H00292_n4CustomerPostalAddress ;
      private string[] H00292_A3CustomerName ;
      private string[] H00292_A41CustomerKvkNumber ;
      private short[] H00292_A1CustomerId ;
      private short[] H00292_A18CustomerLocationId ;
   ...
   public class supplier_agbsupplier_agbcustomerwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8Supplier_AgbId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.Supplier_AgbId, T3.CustomerTypeName, T2.CustomerTypeId, T2.CustomerVatNumber, T2.CustomerPhone, T2.CustomerVisitingAddress, T2.CustomerEmail, T2.CustomerPostalAddress, T2.CustomerName, T2.CustomerKvkNumber, T1.CustomerId, T1.CustomerLocationId";
         sFromString = " FROM ((CustomerLocationSupplier_Agb T1 INNER JOIN Customer T2 ON T2.CustomerId = T1.CustomerId) LEFT JOIN CustomerType T3 ON T3.CustomerTypeId = T2.CustomerTypeId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.Supplier_AgbId = :AV8Supplier_AgbId)");
         ...
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerKvkNumber, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerKvkNumber DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T1.CustomerId DESC, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerName, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerName DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerPostalAddress, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerPostalAddress DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerEmail, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerEmail DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerVisitingAddress, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerVisitingAddress DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerPhone, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerPhone DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerVatNumber, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerVatNumber DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.CustomerTypeId, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.CustomerTypeId DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T3.CustomerTypeName, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T3.CustomerTypeName DESC, T1.CustomerId, T1.CustomerLocationId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.CustomerId, T1.CustomerLocationId, T1.Supplier_AgbId";
         }
                                             ...
                                             short AV8Supplier_AgbId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((CustomerLocationSupplier_Agb T1 INNER JOIN Customer T2 ON T2.CustomerId = T1.CustomerId) LEFT JOIN CustomerType T3 ON T3.CustomerTypeId = T2.CustomerTypeId)";
         AddWhere(sWhereString, "(T1.Supplier_AgbId = :AV8Supplier_AgbId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.CustomerId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.CustomerKvkNumber like '%' || :lV16FilterFullText) or ( T2.CustomerName like '%' || :lV16FilterFullText) or ( T2.CustomerPostalAddress like '%' || :lV16FilterFullText) or ( T2.CustomerEmail like '%' || :lV16FilterFullText) or ( T2.CustomerVisitingAddress like '%' || :lV16FilterFullText) or ( T2.CustomerPhone like '%' || :lV16FilterFullText) or ( T2.CustomerVatNumber like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.CustomerTypeId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T3.CustomerTypeName like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00292(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H00293(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8Supplier_AgbId",GXType.Int16,4,0) ,
