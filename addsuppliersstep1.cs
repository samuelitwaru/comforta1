...
namespace GeneXus.Programs {
   public class addsuppliersstep1 : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714304455", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("addsuppliersstep1.js", "?202482714304457", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void sendrow_292( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_29_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavLocationagbsupplierssdts__supplier_agbcontactname_Internalname,((SdtLocationAGBSuppliersSDT)AV18LocationAGBSuppliersSDTs.Item(AV44GXV1)).gxTpr_Supplier_agbcontactname,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavLocationagbsupplierssdts__supplier_agbcontactname_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(int)edtavLocationagbsupplierssdts__supplier_agbcontactname_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)29,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridsContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV14GoingBack',fld:'vGOINGBACK',pic:''},{av:'dynavLocationoption'},{av:'AV19LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV37UDelete',fld:'vUDELETE',pic:''}]}");
         setEventMetadata("ENTER","{handler:'E112R2',iparms:[{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV42WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'dynavLocationoption'},{av:'AV19LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV34SupplierAGBOptions',fld:'vSUPPLIERAGBOPTIONS',pic:''},{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29}]");
         setEventMetadata("ENTER",",oparms:[]}");
         setEventMetadata("'WIZARDPREVIOUS'","{handler:'E122R2',iparms:[]");
         setEventMetadata("'WIZARDPREVIOUS'",",oparms:[]}");
         setEventMetadata("'DOINSERTAGBSUPPLIER'","{handler:'E132R2',iparms:[{av:'AV34SupplierAGBOptions',fld:'vSUPPLIERAGBOPTIONS',pic:''},{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV14GoingBack',fld:'vGOINGBACK',pic:''},{av:'dynavLocationoption'},{av:'AV19LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("'DOINSERTAGBSUPPLIER'",",oparms:[{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29},{av:'AV34SupplierAGBOptions',fld:'vSUPPLIERAGBOPTIONS',pic:''}]}");
         setEventMetadata("VUDELETE.CLICK","{handler:'E172R2',iparms:[{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV14GoingBack',fld:'vGOINGBACK',pic:''},{av:'dynavLocationoption'},{av:'AV19LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VUDELETE.CLICK",",oparms:[{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29}]}");
         setEventMetadata("GRIDS_FIRSTPAGE","{handler:'subgrids_firstpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV18LocationAGBSuppliersSDTs',fld:'vLOCATIONAGBSUPPLIERSSDTS',grid:29,pic:''},{av:'nGXsfl_29_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:29},{av:'nRC_GXsfl_29',ctrl:'GRIDS',prop:'GridRC',grid:29},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV15HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'AV14GoingBack',fld:'vGOINGBACK',pic:''},{av:'dynavLocationoption'},{av:'AV19LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
