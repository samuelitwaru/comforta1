...
namespace GeneXus.Programs {
   public class productserviceproductservicesupplier_agbwc : GXWebComponent
   {
      public productserviceproductservicesupplier_agbwc( )
      {
      ...
      public productserviceproductservicesupplier_agbwc( IGxContext context )
      {
      ...
      public void execute( short aP0_ProductServiceId )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8ProductServiceId = (short)(Math.Round(NumberUtil.Val( GetPar( "ProductServiceId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8ProductServiceId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8ProductServiceId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV32IsAuthorized_Supplier_AgbNumber = StringUtil.StrToBool( GetPar( "IsAuthorized_Supplier_AgbNumber"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProductServiceId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV32IsAuthorized_Supplier_AgbNumber, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "ProductServiceProductServiceSupplier_AgbWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Product Service Product Service Supplier_Agb WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("productserviceproductservicesupplier_agbwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8ProductServiceId,4,0))}, new string[] {"ProductServiceId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_SUPPLIER_AGBNUMBER", AV32IsAuthorized_Supplier_AgbNumber);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUPPLIER_AGBNUMBER", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Supplier_AgbNumber, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8ProductServiceId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8ProductServiceId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPRODUCTSERVICEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProductServiceId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "ProductServiceProductServiceSupplier_AgbWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Product Service Product Service Supplier_Agb WC", "") ;
      }
      ...
      protected void WB1X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productserviceproductservicesupplier_agbwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductServiceId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A73ProductServiceId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A73ProductServiceId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductServiceId_Jsonclick, 0, "Attribute", "", "", "", "", edtProductServiceId_Visible, 0, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "Id", "end", false, "", "HLP_ProductServiceProductServiceSupplier_AgbWC.htm");
            /* User Defined Control */
      ...
      protected void START1X2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Product Service Product Service Supplier_Agb WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV32IsAuthorized_Supplier_AgbNumber ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIER_AGBID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A55Supplier_AgbId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"SUPPLIER_AGBID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A55Supplier_AgbId), 4, 0, ".", "")));
      }
      ...
      protected void RF1X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8ProductServiceId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H001X2 */
            pr_default.execute(0, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A73ProductServiceId = H001X2_A73ProductServiceId[0];
               AssignAttri(sPrefix, false, "A73ProductServiceId", StringUtil.LTrimStr( (decimal)(A73ProductServiceId), 4, 0));
               A63Supplier_AgbContactName = H001X2_A63Supplier_AgbContactName[0];
               n63Supplier_AgbContactName = H001X2_n63Supplier_AgbContactName[0];
               A62Supplier_AgbPhone = H001X2_A62Supplier_AgbPhone[0];
               n62Supplier_AgbPhone = H001X2_n62Supplier_AgbPhone[0];
               A61Supplier_AgbEmail = H001X2_A61Supplier_AgbEmail[0];
               n61Supplier_AgbEmail = H001X2_n61Supplier_AgbEmail[0];
               A60Supplier_AgbPostalAddress = H001X2_A60Supplier_AgbPostalAddress[0];
               n60Supplier_AgbPostalAddress = H001X2_n60Supplier_AgbPostalAddress[0];
               A59Supplier_AgbVisitingAddress = H001X2_A59Supplier_AgbVisitingAddress[0];
               n59Supplier_AgbVisitingAddress = H001X2_n59Supplier_AgbVisitingAddress[0];
               A58Supplier_AgbKvkNumber = H001X2_A58Supplier_AgbKvkNumber[0];
               A57Supplier_AgbName = H001X2_A57Supplier_AgbName[0];
               A56Supplier_AgbNumber = H001X2_A56Supplier_AgbNumber[0];
               A55Supplier_AgbId = H001X2_A55Supplier_AgbId[0];
               A63Supplier_AgbContactName = H001X2_A63Supplier_AgbContactName[0];
               n63Supplier_AgbContactName = H001X2_n63Supplier_AgbContactName[0];
               A62Supplier_AgbPhone = H001X2_A62Supplier_AgbPhone[0];
               n62Supplier_AgbPhone = H001X2_n62Supplier_AgbPhone[0];
      ...
      protected void send_integrity_lvl_hashes1X2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_SUPPLIER_AGBID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A55Supplier_AgbId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H001X3 */
         pr_default.execute(1, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtSupplier_AgbId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbName_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbKvkNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbKvkNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbKvkNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbVisitingAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbVisitingAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbVisitingAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbPostalAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbPostalAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbPostalAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbEmail_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbEmail_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbPhone_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbPhone_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtSupplier_AgbContactName_Enabled = 0;
         AssignProp(sPrefix, false, edtSupplier_AgbContactName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtSupplier_AgbContactName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      ...
      protected void STRUP1X0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8ProductServiceId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProductServiceId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E161X2( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_Supplier_AgbNumber;
         ...
         AV32IsAuthorized_Supplier_AgbNumber = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV32IsAuthorized_Supplier_AgbNumber", AV32IsAuthorized_Supplier_AgbNumber);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SUPPLIER_AGBNUMBER", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Supplier_AgbNumber, context));
      ...
      private void E181X2( )
      {
         ...
         if ( AV32IsAuthorized_Supplier_AgbNumber )
         {
      ...
      protected void E111X2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceSupplier_AgbWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceSupplier_AgbWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProductServiceProductServiceSupplier_AgbWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProductServiceProductServiceSupplier_AgbWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Supplier_Agb";
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8ProductServiceId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8ProductServiceId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8ProductServiceId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceId), 4, 0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productserviceproductservicesupplier_agbwc", GetJustCreated( ));
         ...
         {
            AV8ProductServiceId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8ProductServiceId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceId), 4, 0));
         }
         wcpOAV8ProductServiceId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8ProductServiceId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV8ProductServiceId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8ProductServiceId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8ProductServiceId", StringUtil.LTrimStr( (decimal)(AV8ProductServiceId), 4, 0));
         }
         else
         {
            AV8ProductServiceId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8ProductServiceId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8ProductServiceId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ProductServiceId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714305511", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("productserviceproductservicesupplier_agbwc.js", "?202482714305511", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtSupplier_AgbId_Internalname = sPrefix+"SUPPLIER_AGBID_"+sGXsfl_35_idx;
         edtSupplier_AgbNumber_Internalname = sPrefix+"SUPPLIER_AGBNUMBER_"+sGXsfl_35_idx;
         edtSupplier_AgbName_Internalname = sPrefix+"SUPPLIER_AGBNAME_"+sGXsfl_35_idx;
         edtSupplier_AgbKvkNumber_Internalname = sPrefix+"SUPPLIER_AGBKVKNUMBER_"+sGXsfl_35_idx;
         edtSupplier_AgbVisitingAddress_Internalname = sPrefix+"SUPPLIER_AGBVISITINGADDRESS_"+sGXsfl_35_idx;
         edtSupplier_AgbPostalAddress_Internalname = sPrefix+"SUPPLIER_AGBPOSTALADDRESS_"+sGXsfl_35_idx;
         edtSupplier_AgbEmail_Internalname = sPrefix+"SUPPLIER_AGBEMAIL_"+sGXsfl_35_idx;
         edtSupplier_AgbPhone_Internalname = sPrefix+"SUPPLIER_AGBPHONE_"+sGXsfl_35_idx;
         edtSupplier_AgbContactName_Internalname = sPrefix+"SUPPLIER_AGBCONTACTNAME_"+sGXsfl_35_idx;
      }
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtSupplier_AgbId_Internalname = sPrefix+"SUPPLIER_AGBID_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbNumber_Internalname = sPrefix+"SUPPLIER_AGBNUMBER_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbName_Internalname = sPrefix+"SUPPLIER_AGBNAME_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbKvkNumber_Internalname = sPrefix+"SUPPLIER_AGBKVKNUMBER_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbVisitingAddress_Internalname = sPrefix+"SUPPLIER_AGBVISITINGADDRESS_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbPostalAddress_Internalname = sPrefix+"SUPPLIER_AGBPOSTALADDRESS_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbEmail_Internalname = sPrefix+"SUPPLIER_AGBEMAIL_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbPhone_Internalname = sPrefix+"SUPPLIER_AGBPHONE_"+sGXsfl_35_fel_idx;
         edtSupplier_AgbContactName_Internalname = sPrefix+"SUPPLIER_AGBCONTACTNAME_"+sGXsfl_35_fel_idx;
      }
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplier_AgbPostalAddress_Internalname,(string)A60Supplier_AgbPostalAddress,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A60Supplier_AgbPostalAddress),(string)"_blank",(string)"",(string)"",(string)edtSupplier_AgbPostalAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtSupplier_AgbContactName_Internalname,(string)A63Supplier_AgbContactName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtSupplier_AgbContactName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:Supplier_AgbId|3:Supplier_AgbNumber|4:Supplier_AgbName|5:Supplier_AgbKvkNumber|6:Supplier_AgbVisitingAddress|7:Supplier_AgbPostalAddress|8:Supplier_AgbEmail|9:Supplier_AgbPhone|10:Supplier_AgbContactName";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E131X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E141X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E181X2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A55Supplier_AgbId',fld:'SUPPLIER_AGBID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtSupplier_AgbNumber_Link',ctrl:'SUPPLIER_AGBNUMBER',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E111X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E151X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_Supplier_AgbNumber',fld:'vISAUTHORIZED_SUPPLIER_AGBNUMBER',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A55Supplier_AgbId',fld:'SUPPLIER_AGBID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H001X2_A73ProductServiceId = new short[1] ;
         H001X2_A63Supplier_AgbContactName = new string[] {""} ;
         H001X2_n63Supplier_AgbContactName = new bool[] {false} ;
         H001X2_A62Supplier_AgbPhone = new string[] {""} ;
         H001X2_n62Supplier_AgbPhone = new bool[] {false} ;
         H001X2_A61Supplier_AgbEmail = new string[] {""} ;
         H001X2_n61Supplier_AgbEmail = new bool[] {false} ;
         H001X2_A60Supplier_AgbPostalAddress = new string[] {""} ;
         H001X2_n60Supplier_AgbPostalAddress = new bool[] {false} ;
         H001X2_A59Supplier_AgbVisitingAddress = new string[] {""} ;
         H001X2_n59Supplier_AgbVisitingAddress = new bool[] {false} ;
         H001X2_A58Supplier_AgbKvkNumber = new string[] {""} ;
         H001X2_A57Supplier_AgbName = new string[] {""} ;
         H001X2_A56Supplier_AgbNumber = new string[] {""} ;
         H001X2_A55Supplier_AgbId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productserviceproductservicesupplier_agbwc__default(),
            new Object[][] {
                new Object[] {
               H001X2_A73ProductServiceId, H001X2_A63Supplier_AgbContactName, H001X2_n63Supplier_AgbContactName, H001X2_A62Supplier_AgbPhone, H001X2_n62Supplier_AgbPhone, H001X2_A61Supplier_AgbEmail, H001X2_n61Supplier_AgbEmail, H001X2_A60Supplier_AgbPostalAddress, H001X2_n60Supplier_AgbPostalAddress, H001X2_A59Supplier_AgbVisitingAddress,
               H001X2_n59Supplier_AgbVisitingAddress, H001X2_A58Supplier_AgbKvkNumber, H001X2_A57Supplier_AgbName, H001X2_A56Supplier_AgbNumber, H001X2_A55Supplier_AgbId
               }
               , new Object[] {
      ...
      private short AV8ProductServiceId ;
      private short wcpOAV8ProductServiceId ;
      ...
      private bool AV32IsAuthorized_Supplier_AgbNumber ;
      ...
      private short[] H001X2_A73ProductServiceId ;
      private string[] H001X2_A63Supplier_AgbContactName ;
      private bool[] H001X2_n63Supplier_AgbContactName ;
      private string[] H001X2_A62Supplier_AgbPhone ;
      private bool[] H001X2_n62Supplier_AgbPhone ;
      private string[] H001X2_A61Supplier_AgbEmail ;
      private bool[] H001X2_n61Supplier_AgbEmail ;
      private string[] H001X2_A60Supplier_AgbPostalAddress ;
      private bool[] H001X2_n60Supplier_AgbPostalAddress ;
      private string[] H001X2_A59Supplier_AgbVisitingAddress ;
      private bool[] H001X2_n59Supplier_AgbVisitingAddress ;
      private string[] H001X2_A58Supplier_AgbKvkNumber ;
      private string[] H001X2_A57Supplier_AgbName ;
      private string[] H001X2_A56Supplier_AgbNumber ;
      private short[] H001X2_A55Supplier_AgbId ;
   ...
   public class productserviceproductservicesupplier_agbwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.ProductServiceId, T2.Supplier_AgbContactName, T2.Supplier_AgbPhone, T2.Supplier_AgbEmail, T2.Supplier_AgbPostalAddress, T2.Supplier_AgbVisitingAddress, T2.Supplier_AgbKvkNumber, T2.Supplier_AgbName, T2.Supplier_AgbNumber, T1.Supplier_AgbId";
         sFromString = " FROM (Supplier_AgbProductService T1 INNER JOIN Supplier_AGB T2 ON T2.Supplier_AgbId = T1.Supplier_AgbId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.Supplier_AgbId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbName like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbKvkNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbVisitingAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbPostalAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbEmail like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbPhone like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbContactName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbNumber, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbNumber DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T1.Supplier_AgbId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbName, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbName DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbKvkNumber, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbKvkNumber DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbVisitingAddress, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbVisitingAddress DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbPostalAddress, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbPostalAddress DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbEmail, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbEmail DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbPhone, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbPhone DESC, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.Supplier_AgbContactName, T1.Supplier_AgbId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.Supplier_AgbContactName DESC, T1.Supplier_AgbId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T1.ProductServiceId";
         }
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (Supplier_AgbProductService T1 INNER JOIN Supplier_AGB T2 ON T2.Supplier_AgbId = T1.Supplier_AgbId)";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.Supplier_AgbId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbName like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbKvkNumber like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbVisitingAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbPostalAddress like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbEmail like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbPhone like '%' || :lV16FilterFullText) or ( T2.Supplier_AgbContactName like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001X2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
               case 1 :
                     return conditional_H001X3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (bool)dynConstraints[11] , (short)dynConstraints[12] , (short)dynConstraints[13] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8ProductServiceId",GXType.Int16,4,0) ,
