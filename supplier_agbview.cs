...
namespace GeneXus.Programs {
   public class supplier_agbview : GXDataArea
   {
      public supplier_agbview( )
      {
      ...
      public supplier_agbview( IGxContext context )
      {
      ...
      public void execute( short aP0_Supplier_AgbId ,
                           string aP1_TabCode )
      {
         this.AV10Supplier_AgbId = aP0_Supplier_AgbId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10Supplier_AgbId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV10Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV10Supplier_AgbId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIER_AGBID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Supplier_AgbId), "ZZZ9"), context));
      ...
      {
         get {
            return "supplier_agbview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplier_agbview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10Supplier_AgbId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Supplier_AgbId","TabCode"}) +"\">") ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "vSUPPLIER_AGBID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Supplier_AgbId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIER_AGBID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Supplier_AgbId), "ZZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Supplier_agbcustomerwc == null ) )
         {
            WebComp_Supplier_agbcustomerwc.componentjscripts();
         }
      ...
      {
         return formatLink("supplier_agbview.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10Supplier_AgbId,4,0)),UrlEncode(StringUtil.RTrim(AV8TabCode))}, new string[] {"Supplier_AgbId","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "Supplier_AgbView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Supplier_Agb View", "") ;
      }
      ...
      protected void WB210( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back to AGB Suppliers", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divSupplier_agbgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProductservice_title_Internalname, context.GetMessage( "Product Service", ""), "", "", lblProductservice_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSupplier_agbcustomer_title_Internalname, context.GetMessage( "Customer", ""), "", "", lblSupplier_agbcustomer_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Supplier_AgbView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Supplier_AgbCustomer") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablesupplier_agbcustomer_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0041"+"", StringUtil.RTrim( WebComp_Supplier_agbcustomerwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0041"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Supplier_agbcustomerwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldSupplier_agbcustomerwc), StringUtil.Lower( WebComp_Supplier_agbcustomerwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0041"+"");
                  }
                  WebComp_Supplier_agbcustomerwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldSupplier_agbcustomerwc), StringUtil.Lower( WebComp_Supplier_agbcustomerwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START212( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Supplier_Agb View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldSupplier_agbcustomerwc = cgiGet( "W0041");
                           if ( ( StringUtil.Len( OldSupplier_agbcustomerwc) == 0 ) || ( StringUtil.StrCmp(OldSupplier_agbcustomerwc, WebComp_Supplier_agbcustomerwc_Component) != 0 ) )
                           {
                              WebComp_Supplier_agbcustomerwc = getWebComponent(GetType(), "GeneXus.Programs", OldSupplier_agbcustomerwc, new Object[] {context} );
                              WebComp_Supplier_agbcustomerwc.ComponentInit();
                              WebComp_Supplier_agbcustomerwc.Name = "OldSupplier_agbcustomerwc";
                              WebComp_Supplier_agbcustomerwc_Component = OldSupplier_agbcustomerwc;
                           }
                           if ( StringUtil.Len( WebComp_Supplier_agbcustomerwc_Component) != 0 )
                           {
                              WebComp_Supplier_agbcustomerwc.componentprocess("W0041", "", sEvt);
                           }
                           WebComp_Supplier_agbcustomerwc_Component = OldSupplier_agbcustomerwc;
                        }
                     }
      ...
      protected void RF212( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Supplier_agbcustomerwc_Component) != 0 )
               {
                  WebComp_Supplier_agbcustomerwc.componentstart();
               }
            }
         }
      ...
      protected void STRUP210( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV10Supplier_AgbId = (short)(Math.Round(context.localUtil.CToN( cgiGet( "vSUPPLIER_AGBID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E11212( )
      {
         ...
         lblWorkwithlink_Link = formatLink("supplier_agbww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV14GXLvl9 = 0;
         /* Using cursor H00212 */
         pr_default.execute(0, new Object[] {AV10Supplier_AgbId});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A55Supplier_AgbId = H00212_A55Supplier_AgbId[0];
            A56Supplier_AgbNumber = H00212_A56Supplier_AgbNumber[0];
            AV14GXLvl9 = 1;
            Form.Caption = A56Supplier_AgbNumber;
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Supplier_AgbGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "supplier_agbgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Supplier_AgbGeneral";
            WebComp_Webcomponent_general_Component = "Supplier_AgbGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0019",(string)"",(short)AV10Supplier_AgbId});
      ...
      protected void S122( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "ProductService") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Productservicewc_Component), StringUtil.Lower( "Supplier_AgbProductServiceWC")) != 0 )
            {
               WebComp_Productservicewc = getWebComponent(GetType(), "GeneXus.Programs", "supplier_agbproductservicewc", new Object[] {context} );
               WebComp_Productservicewc.ComponentInit();
               WebComp_Productservicewc.Name = "Supplier_AgbProductServiceWC";
               WebComp_Productservicewc_Component = "Supplier_AgbProductServiceWC";
            }
            if ( StringUtil.Len( WebComp_Productservicewc_Component) != 0 )
            {
               WebComp_Productservicewc.setjustcreated();
               WebComp_Productservicewc.componentprepare(new Object[] {(string)"W0033",(string)"",(short)AV10Supplier_AgbId});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "Supplier_AgbCustomer") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Supplier_agbcustomerwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Supplier_agbcustomerwc_Component), StringUtil.Lower( "Supplier_AgbSupplier_AgbCustomerWC")) != 0 )
            {
               WebComp_Supplier_agbcustomerwc = getWebComponent(GetType(), "GeneXus.Programs", "supplier_agbsupplier_agbcustomerwc", new Object[] {context} );
               WebComp_Supplier_agbcustomerwc.ComponentInit();
               WebComp_Supplier_agbcustomerwc.Name = "Supplier_AgbSupplier_AgbCustomerWC";
               WebComp_Supplier_agbcustomerwc_Component = "Supplier_AgbSupplier_AgbCustomerWC";
            }
            if ( StringUtil.Len( WebComp_Supplier_agbcustomerwc_Component) != 0 )
            {
               WebComp_Supplier_agbcustomerwc.setjustcreated();
               WebComp_Supplier_agbcustomerwc.componentprepare(new Object[] {(string)"W0041",(string)"",(short)AV10Supplier_AgbId});
               WebComp_Supplier_agbcustomerwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Supplier_agbcustomerwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0041"+"");
               WebComp_Supplier_agbcustomerwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10Supplier_AgbId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV10Supplier_AgbId", StringUtil.LTrimStr( (decimal)(AV10Supplier_AgbId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIER_AGBID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10Supplier_AgbId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Supplier_agbcustomerwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Supplier_agbcustomerwc_Component) != 0 )
            {
               WebComp_Supplier_agbcustomerwc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119591188", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("supplier_agbview.js", "?202482119591188", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divSupplier_agbgeneral_cell_Internalname = "SUPPLIER_AGBGENERAL_CELL";
         ...
         lblSupplier_agbcustomer_title_Internalname = "SUPPLIER_AGBCUSTOMER_TITLE";
         divUnnamedtablesupplier_agbcustomer_Internalname = "UNNAMEDTABLESUPPLIER_AGBCUSTOMER";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Supplier_Agb View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10Supplier_AgbId',fld:'vSUPPLIER_AGBID',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         OldProductservicewc = "";
         lblSupplier_agbcustomer_title_Jsonclick = "";
         WebComp_Supplier_agbcustomerwc_Component = "";
         OldSupplier_agbcustomerwc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         sEvtType = "";
         ...
         scmdbuf = "";
         H00212_A55Supplier_AgbId = new short[1] ;
         H00212_A56Supplier_AgbNumber = new string[] {""} ;
         A56Supplier_AgbNumber = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier_agbview__default(),
            new Object[][] {
                new Object[] {
               H00212_A55Supplier_AgbId, H00212_A56Supplier_AgbNumber
               }
            }
         );
         ...
         WebComp_Supplier_agbcustomerwc = new GeneXus.Http.GXNullWebComponent();
         /* GeneXus formulas. */
      }

      private short AV10Supplier_AgbId ;
      private short wcpOAV10Supplier_AgbId ;
      ...
      private string divSupplier_agbgeneral_cell_Internalname ;
      ...
      private string lblSupplier_agbcustomer_title_Internalname ;
      private string lblSupplier_agbcustomer_title_Jsonclick ;
      private string divUnnamedtablesupplier_agbcustomer_Internalname ;
      private string WebComp_Supplier_agbcustomerwc_Component ;
      private string OldSupplier_agbcustomerwc ;
      private string sEvt ;
      ...
      private bool bDynCreated_Supplier_agbcustomerwc ;
      ...
      private GXWebComponent WebComp_Supplier_agbcustomerwc ;
      private GXUserControl ucPanel_general ;
      private GXUserControl ucTabs ;
      private IGxDataStore dsGAM ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] H00212_A55Supplier_AgbId ;
      private string[] H00212_A56Supplier_AgbNumber ;
   ...
   public class supplier_agbview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10Supplier_AgbId",GXType.Int16,4,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00212", "SELECT Supplier_AgbId, Supplier_AgbNumber FROM Supplier_AGB WHERE Supplier_AgbId = :AV10Supplier_AgbId ORDER BY Supplier_AgbId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00212,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
