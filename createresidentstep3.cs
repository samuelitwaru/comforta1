   ...
   public class createresidentstep3 : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Create Resident Step3", "")) ;
      ...
      {
         return context.GetMessage( "Create Resident Step3", "") ;
      }
      ...
      protected void WB2W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtavResidentincompanyname_Internalname, context.GetMessage( "Name", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavResidentincompanykvknumber_Internalname, context.GetMessage( "KVK Number", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavResidentincompanyemail_Internalname, context.GetMessage( "Email", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavResidentincompanyphone_Internalname, context.GetMessage( "Phone", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsavecompany_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", context.GetMessage( "Add", ""), bttBtnsavecompany_Jsonclick, 5, context.GetMessage( "Add", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOSAVECOMPANY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CreateResidentStep3.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
         ...
         if ( wbEnd == 43 )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnnext_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", context.GetMessage( "Next", ""), bttBtnnext_Jsonclick, 5, context.GetMessage( "Next", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DONEXT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_CreateResidentStep3.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavResidentincompanyid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15ResidentINCompanyId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV15ResidentINCompanyId), "ZZZ9")), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onblur(this,64);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavResidentincompanyid_Jsonclick, 0, "Attribute", "", "", "", "", edtavResidentincompanyid_Visible, 1, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_CreateResidentStep3.htm");
            /* User Defined Control */
      ...
      protected void START2W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Create Resident Step3", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void STRUP2W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavResidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavResidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999 )) ) )
            {
            ...
            {
               AV15ResidentINCompanyId = (short)(Math.Round(context.localUtil.CToN( cgiGet( edtavResidentincompanyid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
               AssignAttri(sPrefix, false, "AV15ResidentINCompanyId", StringUtil.LTrimStr( (decimal)(AV15ResidentINCompanyId), 4, 0));
            }
      ...
      protected void E152W2( )
      {
         ...
         if ( AV28CheckRequiredFieldsResult && ! AV10HasValidationErrors )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "This Company KVKNumber has already been added", ""));
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119573545", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createresidentstep3.js", "?202482119573546", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      protected void sendrow_432( )
      {
         ...
         if ( ( subGrids_Rows * 1 == 0 ) || ( nGXsfl_43_idx <= subGrids_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavDeleterecord_Enabled!=0)&&(edtavDeleterecord_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 48,'"+sPrefix+"',false,'"+sGXsfl_43_idx+"',43)\"" : " ");
            ROClassString = "Attribute";
            GridsRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavDeleterecord_Internalname,StringUtil.RTrim( AV24DeleteRecord),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavDeleterecord_Enabled!=0)&&(edtavDeleterecord_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,48);\"" : " "),"'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVDELETERECORD.CLICK."+sGXsfl_43_idx+"'",(string)"",(string)"",context.GetMessage( "Delete", ""),(string)"",(string)edtavDeleterecord_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavDeleterecord_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)43,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV24DeleteRecord',fld:'vDELETERECORD',pic:''}]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE","{handler:'E112W2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Selectedpage',ctrl:'GRIDSPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("'DONEXT'","{handler:'E142W2',iparms:[{av:'AV21WebSessionKey',fld:'vWEBSESSIONKEY',pic:''},{av:'AV15ResidentINCompanyId',fld:'vRESIDENTINCOMPANYID',pic:'ZZZ9'},{av:'AV17ResidentINCompanyName',fld:'vRESIDENTINCOMPANYNAME',pic:''},{av:'AV16ResidentINCompanyKvkNumber',fld:'vRESIDENTINCOMPANYKVKNUMBER',pic:''},{av:'AV14ResidentINCompanyEmail',fld:'vRESIDENTINCOMPANYEMAIL',pic:''},{av:'AV18ResidentINCompanyPhone',fld:'vRESIDENTINCOMPANYPHONE',pic:''},{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43}]");
         setEventMetadata("'DONEXT'",",oparms:[]}");
         setEventMetadata("'DOSAVECOMPANY'","{handler:'E152W2',iparms:[{av:'AV28CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43},{av:'AV16ResidentINCompanyKvkNumber',fld:'vRESIDENTINCOMPANYKVKNUMBER',pic:''},{av:'AV17ResidentINCompanyName',fld:'vRESIDENTINCOMPANYNAME',pic:''},{av:'AV14ResidentINCompanyEmail',fld:'vRESIDENTINCOMPANYEMAIL',pic:''},{av:'AV18ResidentINCompanyPhone',fld:'vRESIDENTINCOMPANYPHONE',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'}]");
         setEventMetadata("'DOSAVECOMPANY'",",oparms:[{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43},{av:'AV28CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV16ResidentINCompanyKvkNumber',fld:'vRESIDENTINCOMPANYKVKNUMBER',pic:''},{av:'AV17ResidentINCompanyName',fld:'vRESIDENTINCOMPANYNAME',pic:''},{av:'AV14ResidentINCompanyEmail',fld:'vRESIDENTINCOMPANYEMAIL',pic:''},{av:'AV18ResidentINCompanyPhone',fld:'vRESIDENTINCOMPANYPHONE',pic:''}]}");
         setEventMetadata("VDELETERECORD.CLICK","{handler:'E202W2',iparms:[{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV10HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VDELETERECORD.CLICK",",oparms:[{av:'AV19ResidentINCompanySDTs',fld:'vRESIDENTINCOMPANYSDTS',grid:43,pic:''},{av:'nGXsfl_43_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:43},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRIDS',prop:'GridRC',grid:43}]}");
         setEventMetadata("VALIDV_RESIDENTINCOMPANYEMAIL","{handler:'Validv_Residentincompanyemail',iparms:[]");
         setEventMetadata("VALIDV_RESIDENTINCOMPANYEMAIL",",oparms:[]}");
