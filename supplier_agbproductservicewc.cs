...
namespace GeneXus.Programs {
   public class supplier_agbproductservicewc : GXWebComponent
   {
      public supplier_agbproductservicewc( )
      {
      ...
      public supplier_agbproductservicewc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8Supplier_AgbId, AV25Pgmname, AV14OrderedBy, AV15OrderedDsc, AV23IsAuthorized_ProductServiceName, AV24IsAuthorized_ProductServiceTypeName, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV25Pgmname = "Supplier_AgbProductServiceWC";
               WS282( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Supplier_Agb Product Service WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("supplier_agbproductservicewc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8Supplier_AgbId,4,0))}, new string[] {"Supplier_AgbId"}) +"\">") ;
      ...
      {
         return "Supplier_AgbProductServiceWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Supplier_Agb Product Service WC", "") ;
      }
      ...
      protected void WB280( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "supplier_agbproductservicewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START282( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Supplier_Agb Product Service WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RF282( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00282 */
            pr_default.execute(0, new Object[] {AV8Supplier_AgbId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A55Supplier_AgbId = H00282_A55Supplier_AgbId[0];
               AssignAttri(sPrefix, false, "A55Supplier_AgbId", StringUtil.LTrimStr( (decimal)(A55Supplier_AgbId), 4, 0));
               A72ProductServiceTypeName = H00282_A72ProductServiceTypeName[0];
               A71ProductServiceTypeId = H00282_A71ProductServiceTypeId[0];
               A40000ProductServicePicture_GXI = H00282_A40000ProductServicePicture_GXI[0];
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A77ProductServicePicture)) ? A40000ProductServicePicture_GXI : context.convertURL( context.PathToRelativeUrl( A77ProductServicePicture))), !bGXsfl_15_Refreshing);
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "SrcSet", context.GetImageSrcSet( A77ProductServicePicture), true);
               A76ProductServiceQuantity = H00282_A76ProductServiceQuantity[0];
               A75ProductServiceDescription = H00282_A75ProductServiceDescription[0];
               A74ProductServiceName = H00282_A74ProductServiceName[0];
               A73ProductServiceId = H00282_A73ProductServiceId[0];
               A77ProductServicePicture = H00282_A77ProductServicePicture[0];
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A77ProductServicePicture)) ? A40000ProductServicePicture_GXI : context.convertURL( context.PathToRelativeUrl( A77ProductServicePicture))), !bGXsfl_15_Refreshing);
               AssignProp(sPrefix, false, edtProductServicePicture_Internalname, "SrcSet", context.GetImageSrcSet( A77ProductServicePicture), true);
               A71ProductServiceTypeId = H00282_A71ProductServiceTypeId[0];
               A40000ProductServicePicture_GXI = H00282_A40000ProductServicePicture_GXI[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H00283 */
         pr_default.execute(1, new Object[] {AV8Supplier_AgbId});
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "supplier_agbproductservicewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915553525", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("supplier_agbproductservicewc.js", "?202481915553525", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00282_A55Supplier_AgbId = new short[1] ;
         H00282_A72ProductServiceTypeName = new string[] {""} ;
         H00282_A71ProductServiceTypeId = new short[1] ;
         H00282_A40000ProductServicePicture_GXI = new string[] {""} ;
         H00282_A76ProductServiceQuantity = new short[1] ;
         H00282_A75ProductServiceDescription = new string[] {""} ;
         H00282_A74ProductServiceName = new string[] {""} ;
         H00282_A73ProductServiceId = new short[1] ;
         H00282_A77ProductServicePicture = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.supplier_agbproductservicewc__default(),
            new Object[][] {
                new Object[] {
               H00282_A55Supplier_AgbId, H00282_A72ProductServiceTypeName, H00282_A71ProductServiceTypeId, H00282_A40000ProductServicePicture_GXI, H00282_A76ProductServiceQuantity, H00282_A75ProductServiceDescription, H00282_A74ProductServiceName, H00282_A73ProductServiceId, H00282_A77ProductServicePicture
               }
               , new Object[] {
      ...
      private short[] H00282_A55Supplier_AgbId ;
      private string[] H00282_A72ProductServiceTypeName ;
      private short[] H00282_A71ProductServiceTypeId ;
      private string[] H00282_A40000ProductServicePicture_GXI ;
      private short[] H00282_A76ProductServiceQuantity ;
      private string[] H00282_A75ProductServiceDescription ;
      private string[] H00282_A74ProductServiceName ;
      private short[] H00282_A73ProductServiceId ;
      private string[] H00282_A77ProductServicePicture ;
   ...
   public class supplier_agbproductservicewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A55Supplier_AgbId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.Supplier_AgbId, T3.ProductServiceTypeName, T2.ProductServiceTypeId, T2.ProductServicePicture_GXI, T2.ProductServiceQuantity, T2.ProductServiceDescription, T2.ProductServiceName, T1.ProductServiceId, T2.ProductServicePicture";
         sFromString = " FROM ((Supplier_AgbProductService T1 INNER JOIN ProductService T2 ON T2.ProductServiceId = T1.ProductServiceId) INNER JOIN ProductServiceType T3 ON T3.ProductServiceTypeId = T2.ProductServiceTypeId)";
         sOrderString = "";
         ...
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T1.ProductServiceId DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.ProductServiceName, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.ProductServiceName DESC, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.ProductServiceDescription, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.ProductServiceDescription DESC, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.ProductServiceQuantity, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.ProductServiceQuantity DESC, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T2.ProductServiceTypeId, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T2.ProductServiceTypeId DESC, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T3.ProductServiceTypeName, T1.ProductServiceId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId DESC, T3.ProductServiceTypeName DESC, T1.ProductServiceId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.Supplier_AgbId, T1.ProductServiceId";
                                             ...
                                             short A55Supplier_AgbId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((Supplier_AgbProductService T1 INNER JOIN ProductService T2 ON T2.ProductServiceId = T1.ProductServiceId) INNER JOIN ProductServiceType T3 ON T3.ProductServiceTypeId = T2.ProductServiceTypeId)";
         AddWhere(sWhereString, "(T1.Supplier_AgbId = :AV8Supplier_AgbId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00282(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] );
               case 1 :
                     return conditional_H00283(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] );
         }
