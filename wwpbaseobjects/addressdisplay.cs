   ...
   public class addressdisplay : GXHttpHandler
   {
      ...
      protected void wb_table1_2_192( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_192( true) ;
         }
         else
         {
            wb_table2_5_192( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_192e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_192e( true) ;
         }
         else
         {
            wb_table2_5_192e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714321386", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/addressdisplay.js", "?202482714321386", false, true);
         }
