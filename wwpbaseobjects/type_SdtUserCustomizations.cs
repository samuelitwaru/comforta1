...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "UserCustomizations" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtUserCustomizations : GxSilentTrnSdt
   {
      ...
      public void Load( string AV90UserCustomizationsId ,
                        string AV91UserCustomizationsKey )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV90UserCustomizationsId,(string)AV91UserCustomizationsKey});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\UserCustomizations", Namespace = "Comforta11")]
