...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPDateRangePickerOptions.FormattedDaysItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPDateRangePickerOptions.FormattedDaysItem", Namespace="Comforta11")]
