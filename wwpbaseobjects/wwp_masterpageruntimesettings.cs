...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpageruntimesettings : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915551029", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpageruntimesettings.js", "?202481915551029", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("FSCOLOR.LOAD","{handler:'E173P2',iparms:[{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''}]");
         ...
         setEventMetadata("TABLECOLORITEM.CLICK","{handler:'E153P2',iparms:[{av:'FSCOLOR_nFirstRecordOnPage'},{av:'FSCOLOR_nEOF'},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV10ColorName',fld:'vCOLORNAME',pic:''},{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''},{av:'sPrefix'}]");
         ...
         setEventMetadata("FONTSIZESMALL.CLICK","{handler:'E113P2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZEMEDIUM.CLICK","{handler:'E123P2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("FONTSIZELARGE.CLICK","{handler:'E133P2',iparms:[{av:'AV11FontSizeSelected',fld:'vFONTSIZESELECTED',pic:''},{av:'AV5WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]");
         ...
         setEventMetadata("VBACKSTYLE.CONTROLVALUECHANGED","{handler:'E143P2',iparms:[{av:'radavBackstyle'},{av:'AV6BackStyle',fld:'vBACKSTYLE',pic:''}]");
