   ...
   public class savefilteras : GXDataArea
   {
      ...
      protected void wb_table1_2_1C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_5_1C2( true) ;
         }
         else
         {
            wb_table2_5_1C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_1C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_1C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_8_1C2( true) ;
         }
         else
         {
            wb_table3_8_1C2( false) ;
         }
         return  ;
      }

      protected void wb_table3_8_1C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_1C2e( true) ;
         }
         else
         {
            wb_table2_5_1C2e( false) ;
         }
      }

      protected void wb_table3_8_1C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_8_1C2e( true) ;
         }
         else
         {
            wb_table3_8_1C2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714321947", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/savefilteras.js", "?202482714321947", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/pnotify.custom.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVMessage/DVMessageRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E121C2',iparms:[{av:'AV8FilterName',fld:'vFILTERNAME',pic:''},{av:'AV20CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV15UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'AV5GridStateKey',fld:'vGRIDSTATEKEY',pic:'',hsh:true}]");
