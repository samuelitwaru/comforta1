   ...
   public class exportoptions : GXDataArea
   {
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_112( true) ;
         }
         else
         {
            wb_table1_6_112( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_112e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_6_112( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_15_112( true) ;
         }
         else
         {
            wb_table2_15_112( false) ;
         }
         return  ;
      }

      protected void wb_table2_15_112e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table3_52_112( true) ;
         }
         else
         {
            wb_table3_52_112( false) ;
         }
         return  ;
      }

      protected void wb_table3_52_112e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_6_112e( true) ;
         }
         else
         {
            wb_table1_6_112e( false) ;
         }
      }

      protected void wb_table3_52_112( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_52_112e( true) ;
         }
         else
         {
            wb_table3_52_112e( false) ;
         }
      }

      protected void wb_table2_15_112( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavExporttype, cmbavExporttype_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV8ExportType), 1, 0)), 1, cmbavExporttype_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e15111_client"+"'", "int", "", 1, cmbavExporttype.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,25);\"", "", true, 0, "HLP_WWPBaseObjects/ExportOptions.htm");
            cmbavExporttype.CurrentValue = StringUtil.Trim( StringUtil.Str( (decimal)(AV8ExportType), 1, 0));
            ...
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='CellPaddingTop10 CellMarginLeft15'>") ;
            wb_table4_28_112( true) ;
         }
         else
         {
            wb_table4_28_112( false) ;
         }
         return  ;
      }

      protected void wb_table4_28_112e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_15_112e( true) ;
         }
         else
         {
            wb_table2_15_112e( false) ;
         }
      }

      protected void wb_table4_28_112( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_28_112e( true) ;
         }
         else
         {
            wb_table4_28_112e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915572523", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/exportoptions.js", "?202481915572523", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DODOWNLOADTOFILE'","{handler:'E12112',iparms:[]");
         setEventMetadata("'DODOWNLOADTOFILE'",",oparms:[]}");
         setEventMetadata("'DOSAVEGOOGLEDRIVE'","{handler:'E13112',iparms:[{av:'AV9GoogleDocResultXML',fld:'vGOOGLEDOCRESULTXML',pic:'',hsh:true}]");
         ...
         setEventMetadata("VEXPORTTYPE.CLICK","{handler:'E15111',iparms:[{av:'cmbavExporttype'},{av:'AV8ExportType',fld:'vEXPORTTYPE',pic:'9'}]");
