...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwp_masterpagetopactionswc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915551618", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202481915551621", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOACTIONCHANGEPASSWORD'","{handler:'E121I2',iparms:[]");
         setEventMetadata("'DOACTIONCHANGEPASSWORD'",",oparms:[]}");
         setEventMetadata("'DOLOGOUT'","{handler:'E131I2',iparms:[]");
