...
namespace GeneXus.Programs {
   ...
   [XmlType(TypeName =  "Resident" , Namespace = "Comforta11" )]
   [Serializable]
   public class SdtResident : GxSilentTrnSdt
   {
      ...
      public GXBCLevelCollection<SdtResident_INIndividual> gxTpr_Inindividual_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtResident_Inindividual == null )
            {
               gxTv_SdtResident_Inindividual = new GXBCLevelCollection<SdtResident_INIndividual>( context, "Resident.INIndividual", "Comforta11");
            }
      ...
      public GXBCLevelCollection<SdtResident_INCompany> gxTpr_Incompany_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtResident_Incompany == null )
            {
               gxTv_SdtResident_Incompany = new GXBCLevelCollection<SdtResident_INCompany>( context, "Resident.INCompany", "Comforta11");
            }
      ...
      public GXBCLevelCollection<SdtResident_ProductService> gxTpr_Productservice_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtResident_Productservice == null )
            {
               gxTv_SdtResident_Productservice = new GXBCLevelCollection<SdtResident_ProductService>( context, "Resident.ProductService", "Comforta11");
            }
   ...
   [DataContract(Name = @"Resident", Namespace = "Comforta11")]
