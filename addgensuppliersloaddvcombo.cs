...
namespace GeneXus.Programs {
   public class addgensuppliersloaddvcombo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP2_Combo_DataJson )
      {
         addgensuppliersloaddvcombo objaddgensuppliersloaddvcombo;
         objaddgensuppliersloaddvcombo = new addgensuppliersloaddvcombo();
         objaddgensuppliersloaddvcombo.AV17ComboName = aP0_ComboName;
         objaddgensuppliersloaddvcombo.AV18SearchTxtParms = aP1_SearchTxtParms;
         objaddgensuppliersloaddvcombo.AV19Combo_DataJson = "" ;
         objaddgensuppliersloaddvcombo.context.SetSubmitInitialConfig(context);
         objaddgensuppliersloaddvcombo.initialize();
         Submit( executePrivateCatch,objaddgensuppliersloaddvcombo);
         aP2_Combo_DataJson=this.AV19Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((addgensuppliersloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
