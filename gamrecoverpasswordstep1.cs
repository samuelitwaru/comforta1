...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamrecoverpasswordstep1.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7IDP_State))}, new string[] {"IDP_State"}) +"\">") ;
      ...
      {
         return formatLink("gamrecoverpasswordstep1.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7IDP_State))}, new string[] {"IDP_State"})  ;
      }
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "Center", "top", "", "", "div");
            wb_table1_21_0R2( true) ;
         }
         else
         {
            wb_table1_21_0R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_0R2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void E120R2( )
      {
         ...
         if ( AV6Errors.Count == 0 )
         {
            ...
            AV8LinkURL = StringUtil.Trim( AV5Application.gxTpr_Environment.gxTpr_Url) + formatLink("gamrecoverpasswordstep2.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV7IDP_State)),UrlEncode(StringUtil.RTrim(""))}, new string[] {"IDP_State","KeyToChangePassword"}) ;
            AV8LinkURL += "%1";
      ...
      protected void wb_table1_21_0R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table1_21_0R2e( true) ;
         }
         else
         {
            wb_table1_21_0R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915572178", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?202481915572180", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120R2',iparms:[{av:'AV10UserAuthTypeName',fld:'vUSERAUTHTYPENAME',pic:'',hsh:true},{av:'AV11UserName',fld:'vUSERNAME',pic:''},{av:'AV7IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'edtavUsername_Enabled',ctrl:'vUSERNAME',prop:'Enabled'}]}");
         setEventMetadata("BACKTOLOGIN.CLICK","{handler:'E130R2',iparms:[{av:'AV7IDP_State',fld:'vIDP_STATE',pic:''}]");
