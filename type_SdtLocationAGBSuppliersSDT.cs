/*
				   File: type_SdtLocationAGBSuppliersSDT
			Description: LocationAGBSuppliersSDT
...
{
	[XmlRoot(ElementName="LocationAGBSuppliersSDT")]
	[XmlType(TypeName="LocationAGBSuppliersSDT" , Namespace="Comforta11" )]
	[Serializable]
	public class SdtLocationAGBSuppliersSDT : GxUserType
	{
		public SdtLocationAGBSuppliersSDT( )
		{
			/* Constructor for serialization */
			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbnumber = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbname = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbkvknumber = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbvisitingaddress = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbpostaladdress = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbemail = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbphone = "";

			gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbcontactname = "";

		}

		public SdtLocationAGBSuppliersSDT(IGxContext context)
		{
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbid; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbid = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbnumber; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbnumber = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbname; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbname = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbkvknumber; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbkvknumber = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbvisitingaddress; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbvisitingaddress = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbpostaladdress; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbpostaladdress = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbemail; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbemail = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbphone; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbphone = value;
		...
		{
			get {
				return gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbcontactname; 
			}
			set {
				gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbcontactname = value;
		...
		protected short gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbid;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbnumber;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbname;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbkvknumber;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbvisitingaddress;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbpostaladdress;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbemail;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbphone;
		 

		protected string gxTv_SdtLocationAGBSuppliersSDT_Supplier_agbcontactname;
	...
	[GxUnWrappedJson()]
	[DataContract(Name=@"LocationAGBSuppliersSDT", Namespace="Comforta11")]
	public class SdtLocationAGBSuppliersSDT_RESTInterface : GxGenericCollectionItem<SdtLocationAGBSuppliersSDT>, System.Web.SessionState.IRequiresSessionState
	{
		public SdtLocationAGBSuppliersSDT_RESTInterface( ) : base()
		{	
		}

		public SdtLocationAGBSuppliersSDT_RESTInterface( SdtLocationAGBSuppliersSDT psdt ) : base(psdt)
		{	
		}
		...
		public SdtLocationAGBSuppliersSDT sdt
		{
			get { 
				return (SdtLocationAGBSuppliersSDT)Sdt;
			}
			set { 
				Sdt = value;
			}
		...
		void checkSdt( StreamingContext ctx )
		{
			if ( sdt == null )
			{
				sdt = new SdtLocationAGBSuppliersSDT() ;
			}
		}
	}
	#endregion
