...
namespace GeneXus.Programs {
   public class createuseraccount : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_Email ,
                                 ...
                                 out string aP4_GAMUserGUID )
      {
         createuseraccount objcreateuseraccount;
         objcreateuseraccount = new createuseraccount();
         objcreateuseraccount.AV9Email = aP0_Email;
         objcreateuseraccount.AV13GivenName = aP1_GivenName;
         objcreateuseraccount.AV14LastName = aP2_LastName;
         objcreateuseraccount.AV16RoleName = aP3_RoleName;
         objcreateuseraccount.AV12GAMUserGUID = "" ;
         objcreateuseraccount.context.SetSubmitInitialConfig(context);
         objcreateuseraccount.initialize();
         Submit( executePrivateCatch,objcreateuseraccount);
         aP4_GAMUserGUID=this.AV12GAMUserGUID;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((createuseraccount)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
