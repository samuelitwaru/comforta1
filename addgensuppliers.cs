...
namespace GeneXus.Programs {
   public class addgensuppliers : GXDataArea
   {
      ...
      {
         return context.GetMessage( "Add General Suppliers", "") ;
      }
      ...
      protected void WB2M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsertgensupplier_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", context.GetMessage( "Add", ""), bttBtninsertgensupplier_Jsonclick, 5, context.GetMessage( "Add new item", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERTGENSUPPLIER\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_AddGenSuppliers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2M2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Add General Suppliers", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_genid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_genid_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_gencompanyname_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_gencompanyname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_gencompanyname_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_genkvknumber_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_genkvknumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_genkvknumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_gencontactname_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_gencontactname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_gencontactname_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_gencontactphone_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_gencontactphone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_gencontactphone_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_genpostaladdress_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_genpostaladdress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_genpostaladdress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtavLocationgensupplierssdts__supplier_genvisitingaddress_Enabled = 0;
         AssignProp("", false, edtavLocationgensupplierssdts__supplier_genvisitingaddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLocationgensupplierssdts__supplier_genvisitingaddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915582853", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("addgensuppliers.js", "?202481915582856", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Add General Suppliers", "");
         subGrids_Rows = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDS.LOAD","{handler:'E152M2',iparms:[]");
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV49UDelete',fld:'vUDELETE',pic:''}]}");
         setEventMetadata("'DOBACK'","{handler:'E112M2',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E122M2',iparms:[{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'},{av:'AV11Customer',fld:'vCUSTOMER',pic:''},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV11Customer',fld:'vCUSTOMER',pic:''},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35}]}");
         setEventMetadata("'DOINSERTGENSUPPLIER'","{handler:'E132M2',iparms:[{av:'AV46SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("'DOINSERTGENSUPPLIER'",",oparms:[{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'AV46SupplierGenOptions',fld:'vSUPPLIERGENOPTIONS',pic:''}]}");
         setEventMetadata("VUDELETE.CLICK","{handler:'E162M2',iparms:[{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("VUDELETE.CLICK",",oparms:[{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35}]}");
         setEventMetadata("GRIDS_FIRSTPAGE","{handler:'subgrids_firstpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_PREVPAGE","{handler:'subgrids_previouspage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_NEXTPAGE","{handler:'subgrids_nextpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
         setEventMetadata("GRIDS_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRIDS_LASTPAGE","{handler:'subgrids_lastpage',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV25LocationGenSuppliersSDTs',fld:'vLOCATIONGENSUPPLIERSSDTS',grid:35,pic:''},{av:'nGXsfl_35_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:35},{av:'nRC_GXsfl_35',ctrl:'GRIDS',prop:'GridRC',grid:35},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'dynavLocationoption'},{av:'AV26LocationOption',fld:'vLOCATIONOPTION',pic:'ZZZ9'}]");
