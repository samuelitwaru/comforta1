...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="SDTCustomer.LocationItem.Supplier_AgbItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"SDTCustomer.LocationItem.Supplier_AgbItem", Namespace="Comforta11")]
