   ...
   public class customization : GXDataArea
   {
      ...
      protected void WB3O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavCustomercustomization_customercustomizationid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7CustomerCustomization.gxTpr_Customercustomizationid), 4, 0, context.GetLanguageProperty( "decimal_point"), "")), StringUtil.LTrim( ((edtavCustomercustomization_customercustomizationid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV7CustomerCustomization.gxTpr_Customercustomizationid), "ZZZ9") : context.localUtil.Format( (decimal)(AV7CustomerCustomization.gxTpr_Customercustomizationid), "ZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCustomercustomization_customercustomizationid_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCustomercustomization_customercustomizationid_Enabled, 0, "text", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_Customization.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915583692", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("customization.js", "?202481915583693", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10TrnMode',fld:'vTRNMODE',pic:'',hsh:true},{av:'AV14CustomerCustomizationId',fld:'vCUSTOMERCUSTOMIZATIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{ctrl:'BTNENTER',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E133O2',iparms:[{av:'AV10TrnMode',fld:'vTRNMODE',pic:'',hsh:true},{av:'AV12CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''},{av:'AV7CustomerCustomization',fld:'vCUSTOMERCUSTOMIZATION',pic:''},{av:'AV9Messages',fld:'vMESSAGES',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7CustomerCustomization',fld:'vCUSTOMERCUSTOMIZATION',pic:''},{av:'AV9Messages',fld:'vMESSAGES',pic:''},{av:'AV12CheckRequiredFieldsResult',fld:'vCHECKREQUIREDFIELDSRESULT',pic:''}]}");
         return  ;
      }
