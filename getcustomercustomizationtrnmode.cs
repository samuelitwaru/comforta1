...
namespace GeneXus.Programs {
   public class getcustomercustomizationtrnmode : GXProcedure
   {
      ...
      {
         getcustomercustomizationtrnmode objgetcustomercustomizationtrnmode;
         objgetcustomercustomizationtrnmode = new getcustomercustomizationtrnmode();
         objgetcustomercustomizationtrnmode.AV8TrnMode = aP0_TrnMode;
         objgetcustomercustomizationtrnmode.context.SetSubmitInitialConfig(context);
         objgetcustomercustomizationtrnmode.initialize();
         Submit( executePrivateCatch,objgetcustomercustomizationtrnmode);
         aP0_TrnMode=this.AV8TrnMode;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((getcustomercustomizationtrnmode)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
