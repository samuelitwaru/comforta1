...
namespace GeneXus.Programs {
   public class basecolorcomponent : GXWebComponent
   {
      ...
      public basecolorcomponent( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Base Color Component", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("basecolorcomponent.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV11ColorName))}, new string[] {"ColorName"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"subFscolor2_Recordcount", StringUtil.LTrim( StringUtil.NToC( (decimal)(subFscolor2_Recordcount), 5, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return context.GetMessage( "Base Color Component", "") ;
      }
      ...
      protected void WB3K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "basecolorcomponent.aspx");
            }
            /* Div Control */
      ...
      protected void START3K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Base Color Component", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void STRUP3K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            subFscolor2_Recordcount = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"subFscolor2_Recordcount"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E113K2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.saveuserkeyvalue(context ).execute(  "DesignSystemSettings",  AV10WWP_DesignSystemSettings.ToJSonString(false, true)) ;
         ...
         AV12WebSession.Set(context.GetMessage( "SelectedBaseColor", ""), AV11ColorName);
         gxgrFscolor2_refresh( AV8ColorItemClass, AV10WWP_DesignSystemSettings, AV11ColorName, sPrefix) ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "basecolorcomponent", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714295660", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("basecolorcomponent.js", "?202482714295661", false, true);
         }
      ...
      protected void sendrow_152( )
      {
         ...
         Fscolor2Row.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(string)edtavColorname_Internalname,context.GetMessage( "Color Name", ""),(string)"gx-form-item AttributeLabel",(short)0,(bool)true,(string)"width: 25%;"});
         /* Single line edit */
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'FSCOLOR2_nFirstRecordOnPage'},{av:'FSCOLOR2_nEOF'},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV10WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV11ColorName',fld:'vCOLORNAME',pic:''},{av:'sPrefix'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("FSCOLOR2.LOAD","{handler:'E133K2',iparms:[{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV10WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV11ColorName',fld:'vCOLORNAME',pic:''}]");
         setEventMetadata("FSCOLOR2.LOAD",",oparms:[{av:'AV11ColorName',fld:'vCOLORNAME',pic:''},{av:'lblColorsquare_Caption',ctrl:'COLORSQUARE',prop:'Caption'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true}]}");
         setEventMetadata("TABLECOLORITEM.CLICK","{handler:'E113K2',iparms:[{av:'FSCOLOR2_nFirstRecordOnPage'},{av:'FSCOLOR2_nEOF'},{av:'edtavColorname_Visible',ctrl:'vCOLORNAME',prop:'Visible'},{av:'AV8ColorItemClass',fld:'vCOLORITEMCLASS',pic:'',hsh:true},{av:'AV10WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''},{av:'AV11ColorName',fld:'vCOLORNAME',pic:''},{av:'sPrefix'}]");
         setEventMetadata("TABLECOLORITEM.CLICK",",oparms:[{av:'AV10WWP_DesignSystemSettings',fld:'vWWP_DESIGNSYSTEMSETTINGS',pic:''}]}");
