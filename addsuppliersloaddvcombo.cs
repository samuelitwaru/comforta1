...
namespace GeneXus.Programs {
   public class addsuppliersloaddvcombo : GXProcedure
   {
      ...
      public void executeSubmit( string aP0_ComboName ,
                                 ...
                                 out string aP2_Combo_DataJson )
      {
         addsuppliersloaddvcombo objaddsuppliersloaddvcombo;
         objaddsuppliersloaddvcombo = new addsuppliersloaddvcombo();
         objaddsuppliersloaddvcombo.AV17ComboName = aP0_ComboName;
         objaddsuppliersloaddvcombo.AV18SearchTxtParms = aP1_SearchTxtParms;
         objaddsuppliersloaddvcombo.AV19Combo_DataJson = "" ;
         objaddsuppliersloaddvcombo.context.SetSubmitInitialConfig(context);
         objaddsuppliersloaddvcombo.initialize();
         Submit( executePrivateCatch,objaddsuppliersloaddvcombo);
         aP2_Combo_DataJson=this.AV19Combo_DataJson;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((addsuppliersloaddvcombo)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
