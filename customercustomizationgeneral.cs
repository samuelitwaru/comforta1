   ...
   public class customercustomizationgeneral : GXWebComponent
   {
      ...
      protected void WB3L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtCustomerName_Internalname, A3CustomerName, StringUtil.RTrim( context.localUtil.Format( A3CustomerName, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCustomerName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtCustomerName_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_CustomerCustomizationGeneral.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", context.GetMessage( "GXM_update", ""), bttBtnupdate_Jsonclick, 7, context.GetMessage( "GXM_update", ""), "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e113l1_client"+"'", TempTags, "", 2, "HLP_CustomerCustomizationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", context.GetMessage( "GX_BtnDelete", ""), bttBtndelete_Jsonclick, 7, context.GetMessage( "GX_BtnDelete", ""), "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e123l1_client"+"'", TempTags, "", 2, "HLP_CustomerCustomizationGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF3L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A131CustomerCustomizationBaseColor = H003L2_A131CustomerCustomizationBaseColor[0];
               AssignAttri(sPrefix, false, "A131CustomerCustomizationBaseColor", A131CustomerCustomizationBaseColor);
               A1CustomerId = H003L2_A1CustomerId[0];
               AssignAttri(sPrefix, false, "A1CustomerId", StringUtil.LTrimStr( (decimal)(A1CustomerId), 4, 0));
               A132CustomerCustomizationFontSize = H003L2_A132CustomerCustomizationFontSize[0];
               AssignAttri(sPrefix, false, "A132CustomerCustomizationFontSize", A132CustomerCustomizationFontSize);
               A40001CustomerCustomizationFavicon_G = H003L2_A40001CustomerCustomizationFavicon_G[0];
               ...
               A40000CustomerCustomizationLogo_GXI = H003L2_A40000CustomerCustomizationLogo_GXI[0];
               ...
               A3CustomerName = H003L2_A3CustomerName[0];
               AssignAttri(sPrefix, false, "A3CustomerName", A3CustomerName);
               A130CustomerCustomizationFavicon = H003L2_A130CustomerCustomizationFavicon[0];
               AssignAttri(sPrefix, false, "A130CustomerCustomizationFavicon", A130CustomerCustomizationFavicon);
               AssignProp(sPrefix, false, imgCustomerCustomizationFavicon_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A130CustomerCustomizationFavicon)) ? A40001CustomerCustomizationFavicon_G : context.convertURL( context.PathToRelativeUrl( A130CustomerCustomizationFavicon))), true);
               AssignProp(sPrefix, false, imgCustomerCustomizationFavicon_Internalname, "SrcSet", context.GetImageSrcSet( A130CustomerCustomizationFavicon), true);
               A129CustomerCustomizationLogo = H003L2_A129CustomerCustomizationLogo[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915565355", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("customercustomizationgeneral.js", "?202481915565355", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A128CustomerCustomizationId',fld:'CUSTOMERCUSTOMIZATIONID',pic:'ZZZ9'},{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOUPDATE'","{handler:'E113L1',iparms:[{av:'AV12IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A128CustomerCustomizationId',fld:'CUSTOMERCUSTOMIZATIONID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[{ctrl:'BTNUPDATE',prop:'Visible'}]}");
         setEventMetadata("'DODELETE'","{handler:'E123L1',iparms:[{av:'AV13IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'A128CustomerCustomizationId',fld:'CUSTOMERCUSTOMIZATIONID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("VALID_CUSTOMERCUSTOMIZATIONID",",oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H003L2_A128CustomerCustomizationId = new short[1] ;
         H003L2_A131CustomerCustomizationBaseColor = new string[] {""} ;
         H003L2_A1CustomerId = new short[1] ;
         H003L2_A132CustomerCustomizationFontSize = new string[] {""} ;
         H003L2_A40001CustomerCustomizationFavicon_G = new string[] {""} ;
         H003L2_A40000CustomerCustomizationLogo_GXI = new string[] {""} ;
         H003L2_A3CustomerName = new string[] {""} ;
         H003L2_A130CustomerCustomizationFavicon = new string[] {""} ;
         H003L2_A129CustomerCustomizationLogo = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customercustomizationgeneral__default(),
            new Object[][] {
                new Object[] {
               H003L2_A128CustomerCustomizationId, H003L2_A131CustomerCustomizationBaseColor, H003L2_A1CustomerId, H003L2_A132CustomerCustomizationFontSize, H003L2_A40001CustomerCustomizationFavicon_G, H003L2_A40000CustomerCustomizationLogo_GXI, H003L2_A3CustomerName, H003L2_A130CustomerCustomizationFavicon, H003L2_A129CustomerCustomizationLogo
               }
            }
         );
         AV17Pgmname = "CustomerCustomizationGeneral";
      ...
      private short[] H003L2_A128CustomerCustomizationId ;
      private string[] H003L2_A131CustomerCustomizationBaseColor ;
      private short[] H003L2_A1CustomerId ;
      private string[] H003L2_A132CustomerCustomizationFontSize ;
      private string[] H003L2_A40001CustomerCustomizationFavicon_G ;
      private string[] H003L2_A40000CustomerCustomizationLogo_GXI ;
      private string[] H003L2_A3CustomerName ;
      private string[] H003L2_A130CustomerCustomizationFavicon ;
      private string[] H003L2_A129CustomerCustomizationLogo ;
