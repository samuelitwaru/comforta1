...
namespace GeneXus.Programs {
   public class customertypecustomerwc : GXWebComponent
   {
      public customertypecustomerwc( )
      {
      ...
      public customertypecustomerwc( IGxContext context )
      {
      ...
      public void execute( short aP0_CustomerTypeId )
      {
         this.AV8CustomerTypeId = aP0_CustomerTypeId;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "CustomerTypeId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8CustomerTypeId = (short)(Math.Round(NumberUtil.Val( GetPar( "CustomerTypeId"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV8CustomerTypeId), 4, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(short)AV8CustomerTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8CustomerTypeId, AV20ManageFiltersExecutionStep, AV32Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV32Pgmname = "CustomerTypeCustomerWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Customer Type Customer WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("customertypecustomerwc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV8CustomerTypeId,4,0))}, new string[] {"CustomerTypeId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8CustomerTypeId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8CustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vCUSTOMERTYPEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8CustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return "CustomerTypeCustomerWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Customer Type Customer WC", "") ;
      }
      ...
      protected void WB1T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "customertypecustomerwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START1T2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Customer Type Customer WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void RF1T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8CustomerTypeId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H001T2 */
            pr_default.execute(0, new Object[] {AV8CustomerTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A78CustomerTypeId = H001T2_A78CustomerTypeId[0];
               n78CustomerTypeId = H001T2_n78CustomerTypeId[0];
               AssignAttri(sPrefix, false, "A78CustomerTypeId", StringUtil.LTrimStr( (decimal)(A78CustomerTypeId), 4, 0));
               A14CustomerVatNumber = H001T2_A14CustomerVatNumber[0];
               A7CustomerPhone = H001T2_A7CustomerPhone[0];
               n7CustomerPhone = H001T2_n7CustomerPhone[0];
               A6CustomerVisitingAddress = H001T2_A6CustomerVisitingAddress[0];
               n6CustomerVisitingAddress = H001T2_n6CustomerVisitingAddress[0];
               A5CustomerEmail = H001T2_A5CustomerEmail[0];
               n5CustomerEmail = H001T2_n5CustomerEmail[0];
               A4CustomerPostalAddress = H001T2_A4CustomerPostalAddress[0];
               n4CustomerPostalAddress = H001T2_n4CustomerPostalAddress[0];
               A3CustomerName = H001T2_A3CustomerName[0];
               A41CustomerKvkNumber = H001T2_A41CustomerKvkNumber[0];
               A1CustomerId = H001T2_A1CustomerId[0];
               E181T2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H001T3 */
         pr_default.execute(1, new Object[] {AV8CustomerTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtCustomerTypeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtCustomerTypeId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP1T0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8CustomerTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E161T2( )
      {
         ...
         AssignProp(sPrefix, false, edtCustomerTypeId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtCustomerTypeId_Visible), 5, 0), true);
      ...
      protected void E111T2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("CustomerTypeCustomerWCFilters")),UrlEncode(StringUtil.RTrim(AV32Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("CustomerTypeCustomerWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "CustomerTypeCustomerWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "customer_Insert", out  GXt_boolean3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "CustomerTypeCustomerWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "CustomerTypeId";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8CustomerTypeId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8CustomerTypeId = Convert.ToInt16(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV8CustomerTypeId), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8CustomerTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "customertypecustomerwc", GetJustCreated( ));
         ...
         {
            AV8CustomerTypeId = Convert.ToInt16(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV8CustomerTypeId), 4, 0));
         }
         wcpOAV8CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8CustomerTypeId"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8CustomerTypeId != wcpOAV8CustomerTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8CustomerTypeId = AV8CustomerTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8CustomerTypeId = cgiGet( sPrefix+"AV8CustomerTypeId_CTRL");
         if ( StringUtil.Len( sCtrlAV8CustomerTypeId) > 0 )
         {
            AV8CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8CustomerTypeId), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8CustomerTypeId", StringUtil.LTrimStr( (decimal)(AV8CustomerTypeId), 4, 0));
         }
         else
         {
            AV8CustomerTypeId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8CustomerTypeId_PARM"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8CustomerTypeId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8CustomerTypeId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8CustomerTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8CustomerTypeId_CTRL", StringUtil.RTrim( sCtrlAV8CustomerTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119574167", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("customertypecustomerwc.js", "?202482119574167", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:CustomerId|3:CustomerKvkNumber|4:CustomerName|5:CustomerPostalAddress|6:CustomerEmail|7:CustomerVisitingAddress|8:CustomerPhone|9:CustomerVatNumber";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E181T2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E151T2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8CustomerTypeId',fld:'vCUSTOMERTYPEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV32Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A1CustomerId',fld:'CUSTOMERID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV24GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV25GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV26GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'edtavDelete_Visible',ctrl:'vDELETE',prop:'Visible'},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV18ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("NULL","{handler:'Valid_Customervatnumber',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H001T2_A78CustomerTypeId = new short[1] ;
         H001T2_n78CustomerTypeId = new bool[] {false} ;
         H001T2_A14CustomerVatNumber = new string[] {""} ;
         H001T2_A7CustomerPhone = new string[] {""} ;
         H001T2_n7CustomerPhone = new bool[] {false} ;
         H001T2_A6CustomerVisitingAddress = new string[] {""} ;
         H001T2_n6CustomerVisitingAddress = new bool[] {false} ;
         H001T2_A5CustomerEmail = new string[] {""} ;
         H001T2_n5CustomerEmail = new bool[] {false} ;
         H001T2_A4CustomerPostalAddress = new string[] {""} ;
         H001T2_n4CustomerPostalAddress = new bool[] {false} ;
         H001T2_A3CustomerName = new string[] {""} ;
         H001T2_A41CustomerKvkNumber = new string[] {""} ;
         H001T2_A1CustomerId = new short[1] ;
         ...
         sCtrlAV8CustomerTypeId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         gxphoneLink = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.customertypecustomerwc__default(),
            new Object[][] {
                new Object[] {
               H001T2_A78CustomerTypeId, H001T2_n78CustomerTypeId, H001T2_A14CustomerVatNumber, H001T2_A7CustomerPhone, H001T2_n7CustomerPhone, H001T2_A6CustomerVisitingAddress, H001T2_n6CustomerVisitingAddress, H001T2_A5CustomerEmail, H001T2_n5CustomerEmail, H001T2_A4CustomerPostalAddress,
               H001T2_n4CustomerPostalAddress, H001T2_A3CustomerName, H001T2_A41CustomerKvkNumber, H001T2_A1CustomerId
               }
               , new Object[] {
      ...
      private short AV8CustomerTypeId ;
      private short wcpOAV8CustomerTypeId ;
      ...
      private string sCtrlAV8CustomerTypeId ;
      ...
      private short[] H001T2_A78CustomerTypeId ;
      private bool[] H001T2_n78CustomerTypeId ;
      private string[] H001T2_A14CustomerVatNumber ;
      private string[] H001T2_A7CustomerPhone ;
      private bool[] H001T2_n7CustomerPhone ;
      private string[] H001T2_A6CustomerVisitingAddress ;
      private bool[] H001T2_n6CustomerVisitingAddress ;
      private string[] H001T2_A5CustomerEmail ;
      private bool[] H001T2_n5CustomerEmail ;
      private string[] H001T2_A4CustomerPostalAddress ;
      private bool[] H001T2_n4CustomerPostalAddress ;
      private string[] H001T2_A3CustomerName ;
      private string[] H001T2_A41CustomerKvkNumber ;
      private short[] H001T2_A1CustomerId ;
   ...
   public class customertypecustomerwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8CustomerTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " CustomerTypeId, CustomerVatNumber, CustomerPhone, CustomerVisitingAddress, CustomerEmail, CustomerPostalAddress, CustomerName, CustomerKvkNumber, CustomerId";
         sFromString = " FROM Customer";
         sOrderString = "";
         AddWhere(sWhereString, "(CustomerTypeId = :AV8CustomerTypeId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(CustomerId,'9999'), 2) like '%' || :lV16FilterFullText) or ( CustomerKvkNumber like '%' || :lV16FilterFullText) or ( CustomerName like '%' || :lV16FilterFullText) or ( CustomerPostalAddress like '%' || :lV16FilterFullText) or ( CustomerEmail like '%' || :lV16FilterFullText) or ( CustomerVisitingAddress like '%' || :lV16FilterFullText) or ( CustomerPhone like '%' || :lV16FilterFullText) or ( CustomerVatNumber like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerKvkNumber, CustomerId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerKvkNumber DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerName, CustomerId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerName DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerPostalAddress, CustomerId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerPostalAddress DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerEmail, CustomerId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerEmail DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerVisitingAddress, CustomerId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerVisitingAddress DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerPhone, CustomerId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerPhone DESC, CustomerId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY CustomerTypeId, CustomerVatNumber, CustomerId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY CustomerTypeId DESC, CustomerVatNumber DESC, CustomerId";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001T2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] );
               case 1 :
                     return conditional_H001T3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8CustomerTypeId",GXType.Int16,4,0) ,
