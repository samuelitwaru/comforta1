...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="ResidentDetails.ResidentServicesAndProductsItem" , Namespace="Comforta11" )]
	[Serializable]
	...
	[DataContract(Name=@"ResidentDetails.ResidentServicesAndProductsItem", Namespace="Comforta11")]
