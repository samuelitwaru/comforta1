...
namespace GeneXus.Programs {
   public class productserviceproductserviceresidentwc : GXWebComponent
   {
      public productserviceproductserviceresidentwc( )
      {
      ...
      public productserviceproductserviceresidentwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV32IsAuthorized_ResidentTypeName = StringUtil.StrToBool( GetPar( "IsAuthorized_ResidentTypeName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8ProductServiceId, AV20ManageFiltersExecutionStep, AV33Pgmname, AV14OrderedBy, AV15OrderedDsc, AV28IsAuthorized_Update, AV30IsAuthorized_Delete, AV32IsAuthorized_ResidentTypeName, AV31IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV33Pgmname = "ProductServiceProductServiceResidentWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Product Service Product Service Resident WC", "")) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_RESIDENTTYPENAME", AV32IsAuthorized_ResidentTypeName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_RESIDENTTYPENAME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_ResidentTypeName, context));
      ...
      {
         return "ProductServiceProductServiceResidentWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Product Service Product Service Resident WC", "") ;
      }
      ...
      protected void WB1Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "productserviceproductserviceresidentwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START1Y2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Product Service Product Service Resident WC", ""), 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV32IsAuthorized_ResidentTypeName ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_RESIDENTID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A31ResidentId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"RESIDENTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31ResidentId), 4, 0, ".", "")));
      }
      ...
      protected void RF1Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8ProductServiceId } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            });
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H001Y2 */
            pr_default.execute(0, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A73ProductServiceId = H001Y2_A73ProductServiceId[0];
               AssignAttri(sPrefix, false, "A73ProductServiceId", StringUtil.LTrimStr( (decimal)(A73ProductServiceId), 4, 0));
               A83ResidentTypeName = H001Y2_A83ResidentTypeName[0];
               A82ResidentTypeId = H001Y2_A82ResidentTypeId[0];
               A39ResidentGAMGUID = H001Y2_A39ResidentGAMGUID[0];
               A38ResidentPhone = H001Y2_A38ResidentPhone[0];
               n38ResidentPhone = H001Y2_n38ResidentPhone[0];
               A37ResidentAddress = H001Y2_A37ResidentAddress[0];
               n37ResidentAddress = H001Y2_n37ResidentAddress[0];
               A36ResidentEmail = H001Y2_A36ResidentEmail[0];
               A35ResidentInitials = H001Y2_A35ResidentInitials[0];
               n35ResidentInitials = H001Y2_n35ResidentInitials[0];
               A34ResidentLastName = H001Y2_A34ResidentLastName[0];
               A33ResidentGivenName = H001Y2_A33ResidentGivenName[0];
               A40ResidentBsnNumber = H001Y2_A40ResidentBsnNumber[0];
               A31ResidentId = H001Y2_A31ResidentId[0];
               A82ResidentTypeId = H001Y2_A82ResidentTypeId[0];
               A39ResidentGAMGUID = H001Y2_A39ResidentGAMGUID[0];
               A38ResidentPhone = H001Y2_A38ResidentPhone[0];
               n38ResidentPhone = H001Y2_n38ResidentPhone[0];
      ...
      protected void send_integrity_lvl_hashes1Y2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV31IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV31IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_RESIDENTID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, context.localUtil.Format( (decimal)(A31ResidentId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H001Y3 */
         pr_default.execute(1, new Object[] {AV8ProductServiceId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtResidentId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentBsnNumber_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentBsnNumber_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentBsnNumber_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentGivenName_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentGivenName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentGivenName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentLastName_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentLastName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentLastName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentInitials_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentInitials_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentInitials_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentEmail_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentEmail_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentAddress_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentAddress_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentAddress_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentPhone_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentPhone_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentPhone_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentGAMGUID_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentGAMGUID_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentGAMGUID_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentTypeId_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentTypeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentTypeId_Enabled), 5, 0), !bGXsfl_35_Refreshing);
         edtResidentTypeName_Enabled = 0;
         AssignProp(sPrefix, false, edtResidentTypeName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtResidentTypeName_Enabled), 5, 0), !bGXsfl_35_Refreshing);
      ...
      protected void E161Y2( )
      {
         ...
         GXt_boolean1 = AV32IsAuthorized_ResidentTypeName;
         ...
         AV32IsAuthorized_ResidentTypeName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV32IsAuthorized_ResidentTypeName", AV32IsAuthorized_ResidentTypeName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_RESIDENTTYPENAME", GetSecureSignedToken( sPrefix, AV32IsAuthorized_ResidentTypeName, context));
      ...
      private void E181Y2( )
      {
         ...
         if ( AV32IsAuthorized_ResidentTypeName )
         {
      ...
      protected void E111Y2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceResidentWCFilters")),UrlEncode(StringUtil.RTrim(AV33Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("ProductServiceProductServiceResidentWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "ProductServiceProductServiceResidentWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E151Y2( )
      {
         ...
         {
            CallWebObject(formatLink("resident.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","ResidentId"}) );
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "resident_Insert", out  GXt_boolean1) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "ProductServiceProductServiceResidentWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Resident";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "productserviceproductserviceresidentwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714303342", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("productserviceproductserviceresidentwc.js", "?202482714303342", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtResidentGAMGUID_Internalname = sPrefix+"RESIDENTGAMGUID_"+sGXsfl_35_idx;
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtResidentGAMGUID_Internalname = sPrefix+"RESIDENTGAMGUID_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtResidentId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A31ResidentId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A31ResidentId), "ZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtResidentId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)4,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"Id",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtResidentAddress_Internalname,(string)A37ResidentAddress,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A37ResidentAddress),(string)"_blank",(string)"",(string)"",(string)edtResidentAddress_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)1024,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXus\\Address",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtResidentGAMGUID_Internalname = sPrefix+"RESIDENTGAMGUID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:ResidentId|3:ResidentBsnNumber|4:ResidentGivenName|5:ResidentLastName|6:ResidentInitials|7:ResidentEmail|8:ResidentAddress|9:ResidentPhone|10:ResidentGAMGUID|11:ResidentTypeId|12:ResidentTypeName";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E131Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E141Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E181Y2',iparms:[{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'A31ResidentId',fld:'RESIDENTID',pic:'ZZZ9',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'A82ResidentTypeId',fld:'RESIDENTTYPEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV27Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV29Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtResidentTypeName_Link',ctrl:'RESIDENTTYPENAME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E111Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E151Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8ProductServiceId',fld:'vPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV28IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV30IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV32IsAuthorized_ResidentTypeName',fld:'vISAUTHORIZED_RESIDENTTYPENAME',pic:'',hsh:true},{av:'AV31IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'sPrefix'},{av:'A31ResidentId',fld:'RESIDENTID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Residenttypename',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H001Y2_A73ProductServiceId = new short[1] ;
         H001Y2_A83ResidentTypeName = new string[] {""} ;
         H001Y2_A82ResidentTypeId = new short[1] ;
         H001Y2_A39ResidentGAMGUID = new string[] {""} ;
         H001Y2_A38ResidentPhone = new string[] {""} ;
         H001Y2_n38ResidentPhone = new bool[] {false} ;
         H001Y2_A37ResidentAddress = new string[] {""} ;
         H001Y2_n37ResidentAddress = new bool[] {false} ;
         H001Y2_A36ResidentEmail = new string[] {""} ;
         H001Y2_A35ResidentInitials = new string[] {""} ;
         H001Y2_n35ResidentInitials = new bool[] {false} ;
         H001Y2_A34ResidentLastName = new string[] {""} ;
         H001Y2_A33ResidentGivenName = new string[] {""} ;
         H001Y2_A40ResidentBsnNumber = new string[] {""} ;
         H001Y2_A31ResidentId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.productserviceproductserviceresidentwc__default(),
            new Object[][] {
                new Object[] {
               H001Y2_A73ProductServiceId, H001Y2_A83ResidentTypeName, H001Y2_A82ResidentTypeId, H001Y2_A39ResidentGAMGUID, H001Y2_A38ResidentPhone, H001Y2_n38ResidentPhone, H001Y2_A37ResidentAddress, H001Y2_n37ResidentAddress, H001Y2_A36ResidentEmail, H001Y2_A35ResidentInitials,
               H001Y2_n35ResidentInitials, H001Y2_A34ResidentLastName, H001Y2_A33ResidentGivenName, H001Y2_A40ResidentBsnNumber, H001Y2_A31ResidentId
               }
               , new Object[] {
      ...
      private bool AV32IsAuthorized_ResidentTypeName ;
      ...
      private short[] H001Y2_A73ProductServiceId ;
      private string[] H001Y2_A83ResidentTypeName ;
      private short[] H001Y2_A82ResidentTypeId ;
      private string[] H001Y2_A39ResidentGAMGUID ;
      private string[] H001Y2_A38ResidentPhone ;
      private bool[] H001Y2_n38ResidentPhone ;
      private string[] H001Y2_A37ResidentAddress ;
      private bool[] H001Y2_n37ResidentAddress ;
      private string[] H001Y2_A36ResidentEmail ;
      private string[] H001Y2_A35ResidentInitials ;
      private bool[] H001Y2_n35ResidentInitials ;
      private string[] H001Y2_A34ResidentLastName ;
      private string[] H001Y2_A33ResidentGivenName ;
      private string[] H001Y2_A40ResidentBsnNumber ;
      private short[] H001Y2_A31ResidentId ;
   ...
   public class productserviceproductserviceresidentwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.ProductServiceId, T3.ResidentTypeName, T2.ResidentTypeId, T2.ResidentGAMGUID, T2.ResidentPhone, T2.ResidentAddress, T2.ResidentEmail, T2.ResidentInitials, T2.ResidentLastName, T2.ResidentGivenName, T2.ResidentBsnNumber, T1.ResidentId";
         sFromString = " FROM ((ResidentProductService T1 INNER JOIN Resident T2 ON T2.ResidentId = T1.ResidentId) INNER JOIN ResidentType T3 ON T3.ResidentTypeId = T2.ResidentTypeId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.ResidentId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.ResidentBsnNumber like '%' || :lV16FilterFullText) or ( T2.ResidentGivenName like '%' || :lV16FilterFullText) or ( T2.ResidentLastName like '%' || :lV16FilterFullText) or ( T2.ResidentInitials like '%' || :lV16FilterFullText) or ( T2.ResidentEmail like '%' || :lV16FilterFullText) or ( T2.ResidentAddress like '%' || :lV16FilterFullText) or ( T2.ResidentPhone like '%' || :lV16FilterFullText) or ( T2.ResidentGAMGUID like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.ResidentTypeId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T3.ResidentTypeName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentBsnNumber, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentBsnNumber DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T1.ResidentId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentGivenName, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentGivenName DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentLastName, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentLastName DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentInitials, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentInitials DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentEmail, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentEmail DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentAddress, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentAddress DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentPhone, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentPhone DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentGAMGUID, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentGAMGUID DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T2.ResidentTypeId, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T2.ResidentTypeId DESC, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 11 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T3.ResidentTypeName, T1.ResidentId";
         }
         else if ( ( AV14OrderedBy == 11 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T3.ResidentTypeName DESC, T1.ResidentId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.ProductServiceId";
         }
                                             ...
                                             short AV8ProductServiceId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((ResidentProductService T1 INNER JOIN Resident T2 ON T2.ResidentId = T1.ResidentId) INNER JOIN ResidentType T3 ON T3.ResidentTypeId = T2.ResidentTypeId)";
         AddWhere(sWhereString, "(T1.ProductServiceId = :AV8ProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(T1.ResidentId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T2.ResidentBsnNumber like '%' || :lV16FilterFullText) or ( T2.ResidentGivenName like '%' || :lV16FilterFullText) or ( T2.ResidentLastName like '%' || :lV16FilterFullText) or ( T2.ResidentInitials like '%' || :lV16FilterFullText) or ( T2.ResidentEmail like '%' || :lV16FilterFullText) or ( T2.ResidentAddress like '%' || :lV16FilterFullText) or ( T2.ResidentPhone like '%' || :lV16FilterFullText) or ( T2.ResidentGAMGUID like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(T2.ResidentTypeId,'9999'), 2) like '%' || :lV16FilterFullText) or ( T3.ResidentTypeName like '%' || :lV16FilterFullText))");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001Y2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (bool)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] );
               case 1 :
                     return conditional_H001Y3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (string)dynConstraints[9] , (short)dynConstraints[10] , (string)dynConstraints[11] , (short)dynConstraints[12] , (bool)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] );
         }
