...
namespace GeneXus.Programs {
   public class createlocationstep3 : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714302679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("createlocationstep3.js", "?202482714302679", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV20LocationReceptionistSDTs',fld:'vLOCATIONRECEPTIONISTSDTS',grid:51,pic:''},{av:'nGXsfl_51_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:51},{av:'nRC_GXsfl_51',ctrl:'GRIDS',prop:'GridRC',grid:51},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV18HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDS.LOAD",",oparms:[{av:'AV34DeleteRecord',fld:'vDELETERECORD',pic:''}]}");
         setEventMetadata("GRIDSPAGINATIONBAR.CHANGEPAGE","{handler:'E112Q2',iparms:[{av:'GRIDS_nFirstRecordOnPage'},{av:'GRIDS_nEOF'},{av:'AV20LocationReceptionistSDTs',fld:'vLOCATIONRECEPTIONISTSDTS',grid:51,pic:''},{av:'nGXsfl_51_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:51},{av:'nRC_GXsfl_51',ctrl:'GRIDS',prop:'GridRC',grid:51},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'AV18HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridspaginationbar_Selectedpage',ctrl:'GRIDSPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("VDELETERECORD.CLICK","{handler:'E202Q2',iparms:[{av:'AV20LocationReceptionistSDTs',fld:'vLOCATIONRECEPTIONISTSDTS',grid:51,pic:''},{av:'nGXsfl_51_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:51},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_51',ctrl:'GRIDS',prop:'GridRC',grid:51},{av:'GRIDS_nEOF'},{av:'subGrids_Rows',ctrl:'GRIDS',prop:'Rows'},{av:'sPrefix'},{av:'AV18HasValidationErrors',fld:'vHASVALIDATIONERRORS',pic:'',hsh:true}]");
         setEventMetadata("VDELETERECORD.CLICK",",oparms:[{av:'AV20LocationReceptionistSDTs',fld:'vLOCATIONRECEPTIONISTSDTS',grid:51,pic:''},{av:'nGXsfl_51_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:51},{av:'GRIDS_nFirstRecordOnPage'},{av:'nRC_GXsfl_51',ctrl:'GRIDS',prop:'GridRC',grid:51}]}");
