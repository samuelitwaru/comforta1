...
namespace GeneXus.Programs {
   public class createcustomer : GXDataArea
   {
      ...
      public createcustomer( IGxContext context )
      {
      ...
      public void execute( string aP0_PreviousStep ,
                           ...
                           bool aP2_GoingBack )
      {
         this.AV9PreviousStep = aP0_PreviousStep;
         this.AV5CurrentStep = aP1_CurrentStep;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV9PreviousStep = gxfirstwebparm;
               AssignAttri("", false, "AV9PreviousStep", AV9PreviousStep);
               GxWebStd.gx_hidden_field( context, "gxhash_vPREVIOUSSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9PreviousStep, "")), context));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV5CurrentStep = GetPar( "CurrentStep");
                  AssignAttri("", false, "AV5CurrentStep", AV5CurrentStep);
                  GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV5CurrentStep, "")), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("createcustomer.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV9PreviousStep)),UrlEncode(StringUtil.RTrim(AV5CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV7GoingBack))}, new string[] {"PreviousStep","CurrentStep","GoingBack"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vWIZARDSTEPS", AV15WizardSteps);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vWIZARDSTEPS", AV15WizardSteps);
         }
         GxWebStd.gx_hidden_field( context, "gxhash_vWIZARDSTEPS", GetSecureSignedToken( "", AV15WizardSteps, context));
         GxWebStd.gx_hidden_field( context, "vCURRENTSTEPAUX", AV6CurrentStepAux);
         GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6CurrentStepAux, "")), context));
         GxWebStd.gx_hidden_field( context, "vPREVIOUSSTEP", AV9PreviousStep);
         GxWebStd.gx_hidden_field( context, "gxhash_vPREVIOUSSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9PreviousStep, "")), context));
         GxWebStd.gx_hidden_field( context, "vCURRENTSTEP", AV5CurrentStep);
         GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV5CurrentStep, "")), context));
      ...
      {
         return formatLink("createcustomer.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV9PreviousStep)),UrlEncode(StringUtil.RTrim(AV5CurrentStep)),UrlEncode(StringUtil.BoolToStr(AV7GoingBack))}, new string[] {"PreviousStep","CurrentStep","GoingBack"})  ;
      }
      ...
      {
         return context.GetMessage( "Create Customer", "") ;
      }
      ...
      protected void START2D2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Create Customer", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E112D2( )
      {
         /* Start Routine */
         returnInSub = false;
         AV15WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "Comforta11");
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step1";
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Customer Information", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Customer Information", "");
         AV15WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Manager Information", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Manager Information", "");
         AV15WizardSteps.Add(AV14WizardStep, 0);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV5CurrentStep)) )
         {
            AV6CurrentStepAux = "Step1";
            AssignAttri("", false, "AV6CurrentStepAux", AV6CurrentStepAux);
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6CurrentStepAux, "")), context));
            AV12WebSession.Remove(AV17Pgmname+"_Data");
         }
         else
         {
            AV6CurrentStepAux = AV5CurrentStep;
            AssignAttri("", false, "AV6CurrentStepAux", AV6CurrentStepAux);
            GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEPAUX", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6CurrentStepAux, "")), context));
         }
         ...
         if ( StringUtil.Len( WebComp_Steptitles_Component) != 0 )
         {
            ...
            WebComp_Steptitles.componentprepare(new Object[] {(string)"W0009",(string)"",(GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>)AV15WizardSteps,(string)AV6CurrentStepAux});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV6CurrentStepAux, "Step1") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "CreateCustomerStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "createcustomerstep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "CreateCustomerStep1";
               WebComp_Wizardstepwc_Component = "CreateCustomerStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0015",(string)"",(string)AV17Pgmname+"_Data",(string)AV9PreviousStep,(bool)AV7GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV6CurrentStepAux, "Step2") == 0 )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "CreateCustomerStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "createcustomerstep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "CreateCustomerStep2";
               WebComp_Wizardstepwc_Component = "CreateCustomerStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void E122D2( )
      {
         ...
         AV11StepNumber = 1;
         AV18GXV1 = 1;
         while ( AV18GXV1 <= AV15WizardSteps.Count )
         {
            AV14WizardStep = ((GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem)AV15WizardSteps.Item(AV18GXV1));
            if ( StringUtil.StrCmp(AV14WizardStep.gxTpr_Code, AV6CurrentStepAux) == 0 )
            {
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV14WizardStep.gxTpr_Description)) )
               {
                  lblWizardstepdescription_Caption = StringUtil.Format( context.GetMessage( "Step %1/%2 :: %3", ""), StringUtil.Trim( StringUtil.Str( (decimal)(AV11StepNumber), 2, 0)), StringUtil.Trim( StringUtil.Str( (decimal)(AV15WizardSteps.Count), 9, 0)), AV14WizardStep.gxTpr_Description, "", "", "", "", "", "");
                  AssignProp("", false, lblWizardstepdescription_Internalname, "Caption", lblWizardstepdescription_Caption, true);
               }
            }
            else
      ...
      protected void wb_table1_6_2D2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_CreateCustomer.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV9PreviousStep = (string)getParm(obj,0);
         AssignAttri("", false, "AV9PreviousStep", AV9PreviousStep);
         GxWebStd.gx_hidden_field( context, "gxhash_vPREVIOUSSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV9PreviousStep, "")), context));
         AV5CurrentStep = (string)getParm(obj,1);
         AssignAttri("", false, "AV5CurrentStep", AV5CurrentStep);
         GxWebStd.gx_hidden_field( context, "gxhash_vCURRENTSTEP", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV5CurrentStep, "")), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482119591260", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("createcustomer.js", "?202482119591260", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Create Customer", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV15WizardSteps',fld:'vWIZARDSTEPS',pic:'',hsh:true},{av:'AV6CurrentStepAux',fld:'vCURRENTSTEPAUX',pic:'',hsh:true},{av:'AV9PreviousStep',fld:'vPREVIOUSSTEP',pic:'',hsh:true},{av:'AV5CurrentStep',fld:'vCURRENTSTEP',pic:'',hsh:true},{av:'AV7GoingBack',fld:'vGOINGBACK',pic:'',hsh:true}]");
      ...
      private string AV5CurrentStep ;
      private string wcpOAV9PreviousStep ;
      private string wcpOAV5CurrentStep ;
      private string AV6CurrentStepAux ;
