...
namespace GeneXus.Programs {
   public class gx00e1 : GXDataArea
   {
      ...
      public void execute( short aP0_pSupplier_GenId ,
                           out short aP1_pProductServiceId )
      {
         this.AV7pSupplier_GenId = aP0_pSupplier_GenId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV7pSupplier_GenId = (short)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
               AssignAttri("", false, "AV7pSupplier_GenId", StringUtil.LTrimStr( (decimal)(AV7pSupplier_GenId), 4, 0));
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV7pSupplier_GenId = (short)(Math.Round(NumberUtil.Val( GetPar( "pSupplier_GenId"), "."), 18, MidpointRounding.ToEven));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProductServiceId, AV7pSupplier_GenId) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00e1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pSupplier_GenId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pSupplier_GenId","pProductServiceId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPSUPPLIER_GENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pSupplier_GenId), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("gx00e1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pSupplier_GenId,4,0)),UrlEncode(StringUtil.LTrimStr(AV8pProductServiceId,4,0))}, new string[] {"pSupplier_GenId","pProductServiceId"})  ;
      }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductserviceidfilter_Internalname, context.GetMessage( "Product Service Id", ""), "", "", lblLblproductserviceidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110b1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00E1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e120b1_client"+"'", TempTags, "", 2, "HLP_Gx00E1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", context.GetMessage( "GX_BtnCancel", ""), bttBtn_cancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00E1.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {AV7pSupplier_GenId, AV6cProductServiceId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A64Supplier_GenId = H000B2_A64Supplier_GenId[0];
               A73ProductServiceId = H000B2_A73ProductServiceId[0];
               /* Execute user event: Load */
               E140B2 ();
      ...
      {
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV7pSupplier_GenId, AV6cProductServiceId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pSupplier_GenId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV7pSupplier_GenId", StringUtil.LTrimStr( (decimal)(AV7pSupplier_GenId), 4, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202482714332754", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00e1.js", "?202482714332755", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("LBLPRODUCTSERVICEIDFILTER.CLICK","{handler:'E110B1',iparms:[{av:'divProductserviceidfiltercontainer_Class',ctrl:'PRODUCTSERVICEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E150B2',iparms:[{av:'A73ProductServiceId',fld:'PRODUCTSERVICEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pProductServiceId',fld:'vPPRODUCTSERVICEID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProductServiceId',fld:'vCPRODUCTSERVICEID',pic:'ZZZ9'},{av:'AV7pSupplier_GenId',fld:'vPSUPPLIER_GENID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_LASTPAGE",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Supplier_genid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H000B2_A64Supplier_GenId = new short[1] ;
         H000B2_A73ProductServiceId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00e1__default(),
            new Object[][] {
                new Object[] {
               H000B2_A64Supplier_GenId, H000B2_A73ProductServiceId
               }
               , new Object[] {
      ...
      private short AV7pSupplier_GenId ;
      private short AV8pProductServiceId ;
      private short wcpOAV7pSupplier_GenId ;
      ...
      private short[] H000B2_A64Supplier_GenId ;
      private short[] H000B2_A73ProductServiceId ;
   ...
   public class gx00e1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV7pSupplier_GenId",GXType.Int16,4,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT Supplier_GenId, ProductServiceId FROM Supplier_GenProductService WHERE Supplier_GenId = :AV7pSupplier_GenId and ProductServiceId >= :AV6cProductServiceId ORDER BY Supplier_GenId, ProductServiceId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H000B3", "SELECT COUNT(*) FROM Supplier_GenProductService WHERE Supplier_GenId = :AV7pSupplier_GenId and ProductServiceId >= :AV6cProductServiceId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
