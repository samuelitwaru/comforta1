...
namespace GeneXus.Programs {
   public class gamactivateuseraccount : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamactivateuseraccount.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV5ActivationKey))}, new string[] {"ActivationKey"}) +"\">") ;
      ...
      {
         return formatLink("gamactivateuseraccount.aspx", new object[] {UrlEncode(StringUtil.RTrim(AV5ActivationKey))}, new string[] {"ActivationKey"})  ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202481915572058", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamactivateuseraccount.js", "?202481915572060", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E120W2',iparms:[]");
